//  DOC: r015atp_70  
//  DOC: MONTHLY REVENUE RECONCILLIATION BY PHYSICIAN BY LOCATION
...
//  R015TPA.CB CONVERSTION TO POWERHOUSE R015ATP.QZS
//  THIS IS THE FIRST OF 3 PROGRAMS APPEND
//  R015BTP.TXT R015CTP.TXT END OF R015ATP.TXT
//  DATE       BY WHOM   DESCRIPTION
//  ;2007/03    YASEMIN   r015aAL
...
namespace RMA_DATA
{
    public class R015ATP_70 : BaseRDLClass
    {
        protected const string REPORT_NAME = "R015ATP_70";
        ...
        public DataSet GetDataSet(string strConnection, string[] arrParameters, string strReportAssembly, bool blnDebug)
        {
            try
            {
                ...
                Sort = "DOCREVTP_CLINIC_NBR ASC, DOCREVTP_AGENT_CD ASC, DOCREVTP_LOC_CD ASC, DOCREVTP_DOC_NBR ASC, DOCREVTP_OMA_CD ASC";
        ...
        public override void DeclareReportControls()
        {
            try
            {
                ...
                AddControl(ReportSection.FOOTING_AT, "X_DOC_NAME", DataTypes.Character, 30);
            }
        ...
        // # Do not delete, modify or move it.  Updated: 2018-05-10 11:27:45 AM
