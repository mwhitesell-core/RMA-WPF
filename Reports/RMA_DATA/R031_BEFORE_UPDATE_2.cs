...
namespace RMA_DATA
{
    public class R031_BEFORE_UPDATE_2 : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "R031_BEFORE_UPDATE_2";
        ...
        //# Do not delete, modify or move it.  Updated: 9/28/2017 7:45:28 AM
