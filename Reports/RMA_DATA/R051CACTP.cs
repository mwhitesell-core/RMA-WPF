...
namespace RMA_DATA
{
    public class R051CACTP : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "R051CACTP";
        ...
        private string F050TP_DOC_REVENUE_MSTR_DOCREVTP_OMA_CD()
        {
            ...
            try
            {
                strReturnValue = rdrF050TP_DOC_REVENUE_MSTR.GetString("DOCREVTP_OMA_CODE") + rdrF050TP_DOC_REVENUE_MSTR.GetNumber("DOCREVTP_OMA_SUFFIX");
            }
