...
namespace RMA_DATA
{
    public class R051CBATP : BaseRDLClass
    {
        protected const string REPORT_NAME = "R051CBATP";
        ...
        public DataSet GetDataSet(string strConnection, string[] arrParameters, string strReportAssembly, bool blnDebug)
        {
            try
            {
                ...
                Sort = "DOCREVTP_CLINIC_NBR ASC, DOC_DEPT ASC, DOC_FULL_PART_IND ASC, DOCREVTP_OMA_CD";
        ...
        private string X_FEE_DESC()
        {
            ...
            try
            {
                if (QDesign.NULL(rdrF050TP_DOC_REVENUE_MSTR.GetString("DOCREVTP_OMA_CODE")) != QDesign.NULL(null))
                {
