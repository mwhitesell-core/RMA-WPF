...
namespace RMA_DATA
{
    public class R004BTP_70 : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "R004BTP_70";
        ...
        public DataSet GetDataSet(string strConnection, string[] arrParameters, string strReportAssembly, bool blnDebug)
        {
            try
            {
                ...
                Sort = "ICONST_CLINIC_NBR_1_2 ASC, CLMHDR_DOC_DEPT ASC, X_DOC_NBR ASC, X_PAT_NAME ASC, CLMDTL_SV_DATE ASC, CLMDTL_ID ASC";
        ...
        private string X_CLAIM_DTL_ID()
        {
            ...
            try
            {
                strReturnValue = QDesign.Substring(rdrF002_CLAIMS_MSTR_DTL.GetString("CLMDTL_BATCH_NBR") + QDesign.ASCII(rdrF002_CLAIMS_MSTR_DTL.GetNumber("CLMDTL_CLAIM_NBR"), 2), 1, 10);
            }
        ...
        public override void DeclareReportControls()
        {
            try
            {
                ...
                AddControl(ReportSection.PAGE_HEADING, "TEMPORARYDATA.R004ATP_70.X_DOC_NBR", DataTypes.Character, 3);
                AddControl(ReportSection.PAGE_HEADING, "TEMPORARYDATA.R004ATP_70.X_DOC_NAME", DataTypes.Character, 35);
                AddControl(ReportSection.PAGE_HEADING, "TEMPORARYDATA.R004ATP_70.CLMHDR_DOC_DEPT", DataTypes.Numeric, 2);
                AddControl(ReportSection.PAGE_HEADING, "INDEXED.F070_DEPT_MSTR.DEPT_NAME", DataTypes.Character, 30);
                AddControl(ReportSection.REPORT, "TEMPORARYDATA.R004ATP_70.X_PAT_NAME", DataTypes.Character, 10);
                AddControl(ReportSection.REPORT, "X_CLAIM_DTL_ID", DataTypes.Character, 10);
                AddControl(ReportSection.REPORT, "TEMPORARYDATA.R004ATP_70.X_PAT_ID_INFO", DataTypes.Character, 12);
        ...
        public override string ReturnControlValue(string strControl, int intSize)
        {
            switch (strControl)
            {
                ...
                case "TEMPORARYDATA.R004ATP_70.X_DOC_NBR":
                    return Common.StringToField(rdrR004ATP_70.GetString("X_DOC_NBR"));

                case "TEMPORARYDATA.R004ATP_70.X_DOC_NAME":
                    return Common.StringToField(rdrR004ATP_70.GetString("X_DOC_NAME"));

                case "TEMPORARYDATA.R004ATP_70.CLMHDR_DOC_DEPT":
                    return rdrR004ATP_70.GetNumber("CLMHDR_DOC_DEPT").ToString();

                case "INDEXED.F070_DEPT_MSTR.DEPT_NAME":
                    return Common.StringToField(rdrF070_DEPT_MSTR.GetString("DEPT_NAME"));

                case "TEMPORARYDATA.R004ATP_70.X_PAT_NAME":
                    return Common.StringToField(rdrR004ATP_70.GetString("X_PAT_NAME"));

                case "X_CLAIM_DTL_ID":
                    return Common.StringToField(X_CLAIM_DTL_ID());

                case "TEMPORARYDATA.R004ATP_70.X_PAT_ID_INFO":
                    return Common.StringToField(rdrR004ATP_70.GetString("X_PAT_ID_INFO"));
                ...
                case "X_OHIP_FEE":
                    return X_OHIP_FEE().ToString().ToString();

                case "X_TECH_FEE":
                    return X_TECH_FEE().ToString().ToString();

                case "X_PROF_FEE":
                    return X_PROF_FEE().ToString().ToString();

                case "X_OHIP_ADJ":
                    return X_OHIP_ADJ().ToString().ToString();

                case "X_TECH_ADJ":
                    return X_TECH_ADJ().ToString().ToString();

                case "X_PROF_ADJ":
                    return X_PROF_ADJ().ToString().ToString();
