...
namespace RMA_DATA
{
    public class R022D : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "R022D";
        ...
        private string F002_CLMDTL_SV_DATE()
        {
        ...
        private string W_PAT_SURNAME()
        {
            ...
            try
            {
                strReturnValue = QDesign.Substring(rdrU020A1.GetString("PAT_SURNAME"), 1, 6);
            }
            catch (Exception ex)
            {
                //  Write the exception to the log file.
        ...
        private string W_PAT_GIVEN_NAME()
        {
            ...
            try
            {
                strReturnValue = QDesign.Substring(rdrU020A1.GetString("PAT_GIVEN_NAME"), 1, 3);
            }
        ...
        private string W_CLAIM_NBR()
        {
            ...
            try
            {
                strReturnValue = rdrF002_CLAIMS_MSTR_HDR.GetNumber("CLMHDR_CLAIM_NBR").ToString();
            }
        ...
        public override void DeclareReportControls()
        {
            try
            {
                 ...
                 AddControl(ReportSection.HEADING_AT, "TEMPORARYDATA.U020A1.CLMHDR_CLAIM_ID", DataTypes.Character, 16);
                 ...
                 AddControl(ReportSection.REPORT, "INDEXED.F002_CLAIMS_MSTR_DTL.CLMDTL_SV_DATE", DataTypes.Character, 8);
        ...
        public override string ReturnControlValue(string strControl, int intSize)
        {
            switch (strControl)
            {
                ...
                case "INDEXED.F002_CLAIMS_MSTR_DTL.CLMDTL_SV_DATE":
                    return Common.StringToField(F002_CLMDTL_SV_DATE());
