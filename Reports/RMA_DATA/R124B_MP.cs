...
namespace RMA_DATA
{
    public class R124B_MP : BaseRDLClass
    {
        ...
        private string X_FF()
        {
            ...
            try
            {
                ...
                strReturnValue = X_ESC() + "&#" + QDesign.Characters(X_FF_NUM());
            }
        ...
        public override bool SelectIf()
        {
            ...
            if (QDesign.NULL(rdrR124A.GetString("COMP_CODE")) != "INCEXP" 
                & QDesign.NULL(rdrR124A.GetString("COMP_CODE")) != "PAYPOT" 
                & (X_NEW_PARM() == "DOC" 
                | (X_NEW_PARM() == "DEP" & QDesign.NULL(rdrR124A.GetNumber("DOC_DEPT")) != 14 & QDesign.NULL(rdrR124A.GetNumber("DOC_DEPT")) != 15 & QDesign.NULL(rdrR124A.GetNumber("DOC_DEPT")) != 31)))
            {
                blnSelected = true;
            }
        ...
        private string X_TITLE_0()
        {
            ...
            try
            {
                strReturnValue = HPIII_FONT_HEIGHT_16() + HPIII_BOLD() + QDesign.Center(rdrF123_COMPANY_MSTR.GetString("COMPANY_NAME").PadRight(40,' ')) + HPIII_FONT_HEIGHT_10() + HPIII_MEDIUM();
            }
