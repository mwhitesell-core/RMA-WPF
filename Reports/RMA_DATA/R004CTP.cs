...
namespace RMA_DATA
{
    public class R004CTP : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "R004CTP";
        ...
        private void Link_F002_CLAIMS_MSTR_HDR()
        {
            ...
            //strSQL.Append(SelectIf_F002_CLAIMS_MSTR(true));
        ...
        public override void DeclareReportControls()
        {
            try
            {
                ...
                AddControl(ReportSection.FOOTING_AT, "INDEXED.F002_CLAIMS_MSTR.CLMHDR_DOC_DEPT", DataTypes.Numeric, 2);
        ...
        //# Do not delete, modify or move it.  Updated: 10/23/2017 2:13:06 PM
