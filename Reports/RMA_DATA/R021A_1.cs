//  #> PROGRAM-ID.     r021a.qzs
//  ((C)) Dyad Infosys LTD  
//  PROGRAM PURPOSE :  this is the program to determine if there is any undefined reject code
//  MODIFICATION HISTORY
//  DATE   WHO         DESCRIPTION
//  06/aug/16 M.C.        - original 
...
namespace RMA_DATA
{
    public class R021A_1 : BaseRDLClass
    {
        protected const string REPORT_NAME = "R021A_1";
        ...
        private void Access_U021A_EDT_1HT_FILE()
        {
            ...
            strSQL.Append("FROM U021A_EDT_1HT_FILE ");
        ...
        private void Link_F093_HDR_1()
        {
            ...
            strSQL.Append("WHERE ");
            strSQL.Append("OHIP_ERR_CODE = ").Append(Common.StringToField(rdrU021A_EDT_1HT_FILE.GetString("RAT_RMB_ERROR_H_CD_1")));
        ...
        private void Link_F093_HDR_2()
        {
            ...
            strSQL.Append("WHERE ");
            strSQL.Append("OHIP_ERR_CODE = ").Append(Common.StringToField(rdrU021A_EDT_1HT_FILE.GetString("RAT_RMB_ERROR_H_CD_2")));
        ...
        private void Link_F093_HDR_3()
        {
            ...
            strSQL.Append("WHERE ");
            strSQL.Append("OHIP_ERR_CODE = ").Append(Common.StringToField(rdrU021A_EDT_1HT_FILE.GetString("RAT_RMB_ERROR_H_CD_3")));
        ...
        private void Link_F093_HDR_4()
        {
            ...
            strSQL.Append("WHERE ");
            strSQL.Append("OHIP_ERR_CODE = ").Append(Common.StringToField(rdrU021A_EDT_1HT_FILE.GetString("RAT_RMB_ERROR_H_CD_4")));
        ...
        private void Link_F093_HDR_5()
        {
            ...
            strSQL.Append("WHERE ");
            strSQL.Append("OHIP_ERR_CODE = ").Append(Common.StringToField(rdrU021A_EDT_1HT_FILE.GetString("RAT_RMB_ERROR_H_CD_5")));
        ...
        private void Link_F093_DTL_1()
        {
            ...
            strSQL.Append("WHERE ");
            strSQL.Append("OHIP_ERR_CODE = ").Append(Common.StringToField(rdrU021A_EDT_1HT_FILE.GetString("RAT_RMB_ERROR_T_CD_1")));
        ...
        private void Link_F093_DTL_2()
        {
            ...
            strSQL.Append("WHERE ");
            strSQL.Append("OHIP_ERR_CODE = ").Append(Common.StringToField(rdrU021A_EDT_1HT_FILE.GetString("RAT_RMB_ERROR_T_CD_2")));
        ...
        private void Link_F093_DTL_3()
        {
            ...
            strSQL.Append("WHERE ");
            strSQL.Append("OHIP_ERR_CODE = ").Append(Common.StringToField(rdrU021A_EDT_1HT_FILE.GetString("RAT_RMB_ERROR_T_CD_3")));
        ...
        private void Link_F093_DTL_4()
        {
            ...
            strSQL.Append("WHERE ");
            strSQL.Append("OHIP_ERR_CODE = ").Append(Common.StringToField(rdrU021A_EDT_1HT_FILE.GetString("RAT_RMB_ERROR_T_CD_4")));
        ...
        private void Link_F093_DTL_5()
        {
            ...
            strSQL.Append("WHERE ");
            strSQL.Append("OHIP_ERR_CODE = ").Append(Common.StringToField(rdrU021A_EDT_1HT_FILE.GetString("RAT_RMB_ERROR_T_CD_5")));
        ...
        public override bool SelectIf()
        {
            ...
            if ((QDesign.NULL(rdrU021A_EDT_1HT_FILE.GetString("RAT_RMB_ERROR_H_CD_1")) != QDesign.NULL(" ") && !ReportDataFunctions.Exists(rdrF093_HDR_1)) ||
                (QDesign.NULL(rdrU021A_EDT_1HT_FILE.GetString("RAT_RMB_ERROR_H_CD_2")) != QDesign.NULL(" ") && !ReportDataFunctions.Exists(rdrF093_HDR_2)) ||
                (QDesign.NULL(rdrU021A_EDT_1HT_FILE.GetString("RAT_RMB_ERROR_H_CD_3")) != QDesign.NULL(" ") && !ReportDataFunctions.Exists(rdrF093_HDR_3)) ||
                (QDesign.NULL(rdrU021A_EDT_1HT_FILE.GetString("RAT_RMB_ERROR_H_CD_4")) != QDesign.NULL(" ") && !ReportDataFunctions.Exists(rdrF093_HDR_4)) ||
                (QDesign.NULL(rdrU021A_EDT_1HT_FILE.GetString("RAT_RMB_ERROR_H_CD_5")) != QDesign.NULL(" ") && !ReportDataFunctions.Exists(rdrF093_HDR_5)) ||
                (QDesign.NULL(rdrU021A_EDT_1HT_FILE.GetString("RAT_RMB_ERROR_T_CD_1")) != QDesign.NULL(" ") && !ReportDataFunctions.Exists(rdrF093_DTL_1)) ||
                (QDesign.NULL(rdrU021A_EDT_1HT_FILE.GetString("RAT_RMB_ERROR_T_CD_2")) != QDesign.NULL(" ") && !ReportDataFunctions.Exists(rdrF093_DTL_2)) ||
                (QDesign.NULL(rdrU021A_EDT_1HT_FILE.GetString("RAT_RMB_ERROR_T_CD_3")) != QDesign.NULL(" ") && !ReportDataFunctions.Exists(rdrF093_DTL_3)) ||
                (QDesign.NULL(rdrU021A_EDT_1HT_FILE.GetString("RAT_RMB_ERROR_T_CD_4")) != QDesign.NULL(" ") && !ReportDataFunctions.Exists(rdrF093_DTL_4)) ||
                (QDesign.NULL(rdrU021A_EDT_1HT_FILE.GetString("RAT_RMB_ERROR_T_CD_5")) != QDesign.NULL(" ") && !ReportDataFunctions.Exists(rdrF093_DTL_5)))
            {
                blnSelected = true;
            }
        ...
        public override void DeclareReportControls()
        {
            try
            {
                AddControl(ReportSection.SUMMARY, "U021A_EDT_1HT_FILE.RAT_RMB_GROUP_NBR", DataTypes.Character, 4);
                AddControl(ReportSection.SUMMARY, "U021A_EDT_1HT_FILE.RAT_RMB_ACCOUNT_NBR", DataTypes.Character, 8);
                AddControl(ReportSection.SUMMARY, "U021A_EDT_1HT_FILE.RAT_RMB_ERROR_H_CD_1", DataTypes.Character, 3);
                AddControl(ReportSection.SUMMARY, "U021A_EDT_1HT_FILE.RAT_RMB_ERROR_H_CD_2", DataTypes.Character, 3);
                AddControl(ReportSection.SUMMARY, "U021A_EDT_1HT_FILE.RAT_RMB_ERROR_H_CD_3", DataTypes.Character, 3);
                AddControl(ReportSection.SUMMARY, "U021A_EDT_1HT_FILE.RAT_RMB_ERROR_H_CD_4", DataTypes.Character, 3);
                AddControl(ReportSection.SUMMARY, "U021A_EDT_1HT_FILE.RAT_RMB_ERROR_H_CD_5", DataTypes.Character, 3);
                AddControl(ReportSection.SUMMARY, "U021A_EDT_1HT_FILE.RAT_RMB_ERROR_T_CD_1", DataTypes.Character, 3);
                AddControl(ReportSection.SUMMARY, "U021A_EDT_1HT_FILE.RAT_RMB_ERROR_T_CD_2", DataTypes.Character, 3);
                AddControl(ReportSection.SUMMARY, "U021A_EDT_1HT_FILE.RAT_RMB_ERROR_T_CD_3", DataTypes.Character, 3);
                AddControl(ReportSection.SUMMARY, "U021A_EDT_1HT_FILE.RAT_RMB_ERROR_T_CD_4", DataTypes.Character, 3);
                AddControl(ReportSection.SUMMARY, "U021A_EDT_1HT_FILE.RAT_RMB_ERROR_T_CD_5", DataTypes.Character, 3);
                AddControl(ReportSection.SUMMARY, "U021A_EDT_1HT_FILE.RAT_RMB_PROCESS_DATE", DataTypes.Numeric, 8);
                AddControl(ReportSection.SUMMARY, "U021A_EDT_1HT_FILE.RAT_RMB_FILE_NAME", DataTypes.Character, 12);
            }
