...
// department total 
// 09/apr/14 M.C.      - access r031a_active_doctor instead
// 2016/Jul/14 MC1       - change picture 
// 2009/04/14 - MC
...
namespace RMA_DATA
{
    public class R030K : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "R030K";
        ...
        public override void DeclareReportControls()
        {
            try
            {
                AddControl(ReportSection.FOOTING_AT, "TEMPORARYDATA.R031A_ACTIVE_DOCTOR.X_TOTAL_PAID_AMT", DataTypes.Numeric, 8);
                AddControl(ReportSection.REPORT, "TEMPORARYDATA.R031A_ACTIVE_DOCTOR.X_CLINIC", DataTypes.Numeric, 2);
        ...
        //# Do not delete, modify or move it.  Updated: 9/27/2017 2:21:37 PM
        ...
        public override string ReturnControlValue(string strControl, int intSize)
        {
            switch (strControl)
            {
                ...
                case "TEMPORARYDATA.R031A_ACTIVE_DOCTOR.X_CLINIC":
                    return rdrR031A_ACTIVE_DOCTOR.GetNumber("X_CLINIC").ToString().PadLeft(2, ' ');
                ...
                case "DOC_DATE_FAC_TERM":
                    return DOC_DATE_FAC_TERM().ToString().ToString().PadLeft(8, ' ');
