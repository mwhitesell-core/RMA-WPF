...
namespace RMA_DATA
{
    public class YASCLARE_2 : BaseRDLClass
    {
        protected const string REPORT_NAME = "YASCLARE_2";
        ...
        public override bool SelectIf()
        {
            ...
            if ((QDesign.NULL(rdrCLARE2.GetString("DOC_NBR")) == "P31") 
                        || (QDesign.NULL(rdrCLARE2.GetString("DOC_NBR")) == "567") 
                        || (QDesign.NULL(rdrCLARE2.GetString("DOC_NBR")) == "098") 
                        || (QDesign.NULL(rdrCLARE2.GetString("DOC_NBR")) == "09P") 
                        || (QDesign.NULL(rdrCLARE2.GetString("DOC_NBR")) == "W37"))
            {
                blnSelected = true;
            }
