...
namespace RMA_DATA
{
    public class R140_A5 : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "R140_A5";
        protected const bool REPORT_HAS_PARAMETERS = false;

        // Data Helpers.
        private Reader rdrR140_A1 = new Reader();
        private Reader rdrF074_AFP_GROUP_MSTR = new Reader();
        private Reader rdrF074_AFP_GROUP_SEQUENCE_MSTR = new Reader();

        //#CORE_BEGIN_INCLUDE: PRINTER_CODES"

        //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
        //# Do not delete, modify or move it.  Updated: 11/14/2017 1:46:35 PM
        ...
        public DataSet GetDataSet(string strConnection, string[] arrParameters, string strReportAssembly, bool blnDebug)
        {
            try
            {
                ...
                Sort = "AFP_REPORTING_MTH ASC, CONST_SECTION ASC, REPORTING_SEQ ASC";
        ...
        private void Link_F074_AFP_GROUP_SEQUENCE_MSTR()
        {
            StringBuilder strSQL = new StringBuilder(string.Empty);

            strSQL.Append("SELECT ");
            strSQL.Append("DOC_AFP_PAYM_GROUP, ");
            strSQL.Append("CONST_SECTION, ");
            strSQL.Append("REPORTING_SEQ, ");
            strSQL.Append("TOTAL_FLAG ");
            strSQL.Append("FROM [101C].INDEXED.F074_AFP_GROUP_SEQUENCE_MSTR ");
            strSQL.Append("WHERE ");
            strSQL.Append("DOC_AFP_PAYM_GROUP = ").Append(Common.StringToField(rdrR140_A1.GetString("DOC_AFP_PAYM_GROUP")));

            rdrF074_AFP_GROUP_SEQUENCE_MSTR.GetOptionalTable = SqlHelper.ExecuteDataTable(m_cnnQUERY, CommandType.Text, strSQL.ToString());
        ...
        private string X_PERCENTAGE()
        {
            ...
            try
            {
                if (QDesign.NULL(rdrR140_A1.GetNumber("AFP_PAYMENT_PERCENTAGE")) != QDesign.NULL(0d))
                {
                    strReturnValue = "   " + QDesign.ASCII(rdrR140_A1.GetNumber("AFP_PAYMENT_PERCENTAGE"), 2);
                }
                else
                {
        ...
        private decimal RMA_TOTAL()
        {
            decimal decReturnValue = 0;

            try
            {
                if (QDesign.NULL(rdrF074_AFP_GROUP_SEQUENCE_MSTR.GetString("TOTAL_FLAG")) == QDesign.NULL("R"))
                {
        ...
        private decimal RMA_INC_TOTAL()
        {
            decimal decReturnValue = 0;

            try
            {
                if (QDesign.NULL(rdrF074_AFP_GROUP_SEQUENCE_MSTR.GetString("TOTAL_FLAG")) == QDesign.NULL("I"))
                {
                    decReturnValue = rdrR140_A1.GetNumber("X_PAYMENT_AMT");
                }
            }
        ...
        private decimal SOLO_TOTAL()
        {
            decimal decReturnValue = 0;

            try
            {
                if (QDesign.NULL(rdrF074_AFP_GROUP_SEQUENCE_MSTR.GetString("TOTAL_FLAG")) == QDesign.NULL("S"))
                {
                    decReturnValue = rdrR140_A1.GetNumber("X_PAYMENT_AMT");
                }
            }
        ...
        private decimal OTHER_TOTAL()
        {
            decimal decReturnValue = 0;

            try
            {
                if (QDesign.NULL(rdrF074_AFP_GROUP_SEQUENCE_MSTR.GetString("TOTAL_FLAG")) == QDesign.NULL("O"))
                {
                    decReturnValue = rdrR140_A1.GetNumber("X_PAYMENT_AMT");
                }
            }
        ...
        private decimal RMA_INC_SUB_TOTAL()
        {
            decimal decReturnValue = 0;

            try
            {
                decReturnValue = RMA_INC_TOTAL() + SOLO_TOTAL() + OTHER_TOTAL();
            }
        ...
        private decimal GRAND_TOTAL()
        {
            ...
            try
            {
                decReturnValue = RMA_TOTAL() + RMA_INC_TOTAL() + SOLO_TOTAL() + OTHER_TOTAL();
            }
        ...
        public override void DeclareReportControls()
        {
            try
            {
                ...
                AddControl(ReportSection.REPORT, "X_PERCENTAGE", DataTypes.Character, 5);
                ...
                AddControl(ReportSection.FINAL_FOOTING, "SOLO_TOTAL", DataTypes.Numeric, 11);
                AddControl(ReportSection.FINAL_FOOTING, "RMA_INC_TOTAL", DataTypes.Numeric, 11);
                AddControl(ReportSection.FINAL_FOOTING, "OTHER_TOTAL", DataTypes.Numeric, 11);
                AddControl(ReportSection.FINAL_FOOTING, "RMA_INC_SUB_TOTAL", DataTypes.Numeric, 11);
                AddControl(ReportSection.FINAL_FOOTING, "RMA_TOTAL", DataTypes.Numeric, 11);
                AddControl(ReportSection.FINAL_FOOTING, "GRAND_TOTAL", DataTypes.Numeric, 11);
                AddControl(ReportSection.REPORT, "INDEXED.F074_AFP_GROUP_SEQUENCE_MSTR.CONST_SECTION", DataTypes.Character, 2);
                AddControl(ReportSection.REPORT, "INDEXED.F074_AFP_GROUP_SEQUENCE_MSTR.REPORTING_SEQ", DataTypes.Numeric, 2);
            }
        ...
        public override string ReturnControlValue(string strControl, int intSize)
        {
            ...
            {
                case "X_FF":
                    return Common.StringToField(X_FF().ToString());
                ...
                case "X_PERCENTAGE":
                    return Common.StringToField(X_PERCENTAGE().PadRight(5, ' '));

                case "TEMPORARYDATA.R140_A1.X_PAYMENT_AMT":
                    return rdrR140_A1.GetNumber("X_PAYMENT_AMT").ToString().PadLeft(11, ' ');

                case "TEMPORARYDATA.R140_A1.X_SUBMISSION_AMT":
                    return rdrR140_A1.GetNumber("X_SUBMISSION_AMT").ToString().PadLeft(11, ' ');

                case "SOLO_TOTAL":
                    return SOLO_TOTAL().ToString().PadLeft(11, ' ');

                case "RMA_INC_TOTAL":
                    return RMA_INC_TOTAL().ToString().PadLeft(11, ' ');

                case "OTHER_TOTAL":
                    return OTHER_TOTAL().ToString().PadLeft(11, ' ');

                case "RMA_INC_SUB_TOTAL":
                    return RMA_INC_SUB_TOTAL().ToString().PadLeft(11, ' ');

                case "RMA_TOTAL":
                    return RMA_TOTAL().ToString().PadLeft(11, ' ');

                case "GRAND_TOTAL":
                    return GRAND_TOTAL().ToString().PadLeft(11, ' ');

                case "INDEXED.F074_AFP_GROUP_SEQUENCE_MSTR.CONST_SECTION":
                    return Common.StringToField(rdrF074_AFP_GROUP_SEQUENCE_MSTR.GetString("CONST_SECTION").PadRight(2, ' '));

                case "INDEXED.F074_AFP_GROUP_SEQUENCE_MSTR.REPORTING_SEQ":
                    return rdrF074_AFP_GROUP_SEQUENCE_MSTR.GetNumber("REPORTING_SEQ").ToString().PadLeft(2, ' ');
        ...
        public override void AccessData()
        {
            try
            {
                ...
                while (rdrR140_A1.Read())
                {
                    ...
                    {
                        Link_F074_AFP_GROUP_SEQUENCE_MSTR();
                        while ((rdrF074_AFP_GROUP_SEQUENCE_MSTR.Read()))
                        {
                            WriteData();
                        }
                        rdrF074_AFP_GROUP_SEQUENCE_MSTR.Close();
                    }
        ...
        public override void CloseReaders()
        {
            ...
            if ((rdrF074_AFP_GROUP_SEQUENCE_MSTR != null))
            {
                rdrF074_AFP_GROUP_SEQUENCE_MSTR.Close();
                rdrF074_AFP_GROUP_SEQUENCE_MSTR = null;
            }
        }
