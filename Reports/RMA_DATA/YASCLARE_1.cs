...
namespace RMA_DATA
{
    public class YASCLARE_1 : BaseRDLClass
    {
        protected const string REPORT_NAME = "YASCLARE_1";
        ...
        public override bool SelectIf()
        {
            ...
            if ((QDesign.NULL(rdrCLARE2.GetString("DOC_NBR")) == "910") 
                        || (QDesign.NULL(rdrCLARE2.GetString("DOC_NBR")) == "W38") 
                        || (QDesign.NULL(rdrCLARE2.GetString("DOC_NBR")) == "449") 
                        || (QDesign.NULL(rdrCLARE2.GetString("DOC_NBR")) == "G19") 
                        || (QDesign.NULL(rdrCLARE2.GetString("DOC_NBR")) == "219") 
                        || (QDesign.NULL(rdrCLARE2.GetString("DOC_NBR")) == "65E") 
                        || (QDesign.NULL(rdrCLARE2.GetString("DOC_NBR")) == "942") 
                        || (QDesign.NULL(rdrCLARE2.GetString("DOC_NBR")) == "K41"))
            {
                blnSelected = true;
            }
