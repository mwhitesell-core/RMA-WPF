...
namespace RMA_DATA
{
    public class R022E3 : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "R022E3";
        ...
        public override string ReturnControlValue(string strControl, int intSize)
        {
            switch (strControl)
            {
                ...
                case "TEMPORARYDATA.U020E2.W_BATCH_TYPE":
                    return Common.StringToField(rdrU022E2.GetString("W_BATCH_TYPE"));

                case "TEMPORARYDATA.U020E2.BATCTRL_ADJ_CD":
                    return Common.StringToField(rdrU022E2.GetString("BATCTRL_ADJ_CD"));
