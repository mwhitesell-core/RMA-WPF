...
namespace RMA_DATA
{
    public class MP_UTL0201_3 : BaseRDLClass
    {
        ...
        private void Access_UTL0201()
        {
            ...
            strSQL.Append("X_PED, ");
            strSQL.Append("DOC_NAME, DOC_NBR ");
        ...
        private void Link_F119_DOCTOR_YTD_HISTORY()
        {
            ...
            strSQL.Append("WHERE ");
            strSQL.Append("DOC_NBR = ").Append(Common.StringToField(rdrUTL0201.GetString("DOC_NBR")));
        ...
        public override void DeclareReportControls()
        {
            try
            {
                ...
                AddControl(ReportSection.REPORT, "INDEXED.F119_DOCTOR_YTD_HISTORY.AMT_YTD", DataTypes.Numeric, 9);
            }
        ...
        //# Do not delete, modify or move it.  Updated: 10/27/2017 1:32:44 PM
        ...
        public override string ReturnControlValue(string strControl, int intSize)
        {
            switch (strControl)
            {
                ...
                case "AMT_DIFF":
                    return AMT_DIFF().ToString().ToString().PadLeft(7, ' ');
