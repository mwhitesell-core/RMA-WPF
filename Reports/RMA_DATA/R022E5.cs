...
namespace RMA_DATA
{
    public class R022E5 : BaseRDLClass
    {
        protected const string REPORT_NAME = "R022E5";
        ...
        private string SelectIf_U020A1(bool blnAddWhere)
        {
            ...
            strSQL.Append(" (    BATCTRL_AGENT_CD =  0 OR ");
            strSQL.Append("    BATCTRL_AGENT_CD =  2 ))");
        ...
        private string PREV_CLMHDR_CLAIM_ID = string.Empty;
        ...
        public override void DeclareReportControls()
        {
            try
            {
                ...
                AddControl(ReportSection.FOOTING_AT, "TEMPORARYDATA.U020A1.CLMHDR_TOT_CLAIM_AR_OHIP", DataTypes.Numeric, 9);//, SummaryType.SUBTOTAL, "CLMHDR_CLAIM_ID");
                AddControl(ReportSection.REPORT, "TEMPORARYDATA.U020A1.BATCTRL_BATCH_NBR", DataTypes.Character, 8);
                AddControl(ReportSection.REPORT, "TEMPORARYDATA.U020A1.CLMHDR_CLAIM_ID", DataTypes.Character, 16);
            ...
            try
            {
                ...
                while (rdrU020A1.Read())
                {
                    ...
                    while (rdrF002_CLAIMS_MSTR.Read())
                    {
                        ...
                        else if (PREV_BATCTRL_BATCH_NBR != rdrU020A1.GetString("BATCTRL_BATCH_NBR"))
                        {
                            SEQUENCE_NBR_VALUE++;
                            SetPreviousValues();
                        }
        ...
        {
            PREV_BATCTRL_BATCH_NBR = rdrU020A1.GetString("BATCTRL_BATCH_NBR");
            PREV_CLMHDR_CLAIM_ID = rdrU020A1.GetString("CLMHDR_CLAIM_ID");
        }
