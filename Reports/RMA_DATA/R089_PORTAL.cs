...
namespace RMA_DATA
{
    public class R089_PORTAL : BaseRDLClass
    {
        protected const string REPORT_NAME = "R089_PORTAL";
        ...
        public DataSet GetDataSet(string strConnection, string[] arrParameters, string strReportAssembly, bool blnDebug)
        {
            try
            {
                ...
                Sort = "DOC_NBR ASC, X_DOC_NAME ASC, PAT_OLD_SURNAME ASC, CLMHDR_PAT_OHIP_ID_OR_CHART ASC";
        ...
        private string X_DOC_NAME()
        {
            ...
            try
            {
                strReturnValue = (F020_DOCTOR_MSTR_DOC_INITS() + (" " + QDesign.Pack(rdrF020_DOCTOR_MSTR.GetString("DOC_NAME")).TrimEnd()));
            }
        ...
        private string X_DOC_DEPT_NBR()
        {
            ...
            {
                strReturnValue = ("~" 
                            + (rdrREJECTED_CLAIMS.GetString("DOC_NBR") 
        ...
        public override void DeclareReportControls()
        {
            try
            {
                 ...
                 AddControl(ReportSection.PAGE_HEADING, "INDEXED.REJECTED_CLAIMS.DOC_NBR", DataTypes.Character, 3);
                 AddControl(ReportSection.PAGE_HEADING, "DOC_INITS", DataTypes.Character, 3);
        ...
        // # Do not delete, modify or move it.  Updated: 2018-05-14 10:20:15 AM
