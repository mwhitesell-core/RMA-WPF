...
// report(less messy)
// 2013/Jan/23 MC1     - include patient surname & given names in the subfile r004a
// - since this program selects to run one clinic at a time, choose 1 time is sufficient
...
namespace RMA_DATA
{
    public class R004A : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "R004A";
        ...
        private void Link_ICONST_MSTR_REC()
        {
            ...
            strSQL.Append("WHERE ");
            strSQL.Append("ICONST_CLINIC_NBR_1_2 = ").Append(Common.StringToField(QDesign.Substring(rdrF001_BATCH_CONTROL_FILE.GetString("BATCTRL_BATCH_NBR"), 1, 2)));
        ...
        private string Choose()
        {
            ...
            strChoose.Append(ReportDataFunctions.GetWhereCondition("BATCTRL_BATCH_NBR", QDesign.NULL(ReportFunctions.astrScreenParameters[0].ToString()), true));
        ...
        public override bool SelectIf()
        {
            ...
            if ((QDesign.NULL(rdrF001_BATCH_CONTROL_FILE.GetString("BATCTRL_DATE_PERIOD_END")) == QDesign.NULL(QDesign.ASCII(ICONST_MSTR_REC_ICONST_DATE_PERIOD_END()))))
            {
                blnSelected = true;
            }
        ...
        private string X_DOC_NBR()
        {
            ...
            try
            {
                //strReturnValue = QDesign.Substring(rdrF002_CLAIMS_MSTR.GetString("CLMHDR_CLAIM_ID"), 3, 3);
        ...
        private string F010_PAT_MSTR_PAT_OHIP_MMYY()
        {
            ...
            try
            {
                strReturnValue = rdrF010_PAT_MSTR.GetString("PAT_DIRECT_ALPHA") + QDesign.ASCII(rdrF010_PAT_MSTR.GetNumber("PAT_DIRECT_YY"), 2) + QDesign.ASCII(rdrF010_PAT_MSTR.GetNumber("PAT_DIRECT_MM"), 2) + QDesign.ASCII(rdrF010_PAT_MSTR.GetNumber("PAT_DIRECT_DD"), 2) + rdrF010_PAT_MSTR.GetString("PAT_DIRECT_LAST_6");
            }
            catch (Exception ex)
            {
                // Write the exception to the log file.
        ...
        public override void DeclareReportControls()
        {
            try
            {
                ...
                AddControl(ReportSection.SUMMARY, "INDEXED.F002_CLAIMS_MSTR.CLMHDR_ADJ_CD_SUB_TYPE", DataTypes.Character, 1);
                AddControl(ReportSection.SUMMARY, "INDEXED.F002_CLAIMS_MSTR.CLMHDR_BATCH_TYPE", DataTypes.Character, 1);
        ...
        public override string ReturnControlValue(string strControl, int intSize)
        {
            switch (strControl)
            {
                ...
                case "INDEXED.F002_CLAIMS_MSTR.CLMHDR_BATCH_TYPE":
                    return Common.StringToField(rdrF002_CLAIMS_MSTR.GetString("CLMHDR_BATCH_TYPE").PadRight(1, ' '));
