...
namespace RMA_DATA
{
    public class MARYACADEM : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "MARYACADEM";
        ...
        private string Choose()
        {
            ...
            strChoose.Append(ReportDataFunctions.GetWhereCondition("COMP_CODE", "ACADEM", true));
        ...
        //# Do not delete, modify or move it.  Updated: 8/22/2017 10:53:16 AM
        ...
        public override string ReturnControlValue(string strControl, int intSize)
        {
            switch (strControl)
            {
                case "INDEXED.F114_SPECIAL_PAYMENTS.AMT_NET":
                    return rdrF114_SPECIAL_PAYMENTS.GetNumber("AMT_NET").ToString();

                case "INDEXED.F114_SPECIAL_PAYMENTS.AMT_GROSS":
                    return rdrF114_SPECIAL_PAYMENTS.GetNumber("AMT_GROSS").ToString();
