...
//  DOC: FOR Agent 6 only TOTALS AT DOC NO. (CLINIC 70 ONLY)
//  DOC: RUN FOR: for computer operation balancing payroll
//  PROGRAM PURPOSE : COMPUTERIZE REPORT WHICH WAS CREATED MANUALLY
//  DATE       WHO       DESCRIPTION
//  2007/MAY   Y.B.      copied utl0007_70 
...
namespace RMA_DATA
{
    public class UTL0007A_70 : BaseRDLClass
    {
        protected const string REPORT_NAME = "UTL0007A_70";
        ...
        private void Access_F050TP_DOC_REVENUE_MSTR()
        {
            ...
            strSQL.Append(" DOCREVTP_DOC_NBR, ");
            strSQL.Append("DOCREVTP_IN_TECH_AMT_BILLED, ");
            strSQL.Append("DOCREVTP_OUT_TECH_AMT_BILLED, ");
            strSQL.Append("DOCREVTP_IN_TECH_AMT_ADJUSTS, ");
            strSQL.Append("DOCREVTP_OUT_TECH_AMT_ADJUSTS, ");
            strSQL.Append("DOCREVTP_IN_TECH_NBR_SVC, ");
            strSQL.Append("DOCREVTP_OUT_TECH_NBR_SVC, ");
            strSQL.Append("DOCREVTP_IN_PROF_AMT_BILLED, ");
            strSQL.Append("DOCREVTP_OUT_PROF_AMT_BILLED, ");
            strSQL.Append("DOCREVTP_IN_PROF_AMT_ADJUSTS, ");
            strSQL.Append("DOCREVTP_OUT_PROF_AMT_ADJUSTS, ");
            strSQL.Append("DOCREVTP_IN_PROF_NBR_SVC, ");
            strSQL.Append("DOCREVTP_OUT_PROF_NBR_SVC, ");
            strSQL.Append("DOCREVTP_AGENT_CD ");
        ...
        // # Do not delete, modify or move it.  Updated: 2018-05-16 12:44:26 PM
