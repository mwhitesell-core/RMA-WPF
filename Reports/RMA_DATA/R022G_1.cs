...
//  with reason code `36`
//  2010/Oct/04 MC2     - Yasemin (Lori) requested to not prdecimal if clinic 78, 79, 80, 82, 86, 88, 89 & 91 to 95 with error code 55 
...
namespace RMA_DATA
{
    public class R022G_1 : BaseRDLClass
    {
        protected const string REPORT_NAME = "R022G_1";
        ...
        public override bool SelectIf()
        {
            ...
            if ((QDesign.NULL(rdrF002_CLAIMS_MSTR.GetString("CLMHDR_BATCH_TYPE")) == "C" 
                        ...
                        && (QDesign.NULL(QDesign.Substring(rdrF002_CLAIMS_MSTR.GetString("CLMHDR_REFERENCE"), 1, 2)) != "I2" 
                        && QDesign.NULL(QDesign.Substring(rdrF002_CLAIMS_MSTR.GetString("CLMHDR_REFERENCE"), 1, 2)) != "12" 
                        && QDesign.NULL(QDesign.Substring(rdrF002_CLAIMS_MSTR.GetString("CLMHDR_REFERENCE"), 1, 4)) != "PAID")))
            {
                blnSelected = true;
            }
        ...
        private string X_CLINIC()
        {
            ...
            try
            {
                strReturnValue = QDesign.Substring(F002_CLAIMS_MSTR_CLMHDR_CLAIM_ID(), 1, 2);
            }
        ...
        public override void DeclareReportControls()
        {
            try
            {
                 ...
                 AddControl(ReportSection.SUMMARY, "CLMHDR_DATE_CASH_TAPE_PAYMENT", DataTypes.Character, 8);
        ...
        public override string ReturnControlValue(string strControl, int intSize)
        {
            switch (strControl)
            {
                ...
                case "CLMHDR_DATE_CASH_TAPE_PAYMENT":
                    return Common.StringToField(F002_CLAIMS_MSTR_CLMHDR_DATE_CASH_TAPE_PAYMENT(), intSize);
