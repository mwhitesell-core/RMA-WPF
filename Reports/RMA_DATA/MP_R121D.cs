...
namespace RMA_DATA
{
    public class MP_R121D : BaseRDLClass
    {
        ...
        public override bool SelectIf()
        {
            ...
            if (QDesign.NULL(rdrF070_DEPT_MSTR.GetNumber("DEPT_COMPANY")) == QDesign.NULL(2d) && QDesign.NULL(rdrF112_PYCDCEILINGS.GetString("DOC_PAY_CODE")) != QDesign.NULL("7"))
            {
                blnSelected = true;
            }
