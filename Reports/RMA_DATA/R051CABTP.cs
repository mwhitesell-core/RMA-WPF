...
namespace RMA_DATA
{
    public class R051CABTP : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "R051CABTP";
        ...
        public DataSet GetDataSet(string strConnection, string[] arrParameters, string strReportAssembly, bool blnDebug)
        {
            try
            {
                ...
                Sort = "DOCREVTP_CLINIC_NBR ASC, DOC_FULL_PART_IND ASC";
        ...
        private void Link_F040_OMA_FEE_MSTR()
        {
            ...
            strSQL.Append("WHERE ");
            //strSQL.Append("FEE_OMA_CD = ").Append(Common.StringToField(rdrF050TP_DOC_REVENUE_MSTR.GetString("DOCREVTP_OMA_CD")));
            strSQL.Append("FEE_OMA_CD_LTR1 = ").Append(Common.StringToField(rdrF050TP_DOC_REVENUE_MSTR.GetString("DOCREVTP_OMA_CODE")).Substring(0, 1));
            strSQL.Append("FILLER_NUMERIC = ").Append(Common.StringToField(rdrF050TP_DOC_REVENUE_MSTR.GetString("DOCREVTP_OMA_CODE")).Substring(1));
        ...
        private string Choose()
        {
            ...
            strChoose.Append("WHERE DOCREVTP_CLINIC_NBR BETWEEN 60 AND 66");
