...
// DOC: R119B.QZS
// DOC; REPORT MTD AND YTD FIGURES PRINT AT DOC-DEPT
...
// 03/dec/16 A.A.      alpah doctor nbr
...
namespace RMA_DATA
{
    public class R119B : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "R119B";
        ...
        private void Access_Data()
        {
            ...
            strSQL.Append("ORDER BY mstr.DOC_DEPT ");
