...
namespace RMA_DATA
{
    public class UTL0007 : BaseRDLClass
    {
        protected const string REPORT_NAME = "UTL0007";
        ...
        public override bool SelectIf()
        {
            ...
            if (((QDesign.NULL(X_PROF()) != QDesign.NULL(0d))
        ...
        public override void DeclareReportControls()
        {
            try
            {
                ...
                AddControl(ReportSection.FOOTING_AT, "X_NAME", DataTypes.Character, 26);
        ...
        // # Do not delete, modify or move it.  Updated: 2018-05-16 12:44:52 PM
