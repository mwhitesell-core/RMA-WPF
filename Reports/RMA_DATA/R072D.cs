...
namespace RMA_DATA
{
    public class R072D : BaseRDLClass
    {
        protected const string REPORT_NAME = "R072D";
        ...
        public DataSet GetDataSet(string strConnection, string[] arrParameters, string strReportAssembly, bool blnDebug)
        {
            try
            {
                ...
                Sort = "D_ICONST_CLINIC_NBR_1_2 ASC, D_BATCH_TYPE ASC, D_CLMHDR_ADJ_CD ASC, CLMHDR_AGENT_CD ASC";
        ...
        private void Access_U072_PURGE_VALIDATE()
        {
            ...
            strSQL.Append("R_CLMHDR_TOT_CLAIM_AR_OMA, ");
            strSQL.Append("R_CLMHDR_TOT_CLAIM_AR_OHIP, ");
            strSQL.Append("R_CLMHDR_MANUAL_AND_TAPE_PAYMENTS ");
        ...
        public override void DeclareReportControls()
        {
            try
            {
                ...
                AddControl(ReportSection.HEADING_AT, "TEMPORARYDATA.U072_PURGE_VALIDATE.D_CLMHDR_ADJ_CD", DataTypes.Character, 1);
                ...
                AddControl(ReportSection.FOOTING_AT, "TEMPORARYDATA.U072_PURGE_VALIDATE.R_CLMHDR_TOT_CLAIM_AR_OMA", DataTypes.Numeric, 7);
                AddControl(ReportSection.FOOTING_AT, "TEMPORARYDATA.U072_PURGE_VALIDATE.R_CLMHDR_TOT_CLAIM_AR_OHIP", DataTypes.Numeric, 7);
                AddControl(ReportSection.FOOTING_AT, "TEMPORARYDATA.U072_PURGE_VALIDATE.R_CLMHDR_MANUAL_AND_TAPE_PAYMENTS", DataTypes.Numeric, 7);
        ...
        public override string ReturnControlValue(string strControl, int intSize)
        {
            switch (strControl)
            {
                ...
                case "TEMPORARYDATA.U072_PURGE_VALIDATE.D_CLMHDR_ADJ_CD":
                    return Common.StringToField(rdrU072_PURGE_VALIDATE.GetString("D_CLMHDR_ADJ_CD"));
                ...
                case "TEMPORARYDATA.U072_PURGE_VALIDATE.R_CLMHDR_TOT_CLAIM_AR_OMA":
                    return rdrU072_PURGE_VALIDATE.GetNumber("R_CLMHDR_TOT_CLAIM_AR_OMA").ToString();
                case "TEMPORARYDATA.U072_PURGE_VALIDATE.R_CLMHDR_TOT_CLAIM_AR_OHIP":
                    return rdrU072_PURGE_VALIDATE.GetNumber("R_CLMHDR_TOT_CLAIM_AR_OHIP").ToString();
                case "TEMPORARYDATA.U072_PURGE_VALIDATE.R_CLMHDR_MANUAL_AND_TAPE_PAYMENTS":
                    return rdrU072_PURGE_VALIDATE.GetNumber("R_CLMHDR_MANUAL_AND_TAPE_PAYMENTS").ToString();
