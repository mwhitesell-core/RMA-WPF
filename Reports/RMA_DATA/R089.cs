...
namespace RMA_DATA
{
    public class R089 : BaseRDLClass
    {
        protected const string REPORT_NAME = "R089";
        ...
        public DataSet GetDataSet(string strConnection, string[] arrParameters, string strReportAssembly, bool blnDebug)
        {
            try
            {
                ...
                Sort = "DOC_DEPT ASC, DOC_NBR ASC, X_DOC_NAME ASC, PAT_OLD_SURNAME ASC, CLMHDR_PAT_OHIP_ID_OR_CHART ASC";
