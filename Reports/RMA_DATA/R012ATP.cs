//  DOC: R012ATP.QZS
//  DOC: PHYSICIAN REVENUE RECONCILLIATION BY DOCTOR
//  DOC: SORT BY CLINIC/AGENT/DOCTOR/OMA CODE  (DETAIL REPORT)
//  DOC: RUN FOR: MUMC DIAGNOSTICS
//  PROGRAM PURPOSE : REVENUE ANALYSIS RECONCILIATION BY DOCTOR
//  R012TPA.CB CONVERSTION TO POWERHOUSE R012ATP.QZS
//  THIS IS THE FIRST OF 3 PROGRAMS APPEND
//  R012BTP.TXT R012CTP.TXT TO END OF R012ATP.TXT
//  DATE     BY WHOM   DESCRIPTION
//  92/05/28   YASEMIN   ORIGINAL
//  92/12/14   B.E.      USE NCONVERT ON CLINIC NBR WHEN LINKING TO CONST MSTR
//  92/04/23   YASEMIN   TAKE OUT NCONVERT ON CLINIC NBR THEY ARE BOTH NUMERIC
...
namespace RMA_DATA
{
    public class R012ATP : BaseRDLClass
    {
        protected const string REPORT_NAME = "R012ATP";
        ...
        public DataSet GetDataSet(string strConnection, string[] arrParameters, string strReportAssembly, bool blnDebug)
        {
            try
            {
                ...
                Sort = "DOCREVTP_CLINIC_NBR ASC, DOCREVTP_AGENT_CD ASC, DOCREVTP_DOC_NBR ASC, F050TP_DOC_REVENUE_MSTR_DOCREVTP_OMA_CD ASC";
        ...
        public override void DeclareReportControls()
        {
            try
            {
                ...
                AddControl(ReportSection.FOOTING_AT, "F050TP_DOC_REVENUE_MSTR_DOCREVTP_OMA_CD", DataTypes.Character, 5);
        ...
        // # Do not delete, modify or move it.  Updated: 2018-05-10 7:53:43 AM
        public override string ReturnControlValue(string strControl, int intSize)
        {
            ...
            switch (strControl)
            {
                ...
                case "F050TP_DOC_REVENUE_MSTR_DOCREVTP_OMA_CD":
