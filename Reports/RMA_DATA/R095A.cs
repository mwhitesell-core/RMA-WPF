...
//  2010/jul/05   MC1     - modify d-iconst-clinic-nbr-1-2 to define  clinic 70`s to be clinic 71 to 75 inclusive
//  and clinic 60`s to be clinic 61 to 65 inclusive
//  2011/jul/06   MC2 - also include clinic 66 as part of 60`s
//  2016/Jun/28   MC3  - change amount fields from numeric 7 to numeric 9
...
namespace RMA_DATA
{
    public class R095A : BaseRDLClass
    {
        protected const string REPORT_NAME = "R095A";
        protected const bool REPORT_HAS_PARAMETERS = false;
        private Reader rdrU095_RETAIN_BATCH = new Reader();
        ...
        private void Access_U095_RETAIN_BATCH()
        {
            ...
            strSQL.Append("FROM TEMPORARYDATA.U095_RETAIN_BATCH ");
            strSQL.Append(Choose());
            rdrU095_RETAIN_BATCH.GetDataTable = TextHelper.ExecuteDataTable(strSQL.ToString(), ReportFunctions.m_strFlatFilePath, ReportFunctions.TextFiles); ;
            strSQL = null;
        }
        private void Link_ICONST_MSTR_REC()
        {
            ...
            strSQL.Append("WHERE ");
            strSQL.Append("ICONST_CLINIC_NBR_1_2 = ").Append(QDesign.NConvert(QDesign.Substring(rdrU095_RETAIN_BATCH.GetString("BATCTRL_BATCH_NBR"), 1, 2)));
        ...
        private decimal D_CLINIC()
        {
            ...
            try
            {
                decReturnValue = QDesign.NConvert(QDesign.Substring(QDesign.ASCII(rdrU095_RETAIN_BATCH.GetNumber("ICONST_CLINIC_NBR_1_2")), 1, 1));
            }
        ...
        private decimal D_ICONST_CLINIC_NBR_1_2()
        {
            ...
            try
            {
                if (((rdrU095_RETAIN_BATCH.GetNumber("ICONST_CLINIC_NBR_1_2") >= 61)
                            && (rdrU095_RETAIN_BATCH.GetNumber("ICONST_CLINIC_NBR_1_2") <= 66)))
                {
                    decReturnValue = 60;
                }
                else if (((rdrU095_RETAIN_BATCH.GetNumber("ICONST_CLINIC_NBR_1_2") >= 71)
                            && (rdrU095_RETAIN_BATCH.GetNumber("ICONST_CLINIC_NBR_1_2") <= 75)))
                {
                    decReturnValue = 70;
                }
                else
                {
                    decReturnValue = rdrU095_RETAIN_BATCH.GetNumber("ICONST_CLINIC_NBR_1_2");
                }
            }
        ...
        private decimal R_BATCTRL_CALC_AR_DUE()
        {
            ...
            try
            {
                if (((QDesign.NULL(rdrU095_RETAIN_BATCH.GetString("BATCTRL_BATCH_TYPE")) == "P")
                            && (QDesign.NULL(rdrU095_RETAIN_BATCH.GetString("BATCTRL_ADJ_CD")) == "C")))
                {
                    decReturnValue = (0 - rdrU095_RETAIN_BATCH.GetNumber("BATCTRL_CALC_AR_DUE"));
                }
                else
                {
                    decReturnValue = rdrU095_RETAIN_BATCH.GetNumber("BATCTRL_CALC_AR_DUE");
                }
            }
        ...
        private decimal R_BATCTRL_CALC_TOT_REV()
        {
            ...
            try
            {
                if (((QDesign.NULL(rdrU095_RETAIN_BATCH.GetString("BATCTRL_BATCH_TYPE")) == "P")
                            && (QDesign.NULL(rdrU095_RETAIN_BATCH.GetString("BATCTRL_ADJ_CD")) == "C")))
                {
                    decReturnValue = (0 - rdrU095_RETAIN_BATCH.GetNumber("BATCTRL_CALC_TOT_REV"));
                }
                else
                {
                    decReturnValue = rdrU095_RETAIN_BATCH.GetNumber("BATCTRL_CALC_TOT_REV");
                }
            }
        ...
        private decimal R_BATCTRL_MANUAL_PAY_TOT()
        {
            ...
            try
            {
                if (((QDesign.NULL(rdrU095_RETAIN_BATCH.GetString("BATCTRL_BATCH_TYPE")) == "P")
                            && (QDesign.NULL(rdrU095_RETAIN_BATCH.GetString("BATCTRL_ADJ_CD")) == "C")))
                {
                    decReturnValue = (0 - rdrU095_RETAIN_BATCH.GetNumber("BATCTRL_MANUAL_PAY_TOT"));
                }
                else
                {
                    decReturnValue = rdrU095_RETAIN_BATCH.GetNumber("BATCTRL_MANUAL_PAY_TOT");
                }
            }
        ...
        private string D_BATCTRL_ADJ_CD()
        {
            ...
            try
            {
                if ((QDesign.NULL(rdrU095_RETAIN_BATCH.GetString("BATCTRL_BATCH_TYPE")) == "C"))
                {
                    strReturnValue = QDesign.ASCII(rdrU095_RETAIN_BATCH.GetNumber("BATCTRL_AGENT_CD"));
                }
                else
                {
                    strReturnValue = rdrU095_RETAIN_BATCH.GetString("BATCTRL_ADJ_CD");
                }
            }
        ...
        public override void DeclareReportControls()
        {
            try
            {
                ...
                AddControl(ReportSection.SUMMARY, "TEMPORARYDATA.U095_RETAIN_BATCH.D_CUT_OFF_DATE", DataTypes.Numeric, 8);
                ...
                AddControl(ReportSection.SUMMARY, "TEMPORARYDATA.U095_RETAIN_BATCH.BATCTRL_BATCH_TYPE", DataTypes.Character, 1);
                AddControl(ReportSection.SUMMARY, "D_BATCTRL_ADJ_CD", DataTypes.Character, 1);
                AddControl(ReportSection.SUMMARY, "TEMPORARYDATA.U095_RETAIN_BATCH.BATCTRL_CYCLE_NBR", DataTypes.Numeric, 3);
                ...
                AddControl(ReportSection.REPORT, "TEMPORARYDATA.U095_RETAIN_BATCH.BATCTRL_BATCH_NBR", DataTypes.Character, 8);
            }
        ...
        public override string ReturnControlValue(string strControl, int intSize)
        {
            switch (strControl)
            {
                ...
                case "TEMPORARYDATA.U095_RETAIN_BATCH.D_CUT_OFF_DATE":
                    return rdrU095_RETAIN_BATCH.GetNumber("D_CUT_OFF_DATE").ToString();
                ...
                case "TEMPORARYDATA.U095_RETAIN_BATCH.BATCTRL_BATCH_TYPE":
                    return Common.StringToField(rdrU095_RETAIN_BATCH.GetString("BATCTRL_BATCH_TYPE"));
                case "D_BATCTRL_ADJ_CD":
                    return Common.StringToField(D_BATCTRL_ADJ_CD(), intSize);
                case "TEMPORARYDATA.U095_RETAIN_BATCH.BATCTRL_CYCLE_NBR":
                    return rdrU095_RETAIN_BATCH.GetNumber("BATCTRL_CYCLE_NBR").ToString();
                ...
                case "TEMPORARYDATA.U095_RETAIN_BATCH.BATCTRL_BATCH_NBR":
                    return Common.StringToField(rdrU095_RETAIN_BATCH.GetString("BATCTRL_BATCH_NBR"));
                default:
                    return String.Empty;
            }
        }
        ...
        public override void AccessData()
        {
            try
            {
                ...
                Access_U095_RETAIN_BATCH();
                while (rdrU095_RETAIN_BATCH.Read())
                {
        ...
        {
            if (!(rdrU095_RETAIN_BATCH == null))
            {
                rdrU095_RETAIN_BATCH.Close();
                rdrU095_RETAIN_BATCH = null;
            }
