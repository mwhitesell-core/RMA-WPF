...
namespace RMA_DATA
{
    public class R150D_DETAIL__PASS11 : BaseRDLClass
    {
        protected const string REPORT_NAME = "R150D_DETAIL__PASS11";
        ...
        private void Access_R150A()
        {
            ...
            strSQL.Append("T_NET_MICC, ");
            strSQL.Append("T_NET_GARNIS, ");
            strSQL.Append("T_NET_MANPAY, ");
            strSQL.Append("T_NET_PAYEFT ");
        ...
        public override void DeclareReportControls()
        {
            try
            {
                ...
                AddControl(ReportSection.REPORT, "TEMPORARYDATA.R150A.T_NET_MICC", DataTypes.Numeric, 21);
                AddControl(ReportSection.REPORT, "TEMPORARYDATA.R150A.T_NET_GARNIS", DataTypes.Numeric, 21);
                AddControl(ReportSection.REPORT, "TEMPORARYDATA.R150A.T_NET_MANPAY", DataTypes.Numeric, 21);
                AddControl(ReportSection.REPORT, "TEMPORARYDATA.R150A.T_NET_PAYEFT", DataTypes.Numeric, 21);
            }
        ...
        public override string ReturnControlValue(string strControl, int intSize)
        {
            switch (strControl)
            {
                ...
                case "TEMPORARYDATA.R150A.T_NET_MICC":
                    return rdrR150A.GetNumber("T_NET_MICC").ToString();
                case "TEMPORARYDATA.R150A.T_NET_GARNIS":
                    return rdrR150A.GetNumber("T_NET_GARNIS").ToString();
                case "TEMPORARYDATA.R150A.T_NET_MANPAY":
                    return rdrR150A.GetNumber("T_NET_MANPAY").ToString();
                case "TEMPORARYDATA.R150A.T_NET_PAYEFT":
                    return rdrR150A.GetNumber("T_NET_PAYEFT").ToString();
                default:
                    return String.Empty;
            }
        }
