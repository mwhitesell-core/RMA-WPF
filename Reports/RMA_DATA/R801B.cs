//  NAME   : R801B.QZS
//  PURPOSE: LIST OF ALL AUTOMATIC ADJUSTED CLAIMS WITH AGENT `6`, `8 AND
//  `9`.
//  MODIFICATION HISTORY:
//  YY/MMM/DD     BY WHOM        WHY
//  93/AUG/25     M. CHAN        ORIGINAL (SMS 143)
//  93/SEP/13     YASEMIN        FINAL FOOTING AT CLM-ID
//  93/NOV/18     YASEMIN        INCLUDE AGENT 8.
//  94/JAN/11     YASEMIN        TOTALS AT CLNIC
...
namespace RMA_DATA
{
    public class R801B : BaseRDLClass
    {
        protected const string REPORT_NAME = "R801B";
        ...
        public override bool SelectIf()
        {
            ...
            if (QDesign.NULL(rdrADJ_CLAIM_FILE.GetNumber("ADJ_AGENT_CD")) == QDesign.NULL(6d) || QDesign.NULL(rdrADJ_CLAIM_FILE.GetNumber("ADJ_AGENT_CD")) == QDesign.NULL(9d) || QDesign.NULL(rdrADJ_CLAIM_FILE.GetNumber("ADJ_AGENT_CD")) == QDesign.NULL(8d))
            {
                blnSelected = true;
            }
