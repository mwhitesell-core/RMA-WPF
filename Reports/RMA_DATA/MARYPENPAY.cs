...
namespace RMA_DATA
{
    public class MARYPENPAY : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "MARYPENPAY";
        ...
        public override bool SelectIf()
        {
            ...
            if (QDesign.NULL(rdrF114_SPECIAL_PAYMENTS.GetString("COMP_CODE")) == QDesign.NULL("PENPAY"))
            {
                blnSelected = true;
            }
