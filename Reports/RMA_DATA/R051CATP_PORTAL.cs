...
//  08/mar/20  M.C.      original   (clone from r051caatp.qzs)
...
namespace RMA_DATA
{
    public class R051CATP_PORTAL : BaseRDLClass
    {
        protected const string REPORT_NAME = "R051CATP_PORTAL";
        ...
        public DataSet GetDataSet(string strConnection, string[] arrParameters, string strReportAssembly, bool blnDebug)
        {
            try
            {
                ...
                Sort = "DOCREVTP_CLINIC_NBR ASC, DOC_DEPT ASC, DOC_FULL_PART_IND ASC, DOCREVTP_DOC_NBR ASC, DOCREVTP_OMA_CODE ASC";
        ...
        private string X_DOC_DEPT_NBR()
        {
            ...
            {
                strReturnValue = ("~"
                            + (rdrF050TP_DOC_REVENUE_MSTR.GetString("DOCREVTP_DOC_NBR")
