...
namespace RMA_DATA
{
    public class R012ATP_70 : BaseRDLClass
    {
        protected const string REPORT_NAME = "R012ATP_70";
        ...
        public DataSet GetDataSet(string strConnection, string[] arrParameters, string strReportAssembly, bool blnDebug)
        {
            try
            {
                ...
                Sort = "DOCREVTP_CLINIC_NBR ASC, DOCREVTP_AGENT_CD ASC, DOCREVTP_DOC_NBR ASC, DOCREVTP_OMA_CD ASC";
