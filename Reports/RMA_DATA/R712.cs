//  #> PROGRAM-ID.     R712.QZS
//  PROGRAM PURPOSE : TO REPORT SUSPENDED DUPLICATE CLAIMS WITH
//  STATUS  Y 
//  MODIFICATION HISTORY
//  DATE SMS # WHO DESCRIPTION
//  91.03.13 000 Y.B. COPIED FROM R711
//  1999/jan/28         B.E.    - y2k
...
namespace RMA_DATA
{
    public class R712 : BaseRDLClass
    {
        protected const string REPORT_NAME = "R712";
        ...
        // # Do not delete, modify or move it.  Updated: 2018-05-15 3:04:04 PM
        ...
        private string SelectIf_F002_SUSPEND_HDR(bool blnAddWhere)
        {
            ...
            strSQL.Append("CLMHDR_STATUS = ").Append(Common.StringToField(CLMHDR_STATUS_CANCEL()));
        ...
        public override void DeclareReportControls()
        {
            try
            {
                ...
                AddControl(ReportSection.HEADING_AT, "F002_SUSPEND_HDR_CLMHDR_PAT_ACRONYM", DataTypes.Character, 9);
                ...
                AddControl(ReportSection.REPORT, "F002_SUSPEND_DTL_CLMDTL_SV_DATE", DataTypes.Character, 8);
        ...
        public override string ReturnControlValue(string strControl, int intSize)
        {
            ...
            switch (strControl)
            {
                ...
                case "F002_SUSPEND_HDR_CLMHDR_PAT_ACRONYM":
                ...
                case "F002_SUSPEND_DTL_CLMDTL_SV_DATE":
