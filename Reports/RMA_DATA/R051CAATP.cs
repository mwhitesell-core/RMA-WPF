...
namespace RMA_DATA
{
    public class R051CAATP : BaseRDLClass
    {
        protected const string REPORT_NAME = "R051CAATP";
        ...
        public DataSet GetDataSet(string strConnection, string[] arrParameters, string strReportAssembly, bool blnDebug)
        {
            try
            {
                ...
                Sort = "DOCREVTP_CLINIC_NBR ASC, DOC_DEPT ASC, DOC_FULL_PART_IND ASC, DOCREVTP_DOC_NBR ASC, DOCREVTP_OMA_CD";
