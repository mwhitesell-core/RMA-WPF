...
namespace RMA_DATA
{
    public class UTL0011A : BaseRDLClass
    {
        protected const string REPORT_NAME = "UTL0011A";
        ...
        private string F010_PAT_MSTR_PAT_OHIP_MMYY()
        {
            ...
            try
            {
                strReturnValue = rdrF010_PAT_MSTR.GetString("PAT_DIRECT_ALPHA") + (rdrF010_PAT_MSTR.GetNumber("PAT_DIRECT_YY") == 0 ? "" : QDesign.ASCII(rdrF010_PAT_MSTR.GetNumber("PAT_DIRECT_YY"))) + (rdrF010_PAT_MSTR.GetNumber("PAT_DIRECT_MM") == 0 ? "" : QDesign.ASCII(rdrF010_PAT_MSTR.GetNumber("PAT_DIRECT_MM"))) + (rdrF010_PAT_MSTR.GetNumber("PAT_DIRECT_DD") == 0 ? "" : QDesign.ASCII(rdrF010_PAT_MSTR.GetNumber("PAT_DIRECT_DD"))) + rdrF010_PAT_MSTR.GetString("PAT_DIRECT_LAST_6");
            }
        ...
        public override bool SelectIf()
        {
            ...
            if (QDesign.NULL(F010_PAT_MSTR_PAT_OHIP_MMYY()) == QDesign.NULL(" ") && QDesign.NULL(rdrF010_PAT_MSTR.GetNumber("PAT_HEALTH_NBR")) == 0 && QDesign.NULL(rdrF010_PAT_MSTR.GetString("PAT_CHART_NBR")) == QDesign.NULL(" "))
            {
                blnSelected = true;
            }
