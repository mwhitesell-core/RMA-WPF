...
namespace RMA_DATA
{
    public class R004ATP_70 : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "R004ATP_70";
        ...
        private string Choose()
        {
            ...
            strChoose.Append(" WHERE BATCTRL_BATCH_NBR >= ").Append(Common.StringToField("71000000"));
            strChoose.Append(" AND BATCTRL_BATCH_NBR <= ").Append(Common.StringToField("75ZZZ999"));
        ...
        private string X_PAT_NAME()
        {
            ...
            try
            {
                strReturnValue = rdrF010_PAT_MSTR.GetString("PAT_SURNAME_FIRST3") + QDesign.Substring(rdrF010_PAT_MSTR.GetString("PAT_SURNAME_LAST22"), 1, 3) + " " + rdrF010_PAT_MSTR.GetString("PAT_GIVEN_NAME_FIRST1") + QDesign.Substring(rdrF010_PAT_MSTR.GetString("FILLER3"), 1, 2);
            }
