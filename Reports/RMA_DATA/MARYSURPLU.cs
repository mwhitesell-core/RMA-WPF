...
namespace RMA_DATA
{
    public class MARYSURPLU : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "MARYSURPLU";
        ...
        public override bool SelectIf()
        {
            ...
            if (QDesign.NULL(rdrF114_SPECIAL_PAYMENTS.GetString("COMP_CODE")) == QDesign.NULL("SURPLU"))
            {
                blnSelected = true;
            }
