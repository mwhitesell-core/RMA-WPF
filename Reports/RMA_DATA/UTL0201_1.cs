...
namespace RMA_DATA
{
    public class UTL0201_1 : BaseRDLClass
    {
        ...
        public override bool SelectIf()
        {
            ...
            if (QDesign.NULL(rdrF190_COMP_CODES.GetString("COMP_TYPE")) == "P" & QDesign.NULL(rdrF020_DOCTOR_MSTR.GetNumber("DOC_DEPT")) == 42)
                blnSelected = true;
        ...
        private string PREV_EP_NBR()
        {
            ...
            try
            {
                if (QDesign.NULL(QDesign.Substring(rdrUTL0201_F119.GetString("X_PED"), 5, 2)).CompareTo("02") > 0)
                {
                    strReturnValue = QDesign.ASCII(QDesign.NConvert(rdrUTL0201_F119.GetString("X_PED")) - 2);
                }
                else if (QDesign.NULL(QDesign.Substring(rdrUTL0201_F119.GetString("X_PED"), 5, 2)) == "02" & QDesign.NULL(rdrUTL0201_F119.GetString("ENVIRONMENT")) == "101C")
                {
                ...
                else if (QDesign.NULL(QDesign.Substring(rdrUTL0201_F119.GetString("X_PED"), 5, 2)) == "01" & QDesign.NULL(rdrUTL0201_F119.GetString("ENVIRONMENT")) == "101C")
                {
                    strReturnValue = QDesign.ASCII(QDesign.NConvert(QDesign.Substring(rdrUTL0201_F119.GetString("X_PED"), 1, 4)) - 1) + "13";
                }
                else if (QDesign.NULL(QDesign.Substring(rdrUTL0201_F119.GetString("X_PED"), 5, 2)) == "01" & QDesign.NULL(rdrUTL0201_F119.GetString("ENVIRONMENT")) != "101C")
        ...
        public override void DeclareReportControls()
        {
            try
            {
                ...
                AddControl(ReportSection.REPORT, "TEMPORARYDATA.UTL0201_F119.X_PED", DataTypes.Character, 6);
                AddControl(ReportSection.REPORT, "PREV_EP_NBR", DataTypes.Character, 6);
                AddControl(ReportSection.REPORT, "INDEXED.F190_COMP_CODES.COMP_CODE", DataTypes.Character, 6);
                AddControl(ReportSection.REPORT, "TEMPORARYDATA.UTL0201_F119.AMT_MTD", DataTypes.Numeric, 9);
                AddControl(ReportSection.REPORT, "TEMPORARYDATA.UTL0201_F119.AMT_YTD", DataTypes.Numeric, 9);
            }
        ...
        public override string ReturnControlValue(string strControl, int intSize)
        {
            switch (strControl)
            {
                ...
                case "TEMPORARYDATA.UTL0201_F119.AMT_YTD":
                    return (rdrUTL0201_F119.GetNumber("AMT_YTD").ToString().PadLeft(9, ' '));
