...
namespace RMA_DATA
{
    ...
    public class MARYRMACHR : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "MARYRMACHR";
        ...
        public override bool SelectIf()
        {
            ...
            if (QDesign.NULL(rdrF113_DEFAULT_COMP.GetString("COMP_CODE")) == QDesign.NULL("RMACHR") & QDesign.NULL(rdrF113_DEFAULT_COMP.GetNumber("EP_NBR_FROM")) == QDesign.NULL(X_DATE_FROM()) & QDesign.NULL(rdrF113_DEFAULT_COMP.GetNumber("EP_NBR_TO")) == QDesign.NULL(X_DATE_TO()))
            {
                blnSelected = true;
            }
        ...
        //# Do not delete, modify or move it.  Updated: 8/22/2017 10:51:58 AM
