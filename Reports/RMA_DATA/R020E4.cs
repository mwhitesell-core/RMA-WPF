...
namespace RMA_DATA
{
    public class R020E4 : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "R020E4";
        ...
        public override void DeclareReportControls()
        {
            try
            {
                 ...
                 AddControl(ReportSection.SUMMARY, "TEMPORARYDATA.U020E2.BATCTRL_CALC_AR_DUE", DataTypes.Numeric, 9, SummaryType.SUBTOTAL, "W_AGENT");
                 AddControl(ReportSection.SUMMARY, "TEMPORARYDATA.U020E2.BATCTRL_CALC_TOT_REV", DataTypes.Numeric, 9, SummaryType.SUBTOTAL, "W_AGENT");
                 AddControl(ReportSection.SUMMARY, "W_BATCTRL_MANUAL_PAY_TOT", DataTypes.Numeric, 9, SummaryType.SUBTOTAL, "W_AGENT");
                 AddControl(ReportSection.SUMMARY, "TEMPORARYDATA.U020E2.BATCTRL_NBR_CLAIMS_IN_BATCH", DataTypes.Numeric, 5, SummaryType.SUBTOTAL, "W_AGENT");
            }
