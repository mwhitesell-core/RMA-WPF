...
namespace RMA_DATA
{
    public class MP_UTL0101 : BaseRDLClass
    {
        ...
        //# Do not delete, modify or move it.  Updated: 10/27/2017 12:50:09 PM
        ...
        public override string ReturnControlValue(string strControl, int intSize)
        {
            switch (strControl)
            {
                case "TEMPORARYDATA.F119_DUPLICATES.DOC_NBR":
                    return Common.StringToField(rdrF119_DUPLICATES.GetString("DOC_NBR").PadRight(3, ' '));
                ...
                case "TEMPORARYDATA.F119_DUPLICATES.AMT_YTD":
                    return rdrF119_DUPLICATES.GetNumber("AMT_YTD").ToString().PadLeft(8, ' ');
