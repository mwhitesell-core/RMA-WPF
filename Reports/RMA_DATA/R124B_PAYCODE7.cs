...
// #> PROGRAM-ID.     R124B_PAYCODE7.QZS
// ((C)) Dyad Technologies
// PURPOSE: Prdecimal the SERVICE CHARGES       for the physician
// PHASE II - READ SUBFILE AND CREATE ACTUAL INVOICE 
// MODIFICATION HISTORY
// DATE    SAF #  WHO     DESCRIPTION
// 2014/Apr/16        be  - clone from r124b_rma.qzs
// 2014/Apr/17        be1/be2/be3 - cosmetics
...
namespace RMA_DATA
{
    public class R124B_PAYCODE7 : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "R124B_PAYCODE7";
        protected const bool REPORT_HAS_PARAMETERS = true;

        // Data Helpers.
        private Reader rdrR124A_PAYCODE7 = new Reader();
        ...
        //# Do not delete, modify or move it.  Updated: 2017-07-24 9:53:33 PM
        ...
        public DataSet GetDataSet(string strConnection, string[] arrParameters, string strReportAssembly, bool blnDebug)
        {
            try
            {
                ...
                Sort = "DOC_DEPT ASC, DOC_NBR ASC, COMP_CODE_GROUP ASC, PROCESS_SEQ ASC, X_COUNT_STATUS ASC";
        ...
        private void Access_R124A_PAYCODE7()
        {
            ...
            strSQL.Append("FROM TEMPORARYDATA.R124A_PAYCODE7 ");

            strSQL.Append(Choose());

            rdrR124A_PAYCODE7.GetDataTable = TextHelper.ExecuteDataTable(strSQL.ToString(), ReportFunctions.m_strFlatFilePath, ReportFunctions.TextFiles);
        ...
        private void Link_F070_DEPT_MSTR()
        {
            ...
            strSQL.Append("WHERE ");
            strSQL.Append("DEPT_NBR = ").Append(rdrR124A_PAYCODE7.GetNumber("DOC_DEPT"));
        ...
        public override bool SelectIf()
        {
            ...
            if (QDesign.NULL(X_NEW_PARM()) == QDesign.NULL("DOC") | (QDesign.NULL(X_NEW_PARM()) == QDesign.NULL("DEP") & QDesign.NULL(rdrR124A_PAYCODE7.GetNumber("DOC_DEPT")) != QDesign.NULL(14d) & QDesign.NULL(rdrR124A_PAYCODE7.GetNumber("DOC_DEPT")) != QDesign.NULL(15d) & QDesign.NULL(rdrR124A_PAYCODE7.GetNumber("DOC_DEPT")) != QDesign.NULL(31d)))
                blnSelected = true;
        ...
        private string X_PARM_PORTAL()
        {
            ...
            try
            {
                ...
                // Prompt String: "Enter PRINT    or  PORTAL  : " _
            }
        ...
        private string X_EOL_DOC_NBR()
        {
            ...
            try
            {
                ...
                {
                    strReturnValue = rdrR124A_PAYCODE7.GetString("DOC_NBR");
                }
                else if (QDesign.NULL(X_NEW_PARM()) == "DEP")
                {
                    strReturnValue = "Z" + QDesign.ASCII(rdrR124A_PAYCODE7.GetNumber("DOC_DEPT"), 2);
                }
            }
        ...
        private string X_PORTAL_FIELDS()
        {
            ...
            try
            {
                ...
                {
                    strReturnValue = "~" + X_EOL_DOC_NBR() + QDesign.Substring(QDesign.ASCII(rdrR124A_PAYCODE7.GetNumber("DOC_DEPT"), 2), 1, 2) + "~";
                }
                else
                {
                    strReturnValue = "";
        ...
        private string X_PARM()
        {
            ...
            try
            {
                strReturnValue = QDesign.NULL(ReportFunctions.astrScreenParameters[2].ToString());
                // Prompt String: "Enter REGULAR  or  YEAREND : " _
            }
        ...
        private string X_CEILING_EARNINGS_LITERAL()
        {
            ...
            try
            {
                ...
                else if (QDesign.NULL(rdrF070_DEPT_MSTR.GetNumber("DEPT_COMPANY")) != QDesign.NULL(1d))
                {
                    strReturnValue = " ";
                }
            }
        ...
        private string X_COMP_CODE_GROUP_DESC()
        {
            ...
            try
            {
                if (QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "A")
                {
                    strReturnValue = HPIII_FONT_HEIGHT_10() + HPIII_BOLD() + "   " + HPIII_FONT_HEIGHT_10() + HPIII_MEDIUM();
                }
                else if (QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "C")
                {
                    strReturnValue = HPIII_FONT_HEIGHT_10() + HPIII_BOLD() + " " + HPIII_FONT_HEIGHT_10() + HPIII_MEDIUM();
                }
                else if (QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "D")
                {
                    strReturnValue = HPIII_FONT_HEIGHT_10() + HPIII_BOLD() + " " + HPIII_FONT_HEIGHT_10() + HPIII_MEDIUM();
                }
                else if (QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "E")
                {
                    strReturnValue = HPIII_FONT_HEIGHT_10() + HPIII_BOLD() + " " + HPIII_FONT_HEIGHT_10() + HPIII_MEDIUM();
                }
                else if (QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "F")
                {
                    strReturnValue = HPIII_FONT_HEIGHT_10() + HPIII_BOLD() + X_CEILING_EARNINGS_LITERAL() + HPIII_FONT_HEIGHT_10() + HPIII_MEDIUM();
                }
                else if (QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "G")
                {
                    strReturnValue = HPIII_FONT_HEIGHT_10() + HPIII_BOLD() + " " + HPIII_FONT_HEIGHT_10() + HPIII_MEDIUM();
                }
                else if (QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "J")
                {
                    strReturnValue = HPIII_FONT_HEIGHT_10() + HPIII_BOLD() + " " + HPIII_FONT_HEIGHT_10() + HPIII_MEDIUM();
                }
                else if (QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "B" | QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "H" | QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "I" | QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "K" | QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "L" | QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "M" | QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "N")
                {
                    strReturnValue = " ";
                }
                else
        ...
        private decimal X_COUNT_DIFF()
        {
            ...
            try
            {
                decReturnValue = (rdrR124A_PAYCODE7.GetNumber("X_COUNT_STATUS") - rdrR124A_PAYCODE7.GetNumber("X_COUNT_INCREQ"));
            }
        ...
        private decimal X_INCREQ_OFFSET()
        {
            ...
            try
            {
                if (QDesign.NULL(X_COUNT_DIFF()) > QDesign.NULL(1d) & QDesign.NULL(rdrR124A_PAYCODE7.GetNumber("X_INCREQ")) != QDesign.NULL(0d))
                {
                    decReturnValue = X_COUNT_DIFF() + 5;
                }
                else if (QDesign.NULL(X_COUNT_DIFF()) == QDesign.NULL(1d) & QDesign.NULL(rdrR124A_PAYCODE7.GetNumber("X_INCREQ")) != QDesign.NULL(0d))
                {
                    decReturnValue = X_COUNT_DIFF() + 4;
                }
                else if (QDesign.NULL(rdrR124A_PAYCODE7.GetNumber("X_INCREQ")) != QDesign.NULL(0d))
                {
                    decReturnValue = X_COUNT_DIFF() + 3;
                }
                else if (QDesign.NULL(X_COUNT_DIFF()) > QDesign.NULL(1d) & QDesign.NULL(rdrR124A_PAYCODE7.GetNumber("X_INCTAR")) != QDesign.NULL(0d))
                {
        ...
        private string X_SHADING_CTRL_CODES_B()
        {
            ...
            try
            {
                if (QDesign.NULL(rdrR124A_PAYCODE7.GetNumber("X_COUNT_INCREQ_STATUS")) == QDesign.NULL(0d))
                {
                    strReturnValue = " ";
                }
                else
        ...
        private string X_COMP_CODE_GROUP_DESC_CTRL()
        {
            ...
            try
            {
                if (QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "B" | QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "H")
                {
                    strReturnValue = X_ESC() + "&a-1R";
                }
                else if (QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "X" | QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "I" | QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "K" | QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "L")
                {
                    strReturnValue = " ";
                }
                else if (QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "M" | QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "N" | QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "C" | QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "D" | QDesign.NULL(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP")) == "E")
                {
        ...
        private string X_TITLE_0()
        {
            ...
            try
            {
                strReturnValue = HPIII_FONT_HEIGHT_16() + HPIII_BOLD() + X_COMPANY_NAME_OFFSET() + QDesign.Center(rdrF123_COMPANY_MSTR.GetString("COMPANY_NAME")) + HPIII_FONT_HEIGHT_10() + HPIII_MEDIUM();
            }
        ...
        private string X_TITLE_1()
        {
            ...
            try
            {
                strReturnValue = HPIII_FONT_HEIGHT_14() + HPIII_BOLD() + "Invoice for Service Charges" + HPIII_FONT_HEIGHT_10() + HPIII_MEDIUM() + X_ESC() + "&a+80C";
            }
        ...
        private string X_DATE_TITLE()
        {
            ...
            try
            {
                strReturnValue = "For the Fiscal Period July 1, " + QDesign.Substring(QDesign.ASCII(rdrR124A_PAYCODE7.GetNumber("FIRST_EP_NBR_OF_CAL_YR"), 6), 1, 4) + " to June 30, " + QDesign.Substring(QDesign.ASCII(rdrR124A_PAYCODE7.GetNumber("LAST_EP_NBR_OF_CAL_YR"), 6), 1, 4);
            }
        ...
        private string X_MSG1()
        {
            ...
            try
            {
                strReturnValue = HPIII_BOLD() + "Regular monthly payments for the full amount of services delivered will be debited from your specified account ";
            }
        ...
        private string X_MSG2()
        {
            string strReturnValue = string.Empty;

            try
            {
                strReturnValue = "on the last working day of each month as per the Pre-Authorized Debit (PAD) Plan Agreement.";
            }
        ...
        private string X_MSG_LAST()
        {
            ...
            try
            {
                strReturnValue = "For assistance, call " + HPIII_BOLD() + HPIII_FONT_ITALIC() + "Helena Vecera" + HPIII_FONT_UPRIGHT() + HPIII_MEDIUM() + HPIII_CGTIMES() + " at extension 20397.";
            }
        ...
        private string X_MSG0F()
        {
            ...
            try
            {
                if (QDesign.NULL(X_PARM()) == "YEAREND")
                {
        ...
        private string X_YTDCEA_POS_CTRL_CD()
        {
            ...
            try
            {
                strReturnValue = X_ESC() + "&a085C" + X_ESC() + "*p-" + rdrR124A_PAYCODE7.GetString("X_YTDCEA_POS_PRT") + "X";
            }
        ...
        private string X_YTDCEA_VAL_CTRL_CD()
        {
            ...
            try
            {
                strReturnValue = rdrR124A_PAYCODE7.GetString("X_YTDCEA_VAL_PRT") + X_ESC() + "&a100C";
            }
        ...
        private string X_CEICEA_POS_CTRL_CD()
        {
            ...
            try
            {
                strReturnValue = X_ESC() + "&a085C" + X_ESC() + "*p-" + rdrR124A_PAYCODE7.GetString("X_CEICEA_POS_PRT") + "X";
            }
        ...
        private string X_CEICEA_VAL_CTRL_CD()
        {
            ...
            try
            {
                strReturnValue = rdrR124A_PAYCODE7.GetString("X_CEICEA_VAL_PRT") + X_ESC() + "&a100C";
            }
        ...
        private string X_YTDCEX_POS_CTRL_CD()
        {
            ...
            try
            {
                strReturnValue = X_ESC() + "&a085C" + X_ESC() + "*p-" + rdrR124A_PAYCODE7.GetString("X_YTDCEX_POS_PRT") + "X";
            }
        ...
        private string X_YTDCEX_VAL_CTRL_CD()
        {
            ...
            try
            {
                if (QDesign.NULL(rdrR124A_PAYCODE7.GetString("X_YTDCEX_VAL_PRT")) != "0.00")
                {
                    strReturnValue = rdrR124A_PAYCODE7.GetString("X_YTDCEX_VAL_PRT") + X_ESC() + "&a100C";
                }
                else
                {
                    strReturnValue = " ";
        ...
        private string X_YTDREQ_POS_CTRL_CD()
        {
            ...
            try
            {
                strReturnValue = X_ESC() + "&a165C" + X_ESC() + "*p-" + rdrR124A_PAYCODE7.GetString("X_YTDREQ_POS_PRT") + "X";
            }
        ...
        private string X_YTDREQ_VAL_CTRL_CD()
        {
            ...
            try
            {
                if (QDesign.NULL(rdrR124A_PAYCODE7.GetString("X_YTDREQ_VAL_PRT")) != "0.00")
                {
                    strReturnValue = rdrR124A_PAYCODE7.GetString("X_YTDREQ_VAL_PRT");
                }
                else
                {
                    strReturnValue = " ";
        ...
        private string X_CEIREQ_POS_CTRL_CD()
        {
            ...
            try
            {
                strReturnValue = X_ESC() + "&a165C" + X_ESC() + "*p-" + rdrR124A_PAYCODE7.GetString("X_CEIREQ_POS_PRT") + "X";
            }
        ...
        private string X_CEIREQ_VAL_CTRL_CD()
        {
            ...
            try
            {
                if (QDesign.NULL(rdrR124A_PAYCODE7.GetString("X_CEIREQ_VAL_PRT")) != "0.00")
                {
                    strReturnValue = rdrR124A_PAYCODE7.GetString("X_CEIREQ_VAL_PRT");
                }
                else
                {
                    strReturnValue = " ";
        ...
        private string X_YTDTAR_POS_CTRL_CD()
        {
            ...
            try
            {
                strReturnValue = X_ESC() + "&a165C" + X_ESC() + "*p-" + rdrR124A_PAYCODE7.GetString("X_YTDTAR_POS_PRT") + "X";
            }
        ...
        private string X_YTDTAR_VAL_CTRL_CD()
        {
            ...
            try
            {
                strReturnValue = rdrR124A_PAYCODE7.GetString("X_YTDTAR_VAL_PRT");
            }
        ...
        public override void DeclareReportControls()
        {
            try
            {
                ...
                AddControl(ReportSection.HEADING_AT, "X_TITLE_1", DataTypes.Character, 50);
                AddControl(ReportSection.HEADING_AT, "HPIII_MEDIUM", DataTypes.Character, 5);
                AddControl(ReportSection.HEADING_AT, "TEMPORARYDATA.R124A_PAYCODE7.X_DOC_ID_INFO", DataTypes.Character, 50);
                AddControl(ReportSection.HEADING_AT, "TEMPORARYDATA.R124A_PAYCODE7.X_DEPT_NAME", DataTypes.Character, 30);
                AddControl(ReportSection.HEADING_AT, "HPIII_BOLD", DataTypes.Character, 5);
                AddControl(ReportSection.HEADING_AT, "TEMPORARYDATA.R124A_PAYCODE7.X_DEPOSIT", DataTypes.Numeric, 10);
                ...
                AddControl(ReportSection.HEADING_AT, "TEMPORARYDATA.R124A_PAYCODE7.X_BANK", DataTypes.Character, 30);
                AddControl(ReportSection.HEADING_AT, "TEMPORARYDATA.R124A_PAYCODE7.X_DEPOSIT_DATE", DataTypes.Numeric, 8);
                AddControl(ReportSection.HEADING_AT, "TEMPORARYDATA.R124A_PAYCODE7.X_BRANCH", DataTypes.Character, 30);
                AddControl(ReportSection.HEADING_AT, "TEMPORARYDATA.R124A_PAYCODE7.X_BANK_ACCOUNT_PRIVACY_MASKED", DataTypes.Character, 12);
                ...
                AddControl(ReportSection.HEADING_AT, "TEMPORARYDATA.R124A_PAYCODE7.X_PED", DataTypes.Numeric, 8);
                ...
                AddControl(ReportSection.REPORT, "TEMPORARYDATA.R124A_PAYCODE7.X_LINE_TEXT", DataTypes.Character, 190);
                AddControl(ReportSection.FOOTING_AT, "X_SHADING_CTRL_CODES_B", DataTypes.Character, 80);
                AddControl(ReportSection.FOOTING_AT, "X_MSG1", DataTypes.Character, 123);
                AddControl(ReportSection.FOOTING_AT, "X_MSG2", DataTypes.Character, 123);
                AddControl(ReportSection.FOOTING_AT, "X_MSG_LAST", DataTypes.Character, 123);
                AddControl(ReportSection.FOOTING_AT, "X_MSG0F", DataTypes.Character, 123);
                AddControl(ReportSection.REPORT, "TEMPORARYDATA.R124A_PAYCODE7.DOC_DEPT", DataTypes.Numeric, 2);
                AddControl(ReportSection.REPORT, "TEMPORARYDATA.R124A_PAYCODE7.DOC_NBR", DataTypes.Character, 3);
                AddControl(ReportSection.REPORT, "TEMPORARYDATA.R124A_PAYCODE7.COMP_CODE_GROUP", DataTypes.Character, 1);
                AddControl(ReportSection.REPORT, "TEMPORARYDATA.R124A_PAYCODE7.PROCESS_SEQ", DataTypes.Numeric, 2);
                AddControl(ReportSection.REPORT, "TEMPORARYDATA.R124A_PAYCODE7.X_COUNT_STATUS", DataTypes.Numeric, 3);
            }
        ...
        public override string ReturnControlValue(string strControl, int intSize)
        {
            switch (strControl)
            {
                ...
                case "TEMPORARYDATA.R124A_PAYCODE7.X_DOC_ID_INFO":
                    return Common.StringToField(rdrR124A_PAYCODE7.GetString("X_DOC_ID_INFO"));

                case "TEMPORARYDATA.R124A_PAYCODE7.X_DEPT_NAME":
                    return Common.StringToField(rdrR124A_PAYCODE7.GetString("X_DEPT_NAME"));

                case "HPIII_BOLD":
                    return Common.StringToField(HPIII_BOLD(), intSize);

                case "TEMPORARYDATA.R124A_PAYCODE7.X_DEPOSIT":
                    return rdrR124A_PAYCODE7.GetNumber("X_DEPOSIT").ToString();
                ...
                case "TEMPORARYDATA.R124A_PAYCODE7.X_BANK":
                    return Common.StringToField(rdrR124A_PAYCODE7.GetString("X_BANK"));

                case "TEMPORARYDATA.R124A_PAYCODE7.X_DEPOSIT_DATE":
                    return rdrR124A_PAYCODE7.GetNumber("X_DEPOSIT_DATE").ToString();

                case "TEMPORARYDATA.R124A_PAYCODE7.X_BRANCH":
                    return Common.StringToField(rdrR124A_PAYCODE7.GetString("X_BRANCH"));

                case "TEMPORARYDATA.R124A_PAYCODE7.X_BANK_ACCOUNT_PRIVACY_MASKED":
                    return Common.StringToField(rdrR124A_PAYCODE7.GetString("X_BANK_ACCOUNT_PRIVACY_MASKED"));
                ...
                case "TEMPORARYDATA.R124A_PAYCODE7.X_PED":
                    return rdrR124A_PAYCODE7.GetNumber("X_PED").ToString();
                ...
                case "TEMPORARYDATA.R124A_PAYCODE7.X_LINE_TEXT":
                    return Common.StringToField(rdrR124A_PAYCODE7.GetString("X_LINE_TEXT"));

                case "X_SHADING_CTRL_CODES_B":
                    return Common.StringToField(X_SHADING_CTRL_CODES_B(), intSize);

                case "X_MSG1":
                    return Common.StringToField(X_MSG1(), intSize);

                case "X_MSG2":
                    return Common.StringToField(X_MSG2(), intSize);
                ...
                case "TEMPORARYDATA.R124A_PAYCODE7.DOC_DEPT":
                    return rdrR124A_PAYCODE7.GetNumber("DOC_DEPT").ToString();

                case "TEMPORARYDATA.R124A_PAYCODE7.DOC_NBR":
                    return Common.StringToField(rdrR124A_PAYCODE7.GetString("DOC_NBR"));

                case "TEMPORARYDATA.R124A_PAYCODE7.COMP_CODE_GROUP":
                    return Common.StringToField(rdrR124A_PAYCODE7.GetString("COMP_CODE_GROUP"));

                case "TEMPORARYDATA.R124A_PAYCODE7.PROCESS_SEQ":
                    return rdrR124A_PAYCODE7.GetNumber("PROCESS_SEQ").ToString();

                case "TEMPORARYDATA.R124A_PAYCODE7.X_COUNT_STATUS":
                    return rdrR124A_PAYCODE7.GetNumber("X_COUNT_STATUS").ToString();
        ...
        public override void AccessData()
        {
            try
            {
                Access_R124A_PAYCODE7();

                while (rdrR124A_PAYCODE7.Read())
                {
                    Link_F070_DEPT_MSTR();
        ...
        {
            if ((rdrR124A_PAYCODE7 != null))
            {
                rdrR124A_PAYCODE7.Close();
                rdrR124A_PAYCODE7 = null;
            }
