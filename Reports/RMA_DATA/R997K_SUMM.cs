...
namespace RMA_DATA
{
    public class R997K_SUMM : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "R997K_SUMM";
        ...
        public override void DeclareReportControls()
        {
            try
            {
                AddControl(ReportSection.FOOTING_AT, "TEMPORARYDATA.U997_RMB_SRT.DOC_OHIP_NBR", DataTypes.Numeric, 6);
                AddControl(ReportSection.FOOTING_AT, "TEMPORARYDATA.U997_RMB_SRT.DOC_NBR", DataTypes.Character, 3);
                AddControl(ReportSection.FOOTING_AT, "TEMPORARYDATA.U997_RMB_SRT.DOC_NAME", DataTypes.Character, 24);
                AddControl(ReportSection.FOOTING_AT, "TEMPORARYDATA.U997_RMB_SRT.RAT_RMB_AMOUNT_SUB", DataTypes.Numeric, 6);
                AddControl(ReportSection.FOOTING_AT, "TEMPORARYDATA.U997_RMB_SRT.RAT_RMB_AMT_PAID", DataTypes.Numeric, 6);
            }
        ...
        //# Do not delete, modify or move it.  Updated: 9/28/2017 1:41:52 PM
