...
namespace RMA_DATA
{
    public class R030E2 : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "R030E2";
        ...
        private void Access_U030_TOT_CLAIMS()
        {
            ...
            strSQL.Append("PART_HDR_EXPLAN_CD, ");
        ...
        public override bool SelectIf()
        {
            ...
            if ((QDesign.NULL(rdrICONST_MSTR_REC.GetString("ICONST_CLINIC_CARD_COLOUR")) != QDesign.NULL("O")) | ((QDesign.NULL(rdrICONST_MSTR_REC.GetString("ICONST_CLINIC_CARD_COLOUR")) == QDesign.NULL("O")) & (QDesign.NULL(rdrU030_TOT_CLAIMS.GetString("PART_HDR_EXPLAN_CD")) != QDesign.NULL("EV") & QDesign.NULL(rdrU030_TOT_CLAIMS.GetString("PART_HDR_EXPLAN_CD")) != QDesign.NULL("EA") & QDesign.NULL(rdrU030_TOT_CLAIMS.GetString("PART_HDR_EXPLAN_CD")) != QDesign.NULL("EF") & QDesign.NULL(rdrU030_TOT_CLAIMS.GetString("PART_HDR_EXPLAN_CD")) != QDesign.NULL("48") & QDesign.NULL(rdrU030_TOT_CLAIMS.GetString("PART_HDR_EXPLAN_CD")) != QDesign.NULL("I2") & QDesign.NULL(rdrU030_TOT_CLAIMS.GetString("PART_HDR_EXPLAN_CD")) != QDesign.NULL("  "))))
            {
                blnSelected = true;
            }
        ...
        //# Do not delete, modify or move it.  Updated: 9/27/2017 2:15:00 PM
