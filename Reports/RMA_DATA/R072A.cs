...
//  2002/07/05 M.C. - modify the necessary changes
//  2002/07/07 M.C. - modify the amount picture size
//  2004/01/06 M.C. - link expression for clinic nbr
//  2004/01/06 - MC
...
namespace RMA_DATA
{
public class R072A : BaseRDLClass {
    protected const string REPORT_NAME = "R072A";
    protected const bool REPORT_HAS_PARAMETERS = true;
    private Reader rdrU072_RETAIN_CLAIM_HDR = new Reader();
    ...
    public DataSet GetDataSet(string strConnection, string[] arrParameters, string strReportAssembly, bool blnDebug) {
        try
        {
            ...
            //  Create Subfile.
            SubFile = true;
            SubFileName = "U072_RETAIN_CLAIM_HDR";
    ...
    private void Access_U072_RETAIN_CLAIM_HDR() {
        ...
        strSQL.Append("FROM TEMPORARYDATA.U072_RETAIN_CLAIM_HDR ");
        strSQL.Append(Choose());
        rdrU072_RETAIN_CLAIM_HDR.GetDataTable = SqlHelper.ExecuteDataTable(m_cnnQUERY, CommandType.Text, strSQL.ToString());
        strSQL = null;
    }
    private void Link_ICONST_MSTR_REC() {
        ...
        strSQL.Append("WHERE ");
        strSQL.Append("ICONST_CLINIC_NBR_1_2 = ").Append(QDesign.NConvert(QDesign.Substring(rdrU072_RETAIN_CLAIM_HDR.GetString("CLMHDR_BATCH_NBR"), 1, 2)));
    ...
    private decimal R_CLMHDR_TOT_CLAIM_AR_OMA() {
        ...
        try
        {
            decReturnValue = rdrU072_RETAIN_CLAIM_HDR.GetNumber("CLMHDR_TOT_CLAIM_AR_OMA");
        }
    ...
    private decimal R_CLMHDR_TOT_CLAIM_AR_OHIP() {
        ...
        try
        {
            decReturnValue = rdrU072_RETAIN_CLAIM_HDR.GetNumber("CLMHDR_TOT_CLAIM_AR_OHIP");
        }
    ...
    private decimal R_CLMHDR_MANUAL_AND_TAPE_PAYMENTS() {
        ...
        try
        {
            decReturnValue = rdrU072_RETAIN_CLAIM_HDR.GetNumber("CLMHDR_MANUAL_AND_TAPE_PAYMENTS");
        }
    ...
    private string D_CLMHDR_ADJ_CD() {
        ...
        try
        {
            if ((QDesign.NULL(rdrU072_RETAIN_CLAIM_HDR.GetString("CLMHDR_BATCH_TYPE")) == "C")) {
                strReturnValue = " ";
            }
            else
            {
                strReturnValue = rdrU072_RETAIN_CLAIM_HDR.GetString("CLMHDR_ADJ_CD");
            }
        }
    ...
    private decimal D_BATCH_TYPE() {
        ...
        try
        {
            ...
            else if ((QDesign.NULL(rdrU072_RETAIN_CLAIM_HDR.GetString("CLMHDR_BATCH_TYPE")) == "A")) 
            {
                decReturnValue = 2;
            }
            else
    ...
    private string D_TYPE() {
        ...
        try
        {
            ...
            else if ((QDesign.NULL(rdrU072_RETAIN_CLAIM_HDR.GetString("CLMHDR_BATCH_TYPE")) == "P")) 
            {
    ...
    public override void DeclareReportControls() {
        try
        {
            ...
            AddControl(ReportSection.SUMMARY, "TEMPORARYDATA.U072_RETAIN_CLAIM_HDR.X_PED_PURGE_PRIOR_TO_DATE", DataTypes.Character, 1);
            ...
            AddControl(ReportSection.SUMMARY, "TEMPORARYDATA.U072_RETAIN_CLAIM_HDR.CLMHDR_BATCH_TYPE", DataTypes.Character, 1);
            AddControl(ReportSection.SUMMARY, "D_CLMHDR_ADJ_CD", DataTypes.Character, 1);
            AddControl(ReportSection.SUMMARY, "TEMPORARYDATA.U072_RETAIN_CLAIM_HDR.CLMHDR_AGENT_CD", DataTypes.Numeric, 1);
            AddControl(ReportSection.SUMMARY, "TEMPORARYDATA.U072_RETAIN_CLAIM_HDR.CLMHDR_CYCLE_NBR", DataTypes.Numeric, 2);
    ...
    public override string ReturnControlValue(string strControl, int intSize) {
        switch (strControl) {
            ...
            case "TEMPORARYDATA.U072_RETAIN_CLAIM_HDR.X_PED_PURGE_PRIOR_TO_DATE":
                return Common.StringToField(rdrU072_RETAIN_CLAIM_HDR.GetString("X_PED_PURGE_PRIOR_TO_DATE"));
            ...
            case "TEMPORARYDATA.U072_RETAIN_CLAIM_HDR.CLMHDR_BATCH_TYPE":
                return Common.StringToField(rdrU072_RETAIN_CLAIM_HDR.GetString("CLMHDR_BATCH_TYPE"));
            case "D_CLMHDR_ADJ_CD":
                return Common.StringToField(D_CLMHDR_ADJ_CD(), intSize);
            case "TEMPORARYDATA.U072_RETAIN_CLAIM_HDR.CLMHDR_AGENT_CD":
                return rdrU072_RETAIN_CLAIM_HDR.GetNumber("CLMHDR_AGENT_CD").ToString();
            case "TEMPORARYDATA.U072_RETAIN_CLAIM_HDR.CLMHDR_CYCLE_NBR":
                return rdrU072_RETAIN_CLAIM_HDR.GetNumber("CLMHDR_CYCLE_NBR").ToString();
    ...
    public override void AccessData() {
        try
        {
            ...
            Access_U072_RETAIN_CLAIM_HDR();
            while (rdrU072_RETAIN_CLAIM_HDR.Read()) {
            ...
            rdrU072_RETAIN_CLAIM_HDR.Close();
        }
    ...
    public override void CloseReaders() {
        if (!(rdrU072_RETAIN_CLAIM_HDR == null)) {
            rdrU072_RETAIN_CLAIM_HDR.Close();
            rdrU072_RETAIN_CLAIM_HDR = null;
        }
