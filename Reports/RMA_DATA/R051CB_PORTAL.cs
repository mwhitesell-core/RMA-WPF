...
namespace RMA_DATA
{
    public class R051CB_PORTAL : BaseRDLClass
    {
		#region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "
		
        protected const string REPORT_NAME = "R051CB_PORTAL";
        ...
        public DataSet GetDataSet(string strConnection, string[] arrParameters, string strReportAssembly, bool blnDebug)
        {
            try
            {
                ...
                Sort = "DOCREV_CLINIC_1_2 ASC, DOCREV_DEPT ASC, DOC_FULL_PART_IND ASC, DOCREV_OMA_CODE ASC, DOCREV_OMA_SUFF ASC";
        ...
        private void Link_F040_OMA_FEE_MSTR()
        {
            ...
            strSQL.Append("WHERE ");
            //strSQL.Append("FEE_OMA_CD = ").Append(Common.StringToField(rdrF050_DOC_REVENUE_MSTR.GetString("DOCREV_OMA_CD")));
        ...
        // # Do not delete, modify or move it.  Updated: 2018-05-01 11:47:31 PM
