...
namespace RMA_DATA
{
    public class MARYPERC : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "MARYPERC";
        ...
        private string Choose()
        {
            ...
            strChoose.Append(ReportDataFunctions.GetWhereCondition("COMP_CODE", "PERC", true));
        ...
        //# Do not delete, modify or move it.  Updated: 8/22/2017 11:54:42 AM
