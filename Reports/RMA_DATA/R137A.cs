...
namespace RMA_DATA
{
    public class R137A : BaseRDLClass
    {
        ...
        private void Access_Data()
        {
            ...
            strSQL.Append("WHERE (ytd.COMP_CODE = 'TOTINC' AND ytd.REC_TYPE = 'A' AND mstr.DOC_DEPT = '14' AND (ytd.AMT_MTD <> 0 or ytd.AMT_YTD <> 0) AND ytd.AMT_YTD <= 6500000 AND mstr.DOC_RMA_EXPENSE_PERCENT_REG <> 50000)) AS alldata ");
