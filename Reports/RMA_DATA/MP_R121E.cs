...
namespace RMA_DATA
{
    public class MP_R121E : BaseRDLClass
    {
        ...
        public override bool SelectIf()
        {
            ...
            if (QDesign.NULL(rdrF070_DEPT_MSTR.GetNumber("DEPT_COMPANY")) == QDesign.NULL(3d) && QDesign.NULL(rdrF112_PYCDCEILINGS.GetString("DOC_PAY_CODE")) != QDesign.NULL("7"))
            {
                blnSelected = true;
            }
