...
namespace RMA_DATA
{
    public class SPEPRE : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "SPEPRE";
        ...
        public override bool SelectIf()
        {
            ...
            if (QDesign.NULL(rdrF114_SPECIAL_PAYMENTS.GetString("COMP_CODE")) == QDesign.NULL("SPEPRE"))
            {
                blnSelected = true;
            }
