...
//  08/mar/20  M.C.      original (clone from r051cbatp.qzs)
...
namespace RMA_DATA
{
    public class R051CBTP_PORTAL : BaseRDLClass
    {
        protected const string REPORT_NAME = "R051CBTP_PORTAL";
        ...
        public DataSet GetDataSet(string strConnection, string[] arrParameters, string strReportAssembly, bool blnDebug)
        {
            try
            {
                ...
                Sort = "DOCREVTP_CLINIC_NBR ASC, DOC_DEPT ASC, DOC_FULL_PART_IND ASC, DOCREVTP_OMA_CODE ASC";
        ...
        private string Choose()
        {
            ...
            strChoose.Append(ReportDataFunctions.GetWhereCondition("DOCREVTP_CLINIC_NBR", ReportFunctions.astrScreenParameters[0].ToString(), true));
        ...
        public override void DeclareReportControls()
        {
            try
            {
                ...
                AddControl(ReportSection.FOOTING_AT, "X_FEE_DESC", DataTypes.Character, 45);
