...
namespace RMA_DATA
{
public class R011C_70 : BaseRDLClass {
    protected const string REPORT_NAME = "R011C_70";
 ...
 AddControl(ReportSection.FOOTING_AT, "INDEXED.F050_DOC_REVENUE_MSTR.DOCREV_CLINIC_1_2", DataTypes.Character, 2);
