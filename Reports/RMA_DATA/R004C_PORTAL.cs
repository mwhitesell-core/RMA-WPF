...
namespace RMA_DATA
{
    public class R004C_PORTAL : BaseRDLClass
    {
        protected const string REPORT_NAME = "R004C_PORTAL";
        ...
        public override void DeclareReportControls()
        {
            try
            {
                ...
                AddControl(ReportSection.PAGE_HEADING, "TEMPORARYDATA.R004B.ICONST_DATE_PERIOD_END", DataTypes.Numeric, 8);
                ...
                AddControl(ReportSection.FOOTING_AT, "TEMPORARYDATA.R004B.X_SOURCE", DataTypes.Character, 2);
        ...
        // # Do not delete, modify or move it.  Updated: 2018-04-27 12:39:58 PM
        public override string ReturnControlValue(string strControl, int intSize)
        {
            switch (strControl)
            {
                ...
                case "TEMPORARYDATA.R004B.CLMDTL_SV_DATE":
                    return rdrR004B.GetNumber("CLMDTL_SV_DATE").ToString();
