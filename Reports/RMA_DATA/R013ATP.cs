...
namespace RMA_DATA
{
    public class R013ATP : BaseRDLClass {
        protected const string REPORT_NAME = "R013ATP";
        ...
        public DataSet GetDataSet(string strConnection, string[] arrParameters, string strReportAssembly, bool blnDebug) {
            try
            {
                ...
                Sort = "DOCREVTP_CLINIC_NBR ASC, DOCREVTP_AGENT_CD ASC, DOCREVTP_LOC_CD ASC, DOCREVTP_OMA_CODE ASC, DOCREVTP_OMA_SUFFIX ASC";
        ...
        private string X_DAY() {
            ...
            try
            {
                strReturnValue = QDesign.ASCII(rdrICONST_MSTR_REC.GetDate("ICONST_DATE_PERIOD_END_DD"), 2);
            }
        ...
        public override void DeclareReportControls() {
            try
            {
                ...
                AddControl(ReportSection.PAGE_HEADING, "INDEXED.F050TP_DOC_REVENUE_MSTR.DOCREVTP_AGENT_CD", DataTypes.Character, 1);
                AddControl(ReportSection.PAGE_HEADING, "INDEXED.F050TP_DOC_REVENUE_MSTR.DOCREVTP_LOC_CD", DataTypes.Character, 4);
                ...
                AddControl(ReportSection.REPORT, "INDEXED.F050TP_DOC_REVENUE_MSTR.DOCREVTP_OMA_CODE", DataTypes.Character, 4);
                AddControl(ReportSection.REPORT, "INDEXED.F050TP_DOC_REVENUE_MSTR.DOCREVTP_OMA_SUFFIX", DataTypes.Character, 1);
            }
        ...
        // # Do not delete, modify or move it.  Updated: 2018-05-10 11:27:47 AM
        public override string ReturnControlValue(string strControl, int intSize) {
            ...
            switch (strControl) {
                ...
                case "INDEXED.F050TP_DOC_REVENUE_MSTR.DOCREVTP_LOC_CD":
                    return Common.StringToField(rdrF050TP_DOC_REVENUE_MSTR.GetString("DOCREVTP_LOC_CD"));
                ...
                case "INDEXED.F050TP_DOC_REVENUE_MSTR.DOCREVTP_OMA_CODE":
                    return Common.StringToField(rdrF050TP_DOC_REVENUE_MSTR.GetString("DOCREVTP_OMA_CODE"));
                case "INDEXED.F050TP_DOC_REVENUE_MSTR.DOCREVTP_OMA_SUFFIX":
                    return Common.StringToField(rdrF050TP_DOC_REVENUE_MSTR.GetString("DOCREVTP_OMA_SUFFIX"));
                default:
                    return String.Empty;
            }
        }
