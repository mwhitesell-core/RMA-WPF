...
namespace RMA_DATA
{
    public class R121B_COMPANY : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "R121B_COMPANY";
        ...
        public DataSet GetDataSet(string strConnection, string[] arrParameters, string strReportAssembly, bool blnDebug)
        {
            try
            {
                ...
                Sort = "X_KEY2 ASC, DEPT_COMPANY, X_KEY1";
        ...
        private void Access_Data()
        {
            ...
            strSQL.Append("x_key2 = (CASE WHEN DOC_DEPT = 14 THEN 'D' ");
            strSQL.Append("WHEN DOC_FULL_PART_IND = 'F' THEN 'A' ");
            strSQL.Append("WHEN DOC_FULL_PART_IND = 'P' THEN 'B' ");
            ...
            strSQL.Append("WHERE ytd.REC_TYPE = 'A') AS alldata ");
            strSQL.Append("ORDER BY x_key2, DEPT_COMPANY, x_key1 ");
        ...
        //        case "INDEXED.F07_DEPT_MSTR.DEPT_COMPANY":
