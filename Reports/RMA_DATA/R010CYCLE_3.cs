...
namespace RMA_DATA
{
    public class R010CYCLE_3 : BaseRDLClass
    {
        protected const string REPORT_NAME = "R010CYCLE_3";
        ...
        public override bool SelectIf()
        {
            ...
            if (((rdrICONST_MSTR_REC.GetNumber("ICONST_CLINIC_NBR_1_2") >= 61)
                        && (rdrICONST_MSTR_REC.GetNumber("ICONST_CLINIC_NBR_1_2") <= 66)))
            {
                blnSelected = true;
            }
