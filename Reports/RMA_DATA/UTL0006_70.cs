...
namespace RMA_DATA
{
    public class UTL0006_70 : BaseRDLClass
    {
        protected const string REPORT_NAME = "UTL0006_70";
        ...
        public override bool SelectIf()
        {
            ...
            if (QDesign.NULL(rdrF070_DEPT_MSTR.GetNumber("DEPT_COMPANY")) == QDesign.NULL(1d) && (QDesign.NULL(X_PROF()) != QDesign.NULL(0d) || QDesign.NULL(X_TECH()) != QDesign.NULL(0d)))
            {
                blnSelected = true;
            }
        ...
        private string X_CLINIC()
        {
            ...
            try
            {
                if ((QDesign.NULL(rdrF051TP_DOC_CASH_MSTR.GetNumber("DOCASHTP_CLINIC_NBR")) == QDesign.NULL(71d)))
                {
                    strReturnValue = "H520";
                }
                else if ((QDesign.NULL(rdrF051TP_DOC_CASH_MSTR.GetNumber("DOCASHTP_CLINIC_NBR")) == QDesign.NULL(72d)))
                {
                    strReturnValue = "H521";
                }
                else if ((QDesign.NULL(rdrF051TP_DOC_CASH_MSTR.GetNumber("DOCASHTP_CLINIC_NBR")) == QDesign.NULL(73d)))
                {
                    strReturnValue = "H522";
                }
                else if ((QDesign.NULL(rdrF051TP_DOC_CASH_MSTR.GetNumber("DOCASHTP_CLINIC_NBR")) == QDesign.NULL(74d)))
                {
                    strReturnValue = "H523";
                }
                else if ((QDesign.NULL(rdrF051TP_DOC_CASH_MSTR.GetNumber("DOCASHTP_CLINIC_NBR")) == QDesign.NULL(75d)))
                {
                    strReturnValue = "H524";
                }
            }
        ...
        public override void DeclareReportControls()
        {
            try
            {
                ...
                AddControl(ReportSection.FOOTING_AT, "X_CLINIC", DataTypes.Character, 4);
        ...
        // # Do not delete, modify or move it.  Updated: 2018-05-16 12:45:03 PM
