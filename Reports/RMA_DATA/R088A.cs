...
//  10/02/11 YB   copied from r088.qzs and select statement change to include all locations
//  change heading to send it to Ellen Prominski
//  10/02/11 MC1   Yasemin requested to prdecimal the pagae heading once, change from ` page heading `
//  to `initial heading`
...
namespace RMA_DATA
{
    public class R088A : BaseRDLClass
    {
        protected const string REPORT_NAME = "R088A";
