//  DOC: r006btp_70 
//  DOC: MONTHLY CASH APPLIED RECONCILIATION BY DOCTOR (SUMMARY REPORT)
//  DOC: SORT BY CLINIC BY AGENT
//  DOC: RUN FOR: MUMC DIAGNOSTICS
//  PROGRAM PURPOSE : CASH ANALYSIS BY DOCTOR (SUMMARY BY CLINIC BY
//  AGENT REPORT) R006TP.CB CONVERSTION TO POWERHOUSE
//  R006BTP.QZS APPEND R006BTP.TXT TO END OF R006ATP.TXT
//  DATE       BY WHO       DESCRIPTION
//  2007/Mar   YASEMIN      r006btp 
...
namespace RMA_DATA
{
    public class R006BTP_70 : BaseRDLClass
    {
        protected const string REPORT_NAME = "R006BTP_70";
        ...
        public DataSet GetDataSet(string strConnection, string[] arrParameters, string strReportAssembly, bool blnDebug)
        {
            try
            {
                ...
                Sort = "DOCASHTP_CLINIC_NBR ASC, DOCASHTP_AGENT_CD ASC";
        ...
        // # Do not delete, modify or move it.  Updated: 2018-05-09 11:06:45 AM
