...
namespace RMA_DATA
{
    public class R997G : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "R997G";
        ...
        //# Do not delete, modify or move it.  Updated: 9/29/2017 10:47:40 AM
        ...
        public override string ReturnControlValue(string strControl, int intSize)
        {
            switch (strControl)
            {
                ...
                case "TEMPORARYDATA.U997_GOOD_SRT.RAT_145_PAYMENT_DATE":
                    return rdrU997_GOOD_SRT.GetNumber("RAT_145_PAYMENT_DATE").ToString();
                ...
                case "TEMPORARYDATA.U997_GOOD_SRT.RAT_145_SERVICE_DATE":
                    return rdrU997_GOOD_SRT.GetNumber("RAT_145_SERVICE_DATE").ToString();
