...
namespace RMA_DATA
{
    public class MARYSHIFT : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "MARYSHIFT";
        ...
        private string Choose()
        {
            ...
            strChoose.Append(ReportDataFunctions.GetWhereCondition("COMP_CODE", "SHIFT", true));
        ...
        //# Do not delete, modify or move it.  Updated: 8/22/2017 11:54:57 AM
