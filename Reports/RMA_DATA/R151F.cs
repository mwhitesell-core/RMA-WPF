...
namespace RMA_DATA
{
    public class R151F : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "R151F";
        ...
        public override bool SelectIf()
        {
            ...
            if (QDesign.NULL(rdrF070_DEPT_MSTR.GetNumber("DEPT_COMPANY")) == QDesign.NULL(4d))
                blnSelected = true;
        ...
        //# Do not delete, modify or move it.  Updated: 2017-07-25 6:51:42 PM
        ...
        public override string ReturnControlValue(string strControl, int intSize)
        {
            switch (strControl)
            {
                ...
                case "TEMPORARYDATA.R151.DOC_SIN_NBR":
                    return rdrR151.GetNumber("DOC_SIN_NBR").ToString();
