...
namespace RMA_DATA
{
    public class OVPAY : BaseRDLClass
    {
        #region " Renaissance Declarations (Variables, DataReaders, Parameters and Use Files) "

        protected const string REPORT_NAME = "OVPAY";
        ...
        private string Choose()
        {
            ...
            strChoose.Append(ReportDataFunctions.GetWhereCondition("COMP_CODE", "OVPAY", true));
        ...
        //# Do not delete, modify or move it.  Updated: 8/22/2017 11:30:23 AM
