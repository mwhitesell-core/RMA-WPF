...
namespace RMA_DATA
{
    public class MP_R121F : BaseRDLClass
    {
        ...
        public override bool SelectIf()
        {
            ...
            if (QDesign.NULL(rdrF070_DEPT_MSTR.GetNumber("DEPT_COMPANY")) == QDesign.NULL(4d) && QDesign.NULL(rdrF112_PYCDCEILINGS.GetString("DOC_PAY_CODE")) != QDesign.NULL("7"))
            {
                blnSelected = true;
            }
