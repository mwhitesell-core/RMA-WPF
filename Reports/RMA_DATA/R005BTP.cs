...
namespace RMA_DATA
{
    public class R005BTP : BaseRDLClass
    {
        protected const string REPORT_NAME = "R005BTP";
        ...
        private string X_DAY()
        {
            ...
            try
            {
                strReturnValue = QDesign.Substring(QDesign.ASCII(rdrICONST_MSTR_REC.GetDate("ICONST_DATE_PERIOD_END"), 8), 7, 2);
            }
        ...
        // # Do not delete, modify or move it.  Updated: 2018-05-09 11:06:47 AM
