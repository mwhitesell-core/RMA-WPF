...
IF EXISTS(SELECT * FROM sys.sysdatabases WHERE NAME = '%DatabaseName%_BACKUP')
   DROP DATABASE [%DatabaseName%_BACKUP];

IF ('%DatabaseName%' = '101C' OR '%DatabaseName%' = 'MP' OR '%DatabaseName%' = 'SOLO') 
BEGIN
