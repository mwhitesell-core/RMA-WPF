...
-- ==========================================================================================
IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'sp_COPY_F040_OMA_FEE_MSTR_FROM_101_TO_101C')
Begin
	...
	Begin
		...
		IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[101C].[INDEXED].[F040_OMA_FEE_MSTR]') AND type in (N'U'))
...
-- ==========================================================================================
IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'sp_COPY_F040_OMA_FEE_MSTR_FROM_101C_TO_101')
Begin
	EXECUTE sp_executesql N'
