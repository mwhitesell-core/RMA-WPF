...
*		: work file 
*		: "R153A" - doctor statement of charges 
*		: "R153B" - bank charges list report 
*		: "R153C" - bank invoices
* 
*    additional  files for eft development 
*               : "R153EF"  -  eft summary report 
*               : "EFT_CHG"  -  eft file   for charges for upload to bank
* 
...
*                         r153a performing only the sort
*			  and updating eft-constants file  while
*			  r153b now creates the EFT file and reports.  
*
...
*                         for Palliative Care
*                       - also modify $use/r153_bank_info.ws for the new company
...
* 2014-may-14 be1	- change Z record to be updated with DEBIT totals not CREDIT totals of transactions
* 2014-may-28 MC2       - change to use eft_constant_debit instead of eft_constant
* 2016/Aug/29 MC3       - Yasemin requests to show run date in r153ef report
...
*       assign to "$pb_data/eft_constant" 
        assign to "$pb_data/eft_constant_debit" 
        organization is  sequential. 
...
*						      'C' for Credit of account (ie payment) and 'D' for debit or charge
*						      'D' for debit or charge
*     05  ws-rec-d		 pic x		 value 'C'. 
...
*!    05  r153a-h1-doc-nbr			pic 999		value zeroes. 
    05  r153a-h1-doc-nbr			pic xxx		value spaces. 
* 2003/11/18 - end
...
01  eft-prt-1. 
    ...
    "               SUMMARY REPORT FOR E.F.T. CHARGES FILE CREATION  ". 
...
*mf sort r153-work-file		"COBSORT" save 
    sort r153-work-file
...
* be2 use debit not credit values on report
