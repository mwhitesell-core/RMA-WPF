...
* 2008/may/01   Brad1	- allow entry of asst values for CP ICC code 
* 			  as per thekla request
* 2017/Apr/11   MC1	- include constant-mstr-rec-2 and set oma fee based on the oma rate in rec 2 of f090
* 
...
*			asst		                                
* 2008/apr/01 asst now application for CP!!
...
*       (brad1 - allow asst to be displayed)
...
*	(brad1 - allow asst to be entered)
...
*	move fee-curr-h-fee-1		to	fee-curr-a-fee-1 
	compute fee-curr-a-fee-1 = fee-curr-h-fee-1 * const-oma-curr 
* MC1 - end
...
*        move fee-curr-h-fee-2           to      fee-curr-a-fee-2
        compute fee-curr-a-fee-1 = fee-curr-h-fee-1 * const-oma-curr 
        compute fee-curr-a-fee-2 = fee-curr-h-fee-2 * const-oma-curr 
* MC1 - end
...
*	move fee-prev-h-fee-1		to	fee-prev-a-fee-1 
	compute fee-prev-a-fee-1 = fee-prev-h-fee-1 * const-oma-prev 
* MC1 - end
...
*	move fee-prev-h-fee-2		to	fee-prev-a-fee-2 
	compute fee-prev-a-fee-1 = fee-prev-h-fee-1 * const-oma-prev 
	compute fee-prev-a-fee-2 = fee-prev-h-fee-2 * const-oma-prev 
* MC1 - end
