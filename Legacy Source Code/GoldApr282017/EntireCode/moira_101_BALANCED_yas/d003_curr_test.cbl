...
* 12/Oct/29 MC7  - modify in jc0-rewrite-detail for correcting the update of details especially for duplicate oma
*		   Brad suggested to match with line no of the detail before update
* 2012/oct/31 be3-
...
*be3
*   move hold-detail(i)		    to hold-claim-detail-rec(i).
...
*be3 
    move hold-line-no (i) 	    to clmdtl-line-no.
...
* 2012/10/31 - MC7 - check line no to make sure it is the record to be updated

jc0-1.
    if hold-line-no (i) =  clmdtl-line-no
    then 
	next sentence
    else
	perform jc1-read-next-claim-dtl thru jc1-99-exit
	go to jc0-1.                 
*   endif
* 2012/10/31 - end
...
*be3 
	    move ss-clmdtl 		to hold-line-no		 (ss-clmdtl)
