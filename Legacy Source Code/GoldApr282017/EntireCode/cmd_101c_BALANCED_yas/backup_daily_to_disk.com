...
/charly/rmabill/rmabill101c/data/f050_doc_revenue_mstr_history.dat  \
/charly/rmabill/rmabill101c/data/f050_doc_revenue_mstr_history.idx  \
data/f050tp_doc_revenue_mstr            \
data/f050tp_doc_revenue_mstr.idx        \
/charly/rmabill/rmabill101c/data/f050tp_doc_revenue_mstr_history.dat \
/charly/rmabill/rmabill101c/data/f050tp_doc_revenue_mstr_history.idx \
...
cat data/backup_daily_f010_f002.ls          \
	> data/backup_daily_complete_0.ls
date
echo "building files for  DISK cpio 1 ..."
cat data/backup_daily.ls       	        \
	> data/backup_daily_complete_1.ls
date
echo "building files for  DISK cpio 2  ..."
cat data/disk1dir.ls 			\
    data/disk2dir.ls 			\
    data/disk3dir.ls 			\
    data/disk4dir.ls 			\
    data/disk5dir.ls 			\
    ...
    data/mp_data.ls               	\
    data/rmadir.ls			\
	> data/backup_daily_complete_2.ls
echo
date
echo "Starting copy of file to DISK - cpio file 0  ..."
cat       data/backup_daily_complete_0.ls \
    | cpio -ocuvB >  /charly/backup_transfer_area/backup_daily_0.cpio
echo "Starting copy of file to DISK - cpio file 1  ..."
cat       data/backup_daily_complete_1.ls \
    | cpio -ocuvB >  /charly/backup_transfer_area/backup_daily_1.cpio
date
echo "Starting copy of file to DISK - cpio file 2   ..."
cat       data/backup_daily_complete_2.ls \
    | cpio -ocuvB >  /charly/backup_transfer_area/backup_daily_2.cpio
