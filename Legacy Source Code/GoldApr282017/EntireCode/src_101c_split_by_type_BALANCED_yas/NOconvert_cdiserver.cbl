...
****   10 buffer-data-records				pic x(1696).
   10 buffer-data-records				pic x(1800).
...
*   than from C code)
    ...
    move "5"				to debug-value.
    perform xa0-write-audit-request	thru xa0-99-exit.
    perform aa0-initialization          thru aa0-99-exit.

*1*********    move spaces				to buffer-doctor-records.
    move spaces				to buffer-doctor-records.

    perform xa0-write-audit-request	thru xa0-99-exit.

***********
*1       perform ab0-validate		thru ab0-99-exit.
...
*    move key-value2				to	l1-key-value2.
    move debug-value				to	l1-key-value2.
