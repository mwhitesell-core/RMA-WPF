...
*	date		name		revision 
*	-----		-----		--------- 
*	83/11/03	i.warsh		- verified that mtd totals 
*					  print million and ytd 
*					  print 10 million. 
* 
*       87/may/26       shawn blair     - coversion from aos to aos/vs. 
...
*                      - summarized all clinic 60'S TOTAL 
* 
*   revised apr/19/93: - pdr 571 agk 
...
*   2003/dec/20		b.e.	- remove confirm to run job
*   2007/apr/19         M.C.    - summarized all clinic 70'S TOTAL 
*   2010/mar/09         MC1     - include clinic 66 in clinic 60's TOTAL
*   2010/mar/25		MC2	- allow 99999,999.99 in MTD amount
*				- print final MTD & YTD amount on the very last page with proper field size
*				- print final diskette MTD & YTD amount on the very last page with 2 separate lines 
*   2012/Feb/16	 	MC3     - change to print the clinic 60/70 summary page properly for Dave
*   2013/Jun/24         MC4     - change page size from 999 to 9999       
*   2014/Oct/20         MC5     - ignore dummy record 
*   2015/Mar/17		MC6	- change l1-loc-2-4 to be character instead of numeric
...
* 2013/06/24 - MC4 - allow 9999 for page limit  
*    05  filler					pic x(75)	value 
    05  filler					pic x(74)	value 
		"-  COMPLETE BATCH SUMMARY REPORT  -". 
...
* (y2k) 05  filler				pic x(16)	value spaces. 
...
* 2010/03/35 - MC2 - allows zzzzz,zz9.99-
*        10  filler				pic x(1).     
...
*        10  t1-detail-3				pic zzzz,zz9.99-. 
        ...
        10  t1-detail-1				pic zzzzz,zz9.99-. 
        10  t1-detail-2				pic zzzzz,zz9.99-. 
        10  t1-detail-3				pic zzzzz,zz9.99-. 
* 2010/03/25 - end
        10  filler				pic x(1). 
        ...
        10  t1-detail-8				pic zzzzz,zz9.99-. 
        10  t1-detail-9				pic zzzz,zz9. 
        10  t1-detail-10			pic zzzz,zz9. 

* 2010/03/25 - MC2 - print final MTD/YTD on the very last page of the report for proper field size
     05  t1-final-line  redefines   l1-print-line. 
        10  t1-fin-desc				pic x(20).
        10  t1-fin-detail-1			pic zzz,zzz,zz9.99-. 
        10  filler				pic x(2). 
        10  t1-fin-detail-2			pic zzz,zzz,zz9.99-. 
        10  filler				pic x(2). 
        10  t1-fin-detail-3			pic zzz,zzz,zz9.99-. 
        10  filler				pic x(2). 
        10  t1-fin-detail-4			pic z,zzz,zz9. 
        10  filler				pic x(2). 
        10  t1-fin-detail-5			pic z,zzz,zz9. 
        10  filler				pic x(41). 
...
01  scr-prog-in-prog. 
    ...
    05  line 14 col 30 value is "R001B IN PROGRESS". 
...
01  scr-closing-screen. 
    05  blank screen. 
    05  line  3 col 20  value "NUMBER OF DOC-MSTR-FILE ACCESSES = ". 
...
*    05  line  9 col 60  pic 9(7) from ctr-x. 
    05  line 21 col 20	value "PROGRAM R001B ENDING". 
* (y2k - auto fix)
...
*       -- the batch is balanced and has not as yet been sent to ohip ("STATUS < 4). 
...
*   endif 
** 
**  the above lines have been commented out and replace with the 
**    following lines on nov 1/90 by bml. sms 133. 
** 
    move batctrl-adj-cd			to 	l1-adj-code. 
...
*	(print cycle nbr only if the batch'S CYCLE IS NOT = TO THE CURRENT CYCLE) 
    if      ( batctrl-cycle-nbr		= iconst-clinic-cycle-nbr 
      ...
      or    batctrl-date-period-end not = iconst-date-period-end 
    then 
...
* 2012/02/16 - MC3 - retrieve cycle & ped for clinic 60
...
* 2012/02/16 - MC3 - retrieve cycle & ped for clinic 70
...
* 2010/03/25 - MC2 - change to print diskette into 2 separate lines *
*    move "DISKETTE TOTALS"              to t1-desc. 
...
*    perform tb0-write-line              thru tb0-99-exit. 
    ...
    move disk-grnd-tab (1)              to t1-fin-detail-1. 
    move disk-grnd-tab (1)              to t1-fin-detail-2. 
    move disk-grnd-tab (4)              to t1-fin-detail-4. 
    move disk-grnd-tab (5)              to t1-fin-detail-5. 
    perform tb0-write-line              thru tb0-99-exit. 
    
    move 2                              to nbr-lines-to-advance. 
    move "DISKETTE YTD TOTAL"           to t1-fin-desc. 
    move disk-grnd-tab (6)              to t1-fin-detail-1. 
    move disk-grnd-tab (6)              to t1-fin-detail-2. 
    move disk-grnd-tab (9)              to t1-fin-detail-4. 
    move disk-grnd-tab (10)             to t1-fin-detail-5. 
    perform tb0-write-line              thru tb0-99-exit. 

* 2010/03/25 - end

* 2010/03/25 - MC2 - print final MTD & YTD with proper field size
 
    move " FINAL MTD TOTALS  "  	to	t1-fin-desc. 
 
    move fin-tot-1			to	t1-fin-detail-1. 
    move fin-tot-2			to	t1-fin-detail-2. 
    move fin-tot-3			to	t1-fin-detail-3. 
    move fin-tot-4			to	t1-fin-detail-4. 
    move fin-tot-5			to	t1-fin-detail-5. 
    ...
    move fin-tot-6			to	t1-fin-detail-1. 
    move fin-tot-7			to	t1-fin-detail-2. 
    move fin-tot-8			to	t1-fin-detail-3. 
    move fin-tot-9			to	t1-fin-detail-4. 
    move fin-tot-10			to	t1-fin-detail-5.  
