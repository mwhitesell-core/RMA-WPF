...
*		: "r992" missing claims report.                   
*
*    program purpose : this program reports the missing batch-control-claims in the batch control file. 
*		       when a missing batch-ctrl-claim is encountered a report is generated. 
*		       the batch #, period end date and the cycle # is the information that is shown on the report. 
* 
...
* variables 
77  print-file-name				pic x(4)	value "r992". 
77  err-ind					pic 9. 
...
77  ws-claim-bat-nbr				pic x(8)	value zero. 
...
* 2003/dec/10 - MC - not sure about b - assume it's blank
...
01  program-in-progress. 
    05  line 22 col 20 value "PROGRAM R992 IN PROGRESS". 
...
01  scr-closing-screen. 
    ...
    05  line 21 col 17	value "PROGRAM R992 ENDING". 
* (y2k - auto fix)
...
*  if it encounters any missing claims a report is generated. 
   ...
   move clmhdr-orig-batch-nbr  	to 	key-batctrl-file. 
