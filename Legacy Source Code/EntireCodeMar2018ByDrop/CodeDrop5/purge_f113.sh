...
rm $pb_prod/purgef113.log 1>/dev/null  2>/dev/null

echo "Purge f113-history -  STARTING - `date`" > $pb_prod/purgef113.log    

qtp auto=$obj/purge_unlof113_history.qtc << QTP_EXIT 1>>$pb_prod/purgef113.log 2>&1
2008
2008
QTP_EXIT
...
mv  f113_def_comp_history.dat  /charly/purge/101c/f113_def_comp_history.dat
mv  f113_def_comp_history.idx  /charly/purge/101c/f113_def_comp_history.idx
...
echo "Purge f113-history - ENDING - `date`" >> $pb_prod/purgef113.log
