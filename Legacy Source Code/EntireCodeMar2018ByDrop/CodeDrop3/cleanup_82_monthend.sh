...
echo         THIS PROGRAM WILL DELETE THE CLINIC 82 MONTEND REPORTS
...
rm   >/dev/null  2>/dev/null  r070_82
...
rm   >/dev/null  2>/dev/null  r070_srt_work_mstr_82
rm   >/dev/null  2>/dev/null  r070_work_mstr_82
rm   >/dev/null  2>/dev/null  filer001*
rm   >/dev/null  2>/dev/null  r934*.txt
rm   >/dev/null  2>/dev/null  u933*.sf*
rm   >/dev/null  2>/dev/null  claims_subfile*.sf*
