...
Namespace Core.Windows.UI
    ...
    Public MustInherit Class FieldObjectDateBox
        Inherits DatePicker
...
#Region "  Properties  "
        ...
        ''' </history>
        ''' -----------------------------------------------------------------------------
        Private _submittedvalue As String
        <Bindable(False),
        Browsable(False),
        DefaultValue(""),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Advanced)>
        ...
        Private _OldSubmittedValue As String
        ''' -----------------------------------------------------------------------------
        ''' <exclude/>
        '''
        ''' <summary>
        ...
        Friend Property OldSubmittedValue() As String
            Get
                Return _OldSubmittedValue
            End Get
            Set(ByVal Value As String)
                _OldSubmittedValue = Value
            End Set
        End Property

        Private fieldRequestValue As String
        ''' -----------------------------------------------------------------------------
        ''' <exclude/>
        '''
        ''' <summary>
        ...
        Public Property RequestValue() As String
            Get
                Return fieldRequestValue
            End Get
            Set(ByVal Value As String)
                fieldRequestValue = Value
            End Set
        End Property
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Variable name or element name of the field.  For elements, this will be in the format TableName.ElementName, and is used by the dictionary."),
        Category("Core"),
        DefaultValue(""),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("If Refresh is set to True the field will Refresh after a runscreen call."),
        Category("Core"),
        DefaultValue(""),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        ...
        ''' -----------------------------------------------------------------------------
        <Bindable(False),
        Description("TableName of the Textbox.  Read-Only property."),
        Browsable(False),
        DefaultValue(""),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Advanced)>
        ...
        ''' -----------------------------------------------------------------------------
        <Bindable(False),
        Description("Dictionary of the Textbox. Read-Only property."),
        Browsable(False),
        DefaultValue(""),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Advanced)>
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("DataType of the field (Character, Numeric or Date). "),
        Category("Core"),
        DefaultValue(GetType(DataTypes), "NotSet"),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Overridable Property DataType() As DataTypes
            Get
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Specifies the input scale to use for entered values (numeric fields only)."),
        Category("Core"),
        Browsable(True),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Property InputScale() As String
            Get
        ...
        ''' -----------------------------------------------------------------------------
        <Bindable(False),
        Description("Specified whether to use InputScale and OutputScale defined or field or not."),
        Category("Core"),
        DefaultValue(GetType(TriState), "UseDefault"),
        Browsable(True),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Advanced)>
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Specifies the output scaling to use for displayed values (numeric fields only)."),
        Category("Core"),
        Browsable(True),
        DefaultValue(0),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Property OutputScale() As String
            Get
        ...
        ''' -----------------------------------------------------------------------------
        <Bindable(False),
        Description("Specifies the range(s) of acceptable values for a field."),
        Category("Core"),
        Browsable(False),
        DefaultValue(""),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Advanced)>
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Blank when zero flag indicates that the item is displayed as blanks if its value is 0."),
        Category("Core"),
        DefaultValue(GetType(BooleanTypes), "NotSet"),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Overridable Property BWZ() As BooleanTypes
            Get
                Return m_blnBWZ
            End Get
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("AutoNext flag indicates that the cursor will move to the next field when the input size current one is filled"),
        Category("Core"),
        DefaultValue(GetType(BooleanTypes), "NotSet"),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Overridable Property AutoNext() As BooleanTypes
            Get
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("UseDictionary flag indicates that a temp field will use a Dictionary defined field with the same name"),
        Category("Core"),
        DefaultValue(GetType(Boolean), "False"),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Overridable Property UseDictionary() As Boolean
            Get
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Will shift the case of the Text in the control."),
        Category("Core"),
        DefaultValue(GetType(ShiftTypes), "NotSet"),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Overridable Property ShiftType() As ShiftTypes
            Get
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Specifies a single character that is placed to the left of the most significant digit to indicate that the numeric value of the textbox is a negative number."),
        Category("Core"),
        DefaultValue(""),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Overridable Property LeadingSign() As String
            Get
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Specifies the character used to 'fill' unused space to the left of the most significant digit. Note: Float character and Leading sign are taken into account."),
        Category("Core"),
        DefaultValue(""),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Heading displayed for grid column."),
        Category("Core"),
        Browsable(False),
        DefaultValue(""),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Advanced)>
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Specifies the float character to appear to the left of the most significant digit."),
        Category("Core"),
        DefaultValue(""),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Overridable Property Float() As String
            Get
                Return m_strFloat
            End Get
            Set(ByVal Value As String)
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Specifies up to 2 characters that are placed to the right most digit to indicate that the numeric value of the field is a negative number."),
        Category("Core"),
        DefaultValue(""),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Overridable Property TrailingSign() As String
            Get
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Indicates that a value is required for this field when entering a new record."),
        Category("Core"),
        DefaultValue(GetType(BooleanTypes), "NotSet"),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Property Required() As BooleanTypes
            Get
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Displays the control as a read-only control in Entry, Find or Change mode."),
        Category("Core"),
        DefaultValue(GetType(BehaviorTypes), "NotSet"),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Property Display() As BehaviorTypes
            Get
                Return m_BehDisplay
            End Get
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("States that the data on the screen cannot be entered or displayed on the screen unless forced through procedural code."),
        Category("Core"),
        DefaultValue(GetType(BehaviorTypes), "NotSet"),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Property Omit() As BehaviorTypes
            Get
                Return m_BehOmit
            End Get
            Set(ByVal Value As BehaviorTypes)
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Duplicates the value for this field from a previous occurrence of the field on the screen if the user doesn’t enter a value"),
        Category("Core"),
        Browsable(True),
        DefaultValue(GetType(BooleanTypes), "NotSet"),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Advanced)>
        Public Property Duplicate() As BooleanTypes
            Get
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Permanently displays the current value for this field when the screen first appears."),
        Category("Core"),
        DefaultValue(GetType(BooleanTypes), "NotSet"),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Property Fixed() As BooleanTypes
            Get
                Return m_blnFixed
            End Get
            Set(ByVal Value As BooleanTypes)
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Specifies that the field doesn’t appear on the screen."),
        Category("Core"),
        DefaultValue(GetType(BooleanTypes), "NotSet"),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Property Silent() As BooleanTypes
            Get
                Return m_blnSilent
            End Get
            Set(ByVal Value As BooleanTypes)
                ...
                Select Case Value
                    Case BooleanTypes.True
                        MyBase.Visibility = Hidden
                    Case Else
                        MyBase.Visibility = Visible
                End Select
            End Set
        End Property
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Specifies that the field should be hidden (invisible) on the screen."),
        Category("Core"),
        DefaultValue(GetType(BooleanTypes), "NotSet"),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Property Hidden() As BooleanTypes
            Get
                Return m_blnHidden
            End Get
            Set(ByVal Value As BooleanTypes)
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("The user can only enter a value when in Entry mode."),
        Category("Core"),
        DefaultValue(GetType(BooleanTypes), "NotSet"),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Property NoChange() As BooleanTypes
            Get
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("States that once a value has been entered in Entry mode, it cannot be changed until the record has been saved."),
        Category("Core"),
        DefaultValue(GetType(BooleanTypes), "NotSet"),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Property NoCorrect() As BooleanTypes
            Get
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Specifies that this field is read-only in Entry mode."),
        Category("Core"),
        DefaultValue(GetType(BooleanTypes), "NotSet"),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Property NoEntry() As BooleanTypes
            Get
                Return m_blnNoEntry
            End Get
            Set(ByVal Value As BooleanTypes)
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Specifies that this field is read-only in Select (Find) mode."),
        Category("Core"),
        DefaultValue(GetType(BooleanTypes), "NotSet"),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Property NoSelect() As BooleanTypes
            Get
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Display any initial value for this field on the form as soon as the screen appears, if the mode is changed, or if the cluster is initialized.  (Assumed for ALL fields on a slave screen)"),
        Category("Core"),
        DefaultValue(GetType(BooleanTypes), "NotSet"),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Property PreDisplay() As BooleanTypes
            Get
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Suppresses the display of messages."),
        Category("Core"),
        DefaultValue(GetType(BooleanTypes), "NotSet"),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Property NoWarn() As BooleanTypes
            Get
                Return m_blnNoWarn
            End Get
            Set(ByVal Value As BooleanTypes)
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("The default value to be displayed when in Entry mode and no item has previously been entered into the field. If Required is also set to True, the Default option is ignored."),
        Category("Core"),
        DefaultValue(""),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Field is required in Entry mode if the specified condition is met."),
        Category("Core"),
        DefaultValue(""),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Property EntryIf() As String
            Get
                Return m_strEntryIf
            End Get
            Set(ByVal Value As String)
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Specifies a string of characters and metacharacters that provides a general description of values."),
        Category("Core"),
        DefaultValue(""),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Establishes the output picture to be used to format the item value for display."),
        Category("Core"),
        DefaultValue(""),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("Establishes the minimum number (n) of characters displayed. It is generally used to force the display of leading nonsubstitution characters and leading zeros."),
        Category("Core"),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Overridable Property Significance() As String
            Get
        ...
        ''' --- End of Comments ----------------------------------------------------
        <Bindable(False),
        Description("DataType of the underlying item (variable or element) for this field."),
        Category("Core"),
        DefaultValue(GetType(DataTypes), "NotSet"),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Always)>
        Public Property UnderLyingDataType() As ItemDataTypes
            Get
        ...
        ''' --- End of Comments ----------------------------------------------------
        <EditorBrowsable(System.ComponentModel.EditorBrowsableState.Advanced)>
        Public MustOverride Property ValueChanged() As Boolean
        ...
        <Browsable(False),
        DefaultValue(False),
        Description("Specifies whether the field should be shown as a label."),
        EditorBrowsable(System.ComponentModel.EditorBrowsableState.Advanced)>
        Public Property DisplayAsLabel() As Boolean
            Get
...
#Region "  Methods  "
        ...
        'Public  Sub LoadDictionaryValues(ByVal LanguageCode As String) 
        ...
        Protected Friend Overridable Function RaiseGetNewRecordStatus() As Boolean
            If GetNewRecordStatus Is Nothing Then
                Return False
            End If
        ...
        ''' --- End of Comments ----------------------------------------------------
        <EditorBrowsable(System.ComponentModel.EditorBrowsableState.Advanced)>
        Protected Friend Overridable Sub RaiseGetRecordBuffer(ByRef FieldDate As String, ByRef FieldValue As Decimal, ByVal DataType As DataTypes)
            ...
            If Not GetRecordValue Is Nothing Then
                ...
                Else
                    If m_intUnderlyingDataType = DataTypes.NotSet Then
                        LoadValues()
                    End If
                ...
                With objGetterArgs
                    ...
                    If IsNothing(.FieldText) OrElse .FieldText = "0" OrElse .FieldText.Trim = "" Then
                        FieldDate = Nothing
                    Else
                        FieldDate = New Date(.FieldText.Substring(0, 4), .FieldText.Substring(4, 2), .FieldText.Substring(6, 2))
                    End If
                    FieldValue = .FieldValue
                End With
            ...
            Else
                ...
                RaiseEvent GetRecordBuffer(FieldDate, FieldValue, DataType)
            End If
        End Sub
...
#Region "  Events  "
        ...
        ''' --- End of Comments ----------------------------------------------------
        <EditorBrowsable(System.ComponentModel.EditorBrowsableState.Advanced)>
        Public Event GetRecordBuffer(ByRef FieldDate As Date?, ByRef FieldValue As Decimal, ByVal DataType As DataTypes)
        ...
        ''' --- End of Comments ----------------------------------------------------
        <EditorBrowsable(System.ComponentModel.EditorBrowsableState.Advanced)>
        Public Event SetRecordBuffer(ByRef FieldDate As Date?, ByRef FieldValue As Decimal, ByVal DataType As DataTypes)
