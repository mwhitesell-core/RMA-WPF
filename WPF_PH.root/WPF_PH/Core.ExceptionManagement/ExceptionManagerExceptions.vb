...
''' Class	 : ExceptionManagement.CustomPublisherException
''' 
''' -----------------------------------------------------------------------------
''' <summary>
...
''' -----------------------------------------------------------------------------
    <Serializable()> _
Public Class CustomPublisherException
...
#Region "Constructors"
    ...
    Public Sub New (ByVal message As String, ByVal assemblyName As String, ByVal typeName As String, _
                    ByVal publisherFormat As PublisherFormat)
        MyBase.New (message)
    ...
    ' -inner - Sets a reference to the InnerException. 
    Public Sub New (ByVal message As String, ByVal assemblyName As String, ByVal typeName As String, _
                    ByVal publisherFormat As PublisherFormat, ByVal inner As Exception)
        MyBase.New (message, inner)
        Me.m_assemblyName = assemblyName
        Me.m_typeName = typeName
        Me.m_publisherFormat = publisherFormat
...
#End Region
    ...
    ''' <remarks>info - Represents the SerializationInfo of the exception. <br/>
    ''' context - Represents the context information of the exception.
    ''' </remarks>
    ''' <history>
    ''' 	[patrick]	2005/01/04	Created
