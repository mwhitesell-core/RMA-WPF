#-------------------------------------------------------------------------------
# File 'doc_rev_monthly_roll_23.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'doc_rev_monthly_roll_23'
#-------------------------------------------------------------------------------
...
echo ""
$rcmd = $env:QTP +"u014_f050 23"
Invoke-Expression $rcmd | Tee-Object -FilePath "u014_f050_23.log"

echo "PROGRAM `"U015`" NOW LOADING ..."
echo ""
$rcmd = $env:QTP +"u015 23 23 23 23"
Invoke-Expression $rcmd *> u015_23.log
