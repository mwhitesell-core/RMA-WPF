#-------------------------------------------------------------------------------
# File 'purge_f110_mp.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'purge_f110_mp'
#-------------------------------------------------------------------------------
...
Remove-Item $env:pb_prod\purgef110_mp.log *> $null
...
echo "Purge f110-history -  STARTING - $(Get-Date -uformat '%Y-%m-%d %H:%M:%S')" > $env:pb_prod\purgef110_mp.log

$rcmd = $env:QTP + "purge_unlof110_history $1 $2"
Invoke-Expression $rcmd *>> $env:pb_prod\purgef110_mp.log

#Set-Location $env:pb_data

# Move-Item -Force f110_comp_history.dat \\$Env:root\charly\purge\mp\f110_comp_history.dat
# Move-Item -Force f110_comp_history.idx \\$Env:root\charly\purge\mp\f110_comp_history.idx
...
echo "Purge f110-history - ENDING - $(Get-Date -uformat '%Y-%m-%d %H:%M:%S')" >>$env:pb_prod\purgef110_mp.log
