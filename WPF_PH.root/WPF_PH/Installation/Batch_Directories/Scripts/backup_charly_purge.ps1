...
Get-ChildItem -File $Env:root\charly\purge\* | Select -ExpandProperty FullName `
  > $Env:root\charly\purge\backup_charly_purge.ls
...
Get-ChildItem $Env:root\charly\purge\backup_charly_purge.ls, $Env:root\charly\purge\backup_charly_purge.log
echo ""
Get-Content $Env:root\charly\purge\backup_charly_purge.ls | Measure-Object -Line | Select -ExpandProperty Lines
Get-Content $Env:root\charly\purge\backup_charly_purge.log | Measure-Object -Line | Select -ExpandProperty Lines
