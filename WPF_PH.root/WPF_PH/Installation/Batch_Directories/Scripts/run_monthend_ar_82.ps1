#-------------------------------------------------------------------------------
# File 'run_monthend_ar_82.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'run_monthend_ar_82'
#-------------------------------------------------------------------------------
...
$rcmd = $env:COBOL + "r012 82 Y"
Invoke-Expression $rcmd

#lp r012

$rcmd = $env:COBOL + "r013 82 Y"
Invoke-Expression $rcmd

#lp r013

$rcmd = $env:COBOL + "r051a 82 Y"
Invoke-Expression $rcmd
