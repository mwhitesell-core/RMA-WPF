...
# Original file name was 'purge_f119'
#-------------------------------------------------------------------------------
...
Remove-Item $env:pb_prod\purgef119.log *> $null
...
echo "Purge f119-history -  STARTING - $(Get-Date -uformat '%Y-%m-%d %H:%M:%S')" > $env:pb_prod\purgef119.log

$rcmd = $env:QTP + "purge_unlof119_history $1 $2"
Invoke-Expression $rcmd *>>$env:pb_prod\purgef119.log


#Set-Location $env:pb_data

# Move-Item -Force f119_doc_ytd_history.dat \\$Env:root\charly\purge\101c\f119_doc_ytd_history.dat
# Move-Item -Force f119_doc_ytd_history.idx \\$Env:root\charly\purge\101c\f119_doc_ytd_history.idx
...
echo "Purge f119-history - ENDING - $(Get-Date -uformat '%Y-%m-%d %H:%M:%S')" >>$env:pb_prod\purgef119.log
