    ...
    public partial class F002_CLAIMS_MSTR_DTL
    {
        public ObservableCollection<F002_CLAIMS_MSTR_DTL> Collection_UsingStart(ref bool isRetrieveRecord, ObservableCollection<F002_CLAIMS_MSTR_DTL> f002_claims_mstr_dtl = null)
        {
            ...
            sql.Append("SELECT  ")
               ...
               .Append(" FROM")
               .Append(" [INDEXED].[F002_CLAIMS_MSTR_DTL]")
               .Append(" WHERE")
        ...
        public ObservableCollection<F002_CLAIMS_MSTR_DTL> Collection_DTL_Record()
        {
            StringBuilder sql = null;
            sql = new StringBuilder();
        ...
        public ObservableCollection<F002_CLAIMS_MSTR_DTL> Collection_HDR_DTL_For_Clinic_NBR(ref bool isRetrieveRecord, ObservableCollection<F002_CLAIMS_MSTR_DTL> f002_claims_mstr_dtl = null)
        {
            ...
            sql.Append("SELECT ")
              ...
              .Append("      INNER JOIN  [INDEXED].[F002_CLAIMS_MSTR_DTL] b ON a.KEY_CLM_BATCH_NBR = b.KEY_CLM_BATCH_NBR ")
              .Append("                                                    AND a.KEY_CLM_CLAIM_NBR = b.KEY_CLM_CLAIM_NBR")
               .Append(" WHERE")
               .Append("   1= 1");
        ...
        public ObservableCollection<F002_CLAIMS_MSTR_DTL> Collection_HDR_DTL_INNERJOIN_UsingTop(int rows = 3000, bool greaterThanEquals = true)
        {
            ...
            } else
            {
                ...
                if (!string.IsNullOrWhiteSpace(WhereClmdtl_oma_cd))
                {
                    sql.Append(" AND ")
                      .Append(" b.CLMDTL_OMA_CD = '").Append(WhereClmdtl_oma_cd).Append("'");
                }
                ...
                if (!string.IsNullOrWhiteSpace(WhereClmdtl_oma_suff))
                {
                    sql.Append(" AND ")
                       .Append(" b.CLMDTL_OMA_SUFF = '").Append(WhereClmdtl_oma_suff).Append("'");
                }
