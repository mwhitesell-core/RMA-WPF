...
namespace RmaDAL
{
    ...
    {
        public ObservableCollection<F051_DOC_CASH_MSTR> Collection_UsingStart(ref bool isRetrieveRecord, ObservableCollection<F051_DOC_CASH_MSTR> f051_doc_cash_mstr_Collection = null)
        {
            if (f051_doc_cash_mstr_Collection != null)
            {
                F051_DOC_CASH_MSTR objF051_DOC_CASH_MSTR = f051_doc_cash_mstr_Collection.FirstOrDefault();
                if (objF051_DOC_CASH_MSTR != null)
                {
                    ...
                    if (IsSameSearch())
                    {
                        ...
                        return f051_doc_cash_mstr_Collection;
                    }
                }
            }
            ...
            sql.Append("SELECT")
                ...
                .Append(" ,[FILLER]")
                .Append("  FROM")
                .Append("  [INDEXED].[F051_DOC_CASH_MSTR]")
                .Append("  WHERE")
