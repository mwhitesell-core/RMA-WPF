...
namespace RmaDAL
{
    public partial class F112_PYCDCEILINGS_HISTORY : BaseTable
    {
        #region Retrieve

        public ObservableCollection<F112_PYCDCEILINGS_HISTORY> Collection( Guid? rowid,
															string doc_nbr,
															decimal? ep_nbrmin,
															decimal? ep_nbrmax,
															decimal? factormin,
															...
															long? doc_yrly_ceilingmin,
															long? doc_yrly_ceilingmax,
															long? doc_yrly_ceiling_adjustedmin,
															long? doc_yrly_ceiling_adjustedmax,
															decimal? doc_yrly_ceiling_computedmin,
															decimal? doc_yrly_ceiling_computedmax,
															long? doc_yrly_expensemin,
															long? doc_yrly_expensemax,
															long? doc_yrly_expense_adjustedmin,
															long? doc_yrly_expense_adjustedmax,
															...
															long? doc_yrly_ceil_guarmin,
															long? doc_yrly_ceil_guarmax,
															...
															long? doc_yrly_reqrevmin,
															long? doc_yrly_reqrevmax,
															long? doc_yrly_reqrev_adjustedmin,
															long? doc_yrly_reqrev_adjustedmax,
															long? doc_yrly_reqrev_computedmin,
															long? doc_yrly_reqrev_computedmax,
															long? doc_yrly_tarrevmin,
															long? doc_yrly_tarrevmax,
															long? doc_yrly_tarrev_adjustedmin,
															long? doc_yrly_tarrev_adjustedmax,
                                                            ...
                                                            int skip)
        {
            ...
            if (replaceSearch)
            {
                Reader = CoreReader("[INDEXED].[sp_F112_PYCDCEILINGS_HISTORY_RecordCount]", parameters);
				if (Reader.Read())
					TotalItemCount = (int)Reader[0];
				if (TotalItemCount == 0)
				{
					return new ObservableCollection<F112_PYCDCEILINGS_HISTORY>();
				}

            }

            Reader = CoreReader("[INDEXED].[sp_F112_PYCDCEILINGS_HISTORY_Search]", parameters);
            var collection = new ObservableCollection<F112_PYCDCEILINGS_HISTORY>();

            while (Reader.Read())
            {
                collection.Add(new F112_PYCDCEILINGS_HISTORY
                {
					...
					DOC_YRLY_CEILING = Reader["DOC_YRLY_CEILING"].ToString(),
					DOC_YRLY_CEILING_ADJUSTED = Reader["DOC_YRLY_CEILING_ADJUSTED"].ToString(),
					DOC_YRLY_CEILING_COMPUTED = ConvertDEC(Reader["DOC_YRLY_CEILING_COMPUTED"]),
					DOC_YRLY_EXPENSE = Reader["DOC_YRLY_EXPENSE"].ToString(),
					DOC_YRLY_EXPENSE_ADJUSTED = Reader["DOC_YRLY_EXPENSE_ADJUSTED"].ToString(),
					...
					DOC_YRLY_CEIL_GUAR = Reader["DOC_YRLY_CEIL_GUAR"].ToString(),
					...
					DOC_YRLY_REQREV = Reader["DOC_YRLY_REQREV"].ToString(),
					DOC_YRLY_REQREV_ADJUSTED = Reader["DOC_YRLY_REQREV_ADJUSTED"].ToString(),
					DOC_YRLY_REQREV_COMPUTED = Reader["DOC_YRLY_REQREV_COMPUTED"].ToString(),
					DOC_YRLY_TARREV = Reader["DOC_YRLY_TARREV"].ToString(),
					DOC_YRLY_TARREV_ADJUSTED = Reader["DOC_YRLY_TARREV_ADJUSTED"].ToString(),
					...
					_originalDoc_yrly_ceiling = Reader["DOC_YRLY_CEILING"].ToString(),
					_originalDoc_yrly_ceiling_adjusted = Reader["DOC_YRLY_CEILING_ADJUSTED"].ToString(),
					_originalDoc_yrly_ceiling_computed = ConvertDEC(Reader["DOC_YRLY_CEILING_COMPUTED"]),
					_originalDoc_yrly_expense = Reader["DOC_YRLY_EXPENSE"].ToString(),
					_originalDoc_yrly_expense_adjusted = Reader["DOC_YRLY_EXPENSE_ADJUSTED"].ToString(),
					...
					_originalDoc_yrly_ceil_guar = Reader["DOC_YRLY_CEIL_GUAR"].ToString(),
					...
					_originalDoc_yrly_reqrev = Reader["DOC_YRLY_REQREV"].ToString(),
					_originalDoc_yrly_reqrev_adjusted = Reader["DOC_YRLY_REQREV_ADJUSTED"].ToString(),
					_originalDoc_yrly_reqrev_computed = Reader["DOC_YRLY_REQREV_COMPUTED"].ToString(),
					_originalDoc_yrly_tarrev = Reader["DOC_YRLY_TARREV"].ToString(),
					_originalDoc_yrly_tarrev_adjusted = Reader["DOC_YRLY_TARREV_ADJUSTED"].ToString(),
        ...
        public F112_PYCDCEILINGS_HISTORY Class()
        {
        ...
        public ObservableCollection<F112_PYCDCEILINGS_HISTORY> Collection(ObservableCollection<F112_PYCDCEILINGS_HISTORY>
                                                               f112PycdceilingsHistory = null)
        {
            if (IsSameSearch() && f112PycdceilingsHistory != null)
            {
                return f112PycdceilingsHistory;
            }
			...
			Reader = CoreReader("[INDEXED].[sp_F112_PYCDCEILINGS_HISTORY_Match]", parameters);
            var collection = new ObservableCollection<F112_PYCDCEILINGS_HISTORY>();
...
;
		...
		private string _DOC_YRLY_CEILING;
		private string _DOC_YRLY_CEILING_ADJUSTED;
		private decimal? _DOC_YRLY_CEILING_COMPUTED;
		private string _DOC_YRLY_EXPENSE;
		private string _DOC_YRLY_EXPENSE_ADJUSTED;
		private decimal? _DOC_YRLY_EXPENSE_COMPUTED;
		private decimal? _DOC_YRLY_EXPN_ALLOC_PERS;
		private string _DOC_YRLY_CEIL_GUAR;
		...
		private string _DOC_YRLY_REQREV;
		private string _DOC_YRLY_REQREV_ADJUSTED;
		private string _DOC_YRLY_REQREV_COMPUTED;
		private string _DOC_YRLY_TARREV;
		private string _DOC_YRLY_TARREV_ADJUSTED;
		...
		public string DOC_YRLY_CEILING
		{
		...
		public string DOC_YRLY_CEILING_ADJUSTED
		{
		...
		public string DOC_YRLY_EXPENSE
		{
		...
		public string DOC_YRLY_EXPENSE_ADJUSTED
		{
		...
		public string DOC_YRLY_CEIL_GUAR
		{
		...
		public string DOC_YRLY_REQREV_ADJUSTED
		{
		...
		public string DOC_YRLY_REQREV_COMPUTED
		{
		...
		public string DOC_YRLY_TARREV_ADJUSTED
		{
		...
		public string WhereDoc_yrly_ceiling { get; set; }
		private string _whereDoc_yrly_ceiling;
		public string WhereDoc_yrly_ceiling_adjusted { get; set; }
		private string _whereDoc_yrly_ceiling_adjusted;
		public decimal? WhereDoc_yrly_ceiling_computed { get; set; }
		private decimal? _whereDoc_yrly_ceiling_computed;
		public string WhereDoc_yrly_expense { get; set; }
		private string _whereDoc_yrly_expense;
		public string WhereDoc_yrly_expense_adjusted { get; set; }
		private string _whereDoc_yrly_expense_adjusted;
		...
		public string WhereDoc_yrly_ceil_guar { get; set; }
		private string _whereDoc_yrly_ceil_guar;
		...
		public string WhereDoc_yrly_reqrev { get; set; }
		private string _whereDoc_yrly_reqrev;
		public string WhereDoc_yrly_reqrev_adjusted { get; set; }
		private string _whereDoc_yrly_reqrev_adjusted;
		public string WhereDoc_yrly_reqrev_computed { get; set; }
		private string _whereDoc_yrly_reqrev_computed;
		public string WhereDoc_yrly_tarrev { get; set; }
		private string _whereDoc_yrly_tarrev;
		public string WhereDoc_yrly_tarrev_adjusted { get; set; }
		private string _whereDoc_yrly_tarrev_adjusted;
		...
		private string _originalDoc_yrly_ceiling;
		private string _originalDoc_yrly_ceiling_adjusted;
		private decimal? _originalDoc_yrly_ceiling_computed;
		private string _originalDoc_yrly_expense;
		private string _originalDoc_yrly_expense_adjusted;
		private decimal? _originalDoc_yrly_expense_computed;
		private decimal? _originalDoc_yrly_expn_alloc_pers;
		private string _originalDoc_yrly_ceil_guar;
		...
		private string _originalDoc_yrly_reqrev;
		private string _originalDoc_yrly_reqrev_adjusted;
		private string _originalDoc_yrly_reqrev_computed;
		private string _originalDoc_yrly_tarrev;
		private string _originalDoc_yrly_tarrev_adjusted;
        ...
        public bool Delete()
        {
			...
			RowsAffected = CoreExecuteNonQuery("[INDEXED].[sp_F112_PYCDCEILINGS_HISTORY_DeleteRow]", parameters);
		...
		{
		    int RowsAffected = 0;
		    RowsAffected = CoreExecuteNonQuery("[INDEXED].[sp_F112_PYCDCEILINGS_HISTORY_Purge]");
		    CloseConnection();
		    return true;
		}
        ...
        public void Submit()
        {
            ...
            switch (RecordState)
            {
                ...
                case State.Added:
					...
					Reader = CoreReader("[INDEXED].[sp_F112_PYCDCEILINGS_HISTORY_Insert]", parameters);
					if (Reader.Read())
					{
						RowCheckSum = Convert.ToInt32(Reader["RowCheckSum"]);
						ROWID = (Guid) Reader["ROWID"];
                ...
                case State.Modified:
					...
					Reader = CoreReader("[INDEXED].[sp_F112_PYCDCEILINGS_HISTORY_Update]", parameters);
					if (Reader.Read())
					{
						RowCheckSum = Convert.ToInt32(Reader["RowCheckSum"]);
						ROWID = (Guid) Reader["ROWID"];
