...
namespace RmaDAL
{
    public partial class TMP_COUNTERS_ALPHA : BaseTable
    {
        #region Retrieve

        public ObservableCollection<TMP_COUNTERS_ALPHA> Collection( Guid? rowid,
															string tmp_counter_key_alpha,
                                                            ...
                                                            int skip)
        {
            	var parameters = new SqlParameter[]
				{
					...
					new SqlParameter("TMP_COUNTER_KEY_ALPHA",tmp_counter_key_alpha),
            ...
            if (replaceSearch)
            {
                Reader = CoreReader("[INDEXED].[sp_TMP_COUNTERS_ALPHA_RecordCount]", parameters);
				if (Reader.Read())
					TotalItemCount = (int)Reader[0];
				if (TotalItemCount == 0)
				{
					return new ObservableCollection<TMP_COUNTERS_ALPHA>();
				}

            }

            Reader = CoreReader("[INDEXED].[sp_TMP_COUNTERS_ALPHA_Search]", parameters);
            var collection = new ObservableCollection<TMP_COUNTERS_ALPHA>();

            while (Reader.Read())
            {
                collection.Add(new TMP_COUNTERS_ALPHA
                {
					RowCheckSum = Convert.ToInt32(Reader["RowCheckSum"]),
					ROWID = (Guid)Reader["ROWID"],
					TMP_COUNTER_KEY_ALPHA = Reader["TMP_COUNTER_KEY_ALPHA"].ToString(),
					...
					_originalTmp_counter_key_alpha = Reader["TMP_COUNTER_KEY_ALPHA"].ToString(),
        ...
        public TMP_COUNTERS_ALPHA Class()
        {
        ...
        public ObservableCollection<TMP_COUNTERS_ALPHA> Collection(ObservableCollection<TMP_COUNTERS_ALPHA>
                                                               tmpCountersAlpha = null)
        {
            if (IsSameSearch() && tmpCountersAlpha != null)
            {
                return tmpCountersAlpha;
            }
            ...
            if (IsBlankSearch())
            {
            	...
            	var parameters = new SqlParameter[]
				{
					...
					new SqlParameter("TMP_COUNTER_KEY_ALPHA",WhereTmp_counter_key_alpha),
			...
			Reader = CoreReader("[INDEXED].[sp_TMP_COUNTERS_ALPHA_Match]", parameters);
            var collection = new ObservableCollection<TMP_COUNTERS_ALPHA>();
            ...
            while (Reader.Read())
            {
                collection.Add(new TMP_COUNTERS_ALPHA
                {
					...
					_whereTmp_counter_key_alpha = WhereTmp_counter_key_alpha,
        ...
        {
            if (WhereRowid == null 
				&& WhereTmp_counter_key_alpha == null 
        ...
        private bool IsSameSearch()
        {
           return WhereRowid ==  _whereRowid
				&& WhereTmp_counter_key_alpha ==  _whereTmp_counter_key_alpha
...
;
		...
		private Guid _ROWID;
		private string _TMP_COUNTER_KEY_ALPHA;
		...
		public string TMP_COUNTER_KEY_ALPHA
		{
			get { return _TMP_COUNTER_KEY_ALPHA; }
			set
			{
				if (_TMP_COUNTER_KEY_ALPHA != value)
				{
					_TMP_COUNTER_KEY_ALPHA = value;
					ChangeState();
				}
			}
		}
		...
		public string WhereTmp_counter_key_alpha { get; set; }
		private string _whereTmp_counter_key_alpha;
		...
		private string _originalTmp_counter_key_alpha;
        ...
        public bool Undo()
        {
			...
			TMP_COUNTER_KEY_ALPHA = _originalTmp_counter_key_alpha;
        ...
        public bool Delete()
        {
			...
			RowsAffected = CoreExecuteNonQuery("[INDEXED].[sp_TMP_COUNTERS_ALPHA_DeleteRow]", parameters);
		...
		{
		    int RowsAffected = 0;
		    RowsAffected = CoreExecuteNonQuery("[INDEXED].[sp_TMP_COUNTERS_ALPHA_Purge]");
		    CloseConnection();
		    return true;
		}
        ...
        public void Submit()
        {
            ...
            switch (RecordState)
            {
                ...
                case State.Added:
					...
					{
						new SqlParameter("TMP_COUNTER_KEY_ALPHA", SqlNull(TMP_COUNTER_KEY_ALPHA)),
					...
					Reader = CoreReader("[INDEXED].[sp_TMP_COUNTERS_ALPHA_Insert]", parameters);
					if (Reader.Read())
					{
						RowCheckSum = Convert.ToInt32(Reader["RowCheckSum"]);
						ROWID = (Guid) Reader["ROWID"];
                ...
                case State.Modified:
					...
					Reader = CoreReader("[INDEXED].[sp_TMP_COUNTERS_ALPHA_Update]", parameters);
					if (Reader.Read())
					{
						RowCheckSum = Convert.ToInt32(Reader["RowCheckSum"]);
						ROWID = (Guid) Reader["ROWID"];
