...
namespace rma.Views
{
    ...
    partial class Billing_D020B : BasePage
    {
        ...
        private void X_SCREEN_NAME_GetValue(ref string Value)
        {
            ...
            try
            {
                Value = "EARNINGS - CEILING ADJUSTMENTS";
        ...
        //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
        //# Do not delete, modify or move it.  Updated: 5/29/2017 9:56:22 AM
        ...
        //# Precompiler Ver.: 1.0.6353.18277  Generated on: 5/29/2017 9:56:22 AM
        //#-----------------------------------------
        protected override void DisplayFormatting()
        {
            try
            {
                ...
                //# Precompiler Ver.: 1.0.6353.18277 Generated on: 5/29/2017 9:56:22 AM
                Display(ref fldF020_DOCTOR_MSTR_DOC_ADJCEA);
                Display(ref fldF020_DOCTOR_MSTR_DOC_ADJCEX);
        ...
        public override void BindFields()
        {
            try
            {
                fldF020_DOCTOR_MSTR_DOC_ADJCEA.Bind(fleF020_DOCTOR_MSTR);
                fldF020_DOCTOR_MSTR_DOC_ADJCEX.Bind(fleF020_DOCTOR_MSTR);
        ...
        protected override bool Entry()
        {
            try
            {
                //#BEGIN STANDARD PROCEDURE CONTENT
                //# Precompiler Ver.: 1.0.6353.18277 Generated on: 5/29/2017 9:56:22 AM
                Accept(ref fldF020_DOCTOR_MSTR_DOC_ADJCEA);
                Accept(ref fldF020_DOCTOR_MSTR_DOC_ADJCEX);
                //#END STANDARD PROCEDURE CONTENT
                return true;
