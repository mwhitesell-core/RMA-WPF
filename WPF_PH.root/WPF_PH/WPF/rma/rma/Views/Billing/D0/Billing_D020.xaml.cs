...
namespace rma.Views
{
    ...
    partial class Billing_D020 : BasePage
    {
        ...
        {         
            ...
            SetVariables();
            dsrDesigner_OVER.Click += dsrDesigner_OVER_Click;
            ...
            dsrDesigner_96.Click += dsrDesigner_96_Click;
            dsrDesigner_HI96.Click += dsrDesigner_HI96_Click;
            dsrDesigner_HI97.Click += dsrDesigner_HI97_Click;
            dsrDesigner_97.Click += dsrDesigner_97_Click;
            ...
            fldDOC_OVERAGE_AMT.Edit += fldDOC_OVERAGE_AMT_Edit;
            ...
            //       F112_ADD_NEW_REC_1.DOC_YRLY_CEILING_COMPUTED InputScale: 2 OutputScale: 0
            //       F112_ADD_NEW_REC_1.DOC_YRLY_EXPENSE_COMPUTED InputScale: 2 OutputScale: 0
            //       F112_ADD_NEW_REC_1.FACTOR InputScale: 4 OutputScale: 0
            //       F112_ADD_NEW_REC_2.DOC_YRLY_CEILING_COMPUTED InputScale: 2 OutputScale: 0
            //       F112_ADD_NEW_REC_2.DOC_YRLY_EXPENSE_COMPUTED InputScale: 2 OutputScale: 0
            //       F112_ADD_NEW_REC_2.FACTOR InputScale: 4 OutputScale: 0
        ...
        protected override void SetVariables()
        {
            ...
            T_DOC_DATE_FAC_START = new CoreDate("T_DOC_DATE_FAC_START", this);
            T_DOC_DATE_FAC_TERM = new CoreDate("T_DOC_DATE_FAC_TERM", this);

            //Put user code to initialize the page here
            fleF020_DOCTOR_MSTR = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "F020_DOCTOR_MSTR", "", false, false, false, 0, "m_trnTRANS_UPDATE");
            fleF020_DESIGNER = new SqlFileObject(this, FileTypes.Designer, 0, "INDEXED", "F020_DOCTOR_MSTR", "F020_DESIGNER", false, false, false, 0, "m_trnTRANS_UPDATE");
            DOC_NBR_1 = new CoreCharacter("DOC_NBR_1", 3, this, Common.cEmptyString);
            DOC_FLAG_1 = new CoreCharacter("DOC_FLAG_1", 1, this, Common.cEmptyString);
            DOC_NBR_2 = new CoreCharacter("DOC_NBR_2", 3, this, Common.cEmptyString);
            DOC_FLAG_2 = new CoreCharacter("DOC_FLAG_2", 1, this, Common.cEmptyString);
            DOC_NBR_3 = new CoreCharacter("DOC_NBR_3", 3, this, Common.cEmptyString);
            DOC_FLAG_3 = new CoreCharacter("DOC_FLAG_3", 1, this, Common.cEmptyString);
            DOC_NBR_4 = new CoreCharacter("DOC_NBR_4", 3, this, Common.cEmptyString);
            DOC_FLAG_4 = new CoreCharacter("DOC_FLAG_4", 1, this, Common.cEmptyString);
            DOC_NBR_5 = new CoreCharacter("DOC_NBR_5", 3, this, Common.cEmptyString);
            DOC_FLAG_5 = new CoreCharacter("DOC_FLAG_5", 1, this, Common.cEmptyString);
            DOC_NBR_6 = new CoreCharacter("DOC_NBR_6", 3, this, Common.cEmptyString);
            DOC_FLAG_6 = new CoreCharacter("DOC_FLAG_6", 1, this, Common.cEmptyString);
            DOC_NBR_7 = new CoreCharacter("DOC_NBR_7", 3, this, Common.cEmptyString);
            DOC_FLAG_7 = new CoreCharacter("DOC_FLAG_7", 1, this, Common.cEmptyString);
            DOC_NBR_8 = new CoreCharacter("DOC_NBR_8", 3, this, Common.cEmptyString);
            DOC_FLAG_8 = new CoreCharacter("DOC_FLAG_8", 1, this, Common.cEmptyString);
            DOC_NBR_9 = new CoreCharacter("DOC_NBR_9", 3, this, Common.cEmptyString);
            DOC_FLAG_9 = new CoreCharacter("DOC_FLAG_9", 1, this, Common.cEmptyString);
            DOC_NBR_10 = new CoreCharacter("DOC_NBR_10", 3, this, Common.cEmptyString);
            BOLCURRENTCEILINGRECORDEXISTS = new CoreCharacter("BOLCURRENTCEILINGRECORDEXISTS", 1, this, Common.cEmptyString);
            DOC_OVERAGE_AMT = new CoreInteger("DOC_OVERAGE_AMT", 10, this);
            DOC_CURRENT_CEILING = new CoreInteger("DOC_CURRENT_CEILING", 10, this);
            W_NEW_CEIL_EARN = new CoreInteger("W_NEW_CEIL_EARN", 10, this);
            W_MONTHLY_CEIL_EARN = new CoreInteger("W_MONTHLY_CEIL_EARN", 10, this);
            W_DOC_PAY_CODE = new CoreCharacter("W_DOC_PAY_CODE", 1, this, Common.cEmptyString);
            W_DOC_PAY_SUB_CODE = new CoreCharacter("W_DOC_PAY_SUB_CODE", 1, this, Common.cEmptyString);
            W_FACTOR = new CoreDecimal("W_FACTOR", 6, this);
            W_RETRO_TO_EP_NBR = new CoreDecimal("W_RETRO_TO_EP_NBR", 6, this);
            W_DOC_YRLY_CEILING = new CoreInteger("W_DOC_YRLY_CEILING", 10, this);
            W_DOC_YRLY_CEILING_ADJUSTED = new CoreInteger("W_DOC_YRLY_CEILING_ADJUSTED", 10, this);
            W_DOC_YRLY_CEILING_COMPUTED = new CoreInteger("W_DOC_YRLY_CEILING_COMPUTED", 10, this);
            W_DOC_YRLY_EXPENSE = new CoreInteger("W_DOC_YRLY_EXPENSE", 10, this);
            W_DOC_YRLY_EXPENSE_ADJUSTED = new CoreInteger("W_DOC_YRLY_EXPENSE_ADJUSTED", 10, this);
            W_DOC_YRLY_EXPENSE_COMPUTED = new CoreInteger("W_DOC_YRLY_EXPENSE_COMPUTED", 10, this);
            W_DOC_YRLY_EXPN_ALLOC_PERS = new CoreDecimal("W_DOC_YRLY_EXPN_ALLOC_PERS", 2, this);
            W_DOC_YRLY_CEIL_GUAR = new CoreInteger("W_DOC_YRLY_CEIL_GUAR", 10, this);
            W_DOC_YRLY_CEILING_GUAR_PERC = new CoreDecimal("W_DOC_YRLY_CEILING_GUAR_PERC", 3, this);
            W_DOC_RMA_EXPENSE_PERCENT_REG = new CoreInteger("W_DOC_RMA_EXPENSE_PERCENT_REG", 10, this);
            W_DOC_RMA_EXPENSE_PERCENT_MISC = new CoreInteger("W_DOC_RMA_EXPENSE_PERCENT_MISC", 10, this);
            W_DOC_DEPT_EXPENSE_PERCENT_REG = new CoreInteger("W_DOC_DEPT_EXPENSE_PERCENT_REG", 10, this);
            W_DOC_DEPT_EXPENSE_PERCENT_MISC = new CoreInteger("W_DOC_DEPT_EXPENSE_PERCENT_MISC", 10, this);
            W_DOC_YRLY_REQREV = new CoreInteger("W_DOC_YRLY_REQREV", 10, this);
            W_DOC_YRLY_REQREV_ADJUSTED = new CoreInteger("W_DOC_YRLY_REQREV_ADJUSTED", 10, this);
            W_DOC_YRLY_REQREV_COMPUTED = new CoreInteger("W_DOC_YRLY_REQREV_COMPUTED", 10, this);
            W_DOC_YRLY_TARREV = new CoreInteger("W_DOC_YRLY_TARREV", 10, this);
            W_DOC_YRLY_TARREV_ADJUSTED = new CoreInteger("W_DOC_YRLY_TARREV_ADJUSTED", 10, this);
            W_DOC_YRLY_TARREV_COMPUTED = new CoreInteger("W_DOC_YRLY_TARREV_COMPUTED", 10, this);
            W_RETRO_TO_EP_NBR_REQ = new CoreDecimal("W_RETRO_TO_EP_NBR_REQ", 6, this);
            W_RETRO_TO_EP_NBR_TAR = new CoreDecimal("W_RETRO_TO_EP_NBR_TAR", 6, this);
            ...
            fleF112_ADD_NEW_REC_1 = new SqlFileObject(this, FileTypes.Designer, 0, "INDEXED", "F112_PYCDCEILINGS", "F112_ADD_NEW_REC_1", false, false, false, 0, "m_trnTRANS_UPDATE");
            fleF112_ADD_NEW_REC_2 = new SqlFileObject(this, FileTypes.Designer, 0, "INDEXED", "F112_PYCDCEILINGS", "F112_ADD_NEW_REC_2", false, false, false, 0, "m_trnTRANS_UPDATE");
            ...
            W_CURR_CEIL_EARN = new CoreDecimal("W_CURR_CEIL_EARN", 9, this);
            W_CURR_CEIL_EXPN = new CoreDecimal("W_CURR_CEIL_EXPN", 9, this);
            ...
            fleF020_DESIGNER.Access += fleF020_DESIGNER_Access;
            ...
            W_CURRENT_EP_NBR_PLUS_1.GetValue += W_CURRENT_EP_NBR_PLUS_1_GetValue;
        ...
        private void FleF020_DOCTOR_MSTR_SetItemFinals()
        {
            try
            {
                ...
                fleF020_DOCTOR_MSTR.set_SetValue("DOC_DATE_FAC_START_YY", T_DOC_DATE_FAC_START.Value.ToString().PadLeft(8, '0').Substring(0,4));
                fleF020_DOCTOR_MSTR.set_SetValue("DOC_DATE_FAC_START_MM", T_DOC_DATE_FAC_START.Value.ToString().PadLeft(8, '0').Substring(4, 2));
                fleF020_DOCTOR_MSTR.set_SetValue("DOC_DATE_FAC_START_DD", T_DOC_DATE_FAC_START.Value.ToString().PadLeft(8, '0').Substring(6, 2));

                fleF020_DOCTOR_MSTR.set_SetValue("DOC_DATE_FAC_TERM_YY", T_DOC_DATE_FAC_TERM.Value.ToString().PadLeft(8, '0').Substring(0, 4));
                fleF020_DOCTOR_MSTR.set_SetValue("DOC_DATE_FAC_TERM_MM", T_DOC_DATE_FAC_TERM.Value.ToString().PadLeft(8, '0').Substring(4, 2));
                fleF020_DOCTOR_MSTR.set_SetValue("DOC_DATE_FAC_TERM_DD", T_DOC_DATE_FAC_TERM.Value.ToString().PadLeft(8, '0').Substring(6, 2));
        ...
        private SqlFileObject fleF020_DESIGNER;

        private void fleF020_DESIGNER_Access(ref string AccessClause)
        {
            ...
            try
            {
                ...
                strText.Append(" WHERE ").Append(fleF020_DESIGNER.ElementOwner("DOC_NBR")).Append(" = ").Append(Common.StringToField(fleF020_DOCTOR_MSTR.GetStringValue("DOC_OHIP_NBR")));

                strText.Append(" ORDER BY ").Append(fleF020_DESIGNER.ElementOwner("DOC_OHIP_NBR"));
        ...
        private CoreDate T_DOC_DATE_FAC_START;
        private CoreDate T_DOC_DATE_FAC_TERM;

        private CoreCharacter DOC_NBR_1;
        private CoreCharacter DOC_FLAG_1;
        private CoreCharacter DOC_NBR_2;
        private CoreCharacter DOC_FLAG_2;
        private CoreCharacter DOC_NBR_3;
        private CoreCharacter DOC_FLAG_3;
        private CoreCharacter DOC_NBR_4;
        private CoreCharacter DOC_FLAG_4;
        private CoreCharacter DOC_NBR_5;
        private CoreCharacter DOC_FLAG_5;
        private CoreCharacter DOC_NBR_6;
        private CoreCharacter DOC_FLAG_6;
        private CoreCharacter DOC_NBR_7;
        private CoreCharacter DOC_FLAG_7;
        private CoreCharacter DOC_NBR_8;
        private CoreCharacter DOC_FLAG_8;
        private CoreCharacter DOC_NBR_9;
        private CoreCharacter DOC_FLAG_9;
        private CoreCharacter DOC_NBR_10;
        private CoreCharacter BOLCURRENTCEILINGRECORDEXISTS;
        private CoreInteger DOC_OVERAGE_AMT;
        private CoreInteger DOC_CURRENT_CEILING;
        private CoreInteger W_NEW_CEIL_EARN;
        private CoreInteger W_MONTHLY_CEIL_EARN;
        private CoreCharacter W_DOC_PAY_CODE;
        private CoreCharacter W_DOC_PAY_SUB_CODE;
        private CoreDecimal W_FACTOR;
        private CoreDecimal W_RETRO_TO_EP_NBR;
        private CoreInteger W_DOC_YRLY_CEILING;
        private CoreInteger W_DOC_YRLY_CEILING_ADJUSTED;
        private CoreInteger W_DOC_YRLY_CEILING_COMPUTED;
        private CoreInteger W_DOC_YRLY_EXPENSE;
        private CoreInteger W_DOC_YRLY_EXPENSE_ADJUSTED;
        private CoreInteger W_DOC_YRLY_EXPENSE_COMPUTED;
        private CoreDecimal W_DOC_YRLY_EXPN_ALLOC_PERS;
        private CoreInteger W_DOC_YRLY_CEIL_GUAR;
        private CoreDecimal W_DOC_YRLY_CEILING_GUAR_PERC;
        private CoreInteger W_DOC_RMA_EXPENSE_PERCENT_REG;
        private CoreInteger W_DOC_RMA_EXPENSE_PERCENT_MISC;
        private CoreInteger W_DOC_DEPT_EXPENSE_PERCENT_REG;
        private CoreInteger W_DOC_DEPT_EXPENSE_PERCENT_MISC;
        private CoreInteger W_DOC_YRLY_REQREV;
        private CoreInteger W_DOC_YRLY_REQREV_ADJUSTED;
        private CoreInteger W_DOC_YRLY_REQREV_COMPUTED;
        private CoreInteger W_DOC_YRLY_TARREV;
        private CoreInteger W_DOC_YRLY_TARREV_ADJUSTED;
        private CoreInteger W_DOC_YRLY_TARREV_COMPUTED;
        private CoreDecimal W_RETRO_TO_EP_NBR_REQ;
        private CoreDecimal W_RETRO_TO_EP_NBR_TAR;
        private SqlFileObject fleF020_DOCTOR_EXTRA;
        //#-----------------------------------------
        //# fleF020_DOCTOR_EXTRA_Access Procedure
        //# Precompiler Ver.: 1.0.6353.18277  Generated on: 5/29/2017 9:56:24 AM
        //#-----------------------------------------
        ...
        private SqlFileObject fleF112_ADD_NEW_REC_1;
        private SqlFileObject fleF112_ADD_NEW_REC_2;
        private SqlFileObject fleCONSTANTS_MSTR_REC_6;
        //#CORE_BEGIN_INCLUDE: SAVEF020AUDIT_VAR"

        //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
        //# Do not delete, modify or move it.  Updated: 5/29/2017 9:56:24 AM
        ...
        private DDecimal W_CURRENT_EP_NBR_PLUS_1 = new DDecimal(6);
        private void W_CURRENT_EP_NBR_PLUS_1_GetValue(ref decimal Value)
        {
            ...
            try
            {
                ...
                if (13 != QDesign.NULL((QDesign.PHMod(fleCONSTANTS_MSTR_REC_6.GetDecimalValue("CURRENT_EP_NBR"), 100))))
                {
                    CurrentValue = fleCONSTANTS_MSTR_REC_6.GetDecimalValue("CURRENT_EP_NBR") + 1;
                }
                else
                {
                    CurrentValue = QDesign.NConvert(QDesign.ASCII((fleCONSTANTS_MSTR_REC_6.GetDecimalValue("CURRENT_EP_NBR") / 100) + 1) + "01");
                }
        ...
        //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
        //# Do not delete, modify or move it.  Updated: 5/29/2017 9:56:25 AM
        ...
        private void Initialize_TRANS_UPDATE()
        {
            ...
            fleF020_DESIGNER.Transaction = m_trnTRANS_UPDATE;
            ...
            fleF112_ADD_NEW_REC_1.Transaction = m_trnTRANS_UPDATE;
            fleF112_ADD_NEW_REC_2.Transaction = m_trnTRANS_UPDATE;
        ...
        protected override void CloseFiles()
        {
            ...
            try
            {
                ...
                fleF112_ADD_NEW_REC_1.Dispose();
                fleF112_ADD_NEW_REC_2.Dispose();
        ...
        protected override void DisplayFormatting()
        {
            try
            {
                ...
                //# Precompiler Ver.: 1.0.6353.18277 Generated on: 5/29/2017 9:56:24 AM
                Display(ref fldDOC_NBR_1);
                Display(ref fldDOC_FLAG_1);
                Display(ref fldDOC_NBR_2);
                Display(ref fldDOC_FLAG_2);
                Display(ref fldDOC_NBR_3);
                Display(ref fldDOC_FLAG_3);
                Display(ref fldDOC_NBR_4);
                Display(ref fldDOC_FLAG_4);
                Display(ref fldDOC_NBR_5);
                Display(ref fldDOC_FLAG_5);
                Display(ref fldDOC_NBR_6);
                Display(ref fldDOC_FLAG_6);
                Display(ref fldDOC_NBR_7);
                Display(ref fldDOC_FLAG_7);
                Display(ref fldDOC_NBR_8);
                Display(ref fldDOC_FLAG_8);
                Display(ref fldDOC_NBR_9);
                Display(ref fldDOC_FLAG_9);
                Display(ref fldDOC_NBR_10);
                Display(ref fldDOC_OVERAGE_AMT);
                ...
                Display(ref fldF020_DOCTOR_EXTRA_FACTOR_GST_INCOME_REG);
                ...
                Display(ref fldF020_DOCTOR_EXTRA_FACTOR_GST_INCOME_MISC);
        ...
        public override void BindFields()
        {
            try
            {
                fldDOC_NBR_1.Bind(DOC_NBR_1);
                fldDOC_FLAG_1.Bind(DOC_FLAG_1);
                fldDOC_NBR_2.Bind(DOC_NBR_2);
                fldDOC_FLAG_2.Bind(DOC_FLAG_2);
                fldDOC_NBR_3.Bind(DOC_NBR_3);
                fldDOC_FLAG_3.Bind(DOC_FLAG_3);
                fldDOC_NBR_4.Bind(DOC_NBR_4);
                fldDOC_FLAG_4.Bind(DOC_FLAG_4);
                fldDOC_NBR_5.Bind(DOC_NBR_5);
                fldDOC_FLAG_5.Bind(DOC_FLAG_5);
                fldDOC_NBR_6.Bind(DOC_NBR_6);
                fldDOC_FLAG_6.Bind(DOC_FLAG_6);
                fldDOC_NBR_7.Bind(DOC_NBR_7);
                fldDOC_FLAG_7.Bind(DOC_FLAG_7);
                fldDOC_NBR_8.Bind(DOC_NBR_8);
                fldDOC_FLAG_8.Bind(DOC_FLAG_8);
                fldDOC_NBR_9.Bind(DOC_NBR_9);
                fldDOC_FLAG_9.Bind(DOC_FLAG_9);
                fldDOC_NBR_10.Bind(DOC_NBR_10);
                fldDOC_OVERAGE_AMT.Bind(DOC_OVERAGE_AMT);
                ...
                fldF020_DOCTOR_EXTRA_FACTOR_GST_INCOME_REG.Bind(fleF020_DOCTOR_EXTRA);
                ...
                fldF020_DOCTOR_EXTRA_FACTOR_GST_INCOME_MISC.Bind(fleF020_DOCTOR_EXTRA);
        ...
        private bool Internal_COPYF112TOF112ADD_1()
        {
            ...
            try
            {
                ...
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_NBR", fleF112_PYCDCEILINGS.GetStringValue("DOC_NBR"));
                fleF112_ADD_NEW_REC_1.set_SetValue("EP_NBR", fleF112_PYCDCEILINGS.GetDecimalValue("EP_NBR"));
                fleF112_ADD_NEW_REC_1.set_SetValue("FACTOR", fleF112_PYCDCEILINGS.GetDecimalValue("FACTOR"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_PAY_CODE", fleF112_PYCDCEILINGS.GetStringValue("DOC_PAY_CODE"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_PAY_SUB_CODE", fleF112_PYCDCEILINGS.GetStringValue("DOC_PAY_SUB_CODE"));
                fleF112_ADD_NEW_REC_1.set_SetValue("RETRO_TO_EP_NBR", fleF112_PYCDCEILINGS.GetDecimalValue("RETRO_TO_EP_NBR"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_YRLY_CEILING", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_CEILING"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_YRLY_CEILING_ADJUSTED", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_CEILING_ADJUSTED"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_YRLY_CEILING_COMPUTED", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_CEILING_COMPUTED"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_YRLY_EXPENSE", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_EXPENSE"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_YRLY_EXPENSE_ADJUSTED", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_EXPENSE_ADJUSTED"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_YRLY_EXPENSE_COMPUTED", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_EXPENSE_COMPUTED"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_YRLY_EXPN_ALLOC_PERS", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_EXPN_ALLOC_PERS"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_YRLY_CEIL_GUAR", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_CEIL_GUAR"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_YRLY_CEILING_GUAR_PERC", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_CEILING_GUAR_PERC"));
                fleF112_ADD_NEW_REC_1.set_SetValue("LAST_MOD_DATE", fleF112_PYCDCEILINGS.GetNumericDateValue("LAST_MOD_DATE"));
                fleF112_ADD_NEW_REC_1.set_SetValue("LAST_MOD_TIME", fleF112_PYCDCEILINGS.GetDecimalValue("LAST_MOD_TIME"));
                fleF112_ADD_NEW_REC_1.set_SetValue("LAST_MOD_USER_ID", fleF112_PYCDCEILINGS.GetStringValue("LAST_MOD_USER_ID"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_RMA_EXPENSE_PERCENT_REG", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_RMA_EXPENSE_PERCENT_REG"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_RMA_EXPENSE_PERCENT_MISC", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_RMA_EXPENSE_PERCENT_MISC"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_DEPT_EXPENSE_PERCENT_REG", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_DEPT_EXPENSE_PERCENT_REG"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_DEPT_EXPENSE_PERCENT_MISC", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_DEPT_EXPENSE_PERCENT_MISC"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_YRLY_REQREV", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_REQREV"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_YRLY_REQREV_ADJUSTED", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_REQREV_ADJUSTED"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_YRLY_REQREV_COMPUTED", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_REQREV_COMPUTED"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_YRLY_TARREV", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_TARREV"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_YRLY_TARREV_ADJUSTED", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_TARREV_ADJUSTED"));
                fleF112_ADD_NEW_REC_1.set_SetValue("DOC_YRLY_TARREV_COMPUTED", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_TARREV_COMPUTED"));
                fleF112_ADD_NEW_REC_1.set_SetValue("RETRO_TO_EP_NBR_REQ", fleF112_PYCDCEILINGS.GetDecimalValue("RETRO_TO_EP_NBR_REQ"));
                fleF112_ADD_NEW_REC_1.set_SetValue("RETRO_TO_EP_NBR_TAR", fleF112_PYCDCEILINGS.GetDecimalValue("RETRO_TO_EP_NBR_TAR"));
        ...
        private bool Internal_COPYF112TOF112ADD_2()
        {
            ...
            try
            {
                ...
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_NBR", fleF112_PYCDCEILINGS.GetStringValue("DOC_NBR"));
                fleF112_ADD_NEW_REC_2.set_SetValue("EP_NBR", fleF112_PYCDCEILINGS.GetDecimalValue("EP_NBR"));
                fleF112_ADD_NEW_REC_2.set_SetValue("FACTOR", fleF112_PYCDCEILINGS.GetDecimalValue("FACTOR"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_PAY_CODE", fleF112_PYCDCEILINGS.GetStringValue("DOC_PAY_CODE"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_PAY_SUB_CODE", fleF112_PYCDCEILINGS.GetStringValue("DOC_PAY_SUB_CODE"));
                fleF112_ADD_NEW_REC_2.set_SetValue("RETRO_TO_EP_NBR", fleF112_PYCDCEILINGS.GetDecimalValue("RETRO_TO_EP_NBR"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_YRLY_CEILING", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_CEILING"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_YRLY_CEILING_ADJUSTED", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_CEILING_ADJUSTED"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_YRLY_CEILING_COMPUTED", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_CEILING_COMPUTED"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_YRLY_EXPENSE", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_EXPENSE"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_YRLY_EXPENSE_ADJUSTED", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_EXPENSE_ADJUSTED"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_YRLY_EXPENSE_COMPUTED", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_EXPENSE_COMPUTED"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_YRLY_EXPN_ALLOC_PERS", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_EXPN_ALLOC_PERS"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_YRLY_CEIL_GUAR", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_CEIL_GUAR"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_YRLY_CEILING_GUAR_PERC", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_CEILING_GUAR_PERC"));
                fleF112_ADD_NEW_REC_2.set_SetValue("LAST_MOD_DATE", fleF112_PYCDCEILINGS.GetNumericDateValue("LAST_MOD_DATE"));
                fleF112_ADD_NEW_REC_2.set_SetValue("LAST_MOD_TIME", fleF112_PYCDCEILINGS.GetDecimalValue("LAST_MOD_TIME"));
                fleF112_ADD_NEW_REC_2.set_SetValue("LAST_MOD_USER_ID", fleF112_PYCDCEILINGS.GetStringValue("LAST_MOD_USER_ID"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_RMA_EXPENSE_PERCENT_REG", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_RMA_EXPENSE_PERCENT_REG"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_RMA_EXPENSE_PERCENT_MISC", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_RMA_EXPENSE_PERCENT_MISC"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_DEPT_EXPENSE_PERCENT_REG", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_DEPT_EXPENSE_PERCENT_REG"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_DEPT_EXPENSE_PERCENT_MISC", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_DEPT_EXPENSE_PERCENT_MISC"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_YRLY_REQREV", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_REQREV"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_YRLY_REQREV_ADJUSTED", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_REQREV_ADJUSTED"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_YRLY_REQREV_COMPUTED", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_REQREV_COMPUTED"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_YRLY_TARREV", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_TARREV"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_YRLY_TARREV_ADJUSTED", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_TARREV_ADJUSTED"));
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_YRLY_TARREV_COMPUTED", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_TARREV_COMPUTED"));
                fleF112_ADD_NEW_REC_2.set_SetValue("RETRO_TO_EP_NBR_REQ", fleF112_PYCDCEILINGS.GetDecimalValue("RETRO_TO_EP_NBR_REQ"));
                fleF112_ADD_NEW_REC_2.set_SetValue("RETRO_TO_EP_NBR_TAR", fleF112_PYCDCEILINGS.GetDecimalValue("RETRO_TO_EP_NBR_TAR"));
        ...
        private bool Internal_F112RECSAVE()
        {
            ...
            try
            {
                ...
                W_FACTOR.Value = fleF112_PYCDCEILINGS.GetDecimalValue("FACTOR");
                W_DOC_PAY_CODE.Value = fleF112_PYCDCEILINGS.GetStringValue("DOC_PAY_CODE");
                W_DOC_PAY_SUB_CODE.Value = fleF112_PYCDCEILINGS.GetStringValue("DOC_PAY_SUB_CODE");
                W_RETRO_TO_EP_NBR.Value = fleF112_PYCDCEILINGS.GetDecimalValue("RETRO_TO_EP_NBR");
                W_DOC_YRLY_CEILING.Value = fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_CEILING");
                W_DOC_YRLY_CEILING_ADJUSTED.Value = fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_CEILING_ADJUSTED");
                W_DOC_YRLY_CEILING_COMPUTED.Value = fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_CEILING_COMPUTED");
                W_DOC_YRLY_EXPENSE.Value = fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_EXPENSE");
                W_DOC_YRLY_EXPENSE_ADJUSTED.Value = fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_EXPENSE_ADJUSTED");
                W_DOC_YRLY_EXPENSE_COMPUTED.Value = fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_EXPENSE_COMPUTED");
                W_DOC_YRLY_EXPN_ALLOC_PERS.Value = fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_EXPN_ALLOC_PERS");
                W_DOC_YRLY_CEIL_GUAR.Value = fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_CEIL_GUAR");
                W_DOC_YRLY_CEILING_GUAR_PERC.Value = fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_CEILING_GUAR_PERC");
                W_DOC_RMA_EXPENSE_PERCENT_REG.Value = fleF112_PYCDCEILINGS.GetDecimalValue("DOC_RMA_EXPENSE_PERCENT_REG");
                W_DOC_RMA_EXPENSE_PERCENT_MISC.Value = fleF112_PYCDCEILINGS.GetDecimalValue("DOC_RMA_EXPENSE_PERCENT_MISC");
                W_DOC_DEPT_EXPENSE_PERCENT_REG.Value = fleF112_PYCDCEILINGS.GetDecimalValue("DOC_DEPT_EXPENSE_PERCENT_REG");
                W_DOC_DEPT_EXPENSE_PERCENT_MISC.Value = fleF112_PYCDCEILINGS.GetDecimalValue("DOC_DEPT_EXPENSE_PERCENT_MISC");
                W_DOC_YRLY_REQREV.Value = fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_REQREV");
                W_DOC_YRLY_REQREV_ADJUSTED.Value = fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_REQREV_ADJUSTED");
                W_DOC_YRLY_REQREV_COMPUTED.Value = fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_REQREV_COMPUTED");
                W_DOC_YRLY_TARREV.Value = fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_TARREV");
                W_DOC_YRLY_TARREV_ADJUSTED.Value = fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_TARREV_ADJUSTED");
                W_DOC_YRLY_TARREV_COMPUTED.Value = fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_TARREV_COMPUTED");
                W_RETRO_TO_EP_NBR_REQ.Value = fleF112_PYCDCEILINGS.GetDecimalValue("RETRO_TO_EP_NBR_REQ");
        ...
        private bool Internal_F112RECRESTORE()
        {
            ...
            try
            {
                ...
                fleF112_PYCDCEILINGS.set_SetValue("FACTOR", W_FACTOR.Value);
                fleF112_PYCDCEILINGS.set_SetValue("DOC_PAY_CODE", W_DOC_PAY_CODE.Value);
                fleF112_PYCDCEILINGS.set_SetValue("DOC_PAY_SUB_CODE", W_DOC_PAY_SUB_CODE.Value);
                fleF112_PYCDCEILINGS.set_SetValue("RETRO_TO_EP_NBR", W_RETRO_TO_EP_NBR.Value);
                fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_CEILING_ADJUSTED", W_DOC_YRLY_CEILING_ADJUSTED.Value);
                fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_CEILING_COMPUTED", W_DOC_YRLY_CEILING_COMPUTED.Value);
                fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_EXPENSE", W_DOC_YRLY_EXPENSE.Value);
                fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_EXPENSE_ADJUSTED", W_DOC_YRLY_EXPENSE_ADJUSTED.Value);
                fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_EXPENSE_COMPUTED", W_DOC_YRLY_EXPENSE_COMPUTED.Value);
                fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_EXPN_ALLOC_PERS", W_DOC_YRLY_EXPN_ALLOC_PERS.Value);
                fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_CEIL_GUAR", W_DOC_YRLY_CEIL_GUAR.Value);
                fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_CEILING_GUAR_PERC", W_DOC_YRLY_CEILING_GUAR_PERC.Value);
                fleF112_PYCDCEILINGS.set_SetValue("DOC_RMA_EXPENSE_PERCENT_REG", W_DOC_RMA_EXPENSE_PERCENT_REG.Value);
                fleF112_PYCDCEILINGS.set_SetValue("DOC_RMA_EXPENSE_PERCENT_MISC", W_DOC_RMA_EXPENSE_PERCENT_MISC.Value);
                fleF112_PYCDCEILINGS.set_SetValue("DOC_DEPT_EXPENSE_PERCENT_REG", W_DOC_DEPT_EXPENSE_PERCENT_REG.Value);
                fleF112_PYCDCEILINGS.set_SetValue("DOC_DEPT_EXPENSE_PERCENT_MISC", W_DOC_DEPT_EXPENSE_PERCENT_MISC.Value);
                fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_REQREV", W_DOC_YRLY_REQREV.Value);
                fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_REQREV_ADJUSTED", W_DOC_YRLY_REQREV_ADJUSTED.Value);
                fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_REQREV_COMPUTED", W_DOC_YRLY_REQREV_COMPUTED.Value);
                fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_TARREV", W_DOC_YRLY_TARREV.Value);
                fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_TARREV_ADJUSTED", W_DOC_YRLY_TARREV_ADJUSTED.Value);
                fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_TARREV_COMPUTED", W_DOC_YRLY_TARREV_COMPUTED.Value);
                fleF112_PYCDCEILINGS.set_SetValue("RETRO_TO_EP_NBR_REQ", W_RETRO_TO_EP_NBR_REQ.Value);
                fleF112_PYCDCEILINGS.set_SetValue("RETRO_TO_EP_NBR_TAR", W_RETRO_TO_EP_NBR_TAR.Value);
        ...
        //#CORE_BEGIN_INCLUDE: SAVEF020AUDIT"
        ...
        //#CORE_END_INCLUDE: SAVEF020AUDIT"


        //#CORE_BEGIN_INCLUDE: CREATEF020AUDIT"
        ...
        //#CORE_END_INCLUDE: CREATEF020AUDIT"
        ...
        protected override bool PostFind()
        {
            ...
            try
            {
                ...
                while (fleF198_USER_DEFINED_TOTALS.For())
                {
                    Display(ref fldF198_USER_DEFINED_TOTALS_USER_TOTAL1);
                    Display(ref fldF198_USER_DEFINED_TOTALS_USER_TOTAL2);
                    Display(ref fldF198_USER_DEFINED_TOTALS_USER_TOTAL3);
                ...
                fleCONSTANTS_MSTR_REC_6.GetData(m_strWhere.ToString(), GetDataOptions.IsOptional);
                // --> End GET CONSTANTS_MSTR_REC_6 <--
                BOLCURRENTCEILINGRECORDEXISTS.Value = "Y";
                ...
                if (!AccessOk)
                {
                    BOLCURRENTCEILINGRECORDEXISTS.Value = "N";
                    // --> GET F112_PYCDCEILINGS <--
                    m_strWhere = new StringBuilder(" WHERE ");
                    m_strWhere.Append(" ").Append(fleF112_PYCDCEILINGS.ElementOwner("DOC_NBR")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(fleF020_DOCTOR_MSTR.GetStringValue("DOC_NBR")));
                ...
                {
                    Internal_F112RECSAVE();
                }
                else
                {
                    BOLCURRENTCEILINGRECORDEXISTS.Value = " ";
                ...
                Display(ref fldF020_DOCTOR_MSTR_DOC_YRLY_EXPENSE_COMPUTED);
                m_strWhere = new StringBuilder(" WHERE ");
                m_strWhere.Append("").Append(fleF020_DESIGNER.ElementOwner("DOC_OHIP_NBR")).Append(" = ").Append(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_OHIP_NBR"));

                while (fleF020_DESIGNER.WhileRetrieving(m_strWhere.ToString()))
                {
                    if (QDesign.NULL(DOC_NBR_1.Value) == QDesign.NULL(" "))
                    {
                        DOC_NBR_1.Value = fleF020_DESIGNER.GetStringValue("DOC_NBR");
                    ...
                    {
                        if (QDesign.NULL(DOC_NBR_2.Value) == QDesign.NULL(" "))
                        {
                            DOC_NBR_2.Value = fleF020_DESIGNER.GetStringValue("DOC_NBR");
                            if (Convert.ToDecimal(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_YY").ToString().PadLeft(4, '0') + fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_MM").ToString().PadLeft(2, '0') + fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_DD").ToString().PadLeft(2, '0')) != 0)
                            {
                                DOC_FLAG_2.Value = "T";
                            }
                        ...
                        {
                            if (QDesign.NULL(DOC_NBR_3.Value) == QDesign.NULL(" "))
                            {
                                DOC_NBR_3.Value = fleF020_DESIGNER.GetStringValue("DOC_NBR");
                                if (Convert.ToDecimal(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_YY").ToString().PadLeft(4, '0') + fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_MM").ToString().PadLeft(2, '0') + fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_DD").ToString().PadLeft(2, '0')) != 0)
                                {
                                    DOC_FLAG_3.Value = "T";
                                }
                            ...
                            {
                                if (QDesign.NULL(DOC_NBR_4.Value) == QDesign.NULL(" "))
                                {
                                    DOC_NBR_4.Value = fleF020_DESIGNER.GetStringValue("DOC_NBR");
                                    if (Convert.ToDecimal(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_YY").ToString().PadLeft(4, '0') + fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_MM").ToString().PadLeft(2, '0') + fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_DD").ToString().PadLeft(2, '0')) != 0)
                                    {
                                        DOC_FLAG_4.Value = "T";
                                    }
                                ...
                                {
                                    if (QDesign.NULL(DOC_NBR_5.Value) == QDesign.NULL(" "))
                                    {
                                        DOC_NBR_5.Value = fleF020_DESIGNER.GetStringValue("DOC_NBR");
                                        if (Convert.ToDecimal(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_YY").ToString().PadLeft(4, '0') + fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_MM").ToString().PadLeft(2, '0') + fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_DD").ToString().PadLeft(2, '0')) != 0)
                                        {
                                            DOC_FLAG_5.Value = "T";
                                        }
                                    ...
                                    {
                                        if (QDesign.NULL(DOC_NBR_6.Value) == QDesign.NULL(" "))
                                        {
                                            DOC_NBR_6.Value = fleF020_DESIGNER.GetStringValue("DOC_NBR");
                                            if (Convert.ToDecimal(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_YY").ToString().PadLeft(4, '0') + fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_MM").ToString().PadLeft(2, '0') + fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_DD").ToString().PadLeft(2, '0')) != 0)
                                            {
                                                DOC_FLAG_6.Value = "T";
                                            }
                                        ...
                                        {
                                            if (QDesign.NULL(DOC_NBR_7.Value) == QDesign.NULL(" "))
                                            {
                                                DOC_NBR_7.Value = fleF020_DESIGNER.GetStringValue("DOC_NBR");
                                                if (Convert.ToDecimal(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_YY").ToString().PadLeft(4, '0') + fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_MM").ToString().PadLeft(2, '0') + fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_DD").ToString().PadLeft(2, '0')) != 0)
                                                {
                                                    DOC_FLAG_7.Value = "T";
                                                }
                                            ...
                                            {
                                                if (QDesign.NULL(DOC_NBR_8.Value) == QDesign.NULL(" "))
                                                {
                                                    DOC_NBR_8.Value = fleF020_DESIGNER.GetStringValue("DOC_NBR");
                                                    if (Convert.ToDecimal(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_YY").ToString().PadLeft(4, '0') + fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_MM").ToString().PadLeft(2, '0') + fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_DD").ToString().PadLeft(2, '0')) != 0)
                                                    {
                                                        DOC_FLAG_8.Value = "T";
                                                    }
                                                ...
                                                {
                                                    if (QDesign.NULL(DOC_NBR_9.Value) == QDesign.NULL(" "))
                                                    {
                                                        DOC_NBR_9.Value = fleF020_DESIGNER.GetStringValue("DOC_NBR");
                                                        if (Convert.ToDecimal(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_YY").ToString().PadLeft(4, '0') + fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_MM").ToString().PadLeft(2, '0') + fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_DD").ToString().PadLeft(2, '0')) != 0)
                                                        {
                                                            DOC_FLAG_9.Value = "T";
                                                        }
                                                    ...
                                                    {
                                                        if (QDesign.NULL(DOC_NBR_10.Value) == QDesign.NULL(" "))
                                                        {
                                                            DOC_NBR_10.Value = "*";
                                                        }
                                                    }
        ...
        private void fldDOC_OVERAGE_AMT_Edit()
        {

            try
            {

                if (QDesign.NULL(W_DOC_PAY_CODE.Value) == QDesign.NULL("?"))
                {
                    ErrorMessage("Neither Current nor Previous Ceiling record not found - UNABLE to perform AUTO-Calculation of Overage");
                }
        ...
        private void dsrDesigner_OVER_Click(object sender, System.EventArgs e)
        {

            try
            {

                W_MONTHLY_CEIL_EARN.Value = W_CURR_CEIL_EARN.Value / 12;
                W_NEW_CEIL_EARN.Value = (W_MONTHLY_CEIL_EARN.Value + DOC_OVERAGE_AMT.Value) * 12;
                if (QDesign.NULL(BOLCURRENTCEILINGRECORDEXISTS.Value) == QDesign.NULL("N"))
                {
                    Internal_F112RECRESTORE();
                    Internal_COPYF112TOF112ADD_1();
                    fleF112_ADD_NEW_REC_1.set_SetValue("DOC_NBR", fleF020_DOCTOR_MSTR.GetStringValue("DOC_NBR"));
                    fleF112_ADD_NEW_REC_1.set_SetValue("EP_NBR", fleCONSTANTS_MSTR_REC_6.GetDecimalValue("CURRENT_EP_NBR"));
                    fleF112_ADD_NEW_REC_1.set_SetValue("DOC_YRLY_CEILING", W_NEW_CEIL_EARN.Value);
                    fleF112_ADD_NEW_REC_1.set_SetValue("DOC_YRLY_CEILING_ADJUSTED", W_DOC_YRLY_CEILING.Value);
                    fleF112_ADD_NEW_REC_1.set_SetValue("DOC_YRLY_EXPENSE_ADJUSTED", W_DOC_YRLY_EXPENSE.Value);
                    fleF112_ADD_NEW_REC_1.PutData();
                }
                else
                {
                    // --> GET F112_PYCDCEILINGS <--
                    ...
                    fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_CEILING", W_NEW_CEIL_EARN.Value);
                ...
                Internal_COPYF112TOF112ADD_2();
                fleF112_ADD_NEW_REC_2.set_SetValue("EP_NBR", W_CURRENT_EP_NBR_PLUS_1.Value);
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_YRLY_CEILING_ADJUSTED", W_NEW_CEIL_EARN.Value);
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_YRLY_CEILING", W_DOC_YRLY_CEILING.Value);
                fleF112_ADD_NEW_REC_2.set_SetValue("DOC_YRLY_EXPENSE_ADJUSTED", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_EXPENSE"));
                fleF112_ADD_NEW_REC_2.PutData();
                fleF020_DOCTOR_MSTR.set_SetValue("DOC_YRLY_CEILING_COMPUTED", fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_YRLY_CEILING_COMPUTED") + (DOC_OVERAGE_AMT.Value * 100));
        ...
        private void dsrDesigner_94_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                object[] arrRunscreen = { W_DOC_NBR, fleCONSTANTS_MSTR_REC_6, fleF020_DOCTOR_MSTR };               
                if (ApplicationState.Current.Selected == 1)
                    RunScreen(new Mp_D119(), RunScreenModes.Same, ref arrRunscreen);
                else
        ...
        private void dsrDesigner_96_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                W_DOC_NBR.Value = fleF020_DOCTOR_MSTR.GetStringValue("DOC_NBR");
                object[] arrRunscreen = { W_DOC_NBR, fleCONSTANTS_MSTR_REC_6, fleF020_DOCTOR_MSTR };
                RunScreen(new Billing_D119GOV(), RunScreenModes.Same, ref arrRunscreen);
        ...
        private void dsrDesigner_HI96_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                Accept(ref fldW_EP_NBR_FROM);
                object[] arrRunscreen = { W_DOC_NBR, W_EP_NBR_FROM, fleCONSTANTS_MSTR_REC_6, fleF020_DOCTOR_MSTR };
                RunScreen(new Billing_H119GOV(), RunScreenModes.Same, ref arrRunscreen);
        ...
        private void dsrDesigner_HI97_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                Accept(ref fldW_EP_NBR_FROM);
                object[] arrRunscreen = { W_DOC_NBR, W_EP_NBR_FROM, fleCONSTANTS_MSTR_REC_6, fleF020_DOCTOR_MSTR };
                RunScreen(new Billing_H119TITHE(), RunScreenModes.Same, ref arrRunscreen);
        ...
        private void dsrDesigner_97_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                W_DOC_NBR.Value = fleF020_DOCTOR_MSTR.GetStringValue("DOC_NBR");
                object[] arrRunscreen = { W_DOC_NBR, fleCONSTANTS_MSTR_REC_6, fleF020_DOCTOR_MSTR };
                RunScreen(new Billing_D119TITHE(), RunScreenModes.Same, ref arrRunscreen);
        ...
        //# Precompiler Ver.: 1.0.6353.18277  Generated on: 5/29/2017 9:56:25 AM
        //#-----------------------------------------
        private void dsrDesigner_05_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                Accept(ref fldF020_DOCTOR_EXTRA_FACTOR_GST_INCOME_MISC);
                //#END STANDARD PROCEDURE CONTENT
        ...
        private void dsrDesigner_04_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                Accept(ref fldF020_DOCTOR_EXTRA_FACTOR_GST_INCOME_REG);
                //#END STANDARD PROCEDURE CONTENT
