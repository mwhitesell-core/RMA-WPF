...
namespace rma.Views
{
    ...
    partial class Billing_D112A : BasePage
    {
        ...
        private void Page_Load(object sender, RoutedEventArgs e)
        {
            ...
            //       F112_DESIGNER.DOC_YRLY_CEILING_COMPUTED InputScale: 2 OutputScale: 0
            //       F112_DESIGNER.DOC_YRLY_EXPENSE_COMPUTED InputScale: 2 OutputScale: 0
            //       F112_DESIGNER.FACTOR InputScale: 4 OutputScale: 0
        ...
        protected override void SetVariables()
        {
            ...
            fleF112_DESIGNER = new SqlFileObject(this, FileTypes.Designer, 0, "INDEXED", "F112_PYCDCEILINGS", "F112_DESIGNER", false, false, false, 0, "m_trnTRANS_UPDATE");
            ...
            fleF112_DESIGNER.Access += fleF112_DESIGNER_Access;
        ...
        private SqlFileObject fleF112_DESIGNER;

        private void fleF112_DESIGNER_Access(ref string AccessClause)
        {
            ...
            try
            {
                ...
                strText.Append(" WHERE ").Append(fleF112_DESIGNER.ElementOwner("DOC_NBR")).Append(" = ").Append(Common.StringToField(W_DOC_NBR.Value));
                strText.Append(" AND ").Append(fleF112_DESIGNER.ElementOwner("EP_NBR")).Append(" = ").Append((fleF112_PYCDCEILINGS.GetDecimalValue("EP_NBR") - 1));

                strText.Append(" ORDER BY ").Append(fleF112_DESIGNER.ElementOwner("DOC_NBR"));
                strText.Append(", ").Append(fleF112_DESIGNER.ElementOwner("EP_NBR"));
                AccessClause = strText.ToString();
        ...
        //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
        //# Do not delete, modify or move it.  Updated: 5/29/2017 10:06:48 AM
        ...
        //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
        //# Do not delete, modify or move it.  Updated: 5/29/2017 10:06:49 AM
        ...
        private void Initialize_TRANS_UPDATE()
        {
            ...
            fleF112_DESIGNER.Transaction = m_trnTRANS_UPDATE;
        ...
        //# Precompiler Ver.: 1.0.6353.18277  Generated on: 5/29/2017 10:06:49 AM
        //#-----------------------------------------
        ...
        private void fldF112_PYCDCEILINGS_EP_NBR_LookupOn()
        {
            ...
            try
            {
                ...
                if (!AccessOk)
                {
                    ErrorMessage("Invalid Earnings Period.^G");
                }
            ...
            try
            {
                ...
                while (fleF112_PYCDCEILINGS.For())
                {
                    if (fleF112_PYCDCEILINGS.NewRecord)
                    {
                        ...
                        fleF112_DESIGNER.GetData(GetDataOptions.IsOptional);
                        // --> End GET F112_DESIGNER <--
                        if (AccessOk)
                        {
                            fleF112_PYCDCEILINGS.set_SetValue("FACTOR", fleF112_DESIGNER.GetDecimalValue("FACTOR"));
                            fleF112_PYCDCEILINGS.set_SetValue("RETRO_TO_EP_NBR", fleF112_DESIGNER.GetDecimalValue("RETRO_TO_EP_NBR"));
                            fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_CEILING", fleF112_DESIGNER.GetDecimalValue("DOC_YRLY_CEILING"));
                            fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_CEILING_ADJUSTED", fleF112_DESIGNER.GetDecimalValue("DOC_YRLY_CEILING_ADJUSTED"));
                            fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_CEILING_COMPUTED", fleF112_DESIGNER.GetDecimalValue("DOC_YRLY_CEILING_COMPUTED"));
                            fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_EXPENSE", fleF112_DESIGNER.GetDecimalValue("DOC_YRLY_EXPENSE"));
                            fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_EXPENSE_ADJUSTED", fleF112_DESIGNER.GetDecimalValue("DOC_YRLY_EXPENSE_ADJUSTED"));
                            fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_EXPENSE_COMPUTED", fleF112_DESIGNER.GetDecimalValue("DOC_YRLY_EXPENSE_COMPUTED"));
                            fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_EXPN_ALLOC_PERS", fleF112_DESIGNER.GetDecimalValue("DOC_YRLY_EXPN_ALLOC_PERS"));
                            fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_CEIL_GUAR", fleF112_DESIGNER.GetDecimalValue("DOC_YRLY_CEIL_GUAR"));
                            fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_CEILING_GUAR_PERC", fleF112_DESIGNER.GetDecimalValue("DOC_YRLY_CEILING_GUAR_PERC"));
                        }
                    }
                }
                while (fleF112_PYCDCEILINGS.For())
        ...
        //#-----------------------------------------
        //# Append Procedure
        //# Precompiler Ver.: 1.0.6353.18277  Generated on: 5/29/2017 10:05:00 AM
        //#-----------------------------------------
