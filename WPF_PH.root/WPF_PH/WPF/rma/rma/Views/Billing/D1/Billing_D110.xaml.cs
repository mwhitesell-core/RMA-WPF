...
namespace rma.Views
{
    ...
    partial class Billing_D110 : BasePage
    {
        ...
        protected override void SetVariables()
        {
            ...
            fleF110_COMPENSATION_AUDIT = new SqlFileObject(this, FileTypes.Designer, fleF110_COMPENSATION, "SEQUENTIAL", "F110_COMPENSATION_AUDIT", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SequentialDataBase);
        ...
        private void fleF191_EARNINGS_PERIOD_Access(ref string AccessClause)
        {
            ...
            try
            {
                ...
                strText.Append(" WHERE ").Append(fleF191_EARNINGS_PERIOD.ElementOwner("EP_NBR")).Append(" = ").Append((fleF110_COMPENSATION.GetDecimalValue("EP_NBR")));
        ...
        //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
        //# Do not delete, modify or move it.  Updated: 5/29/2017 10:06:18 AM
        ...
        //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
        //# Do not delete, modify or move it.  Updated: 5/29/2017 10:06:19 AM

        protected TextBox fldF110_COMPENSATION_EP_NBR;
        protected ComboBox fldF110_COMPENSATION_COMP_TYPE;
        ...
        protected ComboBox fldF110_COMPENSATION_COMPENSATION_STATUS;
            ...
            try
            {
                switch (Name.ToUpper())
                {
                    ...
                    case "FLDGRDF110_COMPENSATION_COMP_TYPE":
                        fldF110_COMPENSATION_COMP_TYPE = (ComboBox)DataListField;
                    ...
                    case "FLDGRDF110_COMPENSATION_COMP_CODE":
                        ...
                        fldF110_COMPENSATION_COMP_CODE.Edit += fldF110_COMPENSATION_COMP_CODE_Edit;
                        fldF110_COMPENSATION_COMP_CODE.Process -= fldF110_COMPENSATION_COMP_CODE_Process;
                        fldF110_COMPENSATION_COMP_CODE.Process += fldF110_COMPENSATION_COMP_CODE_Process;
                    ...
                    case "FLDGRDF110_COMPENSATION_FACTOR":
                        ...
                        fldF110_COMPENSATION_FACTOR.Process -= fldF110_COMPENSATION_FACTOR_Process;
                        fldF110_COMPENSATION_FACTOR.Process += fldF110_COMPENSATION_FACTOR_Process;
                    ...
                    case "FLDGRDF110_COMPENSATION_AMT_GROSS":
                        ...
                        fldF110_COMPENSATION_AMT_GROSS.Process -= fldF110_COMPENSATION_AMT_GROSS_Process;
                        fldF110_COMPENSATION_AMT_GROSS.Process += fldF110_COMPENSATION_AMT_GROSS_Process;
                    ...
                    case "FLDGRDF110_COMPENSATION_COMPENSATION_STATUS":
                        fldF110_COMPENSATION_COMPENSATION_STATUS = (ComboBox)DataListField;
        ...
        //# Precompiler Ver.: 1.0.6353.18277  Generated on: 5/29/2017 10:06:18 AM
        //#-----------------------------------------
        ...
        private void fleF110_COMPENSATION_AutomaticItemInitialization(bool Fixed)
        {
            try
            {
                ...
                fleF110_COMPENSATION.set_SetValue("DOC_NBR", !Fixed, fleF020_DOCTOR_MSTR.GetStringValue("DOC_NBR"));
        ...
        private void fldF110_COMPENSATION_COMP_CODE_LookupOn()
        {
            ...
            try
            {
                ...
                if (!AccessOk)
                {
                    ErrorMessage("Invalid COMPENSATION Code.\a");
                }
            ...
            try
            {
                switch (Name)
                {
                    case "F110_COMPENSATION_EP_NBR":
                        return fleCONSTANTS_MSTR_REC_6.GetDecimalValue("CURRENT_EP_NBR");
                    default:
                        return "";
                }
        ...
        private void fldF110_COMPENSATION_EP_NBR_Edit()
        {
            ...
            try
            {
                ...
                {
                    Warning("*W* This Earnings Period is NOT within the Current Fiscal Year.\a");
                }
        ...
        private void fldF110_COMPENSATION_COMP_CODE_Edit()
        {
            ...
            try
            {
                ...
                {
                    ErrorMessage("Error - This Compensation Code can`t be input by a USER.\a\a");
                }
        ...
        //# Precompiler Ver.: 1.0.6353.18277  Generated on: 5/29/2017 10:05:02 AM
        //#-----------------------------------------
