...
namespace rma.Views
{
    ...
    partial class Billing_D119 : BasePage
    {
        ...
        //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
        //# Do not delete, modify or move it.  Updated: 5/29/2017 10:07:30 AM
        ...
        //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
        //# Do not delete, modify or move it.  Updated: 5/29/2017 10:07:31 AM
        ...
        //# Precompiler Ver.: 1.0.6353.18277  Generated on: 5/29/2017 10:07:30 AM
        //#-----------------------------------------
        ...
        //#CORE_BEGIN_INCLUDE: SAVEF119AUDIT"
        ...
        private bool Internal_SAVEF119AUDIT()
        {
            ...
            try
            {
                ...
                A_DOC_OHIP_NBR.Value = fleF119_DOCTOR_YTD.GetDecimalValue("DOC_OHIP_NBR");
        ...
        //#CORE_END_INCLUDE: SAVEF119AUDIT"


        //#CORE_BEGIN_INCLUDE: CREATEF119AUDIT"
        ...
        private bool Internal_CREATEF119AUDIT()
        {
            ...
            try
            {
                ...
                fleF119_DOCTOR_YTD_AUDIT.set_SetValue("DOC_OHIP_NBR", A_DOC_OHIP_NBR.Value);
        ...
        private bool Internal_CREATEF119AUDIT_ADD()
        {
            ...
            try
            {
                ...
                fleF119_DOCTOR_YTD_AUDIT.set_SetValue("DOC_OHIP_NBR", fleF119_DOCTOR_YTD.GetDecimalValue("DOC_OHIP_NBR"));
        ...
        //#CORE_END_INCLUDE: CREATEF119AUDIT"
        ...
        protected override bool Find()
        {
            ...
            try
            {
                ...
                while (fleF119_DOCTOR_YTD.ForMissing())
                {
                    ...
                    m_strOrderBy.Append(fleF119_DOCTOR_YTD.ElementOwner("COMP_CODE_GROUP")).Append(",").Append(fleF119_DOCTOR_YTD.ElementOwner("PROCESS_SEQ")).Append(",").Append(fleF119_DOCTOR_YTD.ElementOwner("COMP_CODE"));
                    fleF119_DOCTOR_YTD.GetData(m_strWhere.ToString(), m_strOrderBy.ToString(), GetDataOptions.CreateSubSelect);
                }
        ...
        private void dtlF119_DOCTOR_YTD_EditClick(DataList source, GridButtonEventArgs GridButtonEventArgs)
        {
            ...
            {
                //#BEGIN STANDARD PROCEDURE CONTENT
                //# Precompiler Ver.: 1.0.6353.18277 Generated on: 5/29/2017 10:07:31 AM
