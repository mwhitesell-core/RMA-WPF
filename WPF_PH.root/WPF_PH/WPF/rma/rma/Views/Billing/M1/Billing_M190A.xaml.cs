...
// #> PROGRAM-ID.     M190A.QKS
// ((C)) Dyad Technologies
// PURPOSE: SLAVE SCREEN OFF OF COMPENSATION CODES MASTER FOR
//  USER DEFINED GROSS  values
// MODIFICATION HISTORY
// DATE    SAF #  WHO      DESCRIPTION
// 92/JAN/01  ____   R.A.     - original
// 98/JAN/14  s149   M.C.     - receive error from compilation
// - receiving f190-comp-codes insteal of
// comp-code
// - replace comp-codes with f190-comp-codes
// - modify screen statement with line number 
// and no. of lines
// - modify cluster statement with for 1,16
// and alignment columns
// 1999/jan/31         B.E.  - y2k
...
namespace rma.Views
{
    ...
    partial class Billing_M190A : BasePage
    {
        ...
        private void Page_Load(object sender, RoutedEventArgs e)
        {
            ...
            //       F190_COMP_CODES.AFFECT_GROSS Occurs: 20
        ...
        protected override void SetVariables()
        {
            ...
            fleF190_COMP_CODES = new SqlFileObject(this, FileTypes.Master, 0, "[101C].INDEXED", "F190_COMP_CODES", "", false, false, false, 0, "m_trnTRANS_UPDATE");
        ...
        private void X_SCREEN_NAME_GetValue(ref string Value)
        {
            ...
            try
            {
                Value = "COMPENSATION CODE User Defined `Gross` Flags";
        ...
        //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
        //# Do not delete, modify or move it.  Updated: 5/29/2017 10:15:34 AM
        ...
        //# Precompiler Ver.: 1.0.6353.18277  Generated on: 5/29/2017 10:15:34 AM
        //#-----------------------------------------
        protected override void DisplayFormatting()
        {
            try
            {
                ...
                //# Precompiler Ver.: 1.0.6353.18277 Generated on: 5/29/2017 10:15:34 AM
                Display(ref fldF190_COMP_CODES_AFFECT_GROSS);
        ...
        public override void BindFields()
        {
            try
            {
                fldF190_COMP_CODES_AFFECT_GROSS.Bind(fleF190_COMP_CODES);
        ...
        protected override void SaveParamsReceived()
        {
            ...
            try
            {
                SaveReceivingParams(fleF190_COMP_CODES);
        ...
        protected override bool Entry()
        {
            try
            {
                //#BEGIN STANDARD PROCEDURE CONTENT
                //# Precompiler Ver.: 1.0.6353.18277 Generated on: 5/29/2017 10:15:34 AM
                Accept(ref fldF190_COMP_CODES_AFFECT_GROSS);
                //#END STANDARD PROCEDURE CONTENT
                return true;
        ...
        protected override bool Update()
        {
            try
            {
                //#BEGIN STANDARD PROCEDURE CONTENT
                //# Precompiler Ver.: 1.0.6353.18277 Generated on: 5/29/2017 10:15:34 AM
                fleF190_COMP_CODES.PutData(false, PutTypes.New);
