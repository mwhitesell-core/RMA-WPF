...
namespace rma.Views
{
    ...
    partial class Billing_H119 : BasePage
    {
        ...
        private void fleF119_DOCTOR_YTD_HISTORY_SelectIf(ref string SelectIfClause)
        {
            ...
            try
            {
                ...
                strSQL.Append(" (    ").Append(fleF119_DOCTOR_YTD_HISTORY.ElementOwner("REC_TYPE")).Append(" =  'A')");
        ...
        //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
        //# Do not delete, modify or move it.  Updated: 5/29/2017 10:09:32 AM
        ...
        //# Precompiler Ver.: 1.0.6353.18277  Generated on: 5/29/2017 10:09:32 AM
        //#-----------------------------------------
        ...
        private bool Internal_ACCEPT_VALUES()
        {
            ...
            try
            {
                ...
                fleF119_DOCTOR_YTD_HISTORY.set_SetValue("REC_TYPE", "A");
        ...
        protected override bool Update()
        {
            try
            {
                ...
                {
                    fleF119_DOCTOR_YTD_HISTORY.PutData(false, PutTypes.Deleted);
                }
                while (fleF119_DOCTOR_YTD_HISTORY.For())
                {
        ...
        protected override bool Delete()
        {
            try
            {
                //#BEGIN STANDARD PROCEDURE CONTENT
                //# Precompiler Ver.: 1.0.6353.18277 Generated on: 5/29/2017 10:09:32 AM
                fleF119_DOCTOR_YTD_HISTORY.DeletedRecord = true;
                //#END STANDARD PROCEDURE CONTENT
                return true;
