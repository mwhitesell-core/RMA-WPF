...
namespace rma.Views
{
    ...
    partial class Billing_H119GOV : BasePage
    {
        ...
        private void fleF119_DOCTOR_YTD_HISTORY_SelectIf(ref string SelectIfClause)
        {
            ...
            try
            {
                ...
                strSQL.Append(" (    ").Append(fleF119_DOCTOR_YTD_HISTORY.ElementOwner("REC_TYPE")).Append(" =  'C')");
        ...
        //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
        //# Do not delete, modify or move it.  Updated: 5/29/2017 10:09:25 AM
        ...
        //# Precompiler Ver.: 1.0.6353.18277  Generated on: 5/29/2017 10:09:25 AM
        //#-----------------------------------------
        ...
        protected override bool Entry()
        {
            ...
            try
            {
                ...
                if (QDesign.NULL(W_PASSWORD.Value) == QDesign.NULL(W_SYSDATE.Value))
                {
                    ...
                    {
                        fleF119_DOCTOR_YTD_HISTORY.set_SetValue("REC_TYPE", "C");
                    }
