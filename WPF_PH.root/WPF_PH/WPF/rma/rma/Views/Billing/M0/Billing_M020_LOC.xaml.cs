...
namespace rma.Views
{
    ...
    partial class Billing_M020_LOC : BasePage
    {
        ...
        protected override void SetVariables()
        {
            ...
            fleF030_LOCATIONS_MSTR = new SqlFileObject(this, FileTypes.Reference, 0, "[101C].[101C].INDEXED", "F030_LOCATIONS_MSTR", "", false, false, false, 0, "m_cnnQUERY");
            W_LOC_NBR = new CoreCharacter("W_LOC_NBR", 4, this, Common.cEmptyString);

            fleF020L_DOC_LOCATIONS.InitializeItems += FleF020L_DOC_LOCATIONS_InitializeItems;
        ...
        private void FleF020L_DOC_LOCATIONS_InitializeItems(bool Fixed)
        {
            try
            {
                if (!Fixed)
                    fleF020L_DOC_LOCATIONS.set_SetValue("DOC_NBR", true, fleF020_DOCTOR_MSTR.GetStringValue("DOC_NBR"));
        ...
        protected TextBox fldF020L_DOC_LOCATIONS_DOC_LOC_S1;
        protected TextBox fldF020L_DOC_LOCATIONS_DOC_LOC_S2;
        protected TextBox fldF020L_DOC_LOCATIONS_DOC_LOC_S3;
        ...
        protected override void GetGridFieldObject(object DataListField, ref object CoreField, string Name)
        {
            ...
            try
            {
                switch (Name.ToUpper())
                {
                    ...
                    case "FLDGRDF020L_DOC_LOCATIONS_DOC_LOC_S1":
                        fldF020L_DOC_LOCATIONS_DOC_LOC_S1 = (TextBox)DataListField;
                        CoreField = fldF020L_DOC_LOCATIONS_DOC_LOC_S1;
                        fldF020L_DOC_LOCATIONS_DOC_LOC_S1.Bind(fleF020L_DOC_LOCATIONS);
                        break;

                    case "FLDGRDF020L_DOC_LOCATIONS_DOC_LOC_S2":
                        fldF020L_DOC_LOCATIONS_DOC_LOC_S2 = (TextBox)DataListField;
                        CoreField = fldF020L_DOC_LOCATIONS_DOC_LOC_S2;
                        fldF020L_DOC_LOCATIONS_DOC_LOC_S2.Bind(fleF020L_DOC_LOCATIONS);
                        break;

                    case "FLDGRDF020L_DOC_LOCATIONS_DOC_LOC_S3":
                        fldF020L_DOC_LOCATIONS_DOC_LOC_S3 = (TextBox)DataListField;
                        CoreField = fldF020L_DOC_LOCATIONS_DOC_LOC_S3;
                        fldF020L_DOC_LOCATIONS_DOC_LOC_S3.Bind(fleF020L_DOC_LOCATIONS);
                        break;
        ...
        protected override bool Append()
        {
            try
            {
                ...
                Accept(ref fldF020L_DOC_LOCATIONS_DOC_LOC_S1);
                Accept(ref fldF020L_DOC_LOCATIONS_DOC_LOC_S2);
                Accept(ref fldF020L_DOC_LOCATIONS_DOC_LOC_S3);
