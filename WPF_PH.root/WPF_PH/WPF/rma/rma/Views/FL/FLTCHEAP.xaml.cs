...
namespace rma.Views
{
    partial class FLTCHEAP : BasePage
    {
        ...
        protected override void SetVariables()
        {
            ...
            DEST_AIRPORT = new CoreCharacter("DEST_AIRPORT", 4, this);
            FROM_DATE = new CoreDate("FROM_DATE", this);
            TO_DATE = new CoreDate("TO_DATE", this);
        ...
        private CoreCharacter DEST_AIRPORT;
        private CoreDate FROM_DATE;
        private CoreDate TO_DATE;
        ...
        public override void BindFields()
        {
            try
            {
                fldDEST_AIRPORT.Bind(DEST_AIRPORT);
                fldFROM_DATE.Bind(FROM_DATE);
                fldTO_DATE.Bind(TO_DATE);
        ...
        protected override bool Entry()
        {
            ...
            try
            {
                Accept(ref fldDEST_AIRPORT);
                Accept(ref fldFROM_DATE);
                Accept(ref fldTO_DATE);
        ...
        protected override bool Update()
        {
            ...
            {
                StartJobScript();
                WriteToJobScript("FLTCHEAP", "FLTCHEAP", JobScriptType.QUIZ, "rma~" + DEST_AIRPORT.Value.Trim() + "," + FROM_DATE.Value + "," + TO_DATE.Value);
                EndJobScript();
