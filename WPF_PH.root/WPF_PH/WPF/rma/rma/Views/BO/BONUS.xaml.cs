...
namespace rma.Views
{
    partial class BONUS : BasePage
    {
        ...
        protected override void SetVariables()
        {
            ...
            BONUS_PARM = new CoreCharacter("BONUS_PARM", 8, this);
            DESCRIPTION = new CoreCharacter("DESCRIPTION", 40, this);
            INVEST_DATE = new CoreDate("INVEST_DATE", this);
        ...
        private CoreCharacter BONUS_PARM;
        private CoreCharacter DESCRIPTION;
        private CoreDate INVEST_DATE;
        ...
        public override void BindFields()
        {
            try
            {
                fldBONUS_PARM.Bind(BONUS_PARM);
                fldDESCRIPTION.Bind(DESCRIPTION);
                fldINVEST_DATE.Bind(INVEST_DATE);
        ...
        protected override bool Entry()
        {
            ...
            try
            {
                Accept(ref fldBONUS_PARM);
                Accept(ref fldDESCRIPTION);
                Accept(ref fldINVEST_DATE);
        ...
        protected override bool Update()
        {
            ...
            {
                StartJobScript();
                WriteToJobScript("BONUS", "BONUSDSR", JobScriptType.QTP, "rma~");
                WriteToJobScript("BONUS", "BONUS", JobScriptType.QTP, "rma~" + BONUS_PARM.Value.Trim() + "," + DESCRIPTION.Value.Trim() + "," + INVEST_DATE.Value);
                EndJobScript();
