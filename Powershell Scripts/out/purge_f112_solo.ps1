#-------------------------------------------------------------------------------
# File 'purge_f112_solo.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'purge_f112_solo'
#-------------------------------------------------------------------------------
...
Remove-Item $env:pb_prod\purgef112_solo.log *> $null

echo "Purge f112-history -  STARTING - $(Get-Date -uformat '%Y-%m-%d %H:%M:%S')" > $env:pb_prod\purgef112_solo.log

$rcmd = $env:QTP + "purge_unlof112_history $1 $2"
Invoke-Expression $rcmd *>>$env:pb_prod\purgef112_solo.log


#Set-Location $env:pb_data

# Move-Item -Force f112_pycd_history.dat \\$Env:root\charly\purge\solo\f112_pycd_history.dat
# Move-Item -Force f112_pycd_history.idx \\$Env:root\charly\purge\solo\f112_pycd_history.idx
...
echo "Purge f112-history - ENDING - $(Get-Date -uformat '%Y-%m-%d %H:%M:%S')" >>$env:pb_prod\purgef112_solo.log
