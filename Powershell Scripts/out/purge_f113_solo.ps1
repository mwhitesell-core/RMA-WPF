#-------------------------------------------------------------------------------
# File 'purge_f113_solo.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'purge_f113_solo'
#-------------------------------------------------------------------------------
...
Remove-Item $env:pb_prod\purgef113_solo.log *> $null
...
echo "Purge f113-history -  STARTING - $(Get-Date -uformat '%Y-%m-%d %H:%M:%S')" > $env:pb_prod\purgef113_solo.log

$rcmd = $env:QTP + "purge_unlof113_history $1 $1"
Invoke-Expression $rcmd *>>$env:pb_prod\purgef113_solo.log


#Set-Location $env:pb_data

# Move-Item -Force f113_def_comp_history.dat \\$Env:root\charly\purge\solo\f113_def_comp_history.dat
# Move-Item -Force f113_def_comp_history.idx \\$Env:root\charly\purge\solo\f113_def_comp_history.idx
...
echo "Purge f113-history - ENDING - $(Get-Date -uformat '%Y-%m-%d %H:%M:%S')" >>$env:pb_prod\purgef113_solo.log
