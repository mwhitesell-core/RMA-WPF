#-------------------------------------------------------------------------------
# File 'reload_daily.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'reload_daily'
#-------------------------------------------------------------------------------
...
#   -----------------------------------------------------------
    ...
    if ("$string" -eq "Y" -or "$string" -eq "y")
    {
        ...
        Get-Content data\backup_daily.ls, data\disk1dir.ls, data\disk2dir.ls, data\disk3dir.ls, data\disk4dir.ls, `
          ...
          data\web8dir.ls, data\web9dir.ls, data\web10dir.ls, data\yasemin.ls, data\oscar.ls `
...
#   -----------------------------------------------------------
    ...
    if ("$string" -eq "Y" -or "$string" -eq "y")
    {
        Get-Content backups\oscar.ls | Add-Content data\reload.tmp
    }
#   -----------------------------------------------------------
    ...
    Get-Location
    Get-Date
# CONVERSION ERROR (expected, #739): tape device is involved.
...
echo ""
echo "rewinding tape ..."
# CONVERSION ERROR (expected, #748): tape device is involved.
