...
# Original file name was 'addrlabels'
#-------------------------------------------------------------------------------
...
$var5 = Read-Host
echo ""
echo "SELECT CLINIC NUMBER '22' or '60' or '80' or '81' or '82' or '0' FOR ALL:"
$var0 = Read-Host
echo ""
...
$var2 = Read-Host
echo ""
echo "SELECT '1' RMA OR '2' for RMAINC OR '0' FOR ALL:"
$var4 = Read-Host
echo ""
echo ""
...
if (-not(Test-Path $env:cmd\addrlabels${var3}.ps1 ))
{
        echo "Invalid Option!`a"
        exit
}

&$env:cmd\addrlabels${var3} $var5 $var0 $var1 $var2 $var4 $var3
