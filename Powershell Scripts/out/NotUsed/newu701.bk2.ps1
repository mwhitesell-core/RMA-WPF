#-------------------------------------------------------------------------------
# File 'newu701.bk2.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'newu701.bk2'
#-------------------------------------------------------------------------------
...
#               lp r712.txt
                ...
                &$env:COBOL newu703
# CONVERSION ERROR (expected, #111): Line was useless (error and output sent to /dev/null, exit code not checked).
