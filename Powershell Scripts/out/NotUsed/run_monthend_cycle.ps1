#-------------------------------------------------------------------------------
# File 'run_monthend_cycle.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'run_monthend_cycle'
#-------------------------------------------------------------------------------

clear
echo "RUN_MONTHEND_CYCLE"
echo ""
...
Start-Job -Name "run_monthend_cycle" -InitializationScript $init -ScriptBlock {
  & $env:cmd\run_ohip_monthend_tape ${1} *> ohiptape.ls
}
