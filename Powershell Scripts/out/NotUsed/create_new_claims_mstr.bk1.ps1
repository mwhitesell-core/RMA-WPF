#-------------------------------------------------------------------------------
# File 'create_new_claims_mstr.bk1.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'create_new_claims_mstr.bk1'
#-------------------------------------------------------------------------------
...
Move-Item -Force f002_outstanding.dat $Env:root\foxtrot\purge\f002_outstanding.dat
Move-Item -Force f002_outstanding.idx $Env:root\foxtrot\purge\f002_outstanding.idx
...
&$env:COBOL r073 20131231 Y

# CONVERSION ERROR (expected, #1056): bcheck.
