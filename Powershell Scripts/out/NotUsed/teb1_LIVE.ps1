...
# Original file name was 'teb1_LIVE'
#-------------------------------------------------------------------------------
...
&$env:QTP ";execute $obj/u110"
&$env:QTP u110_1
&$env:QTP u110_2
&$env:QTP u110b_rma "; upload other payroll revenueS" ";execute $obj/u934"
...
echo "---  u131a\b ---"
&$env:QTP u131a ";execute $obj/u131b"
