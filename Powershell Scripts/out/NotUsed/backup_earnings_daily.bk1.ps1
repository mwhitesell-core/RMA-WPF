#-------------------------------------------------------------------------------
# File 'backup_earnings_daily.bk1.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'backup_earnings_daily.bk1'
#-------------------------------------------------------------------------------
...
# CONVERSION ERROR (expected, #88): compressing to cpio.
...
# CONVERSION ERROR (expected, #102): tape device is involved.
...
echo ""
echo ""
# CONVERSION ERROR (expected, #115): tape device is involved.
...
echo "Rewinding tape ..."
# CONVERSION ERROR (expected, #125): tape device is involved.
# mt -f /dev/rmt/0 rewind
