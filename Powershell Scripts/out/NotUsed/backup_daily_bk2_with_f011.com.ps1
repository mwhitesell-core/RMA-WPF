#-------------------------------------------------------------------------------
# File 'backup_daily_bk2_with_f011.com.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'backup_daily_bk2_with_f011.com'
#-------------------------------------------------------------------------------
...
Get-Location
Get-ChildItem data\f002_claims_mstr*, data\f010_pat_mstr*              #data\f011_pat_mstr_elig_history* \
# CONVERSION ERROR (unexpected, #20): Unknown command.
# data/f001_batch_control_file*   \data/f020_doctor_mstr* \data/f050_doc_revenue_mstr* \data/f051_doc_cash_mstr* \data/f050tp_doc_revenue_mstr* \data/f051tp_doc_cash_mstr* \data/f002_claim_shadow* \data/f090_constants_mstr* \data/f021_avail_doctor_mstr* \data/f096_ohip_pay_code* \data/f023_alternative_doc_nbr* \data/f085_rejected_claims* \data/f071_client_rma_claim_nbr* \data/f072_client_mstr*  \data/f073_client_doc_mstr* \data/f074*                 \data/f075*                 \data/f114*                 \data/f113*                 \data/f087_man_rejected_claims* \data/f087_submitted_rejected*  \data/f083_user_mstr* \data/f084_claims_inventory* \data/f088_rat_rejected_claims* \data/f098_equiv_oma_code_mstr* \data/f022*                  \data/adj_claim_file* \data/f002_claims_extra* \data/f020_doctor_extra* \data/resubmit.required \data/f099_group_claim_mstr* \data/f123* \data/f119_doctor_ytd*   \data/f190_comp_codes*   \data/f191_earnings_period*      \data/f924_non_fee_for_service_locations*        \data/icu_app_file*     \production/u010*             \production/ext*              \production/*u993*            \production/icuapp*           \production/r010*             \production/moh_obec*         \production/f086*                 > data/backup_daily.ls
echo ""
echo ""
Get-Date
...
Get-ChildItem -recurse $Env:root\alpha\rmabill\rmabillmp\data\* | Select -ExpandProperty FullName > data\mp_data.ls

echo "Finding ICU data files ..."
Get-ChildItem -recurse $Env:root\alpha\rmabill\rmabillicu\data\* | Select -ExpandProperty FullName > data\icu_data.ls
...
# cat data/backup_daily.ls                \    data/rmadir.ls                      \    data/webdir.ls                      \    data/web1dir.ls                     \    data/web2dir.ls                     \    data/web3dir.ls                     \    data/web4dir.ls                     \    data/web5dir.ls                     \    data/web6dir.ls                     \    data/web7dir.ls                     \    data/web8dir.ls                     \    data/web9dir.ls                     \    data/web10dir.ls                    \    data/diskettedir.ls                 \    data/diskette1dir.ls                \    data/stonedir.ls                    \    data/mumcdir.ls                     \    data/suspend.ls                     \    data/f086.ls                        \    data/mp_data.ls                     \    data/icu_data.ls                    \    | cpio -ocuvB > /dev/rmt/1 
