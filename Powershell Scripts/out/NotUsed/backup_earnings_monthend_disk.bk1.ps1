#-------------------------------------------------------------------------------
# File 'backup_earnings_monthend_disk.bk1.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'backup_earnings_monthend_disk.bk1'
#-------------------------------------------------------------------------------
...
Get-ChildItem production\u110_${1}.sf*, production\r111b_${1}.txt, production\u119_payeft.ps*, `
  ...
  production\r124b_*${1}*, production\r124c_*${1}.txt, production\r125*_${1}.txt, production\r128*_${1}.txt, `
  ...
  production\dumpf119ytd_${1}.txt, production\payeft_${1}.txt, production\paycode1A_ceilings_${1}.txt, `
  data\eft_constant*, data\f020_doctor_mstr*, data\f020_doc_mstr_history*, data\f020_doctor_extra*, `
  data\f050_doc_revenue_mstr, data\f050_doc_revenue_mstr.idx, data\f070_dept_mstr*, data\f074_afp_group_mstr*, `
  data\f074_afp_group_sequence*, data\f075_afp_doc_mstr*, data\f080_bank_mstr*, data\f090_constants_mstr*, `
  data\f095_text_lines*, data\f110_compensation*, data\f110_comp_history*, data\f112_pycdceilings*, `
  data\f112_pycd_history*, data\f113_default_comp*, data\f113_def_comp_history*, `
...
# CONVERSION ERROR (expected, #102): compressing to cpio.
