#-------------------------------------------------------------------------------
# File 'reload_daily_bk1.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'reload_daily_bk1'
#-------------------------------------------------------------------------------
...
#   -----------------------------------------------------------
    ...
    if ("$string" -eq "Y" -or "$string" -eq "y")
    {
        ...
        Get-Content data\backup_daily.ls, data\disk1dir.ls, data\disk2dir.ls, data\disk3dir.ls, data\disk4dir.ls, `
          ...
          data\kathydir.ls, data\mp_data.ls, data\rmadir.ls, data\suspend.ls, data\webdir.ls, data\web1dir.ls, `
          data\web2dir.ls, data\web3dir.ls, data\web4dir.ls, data\web5dir.ls, data\web6dir.ls, data\web7dir.ls, `
          data\web8dir.ls, data\web9dir.ls, data\web10dir.ls, data\yasemin.ls, data\n85.ls `
...
#   -----------------------------------------------------------
    ...
    if ("$string" -eq "Y" -or "$string" -eq "y")
    {
        Get-Content backups\disk1dir.ls | Add-Content data\reload.tmp
    }
#   -----------------------------------------------------------
    ...
    if ("$string" -eq "Y" -or "$string" -eq "y")
    {
        Get-Content backups\disk2dir.ls | Add-Content data\reload.tmp
    }
#   -----------------------------------------------------------
    ...
    if ("$string" -eq "Y" -or "$string" -eq "y")
    {
        Get-Content backups\disk3dir.ls | Add-Content data\reload.tmp
    }
#   -----------------------------------------------------------
    ...
    if ("$string" -eq "Y" -or "$string" -eq "y")
    {
        Get-Content backups\disk4dir.ls | Add-Content data\reload.tmp
    }
#   -----------------------------------------------------------
    ...
    if ("$string" -eq "Y" -or "$string" -eq "y")
    {
        Get-Content backups\disk5dir.ls | Add-Content data\reload.tmp
    }
#   -----------------------------------------------------------
    ...
    if ("$string" -eq "Y" -or "$string" -eq "y")
    {
        Get-Content backups\disk6dir.ls | Add-Content data\reload.tmp
    }
#   -----------------------------------------------------------
    ...
    if ("$string" -eq "Y" -or "$string" -eq "y")
    {
        Get-Content backups\disk7dir.ls | Add-Content data\reload.tmp
    }
#   -----------------------------------------------------------
    ...
    if ("$string" -eq "Y" -or "$string" -eq "y")
    {
        Get-Content backups\disk8dir.ls | Add-Content data\reload.tmp
    }
#   -----------------------------------------------------------
    ...
    if ("$string" -eq "Y" -or "$string" -eq "y")
    {
        Get-Content backups\disk9dir.ls | Add-Content data\reload.tmp
    }
#   -----------------------------------------------------------
    ...
    if ("$string" -eq "Y" -or "$string" -eq "y")
    {
        Get-Content backups\disk10dir.ls | Add-Content data\reload.tmp
    }
#   -----------------------------------------------------------
...
#   -----------------------------------------------------------
    echo "reload - N85 & N85A       ?  (y\[n])"
    &$string = Read-Host
    if ("$string" -eq "Y" -or "$string" -eq "y")
    {
        Get-Content backups\n85.ls | Add-Content data\reload.tmp
    }
#   -----------------------------------------------------------
    ...
    Get-Location
    Get-Date
# CONVERSION ERROR (expected, #738): tape device is involved.
...
echo ""
echo "rewinding tape ..."
# CONVERSION ERROR (expected, #747): tape device is involved.
