#-------------------------------------------------------------------------------
# File 'run_ohip_tape_brad.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'run_ohip_tape_brad'
#-------------------------------------------------------------------------------
...
Remove-Item ru020*, u020_tp.sf*, u020*sf* 2> $null
...
Get-Content ru020a_e | Add-Content ru020a | Set-Content $null
...
Get-Content ru020b_d_e | Add-Content ru020b | Set-Content $null
Get-Content ru020b_s_e | Add-Content ru020b | Set-Content $null
...
Get-Content ru020c_e | Add-Content ru020c | Set-Content $null
...
Get-Content ru020mr_e | Add-Content ru020mr | Set-Content $null
...
Get-Content u020_tapeout_file_e | Add-Content u020_tapeout_file | Set-Content $null
