#-------------------------------------------------------------------------------
# File 'eft_convert_copy_to_hp.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'eft_convert_copy_to_hp'
#-------------------------------------------------------------------------------
...
# awk    -f                fix_eft.awk < eft_ascii.tmp2 > efttape
...
# CONVERSION ERROR (expected, #48): FTP used.
