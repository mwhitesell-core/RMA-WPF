#-------------------------------------------------------------------------------
# File 'backup_daily.com.bk1.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'backup_daily.com.bk1'
#-------------------------------------------------------------------------------
...
Get-ChildItem data\f001_batch_control_file, data\f001_batch_control_file.idx, data\f002_claim_shadow, `
  ...
  production\r010*, production\r085*, production\r087*, production\u085*, production\u010* >> data\backup_daily.ls
...
Get-ChildItem -recurse production\n85* | Select -ExpandProperty FullName > data\n85.ls
...
# CONVERSION ERROR (expected, #192): tape device is involved.
...
Get-Content data\backup_daily.ls, data\disk1dir.ls, data\disk2dir.ls, data\disk3dir.ls, data\disk4dir.ls, `
  ...
  | Set-Content data\backup_daily_complete.ls
echo ""
Get-Date

# CONVERSION ERROR (expected, #230): tape device is involved.
...
# CONVERSION ERROR (expected, #238): tape device is involved.
# mt -f /dev/rmt/0 rewind
