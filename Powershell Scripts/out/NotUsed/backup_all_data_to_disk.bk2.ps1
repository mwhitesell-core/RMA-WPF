#-------------------------------------------------------------------------------
# File 'backup_all_data_to_disk.bk2.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'backup_all_data_to_disk.bk2'
#-------------------------------------------------------------------------------
...
Get-ChildItem production\ext*, production\f086*, production\moh_obec*, production\r010*, production\r085*, `
  production\r087*, production\u085*, production\u010* > $pb_data\backup_101c_prod.ls
...
Get-Content $pb_data\disk1dir.ls, $pb_data\disk2dir.ls, $pb_data\disk3dir.ls, $pb_data\disk4dir.ls, `
  ...
  $pb_data\n85.ls | Add-Content $pb_data\backup_101c_prod.ls
