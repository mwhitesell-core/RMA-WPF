#-------------------------------------------------------------------------------
# File 'backup_daily_to_disk_NOTUSED.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'backup_daily_to_disk_NOTUSED'
#-------------------------------------------------------------------------------
...
# 09/jan/28     M.C.    - backup to cpio with compress  
...
Get-ChildItem data\f001_batch_control_file, data\f001_batch_control_file.idx, data\f002_claim_shadow, `
  ...
  data\f050_doc_revenue_mstr_history.dat, data\f050_doc_revenue_mstr_history.idx, data\f050tp_doc_revenue_mstr, `
  data\f050tp_doc_revenue_mstr.idx, data\f050tp_doc_revenue_mstr_history.dat, `
  data\f050tp_doc_revenue_mstr_history.idx, data\f051_doc_cash_mstr, data\f051_doc_cash_mstr.idx, `
  data\f051tp_doc_cash_mstr, data\f051tp_doc_cash_mstr.idx, data\f060_cheque_reg_mstr, data\f060_cheque_reg_mstr.idx, `
  data\f070_dept_mstr, data\f070_dept_mstr.idx, data\f071_client_rma_claim_nbr, data\f071_client_rma_claim_nbr.idx, `
  data\f072_client_mstr, data\f072_client_mstr.idx, data\f073_client_doc_mstr, data\f073_client_doc_mstr.idx, `
  data\f074*, data\f075*, data\f080_bank_mstr, data\f080_bank_mstr.idx, data\f083_user_mstr*, `
  data\f084_claims_inventory*, data\f085_rejected_claims, data\f085_rejected_claims.idx, data\f086*, `
  data\f087_submitted_rejected*, data\f088_rat_rejected_claims*, data\f090_constants_mstr, `
  ...
  data\f112_pycdceilings*, data\f113_default_comp*, data\f114_special_payments.*, data\f115*, data\f116*, `
...
echo "ignore - all but f002\f010"
# CONVERSION ERROR (expected, #149): compressing to cpio.
# cat data/backup_daily.ls                \   | cpio -ocuvB | compress -c >    /dyad/backup_transfer_area/backup_daily_to_disk_101c.cpio

echo "ignoref010"
# CONVERSION ERROR (expected, #153): compressing to cpio.
# cat data/backup_daily_f010.ls                   \   | cpio -ocuvB | compress -c >    /dyad/backup_transfer_area/backup_daily_to_disk_101c_f010.cpio

echo "f002"
# CONVERSION ERROR (expected, #157): compressing to cpio.
# cat data/backup_daily_f002.ls                   \   | cpio -ocuvB | compress -c >    /dyad/backup_transfer_area/backup_daily_to_disk_101c_f002.cpio
