#-------------------------------------------------------------------------------
# File 'application_of_rat_69_part1.bk1.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'application_of_rat_69_part1.bk1'
#-------------------------------------------------------------------------------
...
Remove-Item u030_69.ls *> $null
#batch << BATCH_EXIT
&$env:cmd\u030 69 *> u030_69.ls
#BATCH_EXIT
Get-Date

# 2014/08/19 - temporary run for clinic 69
&$env:cmd\u030_clinic_dtl_part2_69 >> u030_69.ls 2> u030_69.ls
Get-Date
