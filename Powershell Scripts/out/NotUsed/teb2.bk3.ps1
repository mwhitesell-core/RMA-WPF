...
# Original file name was 'teb2.bk3'
#-------------------------------------------------------------------------------
...
Remove-Item r124b_csv_${1}.txt *> $null
Move-Item -Force r124b_csv.txt r124b_csv_${1}.txt
...
# MC10
Remove-Item r124a_xls_mp_${1}.sf *> $null
Remove-Item r124a_xls_mp_${1}.sfd *> $null
Move-Item -Force r124a_xls.sf r124a_xls_mp_${1}.sf
Move-Item -Force r124a_xls.sfd r124a_xls_mp_${1}.sfd
Remove-Item r124b_csv_${1}.txt *> $null
Move-Item -Force r124b_csv.txt r124b_csv_mp_${1}.txt
