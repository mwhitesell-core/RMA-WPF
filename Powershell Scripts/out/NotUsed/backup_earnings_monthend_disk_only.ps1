#-------------------------------------------------------------------------------
# File 'backup_earnings_monthend_disk_only.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'backup_earnings_monthend_disk_only'
#-------------------------------------------------------------------------------
...
echo ""
Get-Date
Get-ChildItem production\u110${1}.sf*, production\r111b_${1}.txt, production\u119_payeft.ps*, `
  production\r119_${1}.txt, production\r121_${1}.txt, production\r120_${1}.txt, production\r123a_${1}.txt, `
  production\r123b_${1}.txt, production\r123c_${1}.txt, production\r124a_${1}.sf*, production\r124b_${1}.txt, `
  production\debugu114_${1}.txt, production\debugu116cd1_${1}.txt, production\debugu116cd34_${1}.txt, `
  production\dumpf119_${1}.txt, production\dumpf119ytd_${1}.txt, data\eft_constant, data\f020_doctor_mstr*, `
  data\f020_doc_mstr_history*, data\f020_doctor_extra*, data\f050_doc_revenue_mstr*, data\f070_dept_mstr*, `
...
# CONVERSION ERROR (expected, #76): piping to cpio.
# cat $pb_data/backup_earnings_mthend${1}.ls                              \    | cpio -ocuvB                                                       \               > /charly/backup_transfer_area/backup_earnings_mthend${1}.cpio
...
echo ""
echo ""
# CONVERSION ERROR (expected, #94): cpio.
# cpio -itcvB < /charly/backup_transfer_area/backup_earnings_mthend${1}.cpio  > $pb_data/backup_earnings_mthend${1}.log
echo ""
echo ""
