...
Get-Content f086a_orig_new_pat_ids.dat | Set-Content $pb_prod\f086a_orig_new_pat_ids.dat
&$env:cmd\f086a_origdelcopy

Set-Location $Env:root\alpha\home\rma1
Get-Content f086a_orig_new_pat_ids.dat | Add-Content $pb_prod\f086a_orig_new_pat_ids.dat
&$env:cmd\f086a_origdelcopy
...
Get-ChildItem $pb_prod\f086a_orig_new_pat_ids.dat
echo ""
echo ""
