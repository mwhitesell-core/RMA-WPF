#-------------------------------------------------------------------------------
# File 'fix_doc_030_mp.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'fix_doc_030_mp'
#-------------------------------------------------------------------------------

# 2013/Jan/08 MC - fix_doc_030_mp
#  fix doctor 030 records in f110, f119, f119-history, f020 & f020-history  files
#
#--------------------------------------------------------------------------------------------
#
...
Remove-Item fix_doc_030.log *> $null

echo "Fix doctor 030 - starting - $(Get-Date -uformat '%Y-%m-%d %H:%M:%S')" > fix_doc_030.log

# Assuming to fix current f119 & f119 history files (12 passing parameters)
echo "Execute fixf110f119hist.qts ---   " >> fix_doc_030.log
...
&$env:cmd\fix_doc_1  SURPLU 201306  030   0         0           0   0        0         0  94        0         0 `
  >> fix_doc_030.log 2> fix_doc_030.log
&$env:cmd\fix_doc_1  TOTINC 201306  030  93    989907      989907   0        0         0  94   989907   1769719 `
  >> fix_doc_030.log 2> fix_doc_030.log
&$env:cmd\fix_doc_1  INCEXP 201306  030  93    989907      989907   0        0         0  94   989907   1769719 `
  >> fix_doc_030.log 2> fix_doc_030.log

&$env:cmd\fix_doc_1  INCEXP 201306  030  93    989907      989907   0        0         0  94   989907   1769719 `
  >> fix_doc_030.log 2> fix_doc_030.log
&$env:cmd\fix_doc_1  YTDEAR 201306  030  93    989907      989907   0        0         0  94   989907   1769719 `
  >> fix_doc_030.log 2> fix_doc_030.log

&$env:cmd\fix_doc_1  PAYPOT 201306  030  93    989907      989907   0        0         0  94   989907   1769719 `
  >> fix_doc_030.log 2> fix_doc_030.log
&$env:cmd\fix_doc_1  PAYEFT 201306  030  93    989907      989907   0        0         0  94   989907   1769719 `
  >> fix_doc_030.log 2> fix_doc_030.log

# CONVERSION ERROR (unexpected, #39): Unknown command.
...
#                               ,  .        ,  .        ,  .        ,  .       ,  .       ,  .     
&$env:cmd\fix_doc_2  030  201306   1769719     1769719     1769719           0     989907       989907       20 `
  >> fix_doc_030.log 2> fix_doc_030.log
#echo "Execute fixf020hist.qts ---       " >> fix_doc_030.log
...
echo "Fix doctor 030 -  ending - $(Get-Date -uformat '%Y-%m-%d %H:%M:%S')" >> fix_doc_030.log
