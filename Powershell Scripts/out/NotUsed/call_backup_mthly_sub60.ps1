#-------------------------------------------------------------------------------
# File 'call_backup_mthly_sub60.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'call_backup_mthly_sub60'
#-------------------------------------------------------------------------------
...
Get-ChildItem claims_subfile_60_${1}.sf* > subfile60.ls

# CONVERSION ERROR (expected, #78): tape device is involved.
# cat $application_production/60/subfile60.ls |cpio -ocuvB |dd of=/dev/rmt/1
