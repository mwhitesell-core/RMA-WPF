#-------------------------------------------------------------------------------
# File 'backup_earnings_monthend.bk1.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'backup_earnings_monthend.bk1'
#-------------------------------------------------------------------------------
...
Get-ChildItem production\u110_${1}.sf*, production\r111b_${1}.txt, production\u119_payeft.ps*, `
  ...
  production\r124b*_${1}.txt, production\r124c*_${1}.txt, production\r125*_${1}.txt, production\r128*_${1}.txt, `
  ...
  production\payeft_${1}.txt, production\paycode1A_ceilings_${1}.txt, data\eft_constant*, data\f020_doctor_mstr*, `
  ...
  data\f198_user_defined_totals*, data\f199_user_defined_fields* > $pb_data\backup_earnings_mthend${1}.ls
echo ""
echo "performing backup to DISK ..."
echo ""
Get-Date

# CONVERSION ERROR (expected, #91): compressing to cpio.
...
# CONVERSION ERROR (expected, #103): tape device is involved.
# cat $pb_data/backup_earnings_mthend${1}.ls   \    | cpio -ocuvB > /dev/rmt/0
echo ""
echo ""

echo "Rewinding tape ..."
# CONVERSION ERROR (expected, #109): tape device is involved.
...
echo ""
echo ""
# CONVERSION ERROR (expected, #117): tape device is involved.
...
echo "Rewinding tape ..."
# CONVERSION ERROR (expected, #128): tape device is involved.
# mt -f /dev/rmt/0 rewind
