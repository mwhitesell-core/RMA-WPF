#-------------------------------------------------------------------------------
# File 'backup_nightly_to_dyadNOTUSED.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'backup_nightly_to_dyadNOTUSED'
#-------------------------------------------------------------------------------
...
# CONVERSION ERROR (expected, #98): piping to cpio.
# cat data/nightly_to_dyad.ls  | cpio -ocuv > /dyad/backup_transfer_area/backup_nightly.cpio
echo "after cat"
