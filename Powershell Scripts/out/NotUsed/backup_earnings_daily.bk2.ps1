#-------------------------------------------------------------------------------
# File 'backup_earnings_daily.bk2.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'backup_earnings_daily.bk2'
#-------------------------------------------------------------------------------
...
Get-ChildItem eft_constant, f020_doctor_mstr*, f020_doc_mstr_history*, f020_doctor_extra*, f074_afp_group_mstr*, `
  f074_afp_group_sequence*, f075_afp_doc_mstr*, f090_constants_mstr*, f050_doc_revenue_mstr*, f095_text_lines*, `
  f110_compensation*, f110_comp_history*, f112_pycdceilings*, f112_pycd_history*, f113_default_comp*, `
  f113_def_comp_history*, f113_default_comp_upload_driver*, f114_special_payments*, f115*, f116*, f119_doctor_ytd*, `
  f119_doc_ytd_history*, f198_user_defined_totals*, f199_user_defined_fields*, f190_comp_codes*, f191_earnings_period* `
  > backup_earnings_daily${1}.ls
#               2>/dev/null             
...
# CONVERSION ERROR (expected, #85): compressing to cpio.
...
echo ""
echo ""
# CONVERSION ERROR (expected, #112): tape device is involved.
...
echo ""
Get-Content $pb_data\backup_earnings_daily${1}.ls | Measure-Object -Line | Select -ExpandProperty Lines
Get-Content $pb_data\backup_earnings_daily${1}.log | Measure-Object -Line | Select -ExpandProperty Lines

echo "Rewinding tape ..."
# CONVERSION ERROR (expected, #122): tape device is involved.
# mt -f /dev/rmt/0 rewind
