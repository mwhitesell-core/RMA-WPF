#-------------------------------------------------------------------------------
# File 'backupdata_101c_mp.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'backupdata_101c_mp'
#-------------------------------------------------------------------------------

# 2008/10/07            yas - added solo data to be ba
# 2014/08/12            MC1 - correct accordingly            
echo "backupdata"
echo ""
echo ""
...
# CONVERSION ERROR (expected, #52): tape device is involved.
# cat $pb_data/backup_101c_mp_data.ls |cpio -ocuvB > /dev/rmt/0
echo ""
Get-Date
...
# CONVERSION ERROR (expected, #58): tape device is involved.
# mt -f /dev/rmt/0 rewind
...
# CONVERSION ERROR (expected, #83): tape device is involved.
# mt -f /dev/rmt/0 rewind
