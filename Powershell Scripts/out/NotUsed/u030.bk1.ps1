...
# Original file name was 'u030.bk1'
#-------------------------------------------------------------------------------
...
if (($1 -ne 22) -and ($1 -ne 23) -and ($1 -ne 24) -and ($1 -ne 25) -and ($1 -ne 26) -and ($1 -ne 30) &&
     ($1 -ne 31) -and ($1 -ne 32) -and ($1 -ne 33) -and ($1 -ne 34) -and ($1 -ne 35) -and ($1 -ne 36) &&
     ($1 -ne 37) -and ($1 -ne 41) -and ($1 -ne 42) -and ($1 -ne 43) -and ($1 -ne 44) &&
     ($1 -ne 45) -and ($1 -ne 46) -and ($1 -ne 60) -and ($1 -ne 61) -and ($1 -ne 62) &&
     ($1 -ne 63) -and ($1 -ne 64) -and ($1 -ne 65) -and ($1 -ne 66) -and 
     ($1 -ne 68) -and ($1 -ne 69) -and ($1 -ne 71) -and ($1 -ne 72) -and ($1 -ne 73) &&
     ($1 -ne 74) -and ($1 -ne 75) -and ($1 -ne 78) -and ($1 -ne 79) &&
     ($1 -ne 80) -and ($1 -ne 82) -and ($1 -ne 84) -and ($1 -ne 86) &&
     ($1 -ne 87) -and ($1 -ne 88) -and ($1 -ne 89) -and ($1 -ne 90) &&
     ($1 -ne 91) -and ($1 -ne 92) -and ($1 -ne 93) -and ($1 -ne 94) &&
     ($1 -ne 95) -and ($1 -ne 96))
 {
...
&$env:QTP u030bb_1 $1  $1
} else {
echo "Running u030bb.qtc for clinic $1..."
&$env:QTP u030bb 22
echo "Running u030bb_1.qtc for clinic $1 ..."
&$env:QTP u030bb_1 22  22
}
