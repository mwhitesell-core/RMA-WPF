#-------------------------------------------------------------------------------
# File 'purge_f020_mp.ps1'
# Converted to PowerShell by CORE Migration on 2017-12-06 16:09:57
# Original file name was 'purge_f020_mp'
#-------------------------------------------------------------------------------
...
Remove-Item $env:pb_prod\purgef020_mp.log *> $null
...
echo "Purge f020-history -  STARTING - $(Get-Date -uformat '%Y-%m-%d %H:%M:%S')" > $env:pb_prod\purgef020_mp.log

$rcmd = $env:QTP + "purge_unlof020_history $1 $2"
Invoke-Expression $rcmd *>> $env:pb_prod\purgef020_mp.log #2> $env:pb_prod\purgef020_mp.log

#Set-Location $env:pb_data

# Move-Item -Force f020_doc_mstr_history.dat \\$Env:root\charly\purge\mp\f020_doc_mstr_history.dat
# Move-Item -Force f020_doc_mstr_history.idx \\$Env:root\charly\purge\mp\f020_doc_mstr_history.idx
...
echo "Purge f020-history - ENDING - $(Get-Date -uformat '%Y-%m-%d %H:%M:%S')" >> $env:pb_prod\purgef020_mp.log
