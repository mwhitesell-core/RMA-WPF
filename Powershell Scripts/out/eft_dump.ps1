...
Remove-Item eft_ascii.tmp  -EA SilentlyContinue
Remove-Item eft_ascii.tmp2  -EA SilentlyContinue
...
&$env:cmd/add_line_feed.awk.ps1 $env:pb_prod/eft_tape.txt $env:pb_prod/eft_ascii.tmp
...
&$env:cmd\pad_to_1464_bytes.awk.ps1  $env:pb_prod/eft_ascii.tmp $env:pb_prod/eft_ascii.tmp2
&$env:cmd\fix_eft.awk.ps1  $env:pb_prod/eft_ascii.tmp2 $env:pb_prod/efttape
