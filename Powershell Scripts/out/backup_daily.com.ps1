...
$out = $null
$rcmd = $env:QTP + "backup_earnings_daily 1 backup_daily_1"
Invoke-Expression $rcmd | Tee-Object -Variable out
$out | Set-Content $env:pb_data/backup_dailySQL.ls
...
Get-Location
Get-ChildItem -recurse \\$Env:root\alpha\home\rma* | Select -ExpandProperty FullName > $env:pb_data\rmadir.ls
echo ""
echo ""
Get-Date
...
$out = $null
$rcmd = $env:QTP + "backup_earnings_daily 1 backup_daily_2"
Invoke-Expression $rcmd | Tee-Object -Variable out
$out | Set-Content $env:pb_data/mp_data.ls
...
Get-Content data\backup_daily.ls, data\disk1dir.ls, data\disk2dir.ls, data\disk3dir.ls, data\disk4dir.ls, `
  ...
  data\kathydir.ls, 
  #data\mp_data.ls, CORE - MOVED TO SQL, WILL PREVENT 7ZIP FROM BACKING UP FILES
  data\rmadir.ls, data\webdir.ls, data\web1dir.ls, data\web2dir.ls, `
...
&"C:\Program Files\7-Zip\7z.exe" a -aoa $env:pb_data/backup_daily_complete.tar @$env:pb_data/backup_daily_complete.ls 
...
#CORE - APPEND SQL RESULTS AFTER 7ZIP HAS BACKED UP FILES AND BACKUP HAS BEEN VERIFIED
Get-Content data\backup_dailySQL.ls, data\mp_data.ls | Add-Content data\backup_daily_complete
