...
{
   Get-Content ru030a_22 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030b_22 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030c_22 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030d_22 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030e_22 | Out-Printer -Name $env:networkprinter
}
...
Move-Item -Force ru030a.txt ru030a_23
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030a_23 | Out-Printer -Name $env:networkprinter
}

Remove-Item ru030b_23
Move-Item -Force ru030b.txt ru030b_23
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030b_23 | Out-Printer -Name $env:networkprinter
}

Remove-Item ru030c_23
Move-Item -Force ru030c.txt ru030c_23
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030c_23 | Out-Printer -Name $env:networkprinter
}

Remove-Item ru030d_23
Move-Item -Force ru030d.txt ru030d_23
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030d_23 | Out-Printer -Name $env:networkprinter
}

Remove-Item ru030e_23
Move-Item -Force ru030e.txt ru030e_23
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030e_23 | Out-Printer -Name $env:networkprinter
}

Remove-Item ru030f_23
Move-Item -Force ru030f.txt ru030f_23
#lp ru030f_23
Remove-Item r997_23
Move-Item -Force r997.txt r997_23
#lp r997_23
...
Move-Item -Force ru030a.txt ru030a_24
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030a_24 | Out-Printer -Name $env:networkprinter
}

Remove-Item ru030b_24
Move-Item -Force ru030b.txt ru030b_24
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030b_24 | Out-Printer -Name $env:networkprinter
}

Remove-Item ru030c_24
Move-Item -Force ru030c.txt ru030c_24
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030c_24 | Out-Printer -Name $env:networkprinter
}

Remove-Item ru030d_24
Move-Item -Force ru030d.txt ru030d_24
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030d_24 | Out-Printer -Name $env:networkprinter
}

Remove-Item ru030e_24
Move-Item -Force ru030e.txt ru030e_24
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030e_24 | Out-Printer -Name $env:networkprinter
}

Remove-Item ru030f_24
Move-Item -Force ru030f.txt ru030f_24
#lp ru030f_24
Remove-Item r997_24
Move-Item -Force r997.txt r997_24
#lp r997_24
...
Move-Item -Force ru030a.txt ru030a_25
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030a_25 | Out-Printer -Name $env:networkprinter
}

Remove-Item ru030b_25
Move-Item -Force ru030b.txt ru030b_25
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030b_25 | Out-Printer -Name $env:networkprinter
}

Remove-Item ru030c_25
Move-Item -Force ru030c.txt ru030c_25
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030c_25 | Out-Printer -Name $env:networkprinter
}

Remove-Item ru030d_25
Move-Item -Force ru030d.txt ru030d_25
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030d_25 | Out-Printer -Name $env:networkprinter
}

Remove-Item ru030e_25
Move-Item -Force ru030e.txt ru030e_25
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030e_25 | Out-Printer -Name $env:networkprinter
}

Remove-Item ru030f_25
Move-Item -Force ru030f.txt ru030f_25
#lp ru030f_25
Remove-Item r997_25
Move-Item -Force r997.txt r997_25
#lp r997_25
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030a_26 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030b_26 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030c_26 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030d_26 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030e_26 | Out-Printer -Name $env:networkprinter
}
...
Move-Item -Force ru030a.txt ru030a_30
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030a_30 | Out-Printer -Name $env:networkprinter
}

Remove-Item ru030b_30
Move-Item -Force ru030b.txt ru030b_30
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030b_30 | Out-Printer -Name $env:networkprinter
}

Remove-Item ru030c_30
Move-Item -Force ru030c.txt ru030c_30
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030c_30 | Out-Printer -Name $env:networkprinter
}

Remove-Item ru030d_30
Move-Item -Force ru030d.txt ru030d_30
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030d_30 | Out-Printer -Name $env:networkprinter
}

Remove-Item ru030e_30
Move-Item -Force ru030e.txt ru030e_30
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030e_30 | Out-Printer -Name $env:networkprinter
}

Remove-Item ru030f_30
Move-Item -Force ru030f.txt ru030f_30
#lp ru030f_30
Remove-Item r997_30
Move-Item -Force r997.txt r997_30
#lp r997_30
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030a_31 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030b_31 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030c_31 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030d_31 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030e_31 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030a_32 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030b_32 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030c_32 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030d_32 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030e_32 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030a_33 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030b_33 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030c_33 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030d_33 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030e_33 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030a_34 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030b_34 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030c_34 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030d_34 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030e_34 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030a_35 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030b_35 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030c_35 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030d_35 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030e_35 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030a_36 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030b_36 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030c_36 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030d_36 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030e_36 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030a_41 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030b_41 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030c_41 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030d_41 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030e_41 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030a_42 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030b_42 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030c_42 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030d_42 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030e_42 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030a_43 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030b_43 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030c_43 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030d_43 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030e_43 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030a_44 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030b_44 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030c_44 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030d_44 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030e_44 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030a_45 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030b_45 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030c_45 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030d_45 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030e_45 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030a_46 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030b_46 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030c_46 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030d_46 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030e_46 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030a_48 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030b_48 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030c_48 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030d_48 | Out-Printer -Name $env:networkprinter
}
...
if ( $env:networkprinter -ne 'null'  )
{
   Get-Content ru030e_48 | Out-Printer -Name $env:networkprinter
}
