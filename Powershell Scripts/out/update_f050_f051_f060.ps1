...
$cmd = "Get-Content $pb_data\batch_update_f050_f051_f060.flg |    " + $env:QTP + "u901  >> $root\dyad\rmabill\rmabill${env:RMABILL_VERS}\production\u901.log" 
...
#  (if more transactions then rename to correct parm file and recall this macro)
   ...
   echo "Department Change 'indicator' file NOT found"
}
