...
if ($env:RMABILL_VERSION -eq "101c" -or $env:RMABILL_VERSION -eq "101cd3")
{
...
Remove-Item f086_pat_id_bkp_5.d001  -EA SilentlyContinue
...
Remove-Item f086_pat_id_bkp_5.d003  -EA SilentlyContinue
...
#$rcmd = $env:COBOL + "createpatid"
#Invoke-Expression $rcmd

New-Item -Path . -Name "f086_pat_id.dat" -ItemType "file"
