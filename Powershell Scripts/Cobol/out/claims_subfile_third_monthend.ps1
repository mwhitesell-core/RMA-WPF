...
$cmd\claims_subfile_monthend.com  3  > claims_subfile_third_monthend.log
...
Move-Item unlof002hdr_bi_sel.ps bi_f002hdr_me_3.ps
Move-Item unlof002hdr_bi_sel.psd bi_f002hdr_me_3.psd
Move-Item unlof002dtl_bi_sel.ps bi_f002dtl_me_3.ps
Move-Item unlof002dtl_bi_sel.psd bi_f002dtl_me_3.psd
