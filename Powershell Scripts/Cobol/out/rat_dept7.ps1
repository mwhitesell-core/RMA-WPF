...
quiz++ $obj\r997_portal_ss  > r997_portal_ss.log

Move-Item r997_portal_ss.txt r997_portal_ss.csv

# rename all clinic subfiles (all consolidate files) to all
Move-Item u997_good_srt.sf u997_good_srt.sf_all

# rename original 22 clinic subfile back
Move-Item u997_good_srt.sf.bkp u997_good_srt.sf
