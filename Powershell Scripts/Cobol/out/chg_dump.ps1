...
Remove-Item chg_ascii.tmp  > $null
Remove-Item chg_ascii.tmp2  > $null
...
Get-Content chg_ascii.tmp | awk++ $cmd\pad_to_1464_bytes.awk  > chg_ascii.tmp2
Get-Content chg_ascii.tmp2 | awk++ $cmd\fix_eft.awk  > eft_tape_r153_for_bank
