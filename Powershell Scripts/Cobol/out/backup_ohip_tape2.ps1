...
Get-ChildItem ru02*, u020_tapeout_file*, ohiptape, r001*, r014*, r801a.txt, r801b.txt, r801c.txt, r086.txt, r087.txt, r088*.txt, r002*, r004_c*, r010*, ru701, u02*.sf*, u035*.sf*  > backup_ohip_tape2.ls
