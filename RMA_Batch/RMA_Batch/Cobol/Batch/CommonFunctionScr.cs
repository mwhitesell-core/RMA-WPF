...
namespace rma.Cobol
{
    public class CommonFunctionScr : INotifyPropertyChanged
    {
        protected bool isBatchProcess;
        protected bool IsExitForm = false;
        ...
        protected int ws_nbr_settlement_accounts;
        ...
        public ObservableCollection<Rat_record_1> Read_U030_OHIP_RAT_TAPE_SequentialFile()
        {
            ...
            string filePath = Environment.GetEnvironmentVariable("pb_data") + "\\ohip_rat_ascii";
            if (Util.DebugUsingLocalMachine())
            {
                filePath = Directory.GetCurrentDirectory() + "\\ohip_rat_ascii";
            }
            string line = string.Empty;
            ...
            using (StreamReader file = new StreamReader(filePath))
            {
                while ((line = file.ReadLine()) != null)
                {
                    ...
                    if (recordType.Equals("1"))
                    {
                        ...
                        objRat_record_1.Rat_1_payment_date = Util.Str(line.Substring(21, 4)) + Util.Str(line.Substring(25, 2)) + Util.Str(line.Substring(27, 2));
            ...
            using (StreamReader file = new StreamReader(filePath))
            {
                while ((line = file.ReadLine()) != null)
                {
                    ...
                    if (input_type_rec.Equals("B"))   // HEB -
                    {
                        ...
                        obj.Unpriced_bathdr_clinic_1_2 = Util.NumInt(line.Substring(85, 2));
                    ...
                    else if (input_type_rec.Equals("H"))   // HEH  -
                    {
                        ...
                        obj.Unpriced_clmhdr_loc_code = line.Substring(58, 4);
                        ...
                        obj.Unpriced_clmhdr_pat_surname_2 = line.Substring(107, 30);
                        obj.Unpriced_clmhdr_given_name_2 = line.Substring(137, 30);
                    ...
                    else if (input_type_rec.Equals("T"))  // HET  --
                    {
                        ...
                        obj.Unpriced_itm1_oma_amt_billed = Util.NumDec(line.Substring(10, 6))/100;
                        ...
                        obj.Filler = line.Substring(46, 2);
                        //obj.Filler2 = line.Substring(55, 2);
                        obj.Unpriced_itm2_oma_amt_billed = Util.NumDec(line.Substring(48, 6))/100;
                        ...
                        obj.Unpriced_reserved_for_ooc2 = line.Substring(68, 9);
                        //obj.Filler3 = line.Substring(77, 6);
                        obj.Unpriced_itm2_override_price = line.Substring(77, 1);
                        obj.Unpriced_itm2_bilateral = line.Substring(78, 1);
                        //obj.Unpriced_itm3_override_price = line.Substring(87, 1);
                        //obj.Unpriced_itm4_bilateral = line.Substring(88, 1);
                        //obj.Filler4 = line.Substring(89, 23);
                    ...
                    else if (input_type_rec.Equals("E"))   // HEE --
                    {
                        ...
                        obj.Filler = line.Substring(20, 65);
                        obj.Unpriced_cr = line.Substring(85, 1);
        ...
        public ObservableCollection<Claims_keys_record> Read_Claims_Keys_SequentialFile()
        {
            ...
            using (StreamReader file = new StreamReader(filePath))
            {
                while ((line = file.ReadLine()) != null)
                {
                    ...
                    objClaims_keys_record.B_key = line;                      // todo....
        ...
        public ObservableCollection<R004_Work_file_rec> Read_R004WF_SequentialFile(bool lineFeed = true)
        {
            ...
            using (StreamReader file = new StreamReader(filePath))
            {
                if (lineFeed)
                {
                    while ((line = file.ReadLine()) != null)
                    {
                        ...
                        objR004_Work_file_rec.Wf_dept = Util.NumInt(line.Substring(0, 2));
                        objR004_Work_file_rec.Wf_doc_nbr = line.Substring(2, 3);
                        objR004_Work_file_rec.Wf_pat_surname = line.Substring(5, 6);
                        objR004_Work_file_rec.Wf_pat_acronym3 = line.Substring(11, 3);
                        objR004_Work_file_rec.Wf_claim_clinic_nbr_1_2 = Util.NumInt(line.Substring(14, 2));
                        objR004_Work_file_rec.Wf_claim_doctor_nbr = line.Substring(16, 3);
                        objR004_Work_file_rec.Wf_claim_week = Util.NumInt(line.Substring(19, 2));
                        objR004_Work_file_rec.Wf_claim_day = Util.NumInt(line.Substring(21, 1));
                        objR004_Work_file_rec.Wf_claim_nbr = Util.NumInt(line.Substring(22, 2));
                        objR004_Work_file_rec.Wf_pat_id_or_chart = line.Substring(24, 15);
                        objR004_Work_file_rec.Wf_agent_cd = Util.NumInt(line.Substring(39, 1));
                        objR004_Work_file_rec.Wf_adj_cd = line.Substring(40, 1);
                        objR004_Work_file_rec.Wf_payroll = line.Substring(41, 1);
                        objR004_Work_file_rec.Wf_claim_oma = Util.ConvertZoneToNumeric(line.Substring(42, 7));        // 05  wf-claim-oma				pic s9(5)v99.  ???                        
                        objR004_Work_file_rec.Wf_claim_ohip = Util.ConvertZoneToNumeric(line.Substring(49, 7));      // 05  wf-claim-ohip				pic s9(5)v99.                       
                        objR004_Work_file_rec.Wf_service_date_yy = Util.NumInt(line.Substring(56, 4));
                        objR004_Work_file_rec.Wf_service_date_mm = Util.NumInt(line.Substring(60, 2));
                        objR004_Work_file_rec.Wf_service_date_dd = Util.NumInt(line.Substring(62, 2));
                        objR004_Work_file_rec.Wf_claim_date_sys_yy = Util.NumInt(line.Substring(64, 4));
                        objR004_Work_file_rec.Wf_claim_date_sys_mm = Util.NumInt(line.Substring(68, 2));
                        objR004_Work_file_rec.Wf_claim_date_sys_dd = Util.NumInt(line.Substring(70, 2));
                        objR004_Work_file_rec.Wf_diag_cd = Util.NumInt(line.Substring(72, 3));
                        objR004_Work_file_rec.Wf_oma_cd = line.Substring(75, 4);
                        objR004_Work_file_rec.Wf_oma_suff = line.Substring(79, 1);
                        objR004_Work_file_rec.Wf_nbr_serv = Util.NumInt(line.Substring(80, 2));
                        objR004_Work_file_rec.Wf_orig_clinic_nbr_1_2 = Util.NumInt(line.Substring(82, 2));
                        objR004_Work_file_rec.Wf_orig_doc_nbr = line.Substring(84, 3);
                        objR004_Work_file_rec.Wf_orig_week = line.Substring(87, 2);
                        objR004_Work_file_rec.Wf_orig_day = line.Substring(89, 1);
                        objR004_Work_file_rec.Wf_orig_claim_nbr = Util.NumInt(line.Substring(90, 2));
                        objR004_Work_file_rec.Wf_ref_field = line.Substring(92, 9);
                        objR004_Work_file_rec.Wf_trans_cd = line.Substring(101, 1);
                        objR004_Work_file_rec.Wf_amt_tech_billed = Util.NumDec(line.Substring(102, 7));        // 05  wf-amt-tech-billed			pic s9(5)v99.                  
                        objR004_Work_file_rec.Wf_adj_cd_sub_type = line.Substring(109, 1);
                ...
                else
                {
                    ...
                    if (line != null)
                    {
                        ...
                        while (!eoline)
                        {
                            ...
                            objR004_Work_file_rec.Wf_amt_tech_billed = Util.NumDec(tmpLine.Substring(102, 7));        // 05  wf-amt-tech-billed			pic s9(5)v99.                  
                            objR004_Work_file_rec.Wf_adj_cd_sub_type = tmpLine.Substring(109, 1);
        ...
        public ObservableCollection<R004_Work_file_rec> Read_R004WF_After_Sorted_SequentialFile(bool lineFeed = true)
        {
            ...
            using (StreamReader file = new StreamReader(filePath))
            {
                if (lineFeed)
                {
                    while ((line = file.ReadLine()) != null)
                    {
                        ...
                        objR004_Work_file_rec.Wf_adj_cd = line.Substring(40, 1);
                        objR004_Work_file_rec.Wf_payroll = line.Substring(41, 1);
                        objR004_Work_file_rec.Wf_claim_oma = Util.NumDec(line.Substring(42, 7));
                        objR004_Work_file_rec.Wf_claim_ohip = Util.ConvertZoneToNumeric(line.Substring(49, 7));  // Util.NumDec(line.Substring(49, 7));
                        objR004_Work_file_rec.Wf_service_date_yy = Util.NumInt(line.Substring(56, 4));
                        objR004_Work_file_rec.Wf_service_date_mm = Util.NumInt(line.Substring(60, 2));
                        objR004_Work_file_rec.Wf_service_date_dd = Util.NumInt(line.Substring(62, 2));
                        objR004_Work_file_rec.Wf_claim_date_sys_yy = Util.NumInt(line.Substring(64, 4));
                        ...
                        objR004_Work_file_rec.Wf_ref_field = line.Substring(92, 9);
                        objR004_Work_file_rec.Wf_trans_cd = line.Substring(101, 1);
                        objR004_Work_file_rec.Wf_amt_tech_billed = Util.NumDec(line.Substring(102, 7));
                        objR004_Work_file_rec.Wf_adj_cd_sub_type =  line.Substring(109, 1);
                ...
                else
                {
                    ...
                    if (line != null)
                    {
                        ...
                        while (!eoline)
                        {
                            ...
                            objR004_Work_file_rec.Wf_claim_ohip = Util.ConvertZoneToNumeric(line.Substring(49, 7));
                            objR004_Work_file_rec.Wf_service_date_yy = Util.NumInt(tmpLine.Substring(56, 4));
                            objR004_Work_file_rec.Wf_service_date_mm = Util.NumInt(tmpLine.Substring(60, 2));
                            objR004_Work_file_rec.Wf_service_date_dd = Util.NumInt(tmpLine.Substring(62, 2));
                            objR004_Work_file_rec.Wf_claim_date_sys_yy = Util.NumInt(tmpLine.Substring(64, 4));
                            ...
                            objR004_Work_file_rec.Wf_ref_field = tmpLine.Substring(92, 9);
                            objR004_Work_file_rec.Wf_trans_cd = tmpLine.Substring(101, 1);
                            objR004_Work_file_rec.Wf_amt_tech_billed = Util.NumDec(tmpLine.Substring(102, 7));
                            objR004_Work_file_rec.Wf_adj_cd_sub_type = tmpLine.Substring(109, 1);
            ...
            using (StreamReader sr = new StreamReader(filePath))
            {
                if (lineFeed)
                {
                    while ((line = sr.ReadLine()) != null)
                    {
                        ...
                        //objClaims_work_rec.Wk_ohip_stat_2 = Util.NumInt(line.Substring(40, 1));
                        ...
                        //objClaims_work_rec.Wk_act_taken_2 = Util.NumInt(line.Substring(105, 8));
                ...
                else
                {
                    ...
                    if (line != null)
                    {
                        ...
                        while (!eoline)
                        {
                            ...
                            //objClaims_work_rec.Wk_ohip_stat_2 = Util.NumInt(tmpLine.Substring(40, 1));
                            ...
                            //objClaims_work_rec.Wk_act_taken_2 = Util.NumInt(tmpLine.Substring(105, 8));
            ...
            using (StreamReader sr = new StreamReader(filePath))
            {
                ...
                if (line != null)
                {
                    ...
                    while (!eoline)
                    {
                        ...
                        objParam_file_rec.Param_date_dd = Util.NumInt(tmpLine.Substring(49, 2));
                        objParam_file_rec.Filler = tmpLine.Substring(51, 1);
            ...
            using (StreamReader sr = new StreamReader(filePath))
            {
                if (lineFeed)
                {
                    while ((line = sr.ReadLine()) != null)
                    {
                        ...
                        objClaims_work_rec.Wk_ohip_stat_2 = line.Substring(40, 1);
                        objClaims_work_rec.Wk_sub_nbr = line.Substring(41, 1);
                        objClaims_work_rec.Wk_oma_fee = Util.ConvertZoneToNumeric(line.Substring(42, 8));    //  s9(6)v99
                        objClaims_work_rec.Wk_ohip_fee = Util.ConvertZoneToNumeric(line.Substring(50, 8));    //  s9(6)v99
                        objClaims_work_rec.Wk_amount_paid = Util.ConvertZoneToNumeric(line.Substring(58, 8));   //  s9(6)v99
                        objClaims_work_rec.Wk_balance_due = Util.ConvertZoneToNumeric(line.Substring(66, 8));   //  s9(6)v99
                        objClaims_work_rec.Wk_period_end_yy = Util.NumInt(line.Substring(74, 4));
                        objClaims_work_rec.Wk_period_end_mm = Util.NumInt(line.Substring(78, 2));
                        objClaims_work_rec.Wk_period_end_dd = Util.NumInt(line.Substring(80, 2));
        ...
        public ObservableCollection<Edt_1_record> Read_edt_hx_error_file()
        {
            ...
            using (StreamReader sr = new StreamReader(filePath))
            {
                while ((line = sr.ReadLine()) != null)
                {
                    ...
                    if (recordType.ToUpper().Equals("1"))  
                    {
                        ...
                        objEdt_1_record.Edt_1_process_date = Util.Str(objEdt_1_record.Edt_1_process_date_yy).PadLeft(4, '0') + Util.Str(objEdt_1_record.Edt_1_process_date_mm).PadLeft(2, '0') + Util.Str(objEdt_1_record.Edt_1_process_date_dd).PadLeft(2, '0');
                        objEdt_1_record.Edt_1_filler_2 = line.Substring(46, 33);

                        Edt_1_record_Collection.Add(objEdt_1_record);
                    }
                    else if (recordType.ToUpper().Equals("H"))
                    {
                    ...
                    else if (recordType.ToUpper().Equals("R"))
                    {
                    ...
                    else if (recordType.ToUpper().Equals("T"))
                    {
        ...
        public ObservableCollection<Input_rec> Read_u020_tapeout_file(bool lineFeed = true)
        {
            string filePath = Directory.GetCurrentDirectory() + "\\u020_tapeout_file";
            string line = string.Empty;

            ObservableCollection<Input_rec> u020_tapeout_file_Collection = new ObservableCollection<Input_rec>();
            using (StreamReader file = new StreamReader(filePath))
            {
                if (lineFeed)
                {
                    while ((line = file.ReadLine()) != null)
                    {
                        Input_rec objInput_rec = null;
                        objInput_rec = new Input_rec();
                        objInput_rec.Input_rec1 = line.PadRight(79, ' ').Substring(0, 79);
                        u020_tapeout_file_Collection.Add(objInput_rec);
                    }
                }
                else
                {
                    ...
                    if (line != null)
                    {
                        ...
                        {
                            ctr++;
                            string tmpLine = line.Substring(0, 79);
                            if (line.Trim().Length > 79)
                            {
                            ...
                            Input_rec objInput_rec = null;
                            objInput_rec = new Input_rec();
                            objInput_rec.Input_rec1 = tmpLine;
                            u020_tapeout_file_Collection.Add(objInput_rec);
                        }
                    }
                }
            }
            return u020_tapeout_file_Collection;
        }
        ...
        public ObservableCollection<Tp_pat_mstr_rec> Read_Submit_Disk_Pat_In_SequentialFile(bool lineFeed = true)
        {
            ...
            using (StreamReader file = new StreamReader(filePath))
            {
                if (lineFeed)
                {
                    while ((line = file.ReadLine()) != null)
                    {
                        if (Util.Str(line).Trim().Length == 0) break;
                        Tp_pat_mstr_rec objTp_pat_mstr_rec = null;
                        objTp_pat_mstr_rec = new Tp_pat_mstr_rec();

                        objTp_pat_mstr_rec.Tp_pat_func_code = line.Substring(0, 2).Trim();
                        objTp_pat_mstr_rec.Tp_pat_doctor_nbr = Util.NumInt(line.Substring(2, 6));
                        objTp_pat_mstr_rec.Tp_pat_account_id = line.Substring(8, 8).Trim();

                        objTp_pat_mstr_rec.Tp_pat_subscr_surname = line.Substring(16, 25).Trim();
                        objTp_pat_mstr_rec.Tp_pat_subscr_surname_6 = line.Substring(16, 6).Trim();
                        objTp_pat_mstr_rec.Tp_pat_subscr_surname_18 = line.Substring(22, 19).Trim();

                        objTp_pat_mstr_rec.Tp_pat_first_name = line.Substring(41, 24).Trim();
                        objTp_pat_mstr_rec.Tp_pat_first_name_3 = line.Substring(41, 3).Trim();
                        objTp_pat_mstr_rec.Tp_pat_first_name_21 = line.Substring(44, 21).Trim();

                        objTp_pat_mstr_rec.Tp_pat_birth_date = line.Substring(65, 8).Trim();
                        objTp_pat_mstr_rec.Tp_pat_birth_date_r = line.Substring(65, 8).Trim();
                        ...
                        objTp_pat_mstr_rec.Tp_pat_sex = line.Substring(73, 1).Trim();
                        objTp_pat_mstr_rec.Tp_pat_id_no = line.Substring(74, 9).Trim();

                        objTp_pat_mstr_rec.Tp_pat_id_no_r = line.Substring(74, 9).Trim();
                        objTp_pat_mstr_rec.Tp_pat_id_no_first_8_digits = line.Substring(74, 8).Trim();
                        ...
                        objTp_pat_mstr_rec.Tp_pat_id_no_5_digit = line.Substring(78, 1).Trim();
                        ...
                        objTp_pat_mstr_rec.Tp_pat_id_no_9_digit = line.Substring(82, 1).Trim();

                        objTp_pat_mstr_rec.Tp_pat_street_addr = line.Substring(83, 28).Trim();
                        objTp_pat_mstr_rec.Tp_pat_city = line.Substring(111, 18).Trim();
                        objTp_pat_mstr_rec.Tp_pat_prov = line.Substring(129, 4).Trim();
                        objTp_pat_mstr_rec.Tp_pat_postal_code = line.Substring(133, 9).Trim();

                        objTp_pat_mstr_rec.Tp_pat_postal_code_r = line.Substring(133, 9).Trim();
                        objTp_pat_mstr_rec.Tp_pat_postal_code_1 = line.Substring(133, 1).Trim();
                        objTp_pat_mstr_rec.Tp_pat_postal_code_2 = line.Substring(134, 1).Trim();
                        objTp_pat_mstr_rec.Tp_pat_postal_code_3 = line.Substring(135, 1).Trim();
                        objTp_pat_mstr_rec.Tp_pat_postal_code_4 = line.Substring(136, 1).Trim();
                        objTp_pat_mstr_rec.Tp_pat_postal_code_5 = line.Substring(137, 1).Trim();
                        objTp_pat_mstr_rec.Tp_pat_postal_code_6 = line.Substring(138, 1).Trim();
                        objTp_pat_mstr_rec.Filler = line.Substring(139, 3).Trim();
                        objTp_pat_mstr_rec.Tp_pat_phone_no = line.Substring(142, 20).Trim();

                        objTp_pat_mstr_rec.Tp_pat_ohip_health_no = line.Substring(162, 12).Trim();
                        objTp_pat_mstr_rec.Tp_pat_health_no = line.Substring(162, 10).Trim();
                        objTp_pat_mstr_rec.Tp_pat_ohip_filler = line.Substring(172, 2).Trim();

                        objTp_pat_mstr_rec.Tp_pat_version_cd = line.Substring(174, 2).Trim();
                        objTp_pat_mstr_rec.Tp_pat_version_cd_1 = line.Substring(174, 1).Trim();
                        objTp_pat_mstr_rec.Tp_pat_version_cd_2 = line.Substring(175, 1).Trim();

                        objTp_pat_mstr_rec.Tp_pat_relationship = line.Substring(176, 1).Trim();
                        objTp_pat_mstr_rec.Tp_pat_last_name = line.Substring(177, 25).Trim();
                        objTp_pat_mstr_rec.Tp_pat_subscr_initials = line.Substring(202, 3).Trim();
                        objTp_pat_mstr_rec.Tp_pat_agent_cd = Util.NumInt(line.Substring(205, 1));
                        objTp_pat_mstr_rec.seq_pat_doctor_nbr = line.Substring(206, 3);
                ...
                else
                {
                    ...
                    if (line != null)
                    {
                        ...
                        while (!eoline)
                        {
                            ...
                            objTp_pat_mstr_rec.Tp_pat_func_code = tmpLine.Substring(0, 2).Trim();
                            objTp_pat_mstr_rec.Tp_pat_doctor_nbr = Util.NumInt(tmpLine.Substring(2, 6));
                            objTp_pat_mstr_rec.Tp_pat_account_id = tmpLine.Substring(8, 8).Trim();

                            objTp_pat_mstr_rec.Tp_pat_subscr_surname = tmpLine.Substring(16, 25).Trim();
                            objTp_pat_mstr_rec.Tp_pat_subscr_surname_6 = tmpLine.Substring(16, 6).Trim();
                            objTp_pat_mstr_rec.Tp_pat_subscr_surname_18 = tmpLine.Substring(22, 41).Trim();

                            objTp_pat_mstr_rec.Tp_pat_first_name = tmpLine.Substring(41, 24).Trim();
                            objTp_pat_mstr_rec.Tp_pat_first_name_3 = tmpLine.Substring(41, 3).Trim();
                            objTp_pat_mstr_rec.Tp_pat_first_name_21 = tmpLine.Substring(44, 21).Trim();

                            objTp_pat_mstr_rec.Tp_pat_birth_date = tmpLine.Substring(65, 8).Trim();
                            objTp_pat_mstr_rec.Tp_pat_birth_date_r = tmpLine.Substring(65, 8).Trim();
                            ...
                            objTp_pat_mstr_rec.Tp_pat_sex = tmpLine.Substring(73, 1).Trim();
                            objTp_pat_mstr_rec.Tp_pat_id_no = tmpLine.Substring(74, 9).Trim();

                            objTp_pat_mstr_rec.Tp_pat_id_no_r = tmpLine.Substring(74, 9).Trim();
                            objTp_pat_mstr_rec.Tp_pat_id_no_first_8_digits = tmpLine.Substring(74, 8).Trim();
                            ...
                            objTp_pat_mstr_rec.Tp_pat_id_no_5_digit = tmpLine.Substring(78, 1).Trim();
                            ...
                            objTp_pat_mstr_rec.Tp_pat_id_no_9_digit = tmpLine.Substring(82, 1).Trim();

                            objTp_pat_mstr_rec.Tp_pat_street_addr = tmpLine.Substring(83, 28).Trim();
                            objTp_pat_mstr_rec.Tp_pat_city = tmpLine.Substring(111, 18).Trim();
                            objTp_pat_mstr_rec.Tp_pat_prov = tmpLine.Substring(129, 4).Trim();
                            objTp_pat_mstr_rec.Tp_pat_postal_code = tmpLine.Substring(133, 9).Trim();

                            objTp_pat_mstr_rec.Tp_pat_postal_code_r = tmpLine.Substring(133, 9).Trim();
                            objTp_pat_mstr_rec.Tp_pat_postal_code_1 = tmpLine.Substring(133, 1).Trim();
                            objTp_pat_mstr_rec.Tp_pat_postal_code_2 = tmpLine.Substring(134, 1).Trim();
                            objTp_pat_mstr_rec.Tp_pat_postal_code_3 = tmpLine.Substring(135, 1).Trim();
                            objTp_pat_mstr_rec.Tp_pat_postal_code_4 = tmpLine.Substring(136, 1).Trim();
                            objTp_pat_mstr_rec.Tp_pat_postal_code_5 = tmpLine.Substring(137, 1).Trim();
                            objTp_pat_mstr_rec.Tp_pat_postal_code_6 = tmpLine.Substring(138, 1).Trim();
                            objTp_pat_mstr_rec.Filler = line.Substring(139, 3).Trim();
                            objTp_pat_mstr_rec.Tp_pat_phone_no = tmpLine.Substring(142, 20).Trim();

                            objTp_pat_mstr_rec.Tp_pat_ohip_health_no = tmpLine.Substring(162, 12).Trim();
                            objTp_pat_mstr_rec.Tp_pat_health_no = tmpLine.Substring(162, 10).Trim();
                            objTp_pat_mstr_rec.Tp_pat_ohip_filler = tmpLine.Substring(172, 2).Trim();

                            objTp_pat_mstr_rec.Tp_pat_version_cd = tmpLine.Substring(174, 2).Trim();
                            objTp_pat_mstr_rec.Tp_pat_version_cd_1 = tmpLine.Substring(174, 1).Trim();
                            objTp_pat_mstr_rec.Tp_pat_version_cd_2 = tmpLine.Substring(175, 1).Trim();

                            objTp_pat_mstr_rec.Tp_pat_relationship = tmpLine.Substring(176, 1).Trim();
                            objTp_pat_mstr_rec.Tp_pat_last_name = tmpLine.Substring(177, 25).Trim();
                            objTp_pat_mstr_rec.Tp_pat_subscr_initials = tmpLine.Substring(202, 3).Trim();
        ...
        public ObservableCollection<Tp_pat_mstr_rec1> Read_meditech_patient_file_u011_SequentialFile(bool lineFeed = true)
        {
            string filePath = Directory.GetCurrentDirectory() + "\\meditech_patient_file.u011";
            string line = string.Empty;

            ObservableCollection<Tp_pat_mstr_rec1> Tp_pat_mster_rec_Collection = new ObservableCollection<Tp_pat_mstr_rec1>();
            int row = 0;
            ...
            using (StreamReader file = new StreamReader(filePath))
            {
                if (lineFeed)
                {
                    ...
                    {
                        if (Util.Str(line).Trim().Length == 0) break;
                        Tp_pat_mstr_rec1 objTp_pat_mstr_rec = null;
                        objTp_pat_mstr_rec = new Tp_pat_mstr_rec1();

                        line = line.PadRight(204);
                        row++;

                        //05  tp-pat-func-code                pic xx.
                        objTp_pat_mstr_rec.tp_pat_func_code = line.Substring(0, 2);
                        //05  tp-pat-last-name.
                        objTp_pat_mstr_rec.tp_pat_last_name = line.Substring(2, 24);
                        //    10  tp-pat-last-name-6          pic x(6).
                        objTp_pat_mstr_rec.tp_pat_last_name_6 = line.Substring(2, 6);
                        //    10  tp-pat-last-name-18         pic x(18).
                        objTp_pat_mstr_rec.tp_pat_last_name_18 = line.Substring(8, 18);
                        //05  tp-pat-first-name.
                        objTp_pat_mstr_rec.tp_pat_first_name = line.Substring(26, 24);
                        //    10  tp-pat-first-name-3         pic x(3).
                        objTp_pat_mstr_rec.tp_pat_first_name_3 = line.Substring(26, 3);
                        //    10  tp-pat-first-name-21        pic x(21).
                        objTp_pat_mstr_rec.tp_pat_first_name_21 = line.Substring(29, 21);
                        //05  tp-pat-birth-date               pic x(10).
                        objTp_pat_mstr_rec.tp_pat_birth_date = line.Substring(50, 10);
                        //05  tp-pat-birth-date-r   redefines tp-pat-birth-date.
                        objTp_pat_mstr_rec.tp_pat_birth_date_r = objTp_pat_mstr_rec.tp_pat_birth_date;
                        //    10  tp-pat-birth-yy             pic 9(4).
                        objTp_pat_mstr_rec.tp_pat_birth_yy = Util.NumInt(line.Substring(50, 4));
                        //    10  tp-pat-birth-yy-r redefines tp-pat-birth-yy.
                        objTp_pat_mstr_rec.tp_pat_birth_yy_r =  Util.Str(objTp_pat_mstr_rec.tp_pat_birth_yy.ToString());
                        //        15 tp-pat-birth-yy-first-2  pic 9(2).
                        objTp_pat_mstr_rec.tp_pat_birth_yy_first_2 = Util.NumInt(Util.Str(objTp_pat_mstr_rec.tp_pat_birth_yy_r).PadLeft(4,'0').Substring(0, 2));
                        //        15 tp-pat-birth-yy-last-2   pic 9(2).
                        objTp_pat_mstr_rec.tp_pat_birth_yy_last_2 = Util.NumInt(Util.Str(objTp_pat_mstr_rec.tp_pat_birth_yy_r).PadLeft(4,'0').Substring(2, 2));
                        //    10  tp-pat-slash1               pic x.
                        objTp_pat_mstr_rec.tp_pat_slash1 = Util.Str(objTp_pat_mstr_rec.tp_pat_birth_date_r).PadRight(10).Substring(4, 1);
                        //    10  tp-pat-birth-mm             pic 99.
                        objTp_pat_mstr_rec.tp_pat_birth_mm = Util.NumInt(Util.Str(objTp_pat_mstr_rec.tp_pat_birth_date_r).PadRight(10).Substring(5, 2).PadLeft(2,'0'));
                        //    10  tp-pat-slash2               pic x.
                        objTp_pat_mstr_rec.tp_pat_slash2 = Util.Str(objTp_pat_mstr_rec.tp_pat_birth_date_r).PadRight(10).Substring(7, 1);
                        //    10  tp-pat-birth-dd             pic 99.
                        objTp_pat_mstr_rec.tp_pat_birth_dd = Util.NumInt(Util.Str(objTp_pat_mstr_rec.tp_pat_birth_date_r).PadRight(10).Substring(8, 2).PadLeft(2,'0'));
                        //05  tp-pat-sex                      pic x.
                        objTp_pat_mstr_rec.tp_pat_sex = line.Substring(60, 1);

                        //05  tp-pat-id-no                    pic x(15).
                        objTp_pat_mstr_rec.tp_pat_id_no = line.Substring(61, 15);
                        //05  tp-pat-id-no-r        redefines tp-pat-id-no.
                        objTp_pat_mstr_rec.tp_pat_id_no_r = objTp_pat_mstr_rec.tp_pat_id_no;
                        //    10  tp-pat-id-no-first-8-digits.
                        objTp_pat_mstr_rec.tp_pat_id_no_first_8_digits = objTp_pat_mstr_rec.tp_pat_id_no_r;
                        //        15  tp-pat-id-no-site       pic x.
                        objTp_pat_mstr_rec.tp_pat_id_no_site = objTp_pat_mstr_rec.tp_pat_id_no_first_8_digits.Substring(0, 1);
                        //        15  tp-pat-id-no-yy         pic 99.
                        objTp_pat_mstr_rec.tp_pat_id_no_yy = Util.NumInt(objTp_pat_mstr_rec.tp_pat_id_no_first_8_digits.Substring(1, 2).PadLeft(2,'0'));
                        //        15  tp-pat-id-no-mm         pic 99.
                        objTp_pat_mstr_rec.tp_pat_id_no_mm = Util.NumInt(Util.Str(objTp_pat_mstr_rec.tp_pat_id_no_first_8_digits).Substring(3, 2).PadLeft(2,'0'));
                        //        15  tp-pat-id-no-5-digit    pic x.
                        objTp_pat_mstr_rec.tp_pat_id_no_5_digit = Util.Str(objTp_pat_mstr_rec.tp_pat_id_no_first_8_digits).Substring(5, 1);
                        //        15  tp-pat-id-no-6-7-digit  pic 9(2).
                        objTp_pat_mstr_rec.tp_pat_id_no_6_7_digit = Util.NumInt(Util.Str(objTp_pat_mstr_rec.tp_pat_id_no_first_8_digits).Substring(6, 2).PadLeft(2, '0'));

                        //        15  tp-pat-id-no-8-digit    pic 9.
                        objTp_pat_mstr_rec.tp_pat_id_no_8_digit = Util.NumInt(Util.Str(objTp_pat_mstr_rec.tp_pat_id_no_first_8_digits).Substring(8, 1));
                        //        15  tp-pat-id-no-reminder   pic x(5).
                        objTp_pat_mstr_rec.tp_pat_id_no_reminder = Util.Str(objTp_pat_mstr_rec.tp_pat_id_no_first_8_digits).Substring(9, 5);
                        //    10  tp-pat-id-no-last-digit     pic x.
                        objTp_pat_mstr_rec.tp_pat_id_no_last_digit = Util.Str(objTp_pat_mstr_rec.tp_pat_id_no_first_8_digits).Substring(14, 1);

                        //05  tp-pat-id-no-r2         redefines tp-pat-id-no.
                        objTp_pat_mstr_rec.tp_pat_id_no_r2 = objTp_pat_mstr_rec.tp_pat_id_no;
                        //    10  tp-pat-id-no-pos-1          pic x.
                        objTp_pat_mstr_rec.tp_pat_id_no_pos_1 = Util.Str(objTp_pat_mstr_rec.tp_pat_id_no_r2).Substring(0, 1);
                        //    10  tp-pat-id-no-pos-2-10.
                        objTp_pat_mstr_rec.tp_pat_id_no_pos_2_10 = Util.Str(objTp_pat_mstr_rec.tp_pat_id_no_r2).Substring(1, 9);
                        //        15  tp-pat-id-no-pos-2-4    pic 9(3).
                        objTp_pat_mstr_rec.tp_pat_id_no_pos_2_4 = Util.NumInt(Util.Str(objTp_pat_mstr_rec.tp_pat_id_no_pos_2_10).Substring(0, 3));
                        //        15  tp-pat-id-no-pos-5-10   pic 9(6).
                        objTp_pat_mstr_rec.tp_pat_id_no_pos_5_10 = Util.NumInt(Util.Str(objTp_pat_mstr_rec.tp_pat_id_no_pos_2_10).Substring(3, 6));
                        //    10  tp-pat-id-no-pos-11         pic x(1).
                        objTp_pat_mstr_rec.tp_pat_id_no_pos_11 = Util.Str(objTp_pat_mstr_rec.tp_pat_id_no_r2).Substring(10, 1);
                        //    10  tp-pat-id-no-pos-12-15      pic x(4).
                        objTp_pat_mstr_rec.tp_pat_id_no_pos_12_15 = Util.Str(objTp_pat_mstr_rec.tp_pat_id_no_r2).Substring(11, 4);

                        //05  tp-pat-street-addr              pic x(28).
                        objTp_pat_mstr_rec.tp_pat_street_addr = line.Substring(76, 28);
                        //05  tp-pat-street-addr2             pic x(28).
                        objTp_pat_mstr_rec.tp_pat_street_addr2 = line.Substring(104, 28);
                        //05  tp-pat-city                     pic x(18).
                        objTp_pat_mstr_rec.tp_pat_city = line.Substring(132, 18);
                        //05  tp-pat-prov                     pic x(2).
                        objTp_pat_mstr_rec.tp_pat_prov = line.Substring(150, 2);
                        //05  tp-pat-postal-code              pic x(6).
                        objTp_pat_mstr_rec.tp_pat_postal_code = line.Substring(152, 6);
                        //05  tp-pat-postal-code-r     redefines tp-pat-postal-code.
                        objTp_pat_mstr_rec.tp_pat_postal_code_r = objTp_pat_mstr_rec.tp_pat_postal_code;
                        //    10  tp-pat-postal-code-1        pic x.
                        objTp_pat_mstr_rec.tp_pat_postal_code_1 = Util.Str(objTp_pat_mstr_rec.tp_pat_postal_code_r).Substring(0, 1);
                        //    10  tp-pat-postal-code-2        pic x.
                        objTp_pat_mstr_rec.tp_pat_postal_code_2 = Util.Str(objTp_pat_mstr_rec.tp_pat_postal_code_r).Substring(1, 1);
                        //    10  tp-pat-postal-code-3        pic x.
                        objTp_pat_mstr_rec.tp_pat_postal_code_3 = Util.Str(objTp_pat_mstr_rec.tp_pat_postal_code_r).Substring(2, 1);
                        //    10  tp-pat-postal-code-4        pic x.
                        objTp_pat_mstr_rec.tp_pat_postal_code_4 = Util.Str(objTp_pat_mstr_rec.tp_pat_postal_code_r).Substring(3, 1);
                        //    10  tp-pat-postal-code-5        pic x.
                        objTp_pat_mstr_rec.tp_pat_postal_code_5 = Util.Str(objTp_pat_mstr_rec.tp_pat_postal_code_r).Substring(4, 1);
                        //    10  tp-pat-postal-code-6        pic x.
                        objTp_pat_mstr_rec.tp_pat_postal_code_6 = Util.Str(objTp_pat_mstr_rec.tp_pat_postal_code_r).Substring(5, 1);

                        //05  tp-pat-phone-no                 pic x(20).
                        objTp_pat_mstr_rec.tp_pat_phone_no = line.Substring(158, 20);
                        //05  tp-pat-ohip-no                  pic x(8).
                        objTp_pat_mstr_rec.tp_pat_ohip_no = line.Substring(178, 8);
                        //05  tp-pat-health-nbr               pic x(10).
                        objTp_pat_mstr_rec.tp_pat_health_nbr = line.Substring(186, 10);
                        //05  tp-pat-version-cd.
                        objTp_pat_mstr_rec.tp_pat_version_cd = line.Substring(196, 3);
                        //    10  tp-pat-version-cd-1         pic x.
                        objTp_pat_mstr_rec.tp_pat_version_cd_1 = Util.Str(objTp_pat_mstr_rec.tp_pat_version_cd).Substring(0, 1);
                        //    10  tp-pat-version-cd-2         pic x.
                        objTp_pat_mstr_rec.tp_pat_version_cd_2 = Util.Str(objTp_pat_mstr_rec.tp_pat_version_cd).Substring(1, 1);
                        //05  tp-pat-health-65-ind            pic x.
                        objTp_pat_mstr_rec.tp_pat_health_65_ind = Util.Str(objTp_pat_mstr_rec.tp_pat_version_cd).Substring(2, 1);
                        //05  tp-pat-expiry-date.
                        objTp_pat_mstr_rec.tp_pat_expiry_date = line.Substring(199, 4);
                        //    10  tp-pat-expiry-yy            pic 99.
                        objTp_pat_mstr_rec.tp_pat_expiry_yy = Util.NumInt(Util.Str(objTp_pat_mstr_rec.tp_pat_expiry_date).Substring(0,2).PadLeft(2, '0'));
                        //    10  tp-pat-expiry-mm            pic 99.
                        objTp_pat_mstr_rec.tp_pat_expiry_mm = Util.NumInt(Util.Str(objTp_pat_mstr_rec.tp_pat_expiry_date).Substring(2,2).PadLeft(2, '0'));
                        //05  filler                          pic x.
                        objTp_pat_mstr_rec.filler = line.Substring(203, 1);
                        Tp_pat_mster_rec_Collection.Add(objTp_pat_mstr_rec);
                    }
                }
                else
                {
                    ...
                    if (line != null)
                    {
                        ...
                        while(!eoline)
                        {
                            string tmpLine = line.Substring(0, 204);
                            if (line.Trim().Length > 204)
                            {
                                line = line.Substring(204);
                            }
                            else
                            {
                                eoline = true;
                            ...
                            //05  tp-pat-last-name.
                            objTp_pat_mstr_rec.tp_pat_last_name = tmpLine.Substring(2, 24);
                            //    10  tp-pat-last-name-6          pic x(6).
                            objTp_pat_mstr_rec.tp_pat_last_name_6 = tmpLine.Substring(2, 6);
                            //    10  tp-pat-last-name-18         pic x(18).
                            objTp_pat_mstr_rec.tp_pat_last_name_18 = tmpLine.Substring(8, 18);
                            //05  tp-pat-first-name.
                            objTp_pat_mstr_rec.tp_pat_first_name = tmpLine.Substring(26, 24);
                            //    10  tp-pat-first-name-3         pic x(3).
                            objTp_pat_mstr_rec.tp_pat_first_name_3 = tmpLine.Substring(26, 3);
                            //    10  tp-pat-first-name-21        pic x(21).
                            objTp_pat_mstr_rec.tp_pat_first_name_21 = tmpLine.Substring(29, 21);
                            //05  tp-pat-birth-date               pic x(10).
                            objTp_pat_mstr_rec.tp_pat_birth_date = tmpLine.Substring(50, 10);
                            //05  tp-pat-birth-date-r   redefines tp-pat-birth-date.
                            objTp_pat_mstr_rec.tp_pat_birth_date_r = objTp_pat_mstr_rec.tp_pat_birth_date;
                            //    10  tp-pat-birth-yy             pic 9(4).
                            objTp_pat_mstr_rec.tp_pat_birth_yy = Util.NumInt(tmpLine.Substring(60, 4));
                            //    10  tp-pat-birth-yy-r redefines tp-pat-birth-yy.
                            objTp_pat_mstr_rec.tp_pat_birth_yy_r = Util.Str(objTp_pat_mstr_rec.tp_pat_birth_yy.ToString());
                            //        15 tp-pat-birth-yy-first-2  pic 9(2).
                            objTp_pat_mstr_rec.tp_pat_birth_yy_first_2 = Util.NumInt(Util.Str(objTp_pat_mstr_rec.tp_pat_birth_yy_r).Substring(0, 2));
                            //        15 tp-pat-birth-yy-last-2   pic 9(2).
                            objTp_pat_mstr_rec.tp_pat_birth_yy_last_2 = Util.NumInt(Util.Str(objTp_pat_mstr_rec.tp_pat_birth_yy_r).Substring(2, 2));
                            //    10  tp-pat-slash1               pic x.
                            objTp_pat_mstr_rec.tp_pat_slash1 = Util.Str(objTp_pat_mstr_rec.tp_pat_birth_date_r).Substring(4, 1);
                            //    10  tp-pat-birth-mm             pic 99.
                            objTp_pat_mstr_rec.tp_pat_birth_mm = Util.NumInt(Util.Str(objTp_pat_mstr_rec.tp_pat_birth_date_r).Substring(5, 2).PadLeft(2, '0'));
                            //    10  tp-pat-slash2               pic x.
                            objTp_pat_mstr_rec.tp_pat_slash2 = Util.Str(objTp_pat_mstr_rec.tp_pat_birth_date_r).Substring(7, 1);
                            //    10  tp-pat-birth-dd             pic 99.
                            objTp_pat_mstr_rec.tp_pat_birth_dd = Util.NumInt(Util.Str(objTp_pat_mstr_rec.tp_pat_birth_date_r).Substring(8, 2).PadLeft(2, '0'));
                            //05  tp-pat-sex                      pic x.
                            objTp_pat_mstr_rec.tp_pat_sex = tmpLine.Substring(60, 1);

                            //05  tp-pat-id-no                    pic x(15).
                            objTp_pat_mstr_rec.tp_pat_id_no = tmpLine.Substring(61, 15);
                            //05  tp-pat-id-no-r        redefines tp-pat-id-no.
                            objTp_pat_mstr_rec.tp_pat_id_no_r = objTp_pat_mstr_rec.tp_pat_id_no;
                            //    10  tp-pat-id-no-first-8-digits.
                            objTp_pat_mstr_rec.tp_pat_id_no_first_8_digits = objTp_pat_mstr_rec.tp_pat_id_no_r;
                            ...
                            objTp_pat_mstr_rec.tp_pat_id_no_pos_5_10 = Util.NumInt(Util.Str(objTp_pat_mstr_rec.tp_pat_id_no_pos_2_10).Substring(3, 6));
                            //    10  tp-pat-id-no-pos-11         pic x(1).
                            objTp_pat_mstr_rec.tp_pat_id_no_pos_11 = Util.Str(objTp_pat_mstr_rec.tp_pat_id_no_r2).Substring(9, 1);
                            //    10  tp-pat-id-no-pos-12-15      pic x(4).
                            objTp_pat_mstr_rec.tp_pat_id_no_pos_12_15 = Util.Str(objTp_pat_mstr_rec.tp_pat_id_no_r2).Substring(10, 4);

                            //05  tp-pat-street-addr              pic x(28).
                            objTp_pat_mstr_rec.tp_pat_street_addr = tmpLine.Substring(76, 28);
                            //05  tp-pat-street-addr2             pic x(28).
                            objTp_pat_mstr_rec.tp_pat_street_addr2 = tmpLine.Substring(104, 28);
                            //05  tp-pat-city                     pic x(18).
                            objTp_pat_mstr_rec.tp_pat_city = tmpLine.Substring(132, 18);
                            //05  tp-pat-prov                     pic x(2).
                            objTp_pat_mstr_rec.tp_pat_prov = tmpLine.Substring(150, 2);
                            //05  tp-pat-postal-code              pic x(6).
                            objTp_pat_mstr_rec.tp_pat_postal_code = tmpLine.Substring(152, 6);
                            //05  tp-pat-postal-code-r     redefines tp-pat-postal-code.
                            objTp_pat_mstr_rec.tp_pat_postal_code_r = objTp_pat_mstr_rec.tp_pat_postal_code;
                            //    10  tp-pat-postal-code-1        pic x.
                            objTp_pat_mstr_rec.tp_pat_postal_code_1 = Util.Str(objTp_pat_mstr_rec.tp_pat_postal_code_r).Substring(0, 1);
                            ...
                            //05  tp-pat-phone-no                 pic x(20).
                            objTp_pat_mstr_rec.tp_pat_phone_no = tmpLine.Substring(158, 20);
                            //05  tp-pat-ohip-no                  pic x(8).
                            objTp_pat_mstr_rec.tp_pat_ohip_no = tmpLine.Substring(178, 8);
                            //05  tp-pat-health-nbr               pic x(10).
                            objTp_pat_mstr_rec.tp_pat_health_nbr = tmpLine.Substring(186, 10);
                            //05  tp-pat-version-cd.
                            objTp_pat_mstr_rec.tp_pat_version_cd = tmpLine.Substring(196, 3);
                            //    10  tp-pat-version-cd-1         pic x.
                            objTp_pat_mstr_rec.tp_pat_version_cd_1 = Util.Str(objTp_pat_mstr_rec.tp_pat_version_cd).Substring(0, 1);
                            //    10  tp-pat-version-cd-2         pic x.
                            objTp_pat_mstr_rec.tp_pat_version_cd_2 = Util.Str(objTp_pat_mstr_rec.tp_pat_version_cd).Substring(1, 1);
                            ...
                            objTp_pat_mstr_rec.tp_pat_health_65_ind = Util.Str(objTp_pat_mstr_rec.tp_pat_version_cd).Substring(2, 1);
                            //05  tp-pat-expiry-date.
                            objTp_pat_mstr_rec.tp_pat_expiry_date = tmpLine.Substring(199, 4);
                            //    10  tp-pat-expiry-yy            pic 99.
                            objTp_pat_mstr_rec.tp_pat_expiry_yy = Util.NumInt(Util.Str(objTp_pat_mstr_rec.tp_pat_expiry_date).Substring(0, 2).PadLeft(2, '0'));
                            //    10  tp-pat-expiry-mm            pic 99.
                            objTp_pat_mstr_rec.tp_pat_expiry_mm = Util.NumInt(Util.Str(objTp_pat_mstr_rec.tp_pat_expiry_date).Substring(2, 2).PadLeft(2, '0'));
                            //05  filler                          pic x.
                            objTp_pat_mstr_rec.filler = tmpLine.Substring(203, 1);
                            Tp_pat_mster_rec_Collection.Add(objTp_pat_mstr_rec);
                        }
                    }
            ...
            return Tp_pat_mster_rec_Collection;
        }

        public ObservableCollection<Ohip_Benefit_Sched_Rec> Read_Ohip_Benefit_Sched_Tape()
        {
            string filePath = Directory.GetCurrentDirectory() + "\\fee_schedule_ohip_ascii.dat";
            string line = string.Empty;

            ObservableCollection<Ohip_Benefit_Sched_Rec> Ohip_Benefit_Sched_Rec_Collection = new ObservableCollection<Ohip_Benefit_Sched_Rec>();
            
            using (StreamReader file = new StreamReader(filePath))
            {
                while((line = file.ReadLine()) != null)
                {
                    Ohip_Benefit_Sched_Rec objOhip_Benefit_Sched_Rec = null;
                    objOhip_Benefit_Sched_Rec = new Ohip_Benefit_Sched_Rec();

                    objOhip_Benefit_Sched_Rec.ohip_code_grp = line.Substring(0, 4).Trim();
                    objOhip_Benefit_Sched_Rec.ohip_code_ltr = line.Substring(0, 1);
                    objOhip_Benefit_Sched_Rec.ohip_code_nbr = Util.NumInt(line.Substring(1, 3));
                    
                    objOhip_Benefit_Sched_Rec.ohip_effective_yr = Util.NumInt(line.Substring(4, 4));
                    objOhip_Benefit_Sched_Rec.ohip_effective_mth = Util.NumInt(line.Substring(8, 2));
                    objOhip_Benefit_Sched_Rec.ohip_effective_day = Util.NumInt(line.Substring(10, 2));
                    objOhip_Benefit_Sched_Rec.ohip_effective_date_grp = Util.Str(objOhip_Benefit_Sched_Rec.ohip_effective_yr) + Util.Str(objOhip_Benefit_Sched_Rec.ohip_effective_mth).PadLeft(2, '0') + Util.Str(objOhip_Benefit_Sched_Rec.ohip_effective_day).PadLeft(2, '0');
                    
                    objOhip_Benefit_Sched_Rec.ohip_termination_yr = Util.NumInt(line.Substring(12, 4));
                    objOhip_Benefit_Sched_Rec.ohip_termination_mth = Util.NumInt(line.Substring(16, 2));
                    objOhip_Benefit_Sched_Rec.ohip_termination_day = Util.NumInt(line.Substring(18, 2));
                    objOhip_Benefit_Sched_Rec.ohip_termination_date_grp = Util.Str(objOhip_Benefit_Sched_Rec.ohip_termination_yr) + Util.Str(objOhip_Benefit_Sched_Rec.ohip_termination_mth).PadLeft(2, '0') + Util.Str(objOhip_Benefit_Sched_Rec.ohip_termination_day).PadLeft(2, '0');

                    objOhip_Benefit_Sched_Rec.ohip_fees[1] = Util.NumDec(line.Substring(20, 11));
                    objOhip_Benefit_Sched_Rec.ohip_fees[2] = Util.NumDec(line.Substring(31, 11));
                    objOhip_Benefit_Sched_Rec.ohip_fees[3] = Util.NumDec(line.Substring(42, 11));
                    objOhip_Benefit_Sched_Rec.ohip_fees[4] = Util.NumDec(line.Substring(53, 11));
                    objOhip_Benefit_Sched_Rec.ohip_fees[5] = Util.NumDec(line.Substring(64, 11));

                    Ohip_Benefit_Sched_Rec_Collection.Add(objOhip_Benefit_Sched_Rec);
                }
            }
            return Ohip_Benefit_Sched_Rec_Collection;
        }
        ...
        public int CONST_CLINIC_NBR_1_2(CONSTANTS_MSTR_REC_1 obj, int col)
        {
            ...
            switch (col)
            {
                ...
                case 40:
                    ...
                    break;
                case 41:
                    retVal = Util.NumInt(obj.FILLER.Substring(0, 2));
                    break;
                case 42:
                    retVal = Util.NumInt(obj.FILLER.Substring(6, 2));
                    break;
                case 43:
                    retVal = Util.NumInt(obj.FILLER.Substring(12, 2));
                    break;
                case 44:
                    retVal = Util.NumInt(obj.FILLER.Substring(18, 2));
                    break;
                case 45:
                    retVal = Util.NumInt(obj.FILLER.Substring(24, 2));
                    break;
                case 46:
                    retVal = Util.NumInt(obj.FILLER.Substring(30, 2));
                    break;
                case 47:
                    retVal = Util.NumInt(obj.FILLER.Substring(36, 2));
                    break;
                case 48:
                    retVal = Util.NumInt(obj.FILLER.Substring(42, 2));
                    break;
                case 49:
                    retVal = Util.NumInt(obj.FILLER.Substring(48, 2));
                    break;
                case 50:
                    retVal = Util.NumInt(obj.FILLER.Substring(54, 2));
                    break;
                case 51:
                    retVal = Util.NumInt(obj.FILLER.Substring(60, 2));
                    break;
                case 52:
                    retVal = Util.NumInt(obj.FILLER.Substring(66, 2));
                    break;
                case 53:
                    retVal = Util.NumInt(obj.FILLER.Substring(72, 2));
                    break;
                case 54:
                    retVal = Util.NumInt(obj.FILLER.Substring(78, 2));
                    break;
                case 55:
                    retVal = Util.NumInt(obj.FILLER.Substring(84, 2));
                    break;
                case 56:
                    retVal = Util.NumInt(obj.FILLER.Substring(90, 2));
                    break;
                case 57:
                    retVal = Util.NumInt(obj.FILLER.Substring(96, 2));
                    break;
                case 58:
                    retVal = Util.NumInt(obj.FILLER.Substring(102, 2));
                    break;
                case 59:
                    retVal = Util.NumInt(obj.FILLER.Substring(108, 2));
                    break;
                case 60:
                    retVal = Util.NumInt(obj.FILLER.Substring(114, 2));
                    break;
                case 61:
                    retVal = Util.NumInt(obj.FILLER.Substring(120, 2));
                    break;
                case 62:
                    retVal = Util.NumInt(obj.FILLER.Substring(126, 2));
                    break;
                case 63:
                    retVal = Util.NumInt(obj.FILLER.Substring(132, 2));
                    break;
                case 64:
                    retVal = Util.NumInt(obj.FILLER.Substring(138, 2));
                    break;
                case 65:
                    retVal = Util.NumInt(obj.FILLER.Substring(144, 2));
                    break;
                case 66:
                    retVal = Util.NumInt(obj.FILLER.Substring(150, 2));
                    break;
                case 67:
                    retVal = Util.NumInt(obj.FILLER.Substring(156, 2));
                    break;
                case 68:
                    retVal = Util.NumInt(obj.FILLER.Substring(162, 2));
                    break;
                case 69:
                    retVal = Util.NumInt(obj.FILLER.Substring(168, 2));
                    break;
                case 70:
                    retVal = Util.NumInt(obj.FILLER.Substring(174, 2));
                    break;
                case 71:
                    retVal = Util.NumInt(obj.FILLER.Substring(180, 2));
                    break;
                case 72:
                    retVal = Util.NumInt(obj.FILLER.Substring(186, 2));
                    break;
                case 73:
                    retVal = Util.NumInt(obj.FILLER.Substring(192, 2));
                    break;
                case 74:
                    retVal = Util.NumInt(obj.FILLER.Substring(198, 2));
                    break;
                case 75:
                    retVal = Util.NumInt(obj.FILLER.Substring(204, 2));
                    break;
                case 76:
                    retVal = Util.NumInt(obj.FILLER.Substring(210, 2));
                    break;
                case 77:
                    retVal = Util.NumInt(obj.FILLER.Substring(216, 2));
                    break;
                case 78:
                    retVal = Util.NumInt(obj.FILLER.Substring(222, 2));
                    break;
                case 79:
                    retVal = Util.NumInt(obj.FILLER.Substring(228, 2));
                    break;
                case 80:
                    retVal = Util.NumInt(obj.FILLER.Substring(234, 2));
                    break;
                case 81:
                    retVal = Util.NumInt(obj.FILLER.Substring(240, 2));
                    break;
                case 82:
                    retVal = Util.NumInt(obj.FILLER.Substring(246, 2));
                    break;
                case 83:
                    retVal = Util.NumInt(obj.FILLER.Substring(252, 2));
                    break;
                case 84:
                    retVal = Util.NumInt(obj.FILLER.Substring(258, 2));
                    break;
                case 85:
                    retVal = Util.NumInt(obj.FILLER.Substring(264, 2));
                    break;
                case 86:
                    retVal = Util.NumInt(obj.FILLER.Substring(270, 2));
                    break;
                case 87:
                    retVal = Util.NumInt(obj.FILLER.Substring(276, 2));
                    break;
                case 88:
                    retVal = Util.NumInt(obj.FILLER.Substring(282, 2));
                    break;
                case 89:
                    retVal = Util.NumInt(obj.FILLER.Substring(288, 2));
                    break;
                case 90:
                    retVal = Util.NumInt(obj.FILLER.Substring(294, 2));
                    break;
                case 91:
                    retVal = Util.NumInt(obj.FILLER.Substring(300, 2));
                    break;
                case 92:
                    retVal = Util.NumInt(obj.FILLER.Substring(306, 2));
                    break;
                case 93:
                    retVal = Util.NumInt(obj.FILLER.Substring(312, 2));
                    break;
                case 94:
                    retVal = Util.NumInt(obj.FILLER.Substring(318, 2));
                    break;
                case 95:
                    retVal = Util.NumInt(obj.FILLER.Substring(324, 2));
                    break;
                case 96:
                    retVal = Util.NumInt(obj.FILLER.Substring(330, 2));
                    break;
                case 97:
                    retVal = Util.NumInt(obj.FILLER.Substring(336, 2));
                    break;
                case 98:
                    retVal = Util.NumInt(obj.FILLER.Substring(342, 2));
                    break;
                case 99:
                    retVal = Util.NumInt(obj.FILLER.Substring(348, 2));
                    break;
            }
            return retVal;
        }
        ...
        public string CONST_CLINIC_NBR(CONSTANTS_MSTR_REC_1 obj, int col)
        {
            ...
            switch (col)
            {
                ...
                case 40:
                    ...
                    break;
                case 41:
                    retVal = Util.Str(obj.FILLER.Substring(2, 4));
                    break;
                case 42:
                    retVal = Util.Str(obj.FILLER.Substring(8, 4));
                    break;
                case 43:
                    retVal = Util.Str(obj.FILLER.Substring(14, 4));
                    break;
                case 44:
                    retVal = Util.Str(obj.FILLER.Substring(20, 4));
                    break;
                case 45:
                    retVal = Util.Str(obj.FILLER.Substring(26, 4));
                    break;
                case 46:
                    retVal = Util.Str(obj.FILLER.Substring(32, 4));
                    break;
                case 47:
                    retVal = Util.Str(obj.FILLER.Substring(38, 4));
                    break;
                case 48:
                    retVal = Util.Str(obj.FILLER.Substring(44, 4));
                    break;
                case 49:
                    retVal = Util.Str(obj.FILLER.Substring(50, 4));
                    break;
                case 50:
                    retVal = Util.Str(obj.FILLER.Substring(56, 4));
                    break;
                case 51:
                    retVal = Util.Str(obj.FILLER.Substring(62, 4));
                    break;
                case 52:
                    retVal = Util.Str(obj.FILLER.Substring(68, 4));
                    break;
                case 53:
                    retVal = Util.Str(obj.FILLER.Substring(74, 4));
                    break;
                case 54:
                    retVal = Util.Str(obj.FILLER.Substring(80, 4));
                    break;
                case 55:
                    retVal = Util.Str(obj.FILLER.Substring(86, 4));
                    break;
                case 56:
                    retVal = Util.Str(obj.FILLER.Substring(92, 4));
                    break;
                case 57:
                    retVal = Util.Str(obj.FILLER.Substring(98, 4));
                    break;
                case 58:
                    retVal = Util.Str(obj.FILLER.Substring(104, 4));
                    break;
                case 59:
                    retVal = Util.Str(obj.FILLER.Substring(110, 4));
                    break;
                case 60:
                    retVal = Util.Str(obj.FILLER.Substring(116, 4));
                    break;
                case 61:
                    retVal = Util.Str(obj.FILLER.Substring(122, 4));
                    break;
                case 62:
                    retVal = Util.Str(obj.FILLER.Substring(128, 4));
                    break;
                case 63:
                    retVal = Util.Str(obj.FILLER.Substring(134, 4));
                    break;
                case 64:
                    retVal = Util.Str(obj.FILLER.Substring(140, 4));
                    break;
                case 65:
                    retVal = Util.Str(obj.FILLER.Substring(146, 4));
                    break;
                case 66:
                    retVal = Util.Str(obj.FILLER.Substring(152, 4));
                    break;
                case 67:
                    retVal = Util.Str(obj.FILLER.Substring(158, 4));
                    break;
                case 68:
                    retVal = Util.Str(obj.FILLER.Substring(164, 4));
                    break;
                case 69:
                    retVal = Util.Str(obj.FILLER.Substring(170, 4));
                    break;
                case 70:
                    retVal = Util.Str(obj.FILLER.Substring(176, 4));
                    break;
                case 71:
                    retVal = Util.Str(obj.FILLER.Substring(182, 4));
                    break;
                case 72:
                    retVal = Util.Str(obj.FILLER.Substring(188, 4));
                    break;
                case 73:
                    retVal = Util.Str(obj.FILLER.Substring(194, 4));
                    break;
                case 74:
                    retVal = Util.Str(obj.FILLER.Substring(200, 4));
                    break;
                case 75:
                    retVal = Util.Str(obj.FILLER.Substring(206, 4));
                    break;
                case 76:
                    retVal = Util.Str(obj.FILLER.Substring(212, 4));
                    break;
                case 77:
                    retVal = Util.Str(obj.FILLER.Substring(218, 4));
                    break;
                case 78:
                    retVal = Util.Str(obj.FILLER.Substring(224, 4));
                    break;
                case 79:
                    retVal = Util.Str(obj.FILLER.Substring(230, 4));
                    break;
                case 80:
                    retVal = Util.Str(obj.FILLER.Substring(236, 4));
                    break;
                case 81:
                    retVal = Util.Str(obj.FILLER.Substring(242, 4));
                    break;
                case 82:
                    retVal = Util.Str(obj.FILLER.Substring(248, 4));
                    break;
                case 83:
                    retVal = Util.Str(obj.FILLER.Substring(254, 4));
                    break;
                case 84:
                    retVal = Util.Str(obj.FILLER.Substring(260, 4));
                    break;
                case 85:
                    retVal = Util.Str(obj.FILLER.Substring(266, 4));
                    break;
                case 86:
                    retVal = Util.Str(obj.FILLER.Substring(272, 4));
                    break;
                case 87:
                    retVal = Util.Str(obj.FILLER.Substring(278, 4));
                    break;
                case 88:
                    retVal = Util.Str(obj.FILLER.Substring(284, 4));
                    break;
                case 89:
                    retVal = Util.Str(obj.FILLER.Substring(290, 4));
                    break;
                case 90:
                    retVal = Util.Str(obj.FILLER.Substring(296, 4));
                    break;
                case 91:
                    retVal = Util.Str(obj.FILLER.Substring(302, 4));
                    break;
                case 92:
                    retVal = Util.Str(obj.FILLER.Substring(308, 4));
                    break;
                case 93:
                    retVal = Util.Str(obj.FILLER.Substring(314, 4));
                    break;
                case 94:
                    retVal = Util.Str(obj.FILLER.Substring(320, 4));
                    break;
                case 95:
                    retVal = Util.Str(obj.FILLER.Substring(326, 4));
                    break;
                case 96:
                    retVal = Util.Str(obj.FILLER.Substring(332, 4));
                    break;
                case 97:
                    retVal = Util.Str(obj.FILLER.Substring(338, 4));
                    break;
                case 98:
                    retVal = Util.Str(obj.FILLER.Substring(344, 4));
                    break;
                case 99:
                    retVal = Util.Str(obj.FILLER.Substring(350, 4));
                    break;
            }
            return retVal;
        }
        ...
        public int CONST_RATE_CURR(CONSTANTS_MSTR_REC_2 obj, int col)
        {
            int retVal = 0;
            ...
            {
                case 1:
                    retVal = Util.NumInt(obj.CONST_RATE_CURR1);
                    break;
                case 2:
                    retVal = Util.NumInt(obj.CONST_RATE_CURR2);
                    break;
                case 3:
                    retVal = Util.NumInt(obj.CONST_RATE_CURR3);
                    break;
                case 4:
                    retVal = Util.NumInt(obj.CONST_RATE_CURR4);
                    break;
                case 5:
                    retVal = Util.NumInt(obj.CONST_RATE_CURR5);
                    break;
                case 6:
                    retVal = Util.NumInt(obj.CONST_RATE_CURR6);
                    break;
                case 7:
                    retVal = Util.NumInt(obj.CONST_RATE_CURR7);
                    break;
                case 8:
                    retVal = Util.NumInt(obj.CONST_RATE_CURR8);
                    break;
                case 9:
                    retVal = Util.NumInt(obj.CONST_RATE_CURR9);
                    break;
                case 10:
                    retVal = Util.NumInt(obj.CONST_RATE_CURR10);
                    break;
                case 11:
                    retVal = Util.NumInt(obj.CONST_RATE_CURR11);
                    break;
                case 12:
                    retVal = Util.NumInt(obj.CONST_RATE_CURR12);
                    break;
                case 13:
                    retVal = Util.NumInt(obj.CONST_RATE_CURR13);
                    break;
                case 14:
                    retVal = Util.NumInt(obj.CONST_RATE_CURR14);
                    break;
                case 15:
                    retVal = Util.NumInt(obj.CONST_RATE_CURR15);
                    break;
                case 16:
                    retVal = Util.NumInt(obj.CONST_RATE_CURR16);
                    break;
                case 17:
                    retVal = Util.NumInt(obj.CONST_RATE_CURR17);
                    break;
                case 18:
                    retVal = Util.NumInt(obj.CONST_RATE_CURR18);
                    break;
                case 19:
                    retVal = Util.NumInt(obj.CONST_RATE_CURR19);
                    break;
            }
            return retVal;
        }
        ...
        public int CONST_RATE_PREV(CONSTANTS_MSTR_REC_2 obj, int col)
        {
            int retVal = 0;
            ...
            {
                case 1:
                    retVal = Util.NumInt(obj.CONST_RATE_PREV1);
                    break;
                case 2:
                    retVal = Util.NumInt(obj.CONST_RATE_PREV2);
                    break;
                case 3:
                    retVal = Util.NumInt(obj.CONST_RATE_PREV3);
                    break;
                case 4:
                    retVal = Util.NumInt(obj.CONST_RATE_PREV4);
                    break;
                case 5:
                    retVal = Util.NumInt(obj.CONST_RATE_PREV5);
                    break;
                case 6:
                    retVal = Util.NumInt(obj.CONST_RATE_PREV6);
                    break;
                case 7:
                    retVal = Util.NumInt(obj.CONST_RATE_PREV7);
                    break;
                case 8:
                    retVal = Util.NumInt(obj.CONST_RATE_PREV8);
                    break;
                case 9:
                    retVal = Util.NumInt(obj.CONST_RATE_PREV9);
                    break;
                case 10:
                    retVal = Util.NumInt(obj.CONST_RATE_PREV10);
                    break;
                case 11:
                    retVal = Util.NumInt(obj.CONST_RATE_PREV11);
                    break;
                case 12:
                    retVal = Util.NumInt(obj.CONST_RATE_PREV12);
                    break;
                case 13:
                    retVal = Util.NumInt(obj.CONST_RATE_PREV13);
                    break;
                case 14:
                    retVal = Util.NumInt(obj.CONST_RATE_PREV14);
                    break;
                case 15:
                    retVal = Util.NumInt(obj.CONST_RATE_PREV15);
                    break;
                case 16:
                    retVal = Util.NumInt(obj.CONST_RATE_PREV16);
                    break;
                case 17:
                    retVal = Util.NumInt(obj.CONST_RATE_PREV17);
                    break;
                case 18:
                    retVal = Util.NumInt(obj.CONST_RATE_PREV18);
                    break;
                case 19:
                    retVal = Util.NumInt(obj.CONST_RATE_PREV19);
                    break;
            }
            return retVal;
        }
        ...
        public decimal FEE_CURRENT_PREVIOUS_YEARS_Fee_1_GET(F040_OMA_FEE_MSTR obj, int row, int col)
        {
            ...
            if (row == 1 && col == 1)
            {
                retVal = Util.NumDec(obj.FEE_CURR_A_FEE_1) / 10;
            }
            else if (row == 1 && col == 2)
            {
                retVal = Util.NumDec(obj.FEE_CURR_H_FEE_1) / 10;
            }
            else if (row == 2 && col == 1)
            {
                retVal = Util.NumDec(obj.FEE_PREV_A_FEE_1) / 10;
            }
            else if (row == 2 && col == 2)
            {
                retVal = Util.NumDec(obj.FEE_PREV_H_FEE_1) / 10;
            }
            return retVal;
        }
        ...
        public decimal FEE_CURRENT_PREVIOUS_YEARS_Fee_2_GET(F040_OMA_FEE_MSTR obj, int row, int col)
        {
            ...
            if (row == 1 && col == 1)
            {
                retVal = Util.NumDec(obj.FEE_CURR_A_FEE_2) / 10;
            }
            else if (row == 1 && col == 2)
            {
                retVal = Util.NumDec(obj.FEE_CURR_H_FEE_2) / 10;
            }
            else if (row == 2 && col == 1)
            {
                retVal = Util.NumDec(obj.FEE_PREV_A_FEE_2) / 10;
            }
            else if (row == 2 && col == 2)
            {
                retVal = Util.NumDec(obj.FEE_PREV_H_FEE_2) / 10;
            }
            return retVal;
        }
        ...
        public decimal FEE_CURRENT_PREVIOUS_YEARS_Fee_Min_GET(F040_OMA_FEE_MSTR obj, int row, int col)
        {
            ...
            if (row == 1 && col == 1)
            {
                retVal = Util.NumDec(obj.FEE_CURR_A_MIN)/1000;
            }
            else if (row == 1 && col == 2)
            {
                retVal = Util.NumDec(obj.FEE_CURR_H_MIN)/1000;
            }
            else if (row == 2 && col == 1)
            {
                retVal = Util.NumDec(obj.FEE_PREV_A_MIN)/1000;
            }
            else if (row == 2 && col == 2)
            {
                retVal = Util.NumDec(obj.FEE_PREV_H_MIN)/1000;
            }
            return retVal;
        }
        ...
        public decimal FEE_CURRENT_PREVIOUS_YEARS_Fee_Max_GET(F040_OMA_FEE_MSTR obj, int row, int col)
        {
            ...
            if (row == 1 && col == 1)
            {
                retVal = Util.NumDec(obj.FEE_CURR_A_MAX)/1000;
            }
            else if (row == 1 && col == 2)
            {
                retVal = Util.NumDec(obj.FEE_CURR_H_MAX)/1000;
            }
            else if (row == 2 && col == 1)
            {
                retVal = Util.NumDec(obj.FEE_PREV_A_MAX)/1000;
            }
            else if (row == 2 && col == 2)
            {
                retVal = Util.NumDec(obj.FEE_PREV_H_MAX)/1000;
            }
            return retVal;
        }
        ...
        protected async Task Prompt(string controlName, bool batchHasValueBypass = false)
        {
        }
        ...
        protected void Display(string groupName, bool isShow = true)
        {
        }
