...
namespace RmaDAL
{
    public partial class F002_SUSPEND_DTL : BaseTable
    {
        #region Retrieve

        public ObservableCollection<F002_SUSPEND_DTL> Collection( Guid? rowid,
															...
															decimal? clmdtl_diag_cd_localmin,
															decimal? clmdtl_diag_cd_localmax,
                                                            ...
                                                            int skip)
        {
            	var parameters = new SqlParameter[]
				{
					...
					new SqlParameter("CLMDTL_SV_DAY_ALPHA_1",clmdtl_sv_day_alpha_1),
					...
					new SqlParameter("minCLMDTL_DIAG_CD_LOCAL",clmdtl_diag_cd_localmin),
					new SqlParameter("maxCLMDTL_DIAG_CD_LOCAL",clmdtl_diag_cd_localmax),
            ...
            if (replaceSearch)
            {
                Reader = CoreReader("[INDEXED].[sp_F002_SUSPEND_DTL_RecordCount]", parameters);
				if (Reader.Read())
					TotalItemCount = (int)Reader[0];
				if (TotalItemCount == 0)
				{
					return new ObservableCollection<F002_SUSPEND_DTL>();
				}

            }

            Reader = CoreReader("[INDEXED].[sp_F002_SUSPEND_DTL_Search]", parameters);
            var collection = new ObservableCollection<F002_SUSPEND_DTL>();

            while (Reader.Read())
            {
                collection.Add(new F002_SUSPEND_DTL
                {
					...
					CLMDTL_SV_DAY_ALPHA_1 = Reader["CLMDTL_SV_DAY_ALPHA_1"].ToString(),
					...
					CLMDTL_DIAG_CD_LOCAL = ConvertDEC(Reader["CLMDTL_DIAG_CD_LOCAL"]),
					...
					_originalClmdtl_sv_day_alpha_1 = Reader["CLMDTL_SV_DAY_ALPHA_1"].ToString(),
					...
					_originalClmdtl_diag_cd_local = ConvertDEC(Reader["CLMDTL_DIAG_CD_LOCAL"]),
        ...
        public ObservableCollection<F002_SUSPEND_DTL> Collection(ObservableCollection<F002_SUSPEND_DTL>
                                                               f002SuspendDtl = null)
        {
            if (IsSameSearch() && f002SuspendDtl != null)
            {
                return f002SuspendDtl;
            }
            ...
            if (IsBlankSearch())
            {
            	...
            	var parameters = new SqlParameter[]
				{
					...
					new SqlParameter("CLMDTL_SV_DAY_ALPHA_1",WhereClmdtl_sv_day_alpha_1),
					...
					new SqlParameter("CLMDTL_DIAG_CD_LOCAL",WhereClmdtl_diag_cd_local),
			...
			Reader = CoreReader("[INDEXED].[sp_F002_SUSPEND_DTL_Match]", parameters);
            var collection = new ObservableCollection<F002_SUSPEND_DTL>();
            ...
            while (Reader.Read())
            {
                collection.Add(new F002_SUSPEND_DTL
                {
					...
					_whereClmdtl_sv_day_alpha_1 = WhereClmdtl_sv_day_alpha_1,
					...
					_whereClmdtl_diag_cd_local = WhereClmdtl_diag_cd_local,
        ...
        private bool IsBlankSearch()
        {
            if (WhereRowid == null 
				...
				&& WhereClmdtl_sv_day_alpha_1 == null 
				...
				&& WhereClmdtl_diag_cd_local == null 
        ...
        private bool IsSameSearch()
        {
           return WhereRowid ==  _whereRowid
				...
				&& WhereClmdtl_sv_day_alpha_1 ==  _whereClmdtl_sv_day_alpha_1
				...
				&& WhereClmdtl_diag_cd_local ==  _whereClmdtl_diag_cd_local
...
;
		...
		private string _CLMDTL_SV_DAY_ALPHA_1;
		...
		private decimal? _CLMDTL_DIAG_CD_LOCAL;
		...
		public string CLMDTL_SV_DAY_ALPHA_1
		{
			get { return _CLMDTL_SV_DAY_ALPHA_1; }
			set
			{
				if (_CLMDTL_SV_DAY_ALPHA_1 != value)
				{
					_CLMDTL_SV_DAY_ALPHA_1 = value;
					ChangeState();
				}
			}
		}
		...
		public decimal? CLMDTL_DIAG_CD_LOCAL
		{
			get { return _CLMDTL_DIAG_CD_LOCAL; }
			set
			{
				if (_CLMDTL_DIAG_CD_LOCAL != value)
				{
					_CLMDTL_DIAG_CD_LOCAL = value;
					ChangeState();
				}
			}
		}
		...
		public string WhereClmdtl_sv_day_alpha_1 { get; set; }
		private string _whereClmdtl_sv_day_alpha_1;
		...
		public decimal? WhereClmdtl_diag_cd_local { get; set; }
		private decimal? _whereClmdtl_diag_cd_local;
		...
		private string _originalClmdtl_sv_day_alpha_1;
		...
		private decimal? _originalClmdtl_diag_cd_local;
        ...
        public bool Undo()
        {
			...
			CLMDTL_SV_DAY_ALPHA_1 = _originalClmdtl_sv_day_alpha_1;
			...
			CLMDTL_DIAG_CD_LOCAL = _originalClmdtl_diag_cd_local;
        ...
        public bool Delete()
        {
			...
			RowsAffected = CoreExecuteNonQuery("[INDEXED].[sp_F002_SUSPEND_DTL_DeleteRow]", parameters);
		...
		{
		    int RowsAffected = 0;
		    RowsAffected = CoreExecuteNonQuery("[INDEXED].[sp_F002_SUSPEND_DTL_Purge]");
		    CloseConnection();
		    return true;
		}
            ...
            switch (RecordState)
            {
                ...
                case State.Added:
					parameters = new SqlParameter[]
					{
						...
						new SqlParameter("CLMDTL_SV_DAY_ALPHA_1", SqlNull(CLMDTL_SV_DAY_ALPHA_1)),
						...
						new SqlParameter("CLMDTL_DIAG_CD_LOCAL", SqlNull(CLMDTL_DIAG_CD_LOCAL)),
					...
					Reader = CoreReader("[INDEXED].[sp_F002_SUSPEND_DTL_Insert]", parameters);
					if (Reader.Read())
					{
						RowCheckSum = Convert.ToInt32(Reader["RowCheckSum"]);
						ROWID = (Guid) Reader["ROWID"];
                ...
                case State.Modified:
					...
					Reader = CoreReader("[INDEXED].[sp_F002_SUSPEND_DTL_Update]", parameters);
					if (Reader.Read())
					{
						RowCheckSum = Convert.ToInt32(Reader["RowCheckSum"]);
						ROWID = (Guid) Reader["ROWID"];
