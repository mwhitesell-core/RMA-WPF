...
public class R140_A1 : BaseClassControl
{
        ...
        : base(Name, Level)
    {
        ...
        X_PAYMENT_AMT_SUBTOTAL = new CoreDecimal("X_PAYMENT_AMT_SUBTOTAL", 11, this);
        X_SUBMISSION_AMT_SUBTOTAL = new CoreDecimal("X_SUBMISSION_AMT_SUBTOTAL", 11, this);
    ...
    private DDecimal X_PAYMENT_AMT = new DDecimal("X_PAYMENT_AMT", 11);
