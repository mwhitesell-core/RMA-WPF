...
public class R120_EXTRACT_DETAILS_1 : R120
{
        ...
        : base(Name, Level, true)
    {
        ...
        fleF190_COMP_CODES_TMP = new SqlFileObject(this, FileTypes.Primary, 0, "[101C].INDEXED", "F190_COMP_CODES", "F190_COMP_CODES_TMP", false, false, false, 0, "m_trnTRANS_UPDATE");
        ...
        AMT_GROSS.GetValue += AMT_GROSS_GetValue;
        AMT_NET.GetValue += AMT_NET_GetValue;
    ...
    private void COMPENSATION_FACTOR_GetValue(ref decimal Value)
    {
        try
        {
            Value = fleF110_COMPENSATION.GetDecimalValue("FACTOR");
        }
    ...
    private DDecimal AMT_GROSS = new DDecimal("AMT_GROSS", 18);
    private void AMT_GROSS_GetValue(ref decimal Value)
    {
        try
        {
    ...
    private DDecimal AMT_NET = new DDecimal("AMT_NET", 18);
    private void AMT_NET_GetValue(ref decimal Value)
    {
        try
        {
                ...
                while (fleF110_COMPENSATION.QTPForMissing("1"))
                {
                    ...
                    if (Transaction())
                    {
                        ...
                        SubFile(ref m_trnTRANS_UPDATE, ref fleR120AA, SubFileType.Keep, fleF020_DOCTOR_MSTR, "DOC_DEPT", fleF112_PYCDCEILINGS, "DOC_NBR", "EP_NBR", "DOC_PAY_CODE", "DOC_PAY_SUB_CODE",
                                ...
                                "COMP_CODE", "DESC_SHORT", COMPENSATION_FACTOR, AMT_GROSS, AMT_NET, fleF110_COMPENSATION, "COMPENSATION_STATUS", fleF020_DOCTOR_MSTR, "DOC_FULL_PART_IND",
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleR120AA))
            {
                ...
                // GW2018. Wromgg. Sort btreak ONLY AT COMP-CODE!
                ...
                //Reset(ref T_AMT_GROSS, fleR120AA.At("DOC_DEPT") || fleR120AA.At("DOC_NBR") || fleR120AA.At("EP_NBR") || fleR120AA.At("DOC_PAY_CODE") || fleR120AA.At("DOC_PAY_SUB_CODE") || fleR120AA.At("FACTOR") ||
                //     fleR120AA.At("DOC_YRLY_CEILING") || fleR120AA.At("DOC_YRLY_CEILING_GUAR_PERC") || fleR120AA.At("DOC_YRLY_CEIL_GUAR") || fleR120AA.At("DOC_YRLY_EXPENSE") || fleR120AA.At("DOC_YRLY_EXPN_ALLOC_PERS") ||
                //      fleR120AA.At("COMP_TYPE") || fleR120AA.At("COMP_CODE"));
                //Reset(ref T_AMT_NET, fleR120AA.At("DOC_DEPT") || fleR120AA.At("DOC_NBR") || fleR120AA.At("EP_NBR") || fleR120AA.At("DOC_PAY_CODE") || fleR120AA.At("DOC_PAY_SUB_CODE") || fleR120AA.At("FACTOR") ||
                //     fleR120AA.At("DOC_YRLY_CEILING") || fleR120AA.At("DOC_YRLY_CEILING_GUAR_PERC") || fleR120AA.At("DOC_YRLY_CEIL_GUAR") || fleR120AA.At("DOC_YRLY_EXPENSE") || fleR120AA.At("DOC_YRLY_EXPN_ALLOC_PERS") ||
                //      fleR120AA.At("COMP_TYPE") || fleR120AA.At("COMP_CODE"));
