...
public class SOLO_INCOME_SUMMARY : BaseClassControl
{

    private SOLO_INCOME_SUMMARY m_SOLO_INCOME_SUMMARY;

    public SOLO_INCOME_SUMMARY(string Name, int Level)
        : base(Name, Level)
    {
    ...
    public SOLO_INCOME_SUMMARY(string Name, int Level, bool Request)
    ...
    {
        if ((m_SOLO_INCOME_SUMMARY != null))
        {
            m_SOLO_INCOME_SUMMARY.CloseTransactionObjects();
            m_SOLO_INCOME_SUMMARY = null;
        }
    }

    public SOLO_INCOME_SUMMARY GetSOLO_INCOME_SUMMARY(int Level)
    {
        if (m_SOLO_INCOME_SUMMARY == null)
        {
            m_SOLO_INCOME_SUMMARY = new SOLO_INCOME_SUMMARY("SOLO_INCOME_SUMMARY", Level);
        }
        else
        {
            m_SOLO_INCOME_SUMMARY.ResetValues();
        }
        return m_SOLO_INCOME_SUMMARY;
    }
    ...
    public override bool RunQTP()
    {
        ...
        try
        {
            ...
            SOLO_INCOME_SUMMARY_ONE_1 ONE_1 = new SOLO_INCOME_SUMMARY_ONE_1(Name, Level);
            ONE_1.Run();
            ONE_1.Dispose();
            ONE_1 = null;
...
public class SOLO_INCOME_SUMMARY_ONE_1 : SOLO_INCOME_SUMMARY
{

    public SOLO_INCOME_SUMMARY_ONE_1(string Name, int Level)
        : base(Name, Level, true)
    {
        ...
        X_AFPCON = new CoreDecimal("X_AFPCON", 12, this);
        X_TITHD1 = new CoreDecimal("X_TITHD1", 12, this);
        X_TITHD2 = new CoreDecimal("X_TITHD2", 12, this);
        X_TITHD3 = new CoreDecimal("X_TITHD3", 12, this);
        X_DEPMED = new CoreDecimal("X_DEPMED", 12, this);
        X_PAYEFT = new CoreDecimal("X_PAYEFT", 12, this);
        ...
        X_DOC_INITS.GetValue += X_DOC_INITS_GetValue;
    ...
    #region "Declarations (Variables, Files and Transactions)(SOLO_INCOME_SUMMARY_ONE_1)"
    ...
    public override bool SelectIf()
    {
        ...
        try
        {
            if ((QDesign.NULL(fleF119_DOCTOR_YTD_HISTORY.GetStringValue("COMP_CODE")) == "AFPCON" | QDesign.NULL(fleF119_DOCTOR_YTD_HISTORY.GetStringValue("COMP_CODE")) == "TITHD1" | QDesign.NULL(fleF119_DOCTOR_YTD_HISTORY.GetStringValue("COMP_CODE")) == "TITHD2" | QDesign.NULL(fleF119_DOCTOR_YTD_HISTORY.GetStringValue("COMP_CODE")) == "TITHD3" | QDesign.NULL(fleF119_DOCTOR_YTD_HISTORY.GetStringValue("COMP_CODE")) == "DEPMED" | QDesign.NULL(fleF119_DOCTOR_YTD_HISTORY.GetStringValue("COMP_CODE")) == "PAYEFT") & ((fleF119_DOCTOR_YTD_HISTORY.GetDecimalValue("EP_NBR") >= Convert.ToDecimal(Prompt(1)) & fleF119_DOCTOR_YTD_HISTORY.GetDecimalValue("EP_NBR") <= Convert.ToDecimal(Prompt(2))) | (fleF119_DOCTOR_YTD_HISTORY.GetDecimalValue("EP_NBR") >= Convert.ToDecimal(Prompt(3)) & fleF119_DOCTOR_YTD_HISTORY.GetDecimalValue("EP_NBR") <= Convert.ToDecimal(Prompt(4)))) & QDesign.NULL(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DEPT")) == 31)
            {
                return true;
            }
    ...
    private DCharacter X_DOC_INITS = new DCharacter("X_DOC_INITS", 3);
    private void X_DOC_INITS_GetValue(ref string Value)
    {

        try
        {
            Value = QDesign.Pack(fleF020_DOCTOR_MSTR.GetStringValue("DOC_INIT1") + fleF020_DOCTOR_MSTR.GetStringValue("DOC_INIT2") + fleF020_DOCTOR_MSTR.GetStringValue("DOC_INIT3"));
            //Parent:DOC_INITS
    ...
    #region "Standard Generated Procedures(SOLO_INCOME_SUMMARY_ONE_1)"


    #region "Automatic Item Initialization(SOLO_INCOME_SUMMARY_ONE_1)"
    ...
    #region "Transaction Management Procedures(SOLO_INCOME_SUMMARY_ONE_1)"
    ...
    #region "FILE Management Procedures(SOLO_INCOME_SUMMARY_ONE_1)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(SOLO_INCOME_SUMMARY_ONE_1)"
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleF119_DOCTOR_YTD_HISTORY, fleF020_DOCTOR_MSTR))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleSOLOINCOME, fleF119_DOCTOR_YTD_HISTORY.At("DOC_NBR"), SubFileType.Portable, fleF020_DOCTOR_MSTR, "DOC_DEPT", COMMA, fleF119_DOCTOR_YTD_HISTORY, "DOC_NBR", COMMA, fleF020_DOCTOR_MSTR,
                "DOC_NAME", COMMA, X_DOC_INITS, COMMA, "DOC_OHIP_NBR", COMMA, X_AFPCON, COMMA, X_TITHD1, COMMA, X_TITHD2, COMMA, X_TITHD3, COMMA, X_DEPMED, COMMA, X_PAYEFT);
