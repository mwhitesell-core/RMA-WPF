        ...
        try
        {
            ...
            while (fleR085E.QTPForMissing())
            {
                ...
                while (fleF010_PAT_MSTR.QTPForMissing("1"))
                {
                    ...
                    m_strWhere.Append(Common.StringToField(fleR085E.GetStringValue("CLMHDR_PAT_OHIP_ID_OR_CHART").PadRight(16).Substring(0, 1)));
                    m_strWhere.Append(" AND ").Append(" ").Append(fleF010_PAT_MSTR.ElementOwner("PAT_CON_NBR")).Append(" = ");
                    m_strWhere.Append(QDesign.NConvert(fleR085E.GetStringValue("CLMHDR_PAT_OHIP_ID_OR_CHART").PadRight(16).Substring(1, 2)));
                    m_strWhere.Append(" AND ").Append(" ").Append(fleF010_PAT_MSTR.ElementOwner("PAT_I_NBR")).Append(" = ");
                    m_strWhere.Append(QDesign.NConvert(fleR085E.GetStringValue("CLMHDR_PAT_OHIP_ID_OR_CHART").PadRight(16).Substring(3, 12)));
                    m_strWhere.Append(" AND ").Append(" ").Append(fleF010_PAT_MSTR.ElementOwner("FILLER4")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(fleR085E.GetStringValue("CLMHDR_PAT_OHIP_ID_OR_CHART").PadRight(16).Substring(15, 1)));
                    m_strOrderBy = new StringBuilder(" ORDER BY ");
                    m_strOrderBy.Append(fleF010_PAT_MSTR.ElementOwner("PAT_I_KEY"));
                    m_strOrderBy.Append(", ").Append(fleF010_PAT_MSTR.ElementOwner("PAT_CON_NBR"));
                    m_strOrderBy.Append(", ").Append(fleF010_PAT_MSTR.ElementOwner("PAT_I_NBR"));
                    m_strOrderBy.Append(", ").Append(fleF010_PAT_MSTR.ElementOwner("FILLER4"));
