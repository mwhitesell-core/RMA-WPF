    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleU030_PAID_AMT, fleICONST_MSTR_REC, fleF075_AFP_DOC_MSTR, fleF074_AFP_GROUP_MSTR))
            {
                ...
                fleF075_AFP_DOC_MSTR.OutPut(OutPutType.Update, fleF075_AFP_DOC_MSTR.At("DOC_OHIP_NBR") || fleF075_AFP_DOC_MSTR.At("DOC_NBR") || fleF075_AFP_DOC_MSTR.At("DOC_AFP_PAYM_GROUP"), null);

                Reset(ref TOTAL_AMT_PAID, fleF075_AFP_DOC_MSTR.At("DOC_OHIP_NBR") || fleF075_AFP_DOC_MSTR.At("DOC_NBR") || fleF075_AFP_DOC_MSTR.At("DOC_AFP_PAYM_GROUP"));
