...
public class U014_F050_U014_TRANSFER_F050_TO_F050_HIST_3 : U014_F050
{
    ...
    private void fleF050_HIST_ADD_AutomaticItemInitialization(bool Fixed)
    {
        try
        {
            ...
            fleF050_HIST_ADD.set_SetValue("DOCREV_CLINIC_1_2", !Fixed, fleU014_F050.GetStringValue("DOCREV_CLINIC_1_2"));
            fleF050_HIST_ADD.set_SetValue("DOCREV_DEPT", !Fixed, fleU014_F050.GetDecimalValue("DOCREV_DEPT"));
            fleF050_HIST_ADD.set_SetValue("DOCREV_DOC_NBR", !Fixed, fleU014_F050.GetStringValue("DOCREV_DOC_NBR"));
            fleF050_HIST_ADD.set_SetValue("DOCREV_LOCATION", !Fixed, fleU014_F050.GetStringValue("DOCREV_LOCATION"));
            fleF050_HIST_ADD.set_SetValue("DOCREV_OMA_CODE", !Fixed, fleU014_F050.GetStringValue("DOCREV_OMA_CODE"));
            fleF050_HIST_ADD.set_SetValue("DOCREV_OMA_SUFF", !Fixed, fleU014_F050.GetStringValue("DOCREV_OMA_SUFF"));
            fleF050_HIST_ADD.set_SetValue("DOCREV_MTD_IN_REC", !Fixed, fleU014_F050.GetDecimalValue("DOCREV_MTD_IN_REC"));
            fleF050_HIST_ADD.set_SetValue("DOCREV_MTD_IN_SVC", !Fixed, fleU014_F050.GetDecimalValue("DOCREV_MTD_IN_SVC"));
            fleF050_HIST_ADD.set_SetValue("DOCREV_MTD_OUT_REC", !Fixed, fleU014_F050.GetDecimalValue("DOCREV_MTD_OUT_REC"));
            fleF050_HIST_ADD.set_SetValue("DOCREV_MTD_OUT_SVC", !Fixed, fleU014_F050.GetDecimalValue("DOCREV_MTD_OUT_SVC"));
            fleF050_HIST_ADD.set_SetValue("DOCREV_YTD_IN_REC", !Fixed, fleU014_F050.GetDecimalValue("DOCREV_YTD_IN_REC"));
            fleF050_HIST_ADD.set_SetValue("DOCREV_YTD_IN_SVC", !Fixed, fleU014_F050.GetDecimalValue("DOCREV_YTD_IN_SVC"));
            fleF050_HIST_ADD.set_SetValue("DOCREV_YTD_OUT_REC", !Fixed, fleU014_F050.GetDecimalValue("DOCREV_YTD_OUT_REC"));
            fleF050_HIST_ADD.set_SetValue("DOCREV_YTD_OUT_SVC", !Fixed, fleU014_F050.GetDecimalValue("DOCREV_YTD_OUT_SVC"));
        ...
        try
        {
            ...
            while (fleU014_F050.QTPForMissing())
            {
                ...
                while (fleF050_DOC_REVENUE_MSTR_HISTORY.QTPForMissing("1"))
                {
                    ...
                    m_strWhere.Append(" AND ").Append(fleF050_DOC_REVENUE_MSTR_HISTORY.ElementOwner("ICONST_DATE_PERIOD_END")).Append(" = ");
                    m_strWhere.Append(fleU014_F050.GetStringValue("X_ICONST_DATE_PERIOD_END"));
                   
                                                         
                    m_strWhere.Append(" AND ").Append(fleF050_DOC_REVENUE_MSTR_HISTORY.ElementOwner("DOCREV_CLINIC_1_2")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(fleU014_F050.GetStringValue("DOCREV_CLINIC_1_2")));
                    ...
                    m_strWhere.Append(Common.StringToField(fleU014_F050.GetStringValue("DOCREV_DOC_NBR")));
                        
                    m_strWhere.Append(" AND ").Append(fleF050_DOC_REVENUE_MSTR_HISTORY.ElementOwner("DOCREV_LOCATION")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(fleU014_F050.GetStringValue("DOCREV_LOCATION")));
                        
                    m_strWhere.Append(" AND ").Append(fleF050_DOC_REVENUE_MSTR_HISTORY.ElementOwner("DOCREV_OMA_CODE")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(fleU014_F050.GetStringValue("DOCREV_OMA_CODE")));
                        
                    m_strWhere.Append(" AND ").Append(fleF050_DOC_REVENUE_MSTR_HISTORY.ElementOwner("DOCREV_OMA_SUFF")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(fleU014_F050.GetStringValue("DOCREV_OMA_SUFF")));
