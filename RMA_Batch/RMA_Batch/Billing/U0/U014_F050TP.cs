        ...
        try
        {
            ...
            while (fleCONSTANTS_MSTR_REC_7.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                    ...
                    W_CURRENT_COSTING_PED_YYMM.Value = fleCONSTANTS_MSTR_REC_7.GetDecimalValue("CURRENT_COSTING_PED") / 100;
...
public class U014_F050TP_U014_TRANSFER_F050TP_TO_F050_HISTTP_2 : U014_F050TP
{
    ...
    private void PED_DD_GetValue(ref decimal Value)
    {
        ...
        try
        {
            Value = QDesign.PHMod(ICONST_DATE_PERIOD_END.Value, 100);
    ...
    private DDecimal X_ICONST_DATE_PERIOD_END = new DDecimal("X_ICONST_DATE_PERIOD_END", 8);
    private void X_ICONST_DATE_PERIOD_END_GetValue(ref decimal Value)
    {
        ...
        try
        {
            ...
            {
                CurrentValue = QDesign.NConvert(QDesign.ASCII((ICONST_DATE_PERIOD_END.Value / 100), 6) + "01");
            }
            else
            {
                CurrentValue = ICONST_DATE_PERIOD_END.Value;
            }
...
public class U014_F050TP_U014_TRANSFER_F050TP_TO_F050TP_HIST_3 : U014_F050TP
{
    ...
    private void fleF050TP_HIST_ADD_InitializeItems(bool Fixed)
    {
        ...
        try
        {
            ...
            if (!Fixed)
                fleF050TP_HIST_ADD.set_SetValue("ICONST_DATE_PERIOD_END", true, fleU014_F050TP.GetDecimalValue("X_ICONST_DATE_PERIOD_END"));
    ...
    private void fleF050TP_HIST_ADD_AutomaticItemInitialization(bool Fixed)
    {
        try
        {
            ...
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_CLINIC_NBR", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_CLINIC_NBR"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_AGENT_CD", !Fixed, fleU014_F050TP.GetStringValue("DOCREVTP_AGENT_CD"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_LOC_CD", !Fixed, fleU014_F050TP.GetStringValue("DOCREVTP_LOC_CD"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_OMA_CODE", !Fixed, fleU014_F050TP.GetStringValue("DOCREVTP_OMA_CODE"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_OMA_SUFFIX", !Fixed, fleU014_F050TP.GetStringValue("DOCREVTP_OMA_SUFFIX"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_DOC_NBR", !Fixed, fleU014_F050TP.GetStringValue("DOCREVTP_DOC_NBR"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_IN_TECH_AMT_BILLED1", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_TECH_AMT_BILLED1"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_IN_TECH_AMT_BILLED2", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_TECH_AMT_BILLED2"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_IN_TECH_AMT_ADJUSTS1", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_TECH_AMT_ADJUSTS1"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_IN_TECH_AMT_ADJUSTS2", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_TECH_AMT_ADJUSTS2"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_IN_TECH_NBR_SVC1", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_TECH_NBR_SVC1"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_IN_TECH_NBR_SVC2", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_TECH_NBR_SVC2"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_IN_PROF_AMT_BILLED1", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_PROF_AMT_BILLED1"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_IN_PROF_AMT_BILLED2", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_PROF_AMT_BILLED2"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_IN_PROF_AMT_ADJUSTS1", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_PROF_AMT_ADJUSTS1"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_IN_PROF_AMT_ADJUSTS2", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_PROF_AMT_ADJUSTS2"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_IN_PROF_NBR_SVC1", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_PROF_NBR_SVC1"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_IN_PROF_NBR_SVC2", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_PROF_NBR_SVC2"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_OUT_TECH_AMT_BILLED1", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_TECH_AMT_BILLED1"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_OUT_TECH_AMT_BILLED2", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_TECH_AMT_BILLED2"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_OUT_TECH_AMT_ADJUSTS1", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_TECH_AMT_ADJUSTS1"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_OUT_TECH_AMT_ADJUSTS2", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_TECH_AMT_ADJUSTS2"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_OUT_TECH_NBR_SVC1", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_TECH_NBR_SVC1"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_OUT_TECH_NBR_SVC2", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_TECH_NBR_SVC2"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_OUT_PROF_AMT_BILLED1", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_PROF_AMT_BILLED1"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_OUT_PROF_AMT_BILLED2", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_PROF_AMT_BILLED2"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_OUT_PROF_AMT_ADJUSTS1", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_PROF_AMT_ADJUSTS1"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_OUT_PROF_AMT_ADJUSTS2", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_PROF_AMT_ADJUSTS2"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_OUT_PROF_NBR_SVC1", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_PROF_NBR_SVC1"));
            fleF050TP_HIST_ADD.set_SetValue("DOCREVTP_OUT_PROF_NBR_SVC2", !Fixed, fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_PROF_NBR_SVC2"));
        ...
        try
        {
            ...
            while (fleU014_F050TP.QTPForMissing())
            {
                ...
                while (fleF050TP_DOC_REVENUE_MSTR_HISTORY.QTPForMissing("1"))
                {
                    ...
                    m_strWhere.Append(GetWhereClauseString(fleF050TP_DOC_REVENUE_MSTR_HISTORY.ElementOwner("ICONST_DATE_PERIOD_END"), "=", fleU014_F050TP.GetDecimalValue("X_ICONST_DATE_PERIOD_END"), false));
                    m_strWhere.Append(" AND ").Append(fleF050TP_DOC_REVENUE_MSTR_HISTORY.ElementOwner("DOCREVTP_CLINIC_NBR")).Append(" = ");
                    m_strWhere.Append(fleU014_F050TP.GetDecimalValue("DOCREVTP_CLINIC_NBR"));
                    m_strWhere.Append(" AND ").Append(fleF050TP_DOC_REVENUE_MSTR_HISTORY.ElementOwner("DOCREVTP_AGENT_CD")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(fleU014_F050TP.GetStringValue("DOCREVTP_AGENT_CD")));
                    m_strWhere.Append(" AND ").Append(fleF050TP_DOC_REVENUE_MSTR_HISTORY.ElementOwner("DOCREVTP_LOC_CD")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(fleU014_F050TP.GetStringValue("DOCREVTP_LOC_CD")));
                    m_strWhere.Append(" AND ").Append(fleF050TP_DOC_REVENUE_MSTR_HISTORY.ElementOwner("DOCREVTP_OMA_CODE")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(fleU014_F050TP.GetStringValue("DOCREVTP_OMA_CODE")));
                    m_strWhere.Append(" AND ").Append(fleF050TP_DOC_REVENUE_MSTR_HISTORY.ElementOwner("DOCREVTP_OMA_SUFFIX")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(fleU014_F050TP.GetStringValue("DOCREVTP_OMA_SUFFIX")));
                    m_strWhere.Append(" AND ").Append(fleF050TP_DOC_REVENUE_MSTR_HISTORY.ElementOwner("DOCREVTP_DOC_NBR")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(fleU014_F050TP.GetStringValue("DOCREVTP_DOC_NBR")));
                    ...
                    if (Transaction())
                    {
                        ...
                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_IN_TECH_AMT_BILLED1", fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_TECH_AMT_BILLED1"));

                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_IN_TECH_AMT_BILLED1", fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_TECH_AMT_BILLED1"));


                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_IN_TECH_AMT_ADJUSTS1", fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_TECH_AMT_ADJUSTS1"));

                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_IN_TECH_AMT_ADJUSTS2", fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_TECH_AMT_ADJUSTS2"));


                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_IN_TECH_NBR_SVC1", fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_TECH_NBR_SVC1"));

                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_IN_TECH_NBR_SVC2", fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_TECH_NBR_SVC2"));


                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_IN_PROF_AMT_BILLED1", fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_PROF_AMT_BILLED1"));

                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_IN_PROF_AMT_BILLED2", fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_PROF_AMT_BILLED2"));


                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_IN_PROF_AMT_ADJUSTS1", fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_PROF_AMT_ADJUSTS1"));

                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_IN_PROF_AMT_ADJUSTS2", fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_PROF_AMT_ADJUSTS2"));


                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_IN_PROF_NBR_SVC1", fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_PROF_NBR_SVC1"));

                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_IN_PROF_NBR_SVC2", fleU014_F050TP.GetDecimalValue("DOCREVTP_IN_PROF_NBR_SVC2"));


                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_OUT_TECH_AMT_BILLED1", fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_TECH_AMT_BILLED1"));

                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_OUT_TECH_AMT_BILLED2", fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_TECH_AMT_BILLED2"));


                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_OUT_TECH_AMT_ADJUSTS1", fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_TECH_AMT_ADJUSTS1"));

                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_OUT_TECH_AMT_ADJUSTS2", fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_TECH_AMT_ADJUSTS2"));


                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_OUT_TECH_NBR_SVC1", fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_TECH_NBR_SVC1"));

                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_OUT_TECH_NBR_SVC2", fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_TECH_NBR_SVC2"));


                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_OUT_PROF_AMT_BILLED1", fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_PROF_AMT_BILLED1"));

                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_OUT_PROF_AMT_BILLED2", fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_PROF_AMT_BILLED2"));


                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_OUT_PROF_AMT_ADJUSTS1", fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_PROF_AMT_ADJUSTS1"));

                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_OUT_PROF_AMT_ADJUSTS2", fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_PROF_AMT_ADJUSTS2"));


                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_OUT_PROF_NBR_SVC1", fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_PROF_NBR_SVC1"));

                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR_HISTORY, "DOCREVTP_OUT_PROF_NBR_SVC2", fleU014_F050TP.GetDecimalValue("DOCREVTP_OUT_PROF_NBR_SVC2"));
