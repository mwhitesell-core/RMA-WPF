...
public class U020B : BaseClassControl
{

    private U020B m_U020B;

    public U020B(string Name, int Level)
        : base(Name, Level)
    {
    ...
    public override void Dispose()
    {
        if ((m_U020B != null))
        {
            m_U020B.CloseTransactionObjects();
            m_U020B = null;
        }
    }

    public U020B GetU020B(int Level)
    {
        if (m_U020B == null)
        {
            m_U020B = new U020B("U020B", Level);
        }
        else
        {
            m_U020B.ResetValues();
    ...
    public override bool RunQTP()
    {
        ...
        try
        {
            ...
            U020B_SELECT_CLMDTL_1 SELECT_CLMDTL_1 = new U020B_SELECT_CLMDTL_1(Name, Level);
            SELECT_CLMDTL_1.Run();
            SELECT_CLMDTL_1.Dispose();
            SELECT_CLMDTL_1 = null;

            U020B_CHECK_SLI_2 CHECK_SLI_2 = new U020B_CHECK_SLI_2(Name, Level);
            CHECK_SLI_2.Run();
            CHECK_SLI_2.Dispose();
            CHECK_SLI_2 = null;

            U020B_CREATE_TAPE_3 CREATE_TAPE_3 = new U020B_CREATE_TAPE_3(Name, Level);
            CREATE_TAPE_3.Run();
...
public class U020B_SELECT_CLMDTL_1 : U020B
{

    public U020B_SELECT_CLMDTL_1(string Name, int Level)
    ...
    #region "Declarations (Variables, Files and Transactions)(U020B_SELECT_CLMDTL_1)"
    ...
    private void fleU020A1_SelectIf(ref string SelectIfClause)
    {
        ...
        try
        {
            ...
            strSQL.Append(" (    ").Append(fleU020A1.ElementOwner("MOH_FLAG")).Append(" =  'Y' AND ");
            strSQL.Append("    ").Append(fleU020A1.ElementOwner("BATCTRL_BATCH_TYPE")).Append(" =  'C' AND ");
            strSQL.Append("    ").Append(fleU020A1.ElementOwner("PAT_MESS_CODE")).Append(" =  ' ')");
    ...
    private void fleF002_CLAIMS_MSTR_SelectIf(ref string SelectIfClause)
    {
        ...
        try
        {
            ...
            strSQL.Append("    ").Append(fleF002_CLAIMS_MSTR.ElementOwner("CLMDTL_OMA_CD")).Append(" <>  'ZZZZ')");
    ...
    private void W_CLMDTL_NBR_SERV_1_GetValue(ref decimal Value)
    {
        ...
        try
        {
            ...
            if (QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 2, 2) != "MR" &&
                QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 2, 2) != "OP" &&
                QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 1, 1) != "0")
            {
    ...
    private void W_CLMDTL_NBR_SERV_2_GetValue(ref decimal Value)
    {
        ...
        try
        {
            ...
            if (QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 2, 2) != "MR" &&
                QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 2, 2) != "OP" &&
                QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 4, 1) != "0")
            {
    ...
    private void W_CLMDTL_NBR_SERV_3_GetValue(ref decimal Value)
    {
        ...
        try
        {
            ...
            if (QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 2, 2) != "MR" &&
                 QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 2, 2) != "OP" &&
                 QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 7, 1) != "0")
            {
    ...
    private void W_FEE_GetValue(ref decimal Value)
    {
        ...
        try
        {
            ...
            //Value = QDesign.Round(QDesign.Divide(fleF002_CLAIMS_MSTR.GetDecimalValue("CLMDTL_FEE_OHIP"), W_CLMDTL_NBR_SERV.Value));
            Value = QDesign.Divide(fleF002_CLAIMS_MSTR.GetDecimalValue("CLMDTL_FEE_OHIP"), W_CLMDTL_NBR_SERV.Value);
    ...
    private void CLMDTL_SV_DATE_GetValue(ref string Value)
    {
        ...
        try
        {
            Value = QDesign.Substring(QDesign.ASCII(fleF002_CLAIMS_MSTR.GetDecimalValue("CLMDTL_SV_YY"), 4) + QDesign.ASCII(fleF002_CLAIMS_MSTR.GetDecimalValue("CLMDTL_SV_MM"), 2) + QDesign.ASCII(fleF002_CLAIMS_MSTR.GetDecimalValue("CLMDTL_SV_DD"), 2), 1, 8);
    ...
    private void W_CLMDTL_SV_DATE_2_GetValue(ref string Value)
    {
        ...
        try
        {
            Value = QDesign.Substring(QDesign.ASCII(fleF002_CLAIMS_MSTR.GetDecimalValue("CLMDTL_SV_YY"), 4) + QDesign.ASCII(fleF002_CLAIMS_MSTR.GetDecimalValue("CLMDTL_SV_MM"), 2) + QDesign.ASCII(fleF002_CLAIMS_MSTR.GetDecimalValue("CLMDTL_SV_DD"), 2), 1, 6) + QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 5, 2).Trim().PadLeft(2, '0');
    ...
    private void W_CLMDTL_SV_DATE_3_GetValue(ref string Value)
    {
        ...
        try
        {
            Value = QDesign.Substring(QDesign.ASCII(fleF002_CLAIMS_MSTR.GetDecimalValue("CLMDTL_SV_YY"), 4) + QDesign.ASCII(fleF002_CLAIMS_MSTR.GetDecimalValue("CLMDTL_SV_MM"), 2) + QDesign.ASCII(fleF002_CLAIMS_MSTR.GetDecimalValue("CLMDTL_SV_DD"), 2), 1, 6) + QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 8, 2).Trim().PadLeft(2, '0');
    ...
    #region "Standard Generated Procedures(U020B_SELECT_CLMDTL_1)"


    #region "Automatic Item Initialization(U020B_SELECT_CLMDTL_1)"
    ...
    #region "Transaction Management Procedures(U020B_SELECT_CLMDTL_1)"

    //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
    //# Do not delete, modify or move it.  Updated: 6/27/2017 12:28:07 PM
    ...
    #region "FILE Management Procedures(U020B_SELECT_CLMDTL_1)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(U020B_SELECT_CLMDTL_1)"
    ...
    public void Run()
    {
        try
        {
            ...
            while (fleU020A1.QTPForMissing())
            {
                ...
                m_strOrderBy = new StringBuilder(" ORDER BY TRANSLATED_GROUP_NBR, BATCTRL_BATCH_NBR ");
                fleU020A1.GetData("", m_strOrderBy.ToString());
                // --> End GET U020A1 <--
                ...
                while (fleF002_CLAIMS_MSTR.QTPForMissing("1"))
                {
                    ...
                    if (Transaction())
                    {
                        ...
                        "BATCTRL_DATE_BATCH_ENTERED", "ICONST_CLINIC_NBR_1_2", "ICONST_CLINIC_CYCLE_NBR", "ICONST_DATE_PERIOD_END_YY", "ICONST_DATE_PERIOD_END_MM", "ICONST_DATE_PERIOD_END_DD", "CLMHDR_DOC_SPEC_CD", "PAT_HEALTH_NBR", "PAT_VERSION_CD",
                         "CLMHDR_BATCH_NBR", "CLMHDR_CLAIM_NBR", "CLMHDR_ADJ_OMA_CD", "CLMHDR_ADJ_OMA_SUFF", "CLMHDR_ADJ_ADJ_NBR", "W_CLMHDR_HOSP", "CLMHDR_REFER_DOC_NBR",
                        "CLMHDR_DATE_ADMIT", "W_PAT_OHIP_MMYY", "CLMHDR_PAT_KEY_TYPE", "CLMHDR_PAT_KEY_DATA", "CLMHDR_SUB_NBR", "PAT_CHART_NBR", "CLMHDR_MANUAL_REVIEW", "PAT_SURNAME_FIRST3", "PAT_SURNAME_LAST22", "PAT_GIVEN_NAME_FIRST1", "FILLER3", "PAT_BIRTH_DATE_YY", "PAT_BIRTH_DATE_MM", "PAT_BIRTH_DATE_DD", "W_PAT_SEX",
                        "PAT_PROV_CD", "SUBSCR_ADDR1", W_SUBSCR_ADDR2, W_SUBSCR_ADDR3, "SUBSCR_POST_CD1", "SUBSCR_POST_CD2", "SUBSCR_POST_CD3", "SUBSCR_POST_CD4", "SUBSCR_POST_CD5", "SUBSCR_POST_CD6", fleF002_CLAIMS_MSTR, "CLMDTL_OMA_CD", "CLMDTL_OMA_SUFF", W_CLMDTL_FEE_OHIP, "CLMDTL_NBR_SERV",
                        ...
                        "BATCTRL_AGENT_CD", "BATCTRL_DATE_BATCH_ENTERED", "ICONST_CLINIC_NBR_1_2", "ICONST_CLINIC_CYCLE_NBR", "ICONST_DATE_PERIOD_END_YY", "ICONST_DATE_PERIOD_END_MM", "ICONST_DATE_PERIOD_END_DD", "CLMHDR_DOC_SPEC_CD", "PAT_HEALTH_NBR", "PAT_VERSION_CD",
                         "CLMHDR_BATCH_NBR", "CLMHDR_CLAIM_NBR", "CLMHDR_ADJ_OMA_CD", "CLMHDR_ADJ_OMA_SUFF", "CLMHDR_ADJ_ADJ_NBR", "W_CLMHDR_HOSP",
                        "CLMHDR_REFER_DOC_NBR", "CLMHDR_DATE_ADMIT", "W_PAT_OHIP_MMYY", "CLMHDR_PAT_KEY_TYPE", "CLMHDR_PAT_KEY_DATA", "CLMHDR_SUB_NBR", "PAT_CHART_NBR", "CLMHDR_MANUAL_REVIEW", "PAT_SURNAME_FIRST3", "PAT_SURNAME_LAST22", "PAT_GIVEN_NAME_FIRST1", "FILLER3", "PAT_BIRTH_DATE_YY", "PAT_BIRTH_DATE_MM", "PAT_BIRTH_DATE_DD",
                        "W_PAT_SEX", "PAT_PROV_CD", "SUBSCR_ADDR1", W_SUBSCR_ADDR2, W_SUBSCR_ADDR3, "SUBSCR_POST_CD1", "SUBSCR_POST_CD2", "SUBSCR_POST_CD3", "SUBSCR_POST_CD4", "SUBSCR_POST_CD5", "SUBSCR_POST_CD6", fleF002_CLAIMS_MSTR, "CLMDTL_OMA_CD", "CLMDTL_OMA_SUFF", W_CLMDTL_FEE_OHIP_1,
                        ...
                        "BATCTRL_AGENT_CD", "BATCTRL_DATE_BATCH_ENTERED", "ICONST_CLINIC_NBR_1_2", "ICONST_CLINIC_CYCLE_NBR", "ICONST_DATE_PERIOD_END_YY", "ICONST_DATE_PERIOD_END_MM", "ICONST_DATE_PERIOD_END_DD", "CLMHDR_DOC_SPEC_CD", "PAT_HEALTH_NBR", "PAT_VERSION_CD",
                         "CLMHDR_BATCH_NBR", "CLMHDR_CLAIM_NBR", "CLMHDR_ADJ_OMA_CD", "CLMHDR_ADJ_OMA_SUFF", "CLMHDR_ADJ_ADJ_NBR", "W_CLMHDR_HOSP",
                        "CLMHDR_REFER_DOC_NBR", "CLMHDR_DATE_ADMIT", "W_PAT_OHIP_MMYY", "CLMHDR_PAT_KEY_TYPE", "CLMHDR_PAT_KEY_DATA", "CLMHDR_SUB_NBR", "PAT_CHART_NBR", "CLMHDR_MANUAL_REVIEW", "PAT_SURNAME_FIRST3", "PAT_SURNAME_LAST22", "PAT_GIVEN_NAME_FIRST1", "FILLER3", "PAT_BIRTH_DATE_YY", "PAT_BIRTH_DATE_MM", "PAT_BIRTH_DATE_DD",
                        "W_PAT_SEX", "PAT_PROV_CD", "SUBSCR_ADDR1", W_SUBSCR_ADDR2, W_SUBSCR_ADDR3, "SUBSCR_POST_CD1", "SUBSCR_POST_CD2", "SUBSCR_POST_CD3", "SUBSCR_POST_CD4", "SUBSCR_POST_CD5", "SUBSCR_POST_CD6", fleF002_CLAIMS_MSTR, "CLMDTL_OMA_CD", "CLMDTL_OMA_SUFF", W_CLMDTL_FEE_OHIP_2,
                        ...
                        "BATCTRL_AGENT_CD", "BATCTRL_DATE_BATCH_ENTERED", "ICONST_CLINIC_NBR_1_2", "ICONST_CLINIC_CYCLE_NBR", "ICONST_DATE_PERIOD_END_YY", "ICONST_DATE_PERIOD_END_MM", "ICONST_DATE_PERIOD_END_DD", "CLMHDR_DOC_SPEC_CD", "PAT_HEALTH_NBR", "PAT_VERSION_CD",
                         "CLMHDR_BATCH_NBR", "CLMHDR_CLAIM_NBR", "CLMHDR_ADJ_OMA_CD", "CLMHDR_ADJ_OMA_SUFF", "CLMHDR_ADJ_ADJ_NBR", "W_CLMHDR_HOSP",
                        "CLMHDR_REFER_DOC_NBR", "CLMHDR_DATE_ADMIT", "W_PAT_OHIP_MMYY", "CLMHDR_PAT_KEY_TYPE", "CLMHDR_PAT_KEY_DATA", "CLMHDR_SUB_NBR", "PAT_CHART_NBR", "CLMHDR_MANUAL_REVIEW", "PAT_SURNAME_FIRST3", "PAT_SURNAME_LAST22", "PAT_GIVEN_NAME_FIRST1", "FILLER3", "PAT_BIRTH_DATE_YY", "PAT_BIRTH_DATE_MM", "PAT_BIRTH_DATE_DD",
                        "W_PAT_SEX", "PAT_PROV_CD", "SUBSCR_ADDR1", W_SUBSCR_ADDR2, W_SUBSCR_ADDR3, "SUBSCR_POST_CD1", "SUBSCR_POST_CD2", "SUBSCR_POST_CD3", "SUBSCR_POST_CD4", "SUBSCR_POST_CD5", "SUBSCR_POST_CD6", fleF002_CLAIMS_MSTR, "CLMDTL_OMA_CD", "CLMDTL_OMA_SUFF", W_CLMDTL_FEE_OHIP_3,
...
public class U020B_CHECK_SLI_2 : U020B
{

    public U020B_CHECK_SLI_2(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        fleU020B = new SqlFileObject(this, FileTypes.Primary, 0, "TEMPORARYDATA", "U020B", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SubFile);
    ...
    #region "Declarations (Variables, Files and Transactions)(U020B_CHECK_SLI_2)"
    ...
    private void CLAIM_KEY_GetValue(ref string Value)
    {
        ...
        try
        {
            Value = QDesign.Substring(fleU020B.GetStringValue("CLMHDR_BATCH_NBR") + fleU020B.GetStringValue("CLMHDR_CLAIM_NBR").PadLeft(2,'0'), 1, 10);
    ...
    private void fleTMP_COUNTERS_ALPHA_SetItemFinals()
    {
        ...
        try
        {
            fleTMP_COUNTERS_ALPHA.set_SetValue("TMP_COUNTER_KEY_ALPHA", CLAIM_KEY.Value);
            fleTMP_COUNTERS_ALPHA.set_SetValue("TMP_COUNTER_1", SLI_COUNT.Value);
    ...
    #region "Standard Generated Procedures(U020B_CHECK_SLI_2)"


    #region "Automatic Item Initialization(U020B_CHECK_SLI_2)"
    ...
    #region "Transaction Management Procedures(U020B_CHECK_SLI_2)"
    ...
    #region "FILE Management Procedures(U020B_CHECK_SLI_2)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(U020B_CHECK_SLI_2)"
        ...
        try
        {
            ...
            while (fleU020B.QTPForMissing())
            {
                ...
                while (fleF201_SLI_OMA_CODE_SUFF.QTPForMissing("1"))
                {
                    ...
                    m_strWhere.Append(Common.StringToField(fleU020B.GetStringValue("CLMDTL_OMA_CD")));
                    m_strWhere.Append(" And ").Append(fleF201_SLI_OMA_CODE_SUFF.ElementOwner("CLMDTL_OMA_SUFF")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(fleU020B.GetStringValue("CLMDTL_OMA_SUFF")));
...
public class U020B_CREATE_TAPE_3 : U020B
{
    // GW2019. Arp 19. Added
    private int w_batctrl_batch_nbr_count = 0;

    public U020B_CREATE_TAPE_3(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        fleU020B = new SqlFileObject(this, FileTypes.Primary, 0, "TEMPORARYDATA", "U020B", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SubFile);
        ...
        X_ACCOUNTING_NBR.GetValue += X_ACCOUNTING_NBR_GetValue;
    ...
    #region "Declarations (Variables, Files and Transactions)(U020B_CREATE_TAPE_3)"
    ...
    private void W_CLMHDR_CLAIM_ID_GetValue(ref string Value)
    {
        ...
        try
        {
            Value = QDesign.Substring(fleU020B.GetStringValue("CLMHDR_BATCH_NBR") + fleU020B.GetStringValue("CLMHDR_CLAIM_NBR").Trim().PadLeft(2, '0'), 1, 10) + fleU020B.GetStringValue("PAT_VERSION_CD");
    ...
    private void W_BATCH_IND_GetValue(ref string Value)
    {
        ...
        try
        {
            ...
            Value = QDesign.ASCII(((QDesign.SysDate(ref m_cnnQUERY) * 10000) + w_batctrl_batch_nbr_count), 12);
    ...
    private void W_PAT_HEALTH_NBR_GetValue(ref string Value)
    {
        ...
        {
            string CurrentValue = string.Empty;
            if (QDesign.NULL(fleU020B.GetDecimalValue("PAT_HEALTH_NBR")) != 0 & QDesign.NULL(fleU020B.GetDecimalValue("PAT_HEALTH_NBR")) != 1111111116)
            {
    ...
    private void W_PAT_INFO_GetValue(ref string Value)
    {
        ...
        try
        {
            ...
            {
                CurrentValue = W_PAT_HEALTH_NBR.Value + fleU020B.GetStringValue("PAT_VERSION_CD") + QDesign.ASCII(fleU020B.GetDecimalValue("PAT_BIRTH_DATE_YY"), 4) + QDesign.ASCII(fleU020B.GetDecimalValue("PAT_BIRTH_DATE_MM"), 2) + QDesign.ASCII(fleU020B.GetDecimalValue("PAT_BIRTH_DATE_DD"), 2);
            }
            else
            {
                CurrentValue = " ";
    ...
    private void W_CLAIM_HEADER_REC_1_GetValue(ref string Value)
    {
        ...
        try
        {
            Value = W_CLAIM_1_IDENT.Value + W_PAT_INFO.Value + QDesign.Substring(fleU020B.GetStringValue("CLMHDR_BATCH_NBR") + fleU020B.GetStringValue("CLMHDR_CLAIM_NBR").Trim().PadLeft(2,'0'), 3, 8) + W_PAY_PROGRAM.Value + W_PAYEE.Value + W_CLMHDR_REFER_DOC_NBR.Value + fleU020B.GetStringValue("W_CLMHDR_HOSP") + W_CLMHDR_DATE_ADMIT.Value + "    " + W_CLMHDR_MANUAL_REVIEW.Value + W_MOH_SLI_CODE.Value + W_RESERVED_OCC_HDR1.Value;
    ...
    private void W_CLAIM_HEADER_REC_2_GetValue(ref string Value)
    {
        ...
        try
        {
            Value = W_CLAIM_2_IDENT.Value + W_PAT_OHIP_NBR.Value + QDesign.Substring(fleU020B.GetStringValue("PAT_SURNAME_FIRST3") + fleU020B.GetStringValue("PAT_SURNAME_LAST22"), 1, 9) + QDesign.Substring(fleU020B.GetStringValue("PAT_GIVEN_NAME_FIRST1") + fleU020B.GetStringValue("FILLER3"), 1, 5) + fleU020B.GetStringValue("W_PAT_SEX") + fleU020B.GetStringValue("PAT_PROV_CD");
    ...
    private DCharacter X_ACCOUNTING_NBR = new DCharacter("X_ACCOUNTING_NBR", 8);
    private void X_ACCOUNTING_NBR_GetValue(ref string Value)
    {

        try
        {
            Value = QDesign.Substring(fleU020B.GetStringValue("CLMHDR_BATCH_NBR") + fleU020B.GetStringValue("CLMHDR_CLAIM_NBR").PadLeft(2,'0'), 3, 8);
    ...
    private void fleF099_GROUP_CLAIM_MSTR_SetItemFinals()
    {
        try
        {
            fleF099_GROUP_CLAIM_MSTR.set_SetValue("CLMHDR_BATCH_NBR", fleU020B.GetStringValue("CLMHDR_BATCH_NBR"));
            fleF099_GROUP_CLAIM_MSTR.set_SetValue("CLMHDR_CLAIM_NBR", fleU020B.GetDecimalValue("CLMHDR_CLAIM_NBR"));

            fleF099_GROUP_CLAIM_MSTR.set_SetValue("ACCOUNTING_NBR", X_ACCOUNTING_NBR.Value);
            fleF099_GROUP_CLAIM_MSTR.set_SetValue("GROUP_NBR", fleU020B.GetStringValue("TRANSLATED_GROUP_NBR"));
    ...
    #region "Standard Generated Procedures(U020B_CREATE_TAPE_3)"


    #region "Automatic Item Initialization(U020B_CREATE_TAPE_3)"
    ...
    #region "Transaction Management Procedures(U020B_CREATE_TAPE_3)"
    ...
    #region "FILE Management Procedures(U020B_CREATE_TAPE_3)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(U020B_CREATE_TAPE_3)"
        ...
        try
        {
            ...
            while (fleU020B.QTPForMissing())
            {
                ...
                while (fleTMP_COUNTERS_ALPHA.QTPForMissing("1"))
                {
                    ...
                    m_strWhere.Append(Common.StringToField(QDesign.Substring(fleU020B.GetStringValue("CLMHDR_BATCH_NBR") + fleU020B.GetStringValue("CLMHDR_CLAIM_NBR").PadLeft(2, '0'), 1, 10)));
            ...
            // GW2019. Added Sort break processing
            string sort_key = "";
            string prev_sort_key = "";
            w_batctrl_batch_nbr_count = 0;

            while (Sort(fleU020B, fleTMP_COUNTERS_ALPHA))
            {

                sort_key = fleU020B.GetStringValue("CONTRACT_CODE") + fleU020B.GetStringValue("TRANSLATED_GROUP_NBR") + fleU020B.GetStringValue("BATCTRL_BATCH_NBR");

                if (!sort_key.Equals(prev_sort_key))
                    ++w_batctrl_batch_nbr_count;
                ...
                {
                    Count(ref W_R_COUNT, fleU020B.At("CONTRACT_CODE") || fleU020B.At("TRANSLATED_GROUP_NBR") || fleU020B.At("BATCTRL_BATCH_NBR") || At(W_CLMHDR_CLAIM_ID));
                }
                ...
                {
                    Count(ref W_A_COUNT, fleU020B.At("CONTRACT_CODE") || fleU020B.At("TRANSLATED_GROUP_NBR") || fleU020B.At("BATCTRL_BATCH_NBR") || At(W_CLMHDR_CLAIM_ID));
                }
                ...
                Reset(ref W_H_COUNT, fleU020B.At("CONTRACT_CODE") || fleU020B.At("TRANSLATED_GROUP_NBR") || fleU020B.At("BATCTRL_BATCH_NBR"));
                Reset(ref W_R_COUNT, fleU020B.At("CONTRACT_CODE") || fleU020B.At("TRANSLATED_GROUP_NBR") || fleU020B.At("BATCTRL_BATCH_NBR"));
                Reset(ref W_T_COUNT, fleU020B.At("CONTRACT_CODE") || fleU020B.At("TRANSLATED_GROUP_NBR") || fleU020B.At("BATCTRL_BATCH_NBR"));
                Reset(ref W_A_COUNT, fleU020B.At("CONTRACT_CODE") || fleU020B.At("TRANSLATED_GROUP_NBR") || fleU020B.At("BATCTRL_BATCH_NBR"));
                ...
                Count(ref W_BATCH_COUNT, fleU020B.At("CONTRACT_CODE") || fleU020B.At("TRANSLATED_GROUP_NBR") || fleU020B.At("BATCTRL_BATCH_NBR"));

                prev_sort_key = sort_key;

                // GW2019. Added to write out final HEE record
                SubFile(ref m_trnTRANS_UPDATE, ref fleU020_TAPE_T, AtFinal(), SubFileType.Keep, W_TRAILER_REC);
            }
