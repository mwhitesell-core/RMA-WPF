...
public class U022A1_EXTRACT_1 : U022A1
{
    ...
    public override bool SelectIf()
    {
        ...
        try
        {
            if (fleF002_CLAIMS_MSTR.GetDecimalValue("CLMHDR_SERV_DATE") < 10000000 && fleF002_CLAIMS_MSTR.GetDecimalValue("CLMHDR_SERV_DATE") > 0)
            {
                return false;
            }
            else if (((QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_BATCH_TYPE")) == "C"
                & QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_ADJ_OMA_CD")) == "0000"
                & QDesign.NULL(fleCONTRACT_DTL.GetStringValue("MOH_FLAG")) == "Y"
                & BALANCE_DUE.Value > 0
                & ((QDesign.NULL(fleICONST_MSTR_REC.GetStringValue("ICONST_CLINIC_CARD_COLOUR")) == "O"
                & QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_STATUS_OHIP")) != "I2"
                & QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_STATUS_OHIP")) != "35")

                | (QDesign.NULL(fleICONST_MSTR_REC.GetStringValue("ICONST_CLINIC_CARD_COLOUR")) != "O"))

                & (QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_MSG_NBR") + fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_REPRINT_FLAG") + fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_SUB_NBR") + fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_AUTO_LOGOUT") + fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_FEE_COMPLEX") + fleF002_CLAIMS_MSTR.GetStringValue("FILLER")) == " "

                | QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_MSG_NBR") + fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_REPRINT_FLAG") + fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_SUB_NBR") + fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_AUTO_LOGOUT") + fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_FEE_COMPLEX") + fleF002_CLAIMS_MSTR.GetStringValue("FILLER")) == "      00"

                | QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_MSG_NBR") + fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_REPRINT_FLAG") + fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_SUB_NBR") + fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_AUTO_LOGOUT") + fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_FEE_COMPLEX") + fleF002_CLAIMS_MSTR.GetStringValue("FILLER")) == "00000000")

                & X_DAYS_SINCE_PED.Value < 365
                & ((QDesign.NULL(TWO_RATS_PROCESSED.Value) == "Y" & (QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_TAPE_SUBMIT_IND")) != "H" & QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_TAPE_SUBMIT_IND")) != "C"))
                | QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_TAPE_SUBMIT_IND")) == "R")))
                | (QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_TAPE_SUBMIT_IND")) == "X"
                & QDesign.NULL(fleCONTRACT_DTL.GetStringValue("MOH_FLAG")) == "Y"
                & BALANCE_DUE.Value > 0
                & QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_BATCH_TYPE")) == "C"
                & QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_ADJ_OMA_CD")) == "0000"
                & (QDesign.NULL(fleICONST_MSTR_REC.GetStringValue("ICONST_CLINIC_CARD_COLOUR")) != "O"
                | QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_STATUS_OHIP")) != "I2"))
                | (QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_TAPE_SUBMIT_IND")) == "X"
                ...
                & QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_BATCH_TYPE")) == "C"
                & QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_ADJ_OMA_CD")) == "0000"
                & fleF010_PAT_MSTR.GetDecimalValue("PAT_HEALTH_NBR") == 1111111116)
                | (X_DAYS_SINCE_SERVICE.Value >= 150
                & fleF002_CLAIMS_MSTR.GetDecimalValue("CLMHDR_SUBMIT_DATE") == 0
                & QDesign.NULL(fleCONTRACT_DTL.GetStringValue("MOH_FLAG")) == "Y"
                & BALANCE_DUE.Value > 0
                & QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_BATCH_TYPE")) == "C"
                & QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_ADJ_OMA_CD")) == "0000"
                & QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_TAPE_SUBMIT_IND")) != " ")
            )
            {
                return true;
            }
    ...
    private void fleF002_CLAIMS_MSTR_SelectIf(ref string SelectIfClause)
    {
        try
        {
            ...
            strSQL.Append("     [KEY_CLM_BATCH_NBR] in (select [KEY_CLM_BATCH_NBR] from [INDEXED].[F002_OUTSTANDING]) ");
            strSQL.Append("     and [KEY_CLM_CLAIM_NBR] in (select [KEY_CLM_CLAIM_NBR] from [INDEXED].[F002_OUTSTANDING]) ");
            strSQL.Append(" 	and ");

            strSQL.Append(" (    (       ");
            strSQL.Append("                       clmhdr_batch_type = 'C'                            ");
            strSQL.Append("                   and clmhdr_adj_oma_cd = '0000'                         ");
            strSQL.Append("                   and 'Y'  in (select moh_flag from [INDEXED].[CONTRACT_DTL] where CLINIC_NBR = SUBSTRING(KEY_CLM_BATCH_NBR,1,2) and AGENT_CD = CLMHDR_AGENT_CD)                                     ");
            strSQL.Append("                   and (CLMHDR_TOT_CLAIM_AR_OHIP + CLMHDR_MANUAL_AND_TAPE_PAYMENTS) > 0                                    ");
            strSQL.Append("                   and (                                                                                             ");
            strSQL.Append("                            (   'O' in (select iconst_clinic_card_colour from [INDEXED].[ICONST_MSTR_REC] where ICONST_CLINIC_NBR_1_2 = SUBSTRING(KEY_CLM_BATCH_NBR,1,2))           ");
            strSQL.Append("  ");
            strSQL.Append("                                           and clmhdr_status_ohip <> 'I2'               ");
            strSQL.Append("                                           and clmhdr_status_ohip <> '35'               ");
            strSQL.Append("                                   )                                                                                     ");
            strSQL.Append("                         or (     'O' not in (select iconst_clinic_card_colour from [INDEXED].[ICONST_MSTR_REC] where ICONST_CLINIC_NBR_1_2 = SUBSTRING(KEY_CLM_BATCH_NBR,1,2))        ");
            strSQL.Append("                                                 )                                                                                       ");
            strSQL.Append("                                      )                                                                                   ");
            strSQL.Append("                   and  (   CLMHDR_MSG_NBR + CLMHDR_REPRINT_FLAG + CLMHDR_SUB_NBR + CLMHDR_AUTO_LOGOUT + CLMHDR_FEE_COMPLEX + FILLER = ' '           ");
            strSQL.Append("                         or CLMHDR_MSG_NBR + CLMHDR_REPRINT_FLAG + CLMHDR_SUB_NBR + CLMHDR_AUTO_LOGOUT + CLMHDR_FEE_COMPLEX + FILLER = '     00'    ");
            strSQL.Append("                         or CLMHDR_MSG_NBR + CLMHDR_REPRINT_FLAG + CLMHDR_SUB_NBR + CLMHDR_AUTO_LOGOUT + CLMHDR_FEE_COMPLEX + FILLER = '00000000'    ");
            strSQL.Append("                        )                                                 ");
            strSQL.Append("                                                                                   ");
            strSQL.Append("                                                                                                                                ");
            strSQL.Append("                  )                                                                                                      ");
            strSQL.Append("             )                                                            ");
            strSQL.Append("          or (    clmhdr_tape_submit_ind = 'X'                            ");
            strSQL.Append("              and 'Y'  in (select moh_flag from [INDEXED].[CONTRACT_DTL] where CLINIC_NBR = SUBSTRING(KEY_CLM_BATCH_NBR,1,2) and AGENT_CD = CLMHDR_AGENT_CD)                                         ");
            strSQL.Append("              and (CLMHDR_TOT_CLAIM_AR_OHIP + CLMHDR_MANUAL_AND_TAPE_PAYMENTS) > 0                                                      ");
            strSQL.Append("              and clmhdr_batch_type = 'C'                            ");
            strSQL.Append("              and clmhdr_adj_oma_cd = '0000'                         ");
            strSQL.Append("              and (   'O' not in (select iconst_clinic_card_colour from [INDEXED].[ICONST_MSTR_REC] where ICONST_CLINIC_NBR_1_2 = SUBSTRING(KEY_CLM_BATCH_NBR,1,2))                   ");
            strSQL.Append("                   or clmhdr_status_ohip <> 'I2'                          ");
            strSQL.Append("                  )                                                       ");
            strSQL.Append("             )                                                                                                           ");
            strSQL.Append("          or (    clmhdr_tape_submit_ind = 'X'                            ");
            strSQL.Append("              and 'Y'  in (select moh_flag from [INDEXED].[CONTRACT_DTL] where CLINIC_NBR = SUBSTRING(KEY_CLM_BATCH_NBR,1,2) and AGENT_CD = CLMHDR_AGENT_CD)                                          ");
            ...
            strSQL.Append("              and clmhdr_adj_oma_cd = '0000'                                             ");
            strSQL.Append("                    )                                                                                                                    ");
            strSQL.Append("          or (     clmhdr_submit_date =  0                                 ");
            strSQL.Append("              and 'Y'  in (select moh_flag from [INDEXED].[CONTRACT_DTL] where CLINIC_NBR = SUBSTRING(KEY_CLM_BATCH_NBR,1,2) and AGENT_CD = CLMHDR_AGENT_CD)                                          ");
            strSQL.Append("              and (CLMHDR_TOT_CLAIM_AR_OHIP + CLMHDR_MANUAL_AND_TAPE_PAYMENTS) > 0                                          ");
            strSQL.Append("              and clmhdr_batch_type = 'C'                            ");
            strSQL.Append("              and clmhdr_adj_oma_cd = '0000'                         ");
            strSQL.Append("                     and clmhdr_tape_submit_ind <> ' '                                       ");
            strSQL.Append("             ) ");
    ...
    private void CLMHDR_CLAIM_ID_GetValue(ref string Value)
    {
        try
        {
            Value = fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_BATCH_NBR").PadRight(8, ' ') + QDesign.ASCII(fleF002_CLAIMS_MSTR.GetDecimalValue("CLMHDR_CLAIM_NBR"), 2) + fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_ADJ_OMA_CD").PadRight(4, ' ') + fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_ADJ_OMA_SUFF").PadRight(1, ' ') + fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_ADJ_ADJ_NBR").PadRight(1, ' ');
        }
        ...
        try
        {
            ...
            while (fleF002_CLAIMS_MSTR.QTPForMissing())
            {
                ...
                while (fleF002_OUTSTANDING.QTPForMissing("1"))
                {
                    ...
                    m_strWhere.Append(Common.StringToField(fleF002_CLAIMS_MSTR.GetStringValue("KEY_CLM_TYPE")));
                                    ...
                                    while (fleF030_LOCATIONS_MSTR.QTPForMissing("6"))
                                    {
                                        ...
                                        if (Transaction())
                                        {
                                            ...
                                            if (Select_If())
                                            {
                                                ...
                                                CLMHDR_CLAIM_ID, "CLMHDR_CLAIM_NBR", W_CLMHDR_HOSP, "CLMHDR_DATE_ADMIT", "CLMHDR_PAT_KEY_TYPE", "CLMHDR_PAT_KEY_DATA", "CLMHDR_REFER_DOC_NBR", "CLMHDR_LOC", "CLMHDR_I_O_PAT_IND", "CLMHDR_AGENT_CD", "CLMHDR_TOT_CLAIM_AR_OMA",
                                                ...
                                                "CLMHDR_BATCH_NBR", "CLMHDR_CLAIM_NBR", "CLMHDR_ADJ_OMA_SUFF", "CLMHDR_ADJ_ADJ_NBR",
                                                "CLMHDR_DATE_SYS", X_DAYS_SINCE_SERVICE, D_SYSDATE, "CLMHDR_SUBMIT_DATE", X_REC_COUNT, "CLMHDR_SERV_DATE");
