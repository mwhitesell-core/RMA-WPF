...
public class U022B_SELECT_CLMDTL_1 : U022B
{
    ...
    private void W_CLMDTL_NBR_SERV_1_GetValue(ref decimal Value)
    {
        ...
        try
        {
            ...
            if (QDesign.NULL(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"),2,2)) != "MR" &&
                QDesign.NULL(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 2, 2)) != "OP" &&
                QDesign.NULL(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 1, 1)) != "0")
            {
    ...
    private void W_CLMDTL_NBR_SERV_2_GetValue(ref decimal Value)
    {
        ...
        try
        {
            ...
            if (QDesign.NULL(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 2, 2)) != "MR" &&
               QDesign.NULL(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 2, 2)) != "OP" &&
               QDesign.NULL(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 4, 1)) != "0")
            {
    ...
    private void W_CLMDTL_NBR_SERV_3_GetValue(ref decimal Value)
    {
        ...
        try
        {
            ...
            if (QDesign.NULL(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 2, 2)) != "MR" &&
                QDesign.NULL(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 2, 2)) != "OP" &&
                QDesign.NULL(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 7, 1)) != "0")
            {
    ...
    private void CLMDTL_SV_DATE_GetValue(ref string Value)
    {
        ...
        try
        {
            ...
            Value =  QDesign.ASCII(Convert.ToInt64(fleF002_CLAIMS_MSTR.GetDecimalValue("CLMDTL_SV_YY").ToString().PadLeft(4, '0')
                            + fleF002_CLAIMS_MSTR.GetDecimalValue("CLMDTL_SV_MM").ToString().PadLeft(2, '0')
                            + fleF002_CLAIMS_MSTR.GetDecimalValue("CLMDTL_SV_DD").ToString().PadLeft(2, '0')), 8);
    ...
    private void W_CLMDTL_SV_DATE_1_GetValue(ref string Value)
    {
        ...
        try
        {
            Value = QDesign.Substring(CLMDTL_SV_DATE.Value,1,6) + QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"),2,2);
    ...
    private void W_CLMDTL_SV_DATE_2_GetValue(ref string Value)
    {
        ...
        try
        {
            Value = QDesign.Substring(CLMDTL_SV_DATE.Value, 1, 6) + QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 5, 2);
    ...
    private void W_CLMDTL_SV_DATE_3_GetValue(ref string Value)
    {
        ...
        try
        {
            Value = QDesign.Substring(CLMDTL_SV_DATE.Value, 1, 6) + QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R"), 8, 2);
            ...
            while (fleU020A1.QTPForMissing())
            {
                ...
                while (fleF002_CLAIMS_MSTR.QTPForMissing("1"))
                {
                    ...
                    if (Transaction())
                    {
                        ...
                        SubFile(ref m_trnTRANS_UPDATE, ref fleU020B1, QDesign.NULL(W_CLMDTL_NBR_SERV_1.Value) != 0, SubFileType.Keep, fleU020A1, "BATCTRL_BATCH_NBR", "BATCTRL_BATCH_TYPE", "BATCTRL_CLINIC_NBR", "BATCTRL_DOC_NBR_OHIP", "BATCTRL_LOC", "BATCTRL_AGENT_CD", 
                        "BATCTRL_DATE_BATCH_ENTERED", "ICONST_CLINIC_NBR_1_2", "ICONST_CLINIC_CYCLE_NBR", "ICONST_DATE_PERIOD_END_YY", "ICONST_DATE_PERIOD_END_MM", "ICONST_DATE_PERIOD_END_DD", "CLMHDR_DOC_SPEC_CD", "PAT_HEALTH_NBR", "PAT_VERSION_CD",
                        "CLMHDR_BATCH_NBR", "CLMHDR_CLAIM_NBR", "CLMHDR_ADJ_OMA_CD", "CLMHDR_ADJ_OMA_SUFF", "CLMHDR_ADJ_ADJ_NBR", "W_CLMHDR_HOSP", "CLMHDR_REFER_DOC_NBR", 
                        "CLMHDR_DATE_ADMIT", "W_PAT_OHIP_MMYY", "CLMHDR_PAT_KEY_TYPE", "CLMHDR_PAT_KEY_DATA", "CLMHDR_SUB_NBR", "PAT_CHART_NBR", "CLMHDR_MANUAL_REVIEW", "PAT_SURNAME_FIRST3", "PAT_SURNAME_LAST22", "PAT_GIVEN_NAME_FIRST1", "FILLER3", "PAT_BIRTH_DATE_YY", "PAT_BIRTH_DATE_MM", "PAT_BIRTH_DATE_DD", "W_PAT_SEX", 
                        "PAT_PROV_CD", "SUBSCR_ADDR1", W_SUBSCR_ADDR2, W_SUBSCR_ADDR3, "SUBSCR_POST_CD1", "SUBSCR_POST_CD2", "SUBSCR_POST_CD3", "SUBSCR_POST_CD4", "SUBSCR_POST_CD5", "SUBSCR_POST_CD6", fleF002_CLAIMS_MSTR, "CLMDTL_OMA_CD", "CLMDTL_OMA_SUFF", W_CLMDTL_FEE_OHIP_1, W_CLMDTL_NBR_SERV_1, 
                        W_CLMDTL_SV_DATE_1, "CLMDTL_DIAG_CD", "CLMDTL_LINE_NO", fleU020A1, "TRANSLATED_GROUP_NBR", "W_MOH_LOCATION_CODE", "CONTRACT_CODE");




                        SubFile(ref m_trnTRANS_UPDATE, ref fleU020B2, QDesign.NULL(W_CLMDTL_NBR_SERV_2.Value) != 0, SubFileType.Keep, fleU020A1, "BATCTRL_BATCH_NBR", "BATCTRL_BATCH_TYPE", "BATCTRL_CLINIC_NBR", "BATCTRL_DOC_NBR_OHIP", "BATCTRL_LOC", "BATCTRL_AGENT_CD", 
                        "BATCTRL_DATE_BATCH_ENTERED", "ICONST_CLINIC_NBR_1_2", "ICONST_CLINIC_CYCLE_NBR", "ICONST_DATE_PERIOD_END_YY", "ICONST_DATE_PERIOD_END_MM", "ICONST_DATE_PERIOD_END_DD", "CLMHDR_DOC_SPEC_CD", "PAT_HEALTH_NBR", "PAT_VERSION_CD",
                        "CLMHDR_BATCH_NBR", "CLMHDR_CLAIM_NBR", "CLMHDR_ADJ_OMA_CD", "CLMHDR_ADJ_OMA_SUFF", "CLMHDR_ADJ_ADJ_NBR", "W_CLMHDR_HOSP", "CLMHDR_REFER_DOC_NBR", 
                        "CLMHDR_DATE_ADMIT", "W_PAT_OHIP_MMYY", "CLMHDR_PAT_KEY_TYPE", "CLMHDR_PAT_KEY_DATA", "CLMHDR_SUB_NBR", "PAT_CHART_NBR", "CLMHDR_MANUAL_REVIEW", "PAT_SURNAME_FIRST3", "PAT_SURNAME_LAST22", "PAT_GIVEN_NAME_FIRST1", "FILLER3", "PAT_BIRTH_DATE_YY", "PAT_BIRTH_DATE_MM", "PAT_BIRTH_DATE_DD", "W_PAT_SEX", 
                        "PAT_PROV_CD", "SUBSCR_ADDR1", W_SUBSCR_ADDR2, W_SUBSCR_ADDR3, "SUBSCR_POST_CD1", "SUBSCR_POST_CD2", "SUBSCR_POST_CD3", "SUBSCR_POST_CD4", "SUBSCR_POST_CD5", "SUBSCR_POST_CD6", fleF002_CLAIMS_MSTR, "CLMDTL_OMA_CD", "CLMDTL_OMA_SUFF", W_CLMDTL_FEE_OHIP_2,  W_CLMDTL_NBR_SERV_2, 
                        W_CLMDTL_SV_DATE_2, "CLMDTL_DIAG_CD", "CLMDTL_LINE_NO", fleU020A1, "TRANSLATED_GROUP_NBR", "W_MOH_LOCATION_CODE", "CONTRACT_CODE");
                        ...
                        "CLMHDR_BATCH_NBR", "CLMHDR_CLAIM_NBR", "CLMHDR_ADJ_OMA_CD", "CLMHDR_ADJ_OMA_SUFF", "CLMHDR_ADJ_ADJ_NBR", "W_CLMHDR_HOSP", "CLMHDR_REFER_DOC_NBR", 
                        "CLMHDR_DATE_ADMIT", "W_PAT_OHIP_MMYY", "CLMHDR_PAT_KEY_TYPE", "CLMHDR_PAT_KEY_DATA", "CLMHDR_SUB_NBR", "PAT_CHART_NBR", "CLMHDR_MANUAL_REVIEW", "PAT_SURNAME_FIRST3", "PAT_SURNAME_LAST22", "PAT_GIVEN_NAME_FIRST1", "FILLER3", "PAT_BIRTH_DATE_YY", "PAT_BIRTH_DATE_MM", "PAT_BIRTH_DATE_DD", "W_PAT_SEX", 
                        "PAT_PROV_CD", "SUBSCR_ADDR1", W_SUBSCR_ADDR2, W_SUBSCR_ADDR3, "SUBSCR_POST_CD1", "SUBSCR_POST_CD2", "SUBSCR_POST_CD3", "SUBSCR_POST_CD4", "SUBSCR_POST_CD5", "SUBSCR_POST_CD6", fleF002_CLAIMS_MSTR, "CLMDTL_OMA_CD", "CLMDTL_OMA_SUFF", W_CLMDTL_FEE_OHIP_3,  W_CLMDTL_NBR_SERV_3, 
                        W_CLMDTL_SV_DATE_3, "CLMDTL_DIAG_CD", "CLMDTL_LINE_NO", fleU020A1, "TRANSLATED_GROUP_NBR", "W_MOH_LOCATION_CODE", "CONTRACT_CODE");
...
public class U022B_CHECK_SLI_2 : U022B
{
    ...
    private void CLAIM_KEY_GetValue(ref string Value)
    {
        ...
        try
        {
            Value= QDesign.Substring(fleU020B.GetStringValue("CLMHDR_BATCH_NBR") + fleU020B.GetStringValue("CLMHDR_CLAIM_NBR").Trim().PadLeft(2, '0'), 1, 10);
...
public class U022B_CREATE_TAPE_3 : U022B
{
    ...
    private void W_CLMHDR_CLAIM_ID_GetValue(ref string Value)
    {
        ...
        try
        {
            Value = fleU020B.GetStringValue("CLMHDR_BATCH_NBR") + fleU020B.GetStringValue("CLMHDR_CLAIM_NBR").Trim().PadLeft(2, '0') + fleU020B.GetStringValue("PAT_VERSION_CD");
    ...
    private void W_PAT_INFO_GetValue(ref string Value)
    {
        ...
        try
        {
            ...
            {
                CurrentValue = W_PAT_HEALTH_NBR.Value + fleU020B.GetStringValue("PAT_VERSION_CD") +
                    QDesign.ASCII(Convert.ToInt64(fleU020B.GetDecimalValue("PAT_BIRTH_DATE_YY").ToString().PadLeft(4, '0')
                            + fleU020B.GetDecimalValue("PAT_BIRTH_DATE_MM").ToString().PadLeft(2, '0')
                            + fleU020B.GetDecimalValue("PAT_BIRTH_DATE_DD").ToString().PadLeft(2, '0')), 8);
            }
            else
            {
                CurrentValue = " ";
        ...
        try
        {
            ...
            while (fleU020B.QTPForMissing())
            {
                ...
                while (fleTMP_COUNTERS_ALPHA.QTPForMissing("1"))
                {
                    ...
                    m_strWhere.Append(Common.StringToField(QDesign.Substring(fleU020B.GetStringValue("CLMHDR_BATCH_NBR") + fleU020B.GetStringValue("CLMHDR_CLAIM_NBR").Trim().PadLeft(2, '0'), 1, 10)));
