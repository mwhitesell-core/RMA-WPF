...
public class U030B_PART3_A_EVALUATE_CLINIC_AMT_1 : U030B_PART3_A
{
    ...
    {
        this.ScreenType = ScreenTypes.QTP;
        fleR031A_OHIP_PREMIUMS = new SqlFileObject(this, FileTypes.Primary, 0, "SEQUENTIAL", "R031A", "", false, false, false, 0, "m_trnTRANS_UPDATE");
...
public class U030B_PART3_A_SEL_DOCTOR_2 : U030B_PART3_A
{
    ...
    private void DOC_DATE_FAC_START_GetValue(ref decimal Value)
    {
        try
        {
            Value = QDesign.NConvert(QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_START_YY"), 4) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_START_MM"), 2) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_START_DD"), 2));
        }
        ...
        try
        {
            ...
            while (fleR031A_EXTRACT_DATA.QTPForMissing())
            {
                ...
                while (fleF020_DOCTOR_MSTR.QTPForMissing("1"))
                {
                    ...
                    m_strWhere.Append((fleR031A_EXTRACT_DATA.GetDecimalValue("DOC_OHIP_NBR")));

                    m_strOrderBy = new StringBuilder(" ORDER BY ").Append(fleF020_DOCTOR_MSTR.ElementOwner("DOC_DATE_FAC_TERM_YY")).Append(" DESC ");

                    fleF020_DOCTOR_MSTR.GetData(m_strWhere.ToString(), m_strOrderBy.ToString(), GetDataOptions.IsOptional);
                    ...
                    if (Transaction())
                    {
                         ...
                         if (Select_If())
                        {
                            ...
                            Sort(fleR031A_EXTRACT_DATA.GetSortValue("ICONST_CLINIC_NBR_1_2"), fleR031A_EXTRACT_DATA.GetSortValue("X_ADJ_CD"), fleR031A_EXTRACT_DATA.GetSortValue("DOC_OHIP_NBR"));
            ...
            while (Sort(fleR031A_EXTRACT_DATA, fleF020_DOCTOR_MSTR))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleR031A_SORT_DOCTOR, fleR031A_EXTRACT_DATA.At("ICONST_CLINIC_NBR_1_2") || fleR031A_EXTRACT_DATA.At("X_ADJ_CD") || fleR031A_EXTRACT_DATA.At("DOC_OHIP_NBR"), SubFileType.Keep, fleR031A_EXTRACT_DATA, "DOC_OHIP_NBR", fleF020_DOCTOR_MSTR, "DOC_NBR", DOC_DATE_FAC_START, DOC_DATE_FAC_TERM,
                fleR031A_EXTRACT_DATA, "ICONST_CLINIC_NBR_1_2", "X_PAYMENT", "X_ADJ_CD", fleF020_DOCTOR_MSTR, "DOC_DEPT", XCOUNT);



                Reset(ref XCOUNT, fleR031A_EXTRACT_DATA.At("ICONST_CLINIC_NBR_1_2") || fleR031A_EXTRACT_DATA.At("X_ADJ_CD") || fleR031A_EXTRACT_DATA.At("DOC_OHIP_NBR"));
...
public class U030B_PART3_A_SEL_MULTIPLE_DOCTORS_4 : U030B_PART3_A
{
    ...
    public override bool SelectIf()
    {
        ...
        try
        {
            if (fleR031A_SORT_DOCTOR.GetDecimalValue("DOC_OHIP_NBR") == 231472)
                i = 1;
                        ...
                        if (Transaction())
                        {
                            if (Select_If())
                            {
                                SubFile(ref m_trnTRANS_UPDATE, ref fleR031A_MULTIPLE_DOCTOR, SubFileType.Keep, fleR031A_SORT_DOCTOR, "DOC_OHIP_NBR", fleF020_DOCTOR_MSTR, "DOC_NBR", DOC_DATE_FAC_START, DOC_DATE_FAC_TERM, fleR031A_SORT_DOCTOR,
                                    "ICONST_CLINIC_NBR_1_2", "X_PAYMENT", "X_ADJ_CD", fleF020_DOCTOR_MSTR, "DOC_DEPT", fleR031A_SORT_DOCTOR, "XCOUNT");
                            }
                        }
                    }
                }
...
public class U030B_PART3_A_FILTER_22_DOCS_PART1_6 : U030B_PART3_A
{
        ...
        : base(Name, Level, true)
    {
        ...
        fleTMP_DOCTOR_ALPHA.InitializeItems += fleTMP_DOCTOR_ALPHA_AutomaticItemInitialization;
    ...
    private void fleTMP_DOCTOR_ALPHA_AutomaticItemInitialization(bool Fixed)
    {
        try
        {
            fleTMP_DOCTOR_ALPHA.set_SetValue("DOC_OHIP_NBR", !Fixed, fleR031A_MULT_22_CLINIC_DOCTORS.GetDecimalValue("DOC_OHIP_NBR"));
            fleTMP_DOCTOR_ALPHA.set_SetValue("DOC_NBR", !Fixed, fleR031A_MULT_22_CLINIC_DOCTORS.GetStringValue("DOC_NBR"));
        }
                ...
                while (fleTMP_DOCTOR_ALPHA.QTPForMissing("1"))
                {
                    ...
                    if (Transaction())
                    {
                         ...
                         if (Select_If())
                        {
                            ...
                            SubFile(ref m_trnTRANS_UPDATE, ref fleR031A_MULT_OTHER_CLINIC_DOCTORS, SubFileType.Keep, SubFileMode.Append, fleR031A_MULT_22_CLINIC_DOCTORS);
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleR031A_MULT_OTHER_CLINIC_DOCTORS, fleF020_DOCTOR_EXTRA))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleR031A_SELECT_DOCTOR, fleR031A_MULT_OTHER_CLINIC_DOCTORS.At("ICONST_CLINIC_NBR_1_2") || fleR031A_MULT_OTHER_CLINIC_DOCTORS.At("X_ADJ_CD") || fleR031A_MULT_OTHER_CLINIC_DOCTORS.At("DOC_OHIP_NBR"), SubFileType.Keep, SubFileMode.Append, fleR031A_MULT_OTHER_CLINIC_DOCTORS
                    , "DOC_OHIP_NBR", "DOC_NBR", "DOC_DATE_FAC_START", "DOC_DATE_FAC_TERM", "ICONST_CLINIC_NBR_1_2", "X_PAYMENT", "X_ADJ_CD", "DOC_DEPT", "XCOUNT");
            }
        }
        catch (CustomApplicationException ex)
        {
...
public class U030B_PART3_A_DETERMINE_HIGHEST_AMT_13 : U030B_PART3_A
{
    ...
    private SqlFileObject fleR031A_ACTIVE_DOCTOR;
    private DDecimal X_ABS_AMT = new DDecimal("X_ABS_AMT", 8);
...
public class U030B_PART3_A_CALCULATE_BATCH_NBR_14 : U030B_PART3_A
{
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleR031A_RUNNING_AMT))
            {
                fleR031A_HIGHEST_AMT.GetData();
