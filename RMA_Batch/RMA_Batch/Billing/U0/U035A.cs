...
public class U035A_EXTRACT_1 : U035A
{
        ...
        : base(Name, Level, true)
    {
        ...
        SUBSCR_POSTAL_CD.GetValue += SUBSCR_POSTAL_CD_GetValue;
    ...
    private void    PAT_OHIP_MMYY_GetValue(ref string Value)
    {
        try
        {
            Value = fleF010_PAT_MSTR.GetStringValue("PAT_DIRECT_ALPHA") + QDesign.ASCII(fleF010_PAT_MSTR.GetDecimalValue("PAT_DIRECT_YY"), 2) + QDesign.ASCII(fleF010_PAT_MSTR.GetDecimalValue("PAT_DIRECT_MM"), 2) + QDesign.ASCII(fleF010_PAT_MSTR.GetDecimalValue("PAT_DIRECT_DD"), 2) + fleF010_PAT_MSTR.GetStringValue("PAT_DIRECT_LAST_6");
        }
    ...
    private DCharacter SUBSCR_POSTAL_CD = new DCharacter("SUBSCR_POSTAL_CD", 16);
    private void SUBSCR_POSTAL_CD_GetValue(ref string Value)
    {
        try
        {
            Value = fleF010_PAT_MSTR.GetStringValue("SUBSCR_POST_CD1") + fleF010_PAT_MSTR.GetStringValue("SUBSCR_POST_CD2") + fleF010_PAT_MSTR.GetStringValue("SUBSCR_POST_CD3") + fleF010_PAT_MSTR.GetStringValue("SUBSCR_POST_CD4") + fleF010_PAT_MSTR.GetStringValue("SUBSCR_POST_CD5") + fleF010_PAT_MSTR.GetStringValue("SUBSCR_POST_CD6") + fleF010_PAT_MSTR.GetStringValue("FILLER");
        }
            ...
            while (fleF002_CLAIM_SHADOW.QTPForMissing())
            {
                ...
                while (fleF002_CLAIMS_MSTR.QTPForMissing("1"))
                {
                    ...
                    while (fleF010_PAT_MSTR.QTPForMissing("2"))
                    {
                        ...
                        m_strWhere.Append(QDesign.NConvert(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_PAT_KEY_DATA"), 1, 2)));
                        //Parent:CLMHDR_PAT_OHIP_ID_OR_CHART    'Parent:KEY_PAT_MSTR
                        m_strWhere.Append(" AND ").Append(fleF010_PAT_MSTR.ElementOwner("PAT_I_NBR")).Append(" = ");
                        m_strWhere.Append(QDesign.NConvert(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_PAT_KEY_DATA"), 3, 12)));
                        //Parent:CLMHDR_PAT_OHIP_ID_OR_CHART    'Parent:KEY_PAT_MSTR
                        m_strWhere.Append(" AND ").Append(fleF010_PAT_MSTR.ElementOwner("FILLER4")).Append(" = ");
                        m_strWhere.Append(Common.StringToField(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_PAT_KEY_DATA"), 15, 1)));
                        //Parent:CLMHDR_PAT_OHIP_ID_OR_CHART    'Parent:KEY_PAT_MSTR
                        ...
                        while (fleF070_DEPT_MSTR.QTPForMissing("3"))
                        {
                            ...
                            while (fleF020_DOCTOR_MSTR.QTPForMissing("4"))
                            {
                                ...
                                if (Transaction())
                                {
                                    SubFile(ref m_trnTRANS_UPDATE, ref fleU035A, fleF010_PAT_MSTR.Exists() & fleF002_CLAIMS_MSTR.Exists() & QDesign.NULL(fleF002_CLAIMS_MSTR.GetDecimalValue("CLMHDR_AGENT_CD")) != 4 & QDesign.NULL(X_BAL_DUE.Value) > 64 & QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_REPRINT_FLAG")) == "Y", SubFileType.Keep, fleF002_CLAIMS_MSTR, "CLMHDR_AGENT_CD", fleF070_DEPT_MSTR, "DEPT_COMPANY", fleF002_CLAIM_SHADOW,
                                    "CLM_SHADOW_CLINIC", fleF002_CLAIMS_MSTR, "CLMHDR_SUB_NBR", PAT_SURNAME, PAT_GIVEN_NAME, CLMHDR_PAT_OHIP_ID_OR_CHART, fleF002_CLAIM_SHADOW, "CLM_SHADOW_BATCH_NBR",
                                    ...
                                    SubFile(ref m_trnTRANS_UPDATE, ref fleRU035A, !fleF010_PAT_MSTR.Exists() | !fleF002_CLAIMS_MSTR.Exists(), SubFileType.Keep, fleF002_CLAIMS_MSTR, "CLMHDR_AGENT_CD", fleF070_DEPT_MSTR, "DEPT_COMPANY", fleF002_CLAIM_SHADOW,
                                    "CLM_SHADOW_CLINIC", "CLM_SHADOW_SUBDIVISION", fleF002_CLAIMS_MSTR, "CLMHDR_PAT_KEY_TYPE", "CLMHDR_PAT_KEY_DATA", fleF002_CLAIM_SHADOW, "CLM_SHADOW_BATCH_NBR", "CLM_SHADOW_CLAIM_NBR");
                                }
                            }
                        }
                    }
...
public class U035A_EXTRACT_CLM_DTL_3 : U035A
{
    ...
    private DDecimal X_SERV_DATE = new DDecimal("X_SERV_DATE", 8);
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (fleU035B.QTPForMissing())
            {
                ...
                while (fleF002_CLAIMS_MSTR.QTPForMissing("1"))
                {
                    ...
                    while (fleF040_OMA_FEE_MSTR.QTPForMissing("2"))
                    {
                        ...
                        m_strWhere.Append(Common.StringToField((fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_OMA_CD")).PadRight(4).Substring(1, 3)));
                        ...
                        if (Transaction())
                        {
                            if (Select_If())
                            {
                                Sort(fleU035B.GetSortValue("CLMHDR_AGENT_CD"), fleU035B.GetSortValue("CLM_SHADOW_CLINIC"), fleU035B.GetSortValue("CLMHDR_SUB_NBR"), fleU035B.GetSortValue("PAT_SURNAME"), fleU035B.GetSortValue("PAT_GIVEN_NAME"), fleU035B.GetSortValue("DEPT_COMPANY"), fleU035B.GetSortValue("CLMHDR_PAT_OHIP_ID_OR_CHART"), fleU035B.GetSortValue("CLM_SHADOW_BATCH_NBR"), fleU035B.GetSortValue("CLM_SHADOW_CLAIM_NBR"));
            ...
            while (Sort(fleU035B, fleF002_CLAIMS_MSTR, fleF040_OMA_FEE_MSTR))
            {
                ...
                Reset(ref X_CLAIM_REC_COUNTER, fleU035B.At("CLMHDR_AGENT_CD") || fleU035B.At("CLM_SHADOW_CLINIC") || fleU035B.At("CLMHDR_SUB_NBR") || fleU035B.At("PAT_SURNAME") || fleU035B.At("PAT_GIVEN_NAME") || fleU035B.At("DEPT_COMPANY") || fleU035B.At("CLMHDR_PAT_OHIP_ID_OR_CHART") || fleU035B.At("CLM_SHADOW_BATCH_NBR") || fleU035B.At("CLM_SHADOW_CLAIM_NBR"));
            }
        }
        catch (CustomApplicationException ex)
        {
...
public class U035A_EXTRACT_CLM_DESC_4 : U035A
{
        ...
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        fleU035B = new SqlFileObject(this, FileTypes.Primary, 0, "TEMPORARYDATA", "U035B", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SubFile);
        fleF002_CLAIMS_MSTR = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "F002_CLAIMS_MSTR_DESC", "", false, false, false, 0, "m_trnTRANS_UPDATE");
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleU035B, fleF002_CLAIMS_MSTR))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleDESC12, fleU035B.At("CLMHDR_AGENT_CD") || fleU035B.At("CLM_SHADOW_CLINIC") || fleU035B.At("CLMHDR_SUB_NBR") || fleU035B.At("PAT_SURNAME") || fleU035B.At("PAT_GIVEN_NAME") || fleU035B.At("DEPT_COMPANY") || fleU035B.At("CLMHDR_PAT_OHIP_ID_OR_CHART") || fleU035B.At("CLM_SHADOW_BATCH_NBR") || fleU035B.At("CLM_SHADOW_CLAIM_NBR"), QDesign.NULL(X_DESC12.Value) != QDesign.NULL(" "),
                SubFileType.Keep, SubFileMode.Append, fleU035B, "CLMHDR_AGENT_CD", "DEPT_COMPANY", "CLM_SHADOW_CLINIC", "CLMHDR_SUB_NBR", "PAT_SURNAME", "PAT_GIVEN_NAME", "CLMHDR_PAT_OHIP_ID_OR_CHART", "CLM_SHADOW_BATCH_NBR", "CLM_SHADOW_CLAIM_NBR", "SUBSCR_ADDR1", "SUBSCR_ADDR2", "SUBSCR_ADDR3", "SUBSCR_POSTAL_CD", "PAT_COUNTRY", "PAT_OHIP_MMYY",
                X_SERV_DATE, X_NBR_SERV, X_CLAIM_NO, X_CLAIM_REC_COUNTER, X_OHIP_CD, X_DOC_NAME, X_HOSP, X_DESC12, X_CHARGE, X_CREDIT, X_TYPE, X_PAT);

                SubFile(ref m_trnTRANS_UPDATE, ref fleDESC34, fleU035B.At("CLMHDR_AGENT_CD") || fleU035B.At("CLM_SHADOW_CLINIC") || fleU035B.At("CLMHDR_SUB_NBR") || fleU035B.At("PAT_SURNAME") || fleU035B.At("PAT_GIVEN_NAME") || fleU035B.At("DEPT_COMPANY") || fleU035B.At("CLMHDR_PAT_OHIP_ID_OR_CHART") || fleU035B.At("CLM_SHADOW_BATCH_NBR") || fleU035B.At("CLM_SHADOW_CLAIM_NBR"), QDesign.NULL(X_DESC34.Value) != QDesign.NULL(" "),
                SubFileType.Keep, SubFileMode.Append, fleU035B, "CLMHDR_AGENT_CD", "DEPT_COMPANY", "CLM_SHADOW_CLINIC", "CLMHDR_SUB_NBR", "PAT_SURNAME", "PAT_GIVEN_NAME", "CLMHDR_PAT_OHIP_ID_OR_CHART", "CLM_SHADOW_BATCH_NBR", "CLM_SHADOW_CLAIM_NBR", "SUBSCR_ADDR1", "SUBSCR_ADDR2", "SUBSCR_ADDR3", "SUBSCR_POSTAL_CD", "PAT_COUNTRY", "PAT_OHIP_MMYY",
                X_SERV_DATE, X_NBR_SERV, X_CLAIM_NO, X_CLAIM_REC_COUNTER, X_OHIP_CD, X_DOC_NAME, X_HOSP, X_DESC34, X_CHARGE, X_CREDIT, X_TYPE, X_PAT);

                SubFile(ref m_trnTRANS_UPDATE, ref fleDESC5, fleU035B.At("CLMHDR_AGENT_CD") || fleU035B.At("CLM_SHADOW_CLINIC") || fleU035B.At("CLMHDR_SUB_NBR") || fleU035B.At("PAT_SURNAME") || fleU035B.At("PAT_GIVEN_NAME") || fleU035B.At("DEPT_COMPANY") || fleU035B.At("CLMHDR_PAT_OHIP_ID_OR_CHART") || fleU035B.At("CLM_SHADOW_BATCH_NBR") || fleU035B.At("CLM_SHADOW_CLAIM_NBR"), QDesign.NULL(X_DESC5.Value) != QDesign.NULL(" "),
                SubFileType.Keep, SubFileMode.Append, fleU035B, "CLMHDR_AGENT_CD", "DEPT_COMPANY", "CLM_SHADOW_CLINIC", "CLMHDR_SUB_NBR", "PAT_SURNAME", "PAT_GIVEN_NAME", "CLMHDR_PAT_OHIP_ID_OR_CHART", "CLM_SHADOW_BATCH_NBR", "CLM_SHADOW_CLAIM_NBR", "SUBSCR_ADDR1", "SUBSCR_ADDR2", "SUBSCR_ADDR3", "SUBSCR_POSTAL_CD", "PAT_COUNTRY", "PAT_OHIP_MMYY",
                X_SERV_DATE, X_NBR_SERV, X_CLAIM_NO, X_CLAIM_REC_COUNTER, X_OHIP_CD, X_DOC_NAME, X_HOSP, X_DESC5, X_CHARGE, X_CREDIT, X_TYPE, X_PAT);

                Reset(ref X_CLAIM_REC_CTR, fleU035B.At("CLMHDR_AGENT_CD") || fleU035B.At("CLM_SHADOW_CLINIC") || fleU035B.At("CLMHDR_SUB_NBR") || fleU035B.At("PAT_SURNAME") || fleU035B.At("PAT_GIVEN_NAME") || fleU035B.At("DEPT_COMPANY") || fleU035B.At("CLMHDR_PAT_OHIP_ID_OR_CHART") || fleU035B.At("CLM_SHADOW_BATCH_NBR") || fleU035B.At("CLM_SHADOW_CLAIM_NBR"));
                Reset(ref X_DESC_REC_COUNTER, fleU035B.At("CLMHDR_AGENT_CD") || fleU035B.At("CLM_SHADOW_CLINIC") || fleU035B.At("CLMHDR_SUB_NBR") || fleU035B.At("PAT_SURNAME") || fleU035B.At("PAT_GIVEN_NAME") || fleU035B.At("DEPT_COMPANY") || fleU035B.At("CLMHDR_PAT_OHIP_ID_OR_CHART") || fleU035B.At("CLM_SHADOW_BATCH_NBR") || fleU035B.At("CLM_SHADOW_CLAIM_NBR"));
                Reset(ref X_DESC12, fleU035B.At("CLMHDR_AGENT_CD") || fleU035B.At("CLM_SHADOW_CLINIC") || fleU035B.At("CLMHDR_SUB_NBR") || fleU035B.At("PAT_SURNAME") || fleU035B.At("PAT_GIVEN_NAME") || fleU035B.At("DEPT_COMPANY") || fleU035B.At("CLMHDR_PAT_OHIP_ID_OR_CHART") || fleU035B.At("CLM_SHADOW_BATCH_NBR") || fleU035B.At("CLM_SHADOW_CLAIM_NBR"));
                Reset(ref X_DESC34, fleU035B.At("CLMHDR_AGENT_CD") || fleU035B.At("CLM_SHADOW_CLINIC") || fleU035B.At("CLMHDR_SUB_NBR") || fleU035B.At("PAT_SURNAME") || fleU035B.At("PAT_GIVEN_NAME") || fleU035B.At("DEPT_COMPANY") || fleU035B.At("CLMHDR_PAT_OHIP_ID_OR_CHART") || fleU035B.At("CLM_SHADOW_BATCH_NBR") || fleU035B.At("CLM_SHADOW_CLAIM_NBR"));
                Reset(ref X_DESC5, fleU035B.At("CLMHDR_AGENT_CD") || fleU035B.At("CLM_SHADOW_CLINIC") || fleU035B.At("CLMHDR_SUB_NBR") || fleU035B.At("PAT_SURNAME") || fleU035B.At("PAT_GIVEN_NAME") || fleU035B.At("DEPT_COMPANY") || fleU035B.At("CLMHDR_PAT_OHIP_ID_OR_CHART") || fleU035B.At("CLM_SHADOW_BATCH_NBR") || fleU035B.At("CLM_SHADOW_CLAIM_NBR"));
            }
        }
        catch (CustomApplicationException ex)
        {
            ...
            while (fleU035B.QTPForMissing())
            {
                ...
                while (fleF094_MSG_MSTR.QTPForMissing("1"))
                {
                    ...
                    if (Transaction())
                    {
                        ...
                        SubFile(ref m_trnTRANS_UPDATE, ref fleCLM_MSG1, QDesign.NULL(fleF094_MSG_MSTR.GetStringValue("MSG_DTL1")) != QDesign.NULL(" "), SubFileType.Keep, SubFileMode.Append, fleU035B, "CLMHDR_AGENT_CD", "DEPT_COMPANY", "CLM_SHADOW_CLINIC", "CLMHDR_SUB_NBR", "PAT_SURNAME", 
                        ...
                        X_SERV_DATE, X_NBR_SERV, X_CLAIM_NO, X_CLAIM_REC_COUNTER, X_OHIP_CD, X_DOC_NAME, X_HOSP, fleF094_MSG_MSTR, "MSG_DTL1", X_CHARGE, X_CREDIT, X_TYPE, X_PAT);

                        X_CLAIM_REC_COUNTER.Value = 202;

                        SubFile(ref m_trnTRANS_UPDATE, ref fleCLM_MSG2, QDesign.NULL(fleF094_MSG_MSTR.GetStringValue("MSG_DTL1")) != QDesign.NULL(" "), SubFileType.Keep, SubFileMode.Append, fleU035B, "CLMHDR_AGENT_CD", "DEPT_COMPANY", "CLM_SHADOW_CLINIC", "CLMHDR_SUB_NBR", "PAT_SURNAME", 
                        "PAT_GIVEN_NAME", "CLMHDR_PAT_OHIP_ID_OR_CHART", "CLM_SHADOW_BATCH_NBR", "CLM_SHADOW_CLAIM_NBR", "SUBSCR_ADDR1", "SUBSCR_ADDR2", "SUBSCR_ADDR3", "SUBSCR_POSTAL_CD", "PAT_COUNTRY", "PAT_OHIP_MMYY",
                        X_SERV_DATE, X_NBR_SERV, X_CLAIM_NO, X_CLAIM_REC_COUNTER, X_OHIP_CD, X_DOC_NAME, X_HOSP, fleF094_MSG_MSTR, "MSG_DTL2", X_CHARGE, X_CREDIT, X_TYPE, X_PAT);

                        X_CLAIM_REC_COUNTER.Value = 203;

                        SubFile(ref m_trnTRANS_UPDATE, ref fleCLM_MSG3, QDesign.NULL(fleF094_MSG_MSTR.GetStringValue("MSG_DTL3")) != QDesign.NULL(" "), SubFileType.Keep, SubFileMode.Append, fleU035B, "CLMHDR_AGENT_CD", "DEPT_COMPANY", "CLM_SHADOW_CLINIC", "CLMHDR_SUB_NBR", "PAT_SURNAME", 
                        "PAT_GIVEN_NAME", "CLMHDR_PAT_OHIP_ID_OR_CHART", "CLM_SHADOW_BATCH_NBR", "CLM_SHADOW_CLAIM_NBR", "SUBSCR_ADDR1", "SUBSCR_ADDR2", "SUBSCR_ADDR3", "SUBSCR_POSTAL_CD", "PAT_COUNTRY", "PAT_OHIP_MMYY",
                        X_SERV_DATE, X_NBR_SERV, X_CLAIM_NO, X_CLAIM_REC_COUNTER, X_OHIP_CD, X_DOC_NAME, X_HOSP, fleF094_MSG_MSTR, "MSG_DTL3", X_CHARGE, X_CREDIT, X_TYPE, X_PAT);

                        X_CLAIM_REC_COUNTER.Value = 204;

                        SubFile(ref m_trnTRANS_UPDATE, ref fleCLM_MSG4, QDesign.NULL(fleF094_MSG_MSTR.GetStringValue("MSG_DTL4")) != QDesign.NULL(" "), SubFileType.Keep, SubFileMode.Append, fleU035B, "CLMHDR_AGENT_CD", "DEPT_COMPANY", "CLM_SHADOW_CLINIC", "CLMHDR_SUB_NBR", "PAT_SURNAME", 
                        "PAT_GIVEN_NAME", "CLMHDR_PAT_OHIP_ID_OR_CHART", "CLM_SHADOW_BATCH_NBR", "CLM_SHADOW_CLAIM_NBR", "SUBSCR_ADDR1", "SUBSCR_ADDR2", "SUBSCR_ADDR3", "SUBSCR_POSTAL_CD", "PAT_COUNTRY", "PAT_OHIP_MMYY",
                        X_SERV_DATE, X_NBR_SERV, X_CLAIM_NO, X_CLAIM_REC_COUNTER, X_OHIP_CD, X_DOC_NAME, X_HOSP, fleF094_MSG_MSTR, "MSG_DTL4", X_CHARGE, X_CREDIT, X_TYPE, X_PAT);
                    }
                }
            }
        }
