...
public class U140_A_U140_EXTRACT_DOC_AFP_GROUP_1 : U140_A
{
    ...
    public U140_A_U140_EXTRACT_DOC_AFP_GROUP_1(string Name, int Level) : base(Name, Level, true)
    {
        ...
        fleCLINIC1 = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "ICONST_MSTR_REC", "CLINIC1", false, false, false, 0, "m_trnTRANS_UPDATE");
    ...
    private void fleF020_DOCTOR_MSTR_Choose(ref string ChooseClause)
    {
        ...
        try
        {
            ...
            strSQL.Append(fleF020_DOCTOR_MSTR.ElementOwner("DOC_OHIP_NBR")).Append(" BETWEEN ");
            strSQL.Append(1).Append(" AND ").Append(999999);
    ...
    private DDecimal X_TERM_DATE = new DDecimal("X_TERM_DATE", 8);
    private void X_TERM_DATE_GetValue(ref decimal Value)
    {
        ...
        try
        {
            ...
            if (QDesign.NULL(QDesign.NConvert(QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_YY")) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_MM")) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_DD")))) == 0)
            {
                CurrentValue = 20991231;
            }
            else
            {
                CurrentValue = QDesign.NConvert(QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_YY")) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_MM")).PadLeft(2, '0') + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_DD")).PadLeft(2, '0'));
            }
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (fleF020_DOCTOR_MSTR.QTPForMissing())
            {
                ...
                {
                    // --> GET F020C_DOC_CLINIC_NEXT_BATCH_NBR <--
                    ...
                    // --> End GET F020C_DOC_CLINIC_NEXT_BATCH_NBR <--

                    while (fleCLINIC1.QTPForMissing("2"))
                    {
                        // --> GET CLINIC1 <--
                        m_strWhere = new StringBuilder(" WHERE ");
                        m_strWhere.Append(fleCLINIC1.ElementOwner("ICONST_CLINIC_NBR_1_2")).Append(" = ");
                        m_strWhere.Append(fleF020C_DOC_CLINIC_NEXT_BATCH_NBR.GetDecimalValue("DOC_CLINIC_NBR"));
...
public class U140_A_U140_EXTRACT_REPORTING_GRP_2 : U140_A
{
    ...
    public U140_A_U140_EXTRACT_REPORTING_GRP_2(string Name, int Level) : base(Name, Level, true)
    {
        ...
        fleF020_DOCTOR_MSTR = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "F020_DOCTOR_MSTR", "", false, false, false, 0, "m_trnTRANS_UPDATE");
        fleF074_AFP_GROUP_SEQUENCE_MSTR = new SqlFileObject(this, FileTypes.Primary, 0, "[101C].INDEXED", "F074_AFP_GROUP_SEQUENCE_MSTR", "", false, false, false, 0, "m_trnTRANS_UPDATE");
                    ...
                    while (fleF074_AFP_GROUP_SEQUENCE_MSTR.QTPForMissing("2"))
                    {
                        ...
                        if (Transaction())
                        {
                            ...
                            if (Select_If())
                            {
                                ...
                                SubFile(ref m_trnTRANS_UPDATE, ref fleAFPA2S, SubFileType.Keep, SubFileMode.Append, fleF020_DOCTOR_MSTR, "DOC_OHIP_NBR", "DOC_NBR", X_TERM_DATE, fleAFP_A2S_FILE, "DOC_AFP_PAYM_GROUP");
...
public class U140_A_U140_CREATE_F075_RECORDS_5 : U140_A
{
    ...
    private void fleF075_AFP_DOC_MSTR_AutomaticItemInitialization(bool Fixed)
    {
        try
        {
            ...
            //TODO: Manual steps may be required.
            fleF075_AFP_DOC_MSTR.set_SetValue("DOC_AFP_PAYM_GROUP", !Fixed, fleU140_A.GetStringValue("DOC_AFP_PAYM_GROUP"));
        ...
        try
        {
            ...
            while (fleU140_A.QTPForMissing())
            {
                ...
                while (fleTMP_DOCTOR_ALPHA.QTPForMissing("1"))
                {
                    ...
                    m_strWhere.Append((fleU140_A.GetDecimalValue("DOC_OHIP_NBR")));
                    m_strWhere.Append(" And ").Append(fleTMP_DOCTOR_ALPHA.ElementOwner("DOC_NBR")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(fleU140_A.GetStringValue("DOC_NBR")));
            ...
            while (Sort(fleU140_A, fleTMP_DOCTOR_ALPHA, fleF020_DOCTOR_MSTR))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleBRADDEBUG, SubFileType.Keep, fleU140_A, "DOC_OHIP_NBR", "DOC_NBR", "DOC_AFP_PAYM_GROUP", fleTMP_DOCTOR_ALPHA,
        ...
        try
        {
            ...
            while (fleU140_A_DOC_COUNT.QTPForMissing())
            {
                ...
                while (fleF075_AFP_DOC_MSTR.QTPForMissing("1"))
                {
                    ...
                    m_strWhere.Append((fleU140_A_DOC_COUNT.GetDecimalValue("DOC_OHIP_NBR")));
