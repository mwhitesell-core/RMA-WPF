                ...
                while (fleF112_PYCDCEILINGS.QTPForMissing("1"))
                {
                    ...
                    while (fleF020_DOCTOR_MSTR.QTPForMissing("2"))
                    {
                        ...
                        if (Transaction())
                        {
                            ...
                            DEBUG_NOTE.Value = "Generated By: u116 - PAYPOT -  U116_RUN_0_CALC_PAYCD_0";
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleCONSTANTS_MSTR_REC_6, fleF112_PYCDCEILINGS, fleF020_DOCTOR_MSTR, fleF190_COMP_CODES, fleF110_GTYPE, fleF110_TOTADV))
            {
                ...
                DEBUG_NOTE.Value = "Generated By: u116 - GTYPE - U116_RUN_1_CALC_PAYCD_1X";
                SubFile(ref m_trnTRANS_UPDATE, ref fleF119_GTYPE, fleF112_PYCDCEILINGS.At("DOC_NBR"), QDesign.NULL(fleF190_COMP_CODES.GetStringValue("COMP_TYPE")) == "I" | QDesign.NULL(QDesign.Substring(fleF190_COMP_CODES.GetStringValue("COMP_CODE"), 1, 5)) == "GTYPE", SubFileType.Keep, SubFileMode.Append, 
                    fleF112_PYCDCEILINGS, "DOC_NBR", X_COMP_CODE, fleF190_COMP_CODES, "REPORTING_SEQ",
                    "COMP_CODE_GROUP", X_REC_TYPE, X_NOT_NEEDED, W_POTGUAR_AMT_NET_REVERSE_SIGN, DEBUG_NOTE);

                X_COMP_CODE_PAYPOT.Value = "PAYPOT";

                DEBUG_NOTE.Value = "Generated By: u116 - PAYPOT - U116_RUN_1_CALC_PAYCD_1X";
                ...
                DEBUG_NOTE.Value = "Generated By: u116 - UNDER - U116_RUN_1_CALC_PAYCD_1X";
                            ...
                            while (fleF020_DOCTOR_MSTR.QTPForMissing("4"))
                            {
                                ...
                                while (fleF110_TOTADV.QTPForMissing("5"))
                                {
                                    ...
                                    if (Transaction())
                                    {
                                        ...
                                        DEBUG_NOTE.Value = "Generated By: u116 - RUN_2_CALC_PAYCD_2";
                                        SubFile(ref m_trnTRANS_UPDATE, ref fleF119, SubFileType.Keep, SubFileMode.Append,
                                            fleF112_PYCDCEILINGS, "DOC_NBR", X_COMP_CODE, PAYPOT_SEQ_RPT, PAYPOT_GROUP, X_REC_TYPE, NEW_DOC_YTDEAR,
                                            W_PAYPOT_AMT_NET, DEBUG_NOTE);

                                        // Moved the output here (used to be right before the subfile. 
                                        // Abiove the subfile was Causing the new_doc_ytdear to be processed twice resulting in a wrong paypot new_doc_ytdear in the subfile
                                        fleF020_DOCTOR_MSTR.OutPut(OutPutType.Update);
                                ...
                                while (fleF110_CEIEAR.QTPForMissing("5"))
                                {
                                    ...
                                    while (fleF110_TOTADV.QTPForMissing("6"))
                                    {
                                        ...
                                        if (Transaction())
                                        {
                                            ...
                                            DEBUG_NOTE.Value = "Generated By: u11c - PAYPOT - RUN_3_PAYCODES_346";
                                            ...
                                            X_COMP_CODE_STATUS.Value = "STATUS";
                                            DEBUG_NOTE.Value = "Generated By: u11c - UNDER - RUN_3_PAYCODES_346";
                                            ...
                                            DEBUG_NOTE.Value = "Generated By: u11c - GTYPE - RUN_3_PAYCODES_346";
                                            ...
                                            // Moved output here. Previousl was anbove subfile f119. Logic was firing twice.
                                            fleF020_DOCTOR_MSTR.OutPut(OutPutType.Update);
                    ...
                    while (fleF110_TOTINC.QTPForMissing("2"))
                    {
                        ...
                        while (fleF020_DOCTOR_MSTR.QTPForMissing("3"))
                        {
                            ...
                            if (Transaction())
                            {
                                ...
                                DEBUG_NOTE.Value = "Generated By: u116 - U116_RUN_2_CALC_PAYCD_5";
                                SubFile(ref m_trnTRANS_UPDATE, ref fleF119, SubFileType.Keep, SubFileMode.Append, fleF112_PYCDCEILINGS, "DOC_NBR", X_COMP_CODE, PAYPOT_SEQ_RPT, PAYPOT_GROUP, X_REC_TYPE, NEW_DOC_YTDEAR,
                                W_PAYPOT_AMT_NET, DEBUG_NOTE);

                                // Moved output statement here. Double counting the defines if moved above subfile f119.
                                fleF020_DOCTOR_MSTR.OutPut(OutPutType.Update);
