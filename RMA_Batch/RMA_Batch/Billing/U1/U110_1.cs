    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (fleF050_DOC_REVENUE_MSTR.QTPForMissing())
            {
                ...
                //if (!fleF050_DOC_REVENUE_MSTR.GetStringValue("DOCREV_DOC_NBR").Equals("00F") 
                //    && !fleF050_DOC_REVENUE_MSTR.GetStringValue("DOCREV_DOC_NBR").Equals("734"))
                //    continue;
            ...
            while (Sort(fleF050_DOC_REVENUE_MSTR, fleF020_DOCTOR_MSTR, fleICONST_MSTR_REC))
            {
                ...
                if (fleF050_DOC_REVENUE_MSTR.At("DOCREV_CLINIC_1_2") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DEPT") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DOC_NBR"))
                {
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_AUDIT_DOC, (1==1), SubFileType.Keep, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR", fleF020_DOCTOR_MSTR, "DOC_AFP_PAYM_GROUP", MTD_BILLING, COMP_CODE,
                    FACTOR, PROCESS_SEQ, COMP_TYPE);



                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110, (1 == 1), QDesign.NULL(fleF020_DOCTOR_MSTR.GetStringValue("DOC_AFP_PAYM_GROUP")) == QDesign.NULL(" ") | (QDesign.NULL(fleF020_DOCTOR_MSTR.GetStringValue("DOC_AFP_PAYM_GROUP")) != QDesign.NULL(" ") & QDesign.NULL(MTD_BILL.Value) != 0), SubFileType.Keep, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR", COMP_CODE, COMP_TYPE, PROCESS_SEQ,
                    FACTOR, MTD_BILLING);
                    ...
                    //buf1 = Convert.ToString(PROCESS_SEQ.Value);
                    //buf2 = Convert.ToString(FACTOR.Value);
                    //buf3 = Convert.ToString(MTD_BILLING.Value);


                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MISC0, (1 == 1), QDesign.NULL(MTD_MISC0.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MISC1, (1 == 1), QDesign.NULL(MTD_MISC1.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MISC2, (1 == 1), QDesign.NULL(MTD_MISC2.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MISC3, (1 == 1), QDesign.NULL(MTD_MISC3.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MISC4, (1 == 1), QDesign.NULL(MTD_MISC4.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MISC5, (1 == 1), QDesign.NULL(MTD_MISC5.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MISC6, (1 == 1), QDesign.NULL(MTD_MISC6.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MISC7, (1 == 1), QDesign.NULL(MTD_MISC7.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MISC8, (1 == 1), QDesign.NULL(MTD_MISC8.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MISC9, (1 == 1), QDesign.NULL(MTD_MISC9.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MICV, (1 == 1), QDesign.NULL(MTD_MICV.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MICM, (1 == 1), QDesign.NULL(MTD_MICM.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MISJ, (1 == 1), QDesign.NULL(MTD_MISJ.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MISP, (1 == 1), QDesign.NULL(MTD_MISP.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MOHR, (1 == 1), QDesign.NULL(MTD_MOHR.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MICB, (1 == 1), QDesign.NULL(MTD_MICB.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MIBR, (1 == 1), QDesign.NULL(MTD_MIBR.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MINH, (1 == 1), QDesign.NULL(MTD_MINH.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MHSC, (1 == 1), QDesign.NULL(MTD_MHSC.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_DHSC, (1 == 1), QDesign.NULL(MTD_DHSC.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_AGEP, (1 == 1), QDesign.NULL(MTD_AGEP.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MICA, (1 == 1), QDesign.NULL(MTD_MICA.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MICC, (1 == 1), QDesign.NULL(MTD_MICC.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MICD, (1 == 1), QDesign.NULL(MTD_MICD.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MICE, (1 == 1), QDesign.NULL(MTD_MICE.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR",
                    COMP_CODE, COMP_TYPE, PROCESS_SEQ, FACTOR, MTD_BILLING);
