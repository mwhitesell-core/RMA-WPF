...
public class U140_D_U140_D1_GET_TRANS_IN_A2S_1 : U140_D
{
    ...
    private void DOC_DATE_FAC_TERM_GetValue(ref decimal Value)
    {
        ...
        try
        {
            ...
            CurrentValue = QDesign.NConvert(QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_YY")) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_MM")) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_DD")));
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (fleAFP_A2S_FILE.QTPForMissing())
            {
                ...
                while (fleF020_DOCTOR_MSTR.QTPForMissing("1"))
                {
                    ...
                    while (fleF075_AFP_DOC_MSTR.QTPForMissing("2"))
                    {
                        ...
                        if (fleAFP_A2S_FILE.GetStringValue("DOC_AFP_PAYM_GROUP") == "H129")
                        {
            ...
            while (Sort(fleAFP_A2S_FILE, fleF020_DOCTOR_MSTR, fleF075_AFP_DOC_MSTR, fleF074_AFP_GROUP_MSTR, fleF070_DEPT_MSTR))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleU140_D1, fleAFP_A2S_FILE.At("DOC_AFP_PAYM_SOLO") || fleAFP_A2S_FILE.At("DOC_AFP_PAYM_GROUP") || At(X_TERM_DATE) || fleF020_DOCTOR_MSTR.At("DOC_NBR"), SubFileType.Keep, SubFileMode.Append, fleAFP_A2S_FILE, "AFP_TRANSACTION_ID", "AFP_RECORD_ID", "DOC_AFP_PAYM_GROUP", fleF074_AFP_GROUP_MSTR, "AFP_GROUP_NAME",
                fleF075_AFP_DOC_MSTR, "AFP_MULTI_DOC_RA_PERCENTAGE", fleAFP_A2S_FILE, "DOC_AFP_PAYM_SOLO", fleF020_DOCTOR_MSTR, "DOC_NBR", fleAFP_A2S_FILE, "AFP_SOLO_NAME", X_DOC_NAME, fleF070_DEPT_MSTR, "DEPT_NBR", "DEPT_NAME", fleAFP_A2S_FILE, "AFP_PAYMENT_PERCENTAGE",
                fleF075_AFP_DOC_MSTR, "AFP_PAYMENT_AMT", "AFP_SUBMISSION_AMT", X_CONVERSION_AMT, X_SUBMISSION_AMT, fleF074_AFP_GROUP_MSTR, "AFP_GROUP_PROCESS_FLAG",
                DOC_DATE_FAC_TERM, fleF074_AFP_GROUP_MSTR, "AFP_REPORTING_MTH");
