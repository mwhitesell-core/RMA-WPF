...
public class NEWU701_1_1 : NEWU701
{
        ...
        : base(Name, Level, true)
    {
        ...
        fleF002_DESC_2 = new SqlFileObject(this, FileTypes.Primary, 0, "SEQUENTIAL", "F002_SUSPEND_DESC", "F002_DESC_2", false, false, false, 0, "m_trnTRANS_UPDATE");
        fleF002_DESC_3 = new SqlFileObject(this, FileTypes.Primary, 0, "SEQUENTIAL", "F002_SUSPEND_DESC", "F002_DESC_3", false, false, false, 0, "m_trnTRANS_UPDATE");
        fleF002_DESC_4 = new SqlFileObject(this, FileTypes.Primary, 0, "SEQUENTIAL", "F002_SUSPEND_DESC", "F002_DESC_4", false, false, false, 0, "m_trnTRANS_UPDATE");
            ...
            while (fleSUBMIT_DISK_DESC.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                    ...
                    while (fleF002_SUSPEND_HDR.QTPForMissing())
                    {
                        ...
                        m_strWhere.Append(" ").Append(fleF002_SUSPEND_HDR.ElementOwner("CLMHDR_DOC_NBR_OHIP")).Append(" = ");
                        ...
                        m_strOrderBy.Append(fleF002_SUSPEND_HDR.ElementOwner("CLMHDR_DOC_NBR_OHIP"));
