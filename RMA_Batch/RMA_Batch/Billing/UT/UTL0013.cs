...
public class UTL0013_ONE_1 : UTL0013
{
    ...
    public override bool SelectIf()
    {
        ...
        try
        {
            if (((QDesign.NULL(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DEPT")) == 13 
                | QDesign.NULL(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DEPT")) == 14) 
                & (Convert.ToDecimal(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_YY").ToString().PadLeft(4, '0') + fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_MM").ToString().PadLeft(2, '0') + fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_DD").ToString().PadLeft(2, '0')) == 0 
                | Convert.ToDecimal(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_YY").ToString().PadLeft(4, '0') + fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_MM").ToString().PadLeft(2, '0') + fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_DD").ToString().PadLeft(2, '0')) > QDesign.SysDate(ref m_cnnQUERY))))
            {
                return true;
            }
        ...
        try
        {
            ...
            while (fleUTL0013_A.QTPForMissing())
            {
                ...
                while (fleF020_DOCTOR_MSTR.QTPForMissing("1"))
                {
                    ...
                    m_strWhere.Append((fleUTL0013_A.GetDecimalValue("DOC_OHIP_NBR")));
                    ...
                    while (fleF020_DOCTOR_EXTRA.QTPForMissing("2"))
                    {
                        ...
                        if (Transaction())
                        {
                            ...
                            if (Select_If())
                            {
                                ...
                                SubFile(ref m_trnTRANS_UPDATE, "UTL0013_B", SubFileType.Keep, SubFileMode.Append, REC_IND, fleF020_DOCTOR_MSTR, fleF020_DOCTOR_EXTRA, "PAY_THIS_DOCTOR_OHIP_PREMIUM", "PAY_THIS_DOCTOR_OHIP_PREMIUM");
