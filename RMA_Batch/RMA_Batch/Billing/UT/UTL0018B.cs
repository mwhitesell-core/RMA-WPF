...
public class UTL0018B : BaseClassControl
{

    private UTL0018B m_UTL0018B;

    public UTL0018B(string Name, int Level)
        : base(Name, Level)
    {
    ...
    public UTL0018B(string Name, int Level, bool Request)
    ...
    public override void Dispose()
    {
        if ((m_UTL0018B != null))
        {
            m_UTL0018B.CloseTransactionObjects();
            m_UTL0018B = null;
        }
    }

    public UTL0018B GetUTL0018B(int Level)
    {
        if (m_UTL0018B == null)
        {
            m_UTL0018B = new UTL0018B("UTL0018B", Level);
        }
        else
        {
            m_UTL0018B.ResetValues();
        }
        return m_UTL0018B;
    }
    ...
    public override bool RunQTP()
    {
        ...
        try
        {
            ...
            UTL0018B_EXTRACT_CLINIC_22_60_37_1 EXTRACT_CLINIC_22_60_37_1 = new UTL0018B_EXTRACT_CLINIC_22_60_37_1(Name, Level);
            EXTRACT_CLINIC_22_60_37_1.Run();
            EXTRACT_CLINIC_22_60_37_1.Dispose();
            EXTRACT_CLINIC_22_60_37_1 = null;

            UTL0018B_UPDATE_MONTHEND_1_CLINICS_2 UPDATE_MONTHEND_1_CLINICS_2 = new UTL0018B_UPDATE_MONTHEND_1_CLINICS_2(Name, Level);
            UPDATE_MONTHEND_1_CLINICS_2.Run();
            UPDATE_MONTHEND_1_CLINICS_2.Dispose();
            UPDATE_MONTHEND_1_CLINICS_2 = null;

            UTL0018B_UPDATE_MONTHEND_2_CLINICS_3 UPDATE_MONTHEND_2_CLINICS_3 = new UTL0018B_UPDATE_MONTHEND_2_CLINICS_3(Name, Level);
            UPDATE_MONTHEND_2_CLINICS_3.Run();
            UPDATE_MONTHEND_2_CLINICS_3.Dispose();
            UPDATE_MONTHEND_2_CLINICS_3 = null;

            UTL0018B_UPDATE_MONTHEND_3_CLINICS_4 UPDATE_MONTHEND_3_CLINICS_4 = new UTL0018B_UPDATE_MONTHEND_3_CLINICS_4(Name, Level);
            UPDATE_MONTHEND_3_CLINICS_4.Run();
            UPDATE_MONTHEND_3_CLINICS_4.Dispose();
            UPDATE_MONTHEND_3_CLINICS_4 = null;
...
public class UTL0018B_EXTRACT_CLINIC_22_60_37_1 : UTL0018B
{

    public UTL0018B_EXTRACT_CLINIC_22_60_37_1(string Name, int Level)
    ...
    #region "Declarations (Variables, Files and Transactions)(UTL0018B_EXTRACT_CLINIC_22_60_37_1)"
    ...
    private void ICONST_DATE_PERIOD_END_GetValue(ref decimal Value)
    {
        ...
        try
        {
            Value = QDesign.NConvert(QDesign.ASCII(fleICONST_MSTR_REC.GetDecimalValue("ICONST_DATE_PERIOD_END_YY").ToString().PadLeft(4, '0')
    ...
    #region "Standard Generated Procedures(UTL0018B_EXTRACT_CLINIC_22_60_37_1)"


    #region "Automatic Item Initialization(UTL0018B_EXTRACT_CLINIC_22_60_37_1)"
    ...
    #region "Transaction Management Procedures(UTL0018B_EXTRACT_CLINIC_22_60_37_1)"
    ...
    #region "FILE Management Procedures(UTL0018B_EXTRACT_CLINIC_22_60_37_1)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(UTL0018B_EXTRACT_CLINIC_22_60_37_1)"
        ...
        try
        {
            ...
            while (fleICONST_MSTR_REC.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                    ...
                    "ICONSTPEDNUMBERWITHINFISCALYEAR");
...
public class UTL0018B_UPDATE_MONTHEND_1_CLINICS_2 : UTL0018B
{
    public UTL0018B_UPDATE_MONTHEND_1_CLINICS_2(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        fleICONST_MSTR_REC = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "ICONST_MSTR_REC", "", false, false, false, 0, "m_trnTRANS_UPDATE");
    ...
    #region "Declarations (Variables, Files and Transactions)(UTL0018B_UPDATE_MONTHEND_1_CLINICS_2)"
    ...
    #region "Standard Generated Procedures(UTL0018B_UPDATE_MONTHEND_1_CLINICS_2)"


    #region "Automatic Item Initialization(UTL0018B_UPDATE_MONTHEND_1_CLINICS_2)"
    ...
    #region "Transaction Management Procedures(UTL0018B_UPDATE_MONTHEND_1_CLINICS_2)"
    ...
    #region "FILE Management Procedures(UTL0018B_UPDATE_MONTHEND_1_CLINICS_2)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(UTL0018B_UPDATE_MONTHEND_1_CLINICS_2)"

    public void Run()
    {
        try
        {
            Request("UPDATE_MONTHEND_1_CLINICS_2");
            ...
            while (fleICONST_MSTR_REC.QTPForMissing())
            {
                ...
                while (fleEXT_CLINIC37.QTPForMissing("1"))
                {
                    ...
                    if (Transaction())
                    {
                         if (Select_If())
                        {
                            fleICONST_MSTR_REC.set_SetValue("ICONST_DATE_PERIOD_END_YY", QDesign.NConvert((fleEXT_CLINIC37.GetDecimalValue("ICONST_DATE_PERIOD_END")).ToString().PadRight(8).Substring(0, 4)));
                            fleICONST_MSTR_REC.set_SetValue("ICONST_DATE_PERIOD_END_MM", QDesign.NConvert((fleEXT_CLINIC37.GetDecimalValue("ICONST_DATE_PERIOD_END")).ToString().PadRight(8).Substring(4, 2)));
                            fleICONST_MSTR_REC.set_SetValue("ICONST_DATE_PERIOD_END_DD", QDesign.NConvert((fleEXT_CLINIC37.GetDecimalValue("ICONST_DATE_PERIOD_END")).ToString().PadRight(8).Substring(6, 2)));
                            fleICONST_MSTR_REC.set_SetValue("ICONSTPEDNUMBERWITHINFISCALYEAR", fleEXT_CLINIC37.GetDecimalValue("ICONSTPEDNUMBERWITHINFISCALYEAR") + 1);
        ...
        {
            EndRequest("UPDATE_MONTHEND_1_CLINICS_2");
        }
...
//UPDATE_MONTHEND_1_CLINICS_2

public class UTL0018B_UPDATE_MONTHEND_2_CLINICS_3 : UTL0018B
{

    public UTL0018B_UPDATE_MONTHEND_2_CLINICS_3(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        fleICONST_MSTR_REC = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "ICONST_MSTR_REC", "", false, false, false, 0, "m_trnTRANS_UPDATE");
    ...
    #region "Declarations (Variables, Files and Transactions)(UTL0018B_UPDATE_MONTHEND_2_CLINICS_3)"
    ...
    #region "Standard Generated Procedures(UTL0018B_UPDATE_MONTHEND_2_CLINICS_3)"


    #region "Automatic Item Initialization(UTL0018B_UPDATE_MONTHEND_2_CLINICS_3)"
    ...
    #region "Transaction Management Procedures(UTL0018B_UPDATE_MONTHEND_2_CLINICS_3)"
    ...
    #region "FILE Management Procedures(UTL0018B_UPDATE_MONTHEND_2_CLINICS_3)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(UTL0018B_UPDATE_MONTHEND_2_CLINICS_3)"
                ...
                while (fleEXT_CLINIC60.QTPForMissing("1"))
                {
                    ...
                    if (Transaction())
                    {
                         if (Select_If())
                        {
                            ...
                            fleICONST_MSTR_REC.set_SetValue("ICONST_DATE_PERIOD_END_YY", QDesign.NConvert((fleEXT_CLINIC60.GetDecimalValue("ICONST_DATE_PERIOD_END")).ToString().PadRight(8).Substring(0, 4)));
                            fleICONST_MSTR_REC.set_SetValue("ICONST_DATE_PERIOD_END_MM", QDesign.NConvert((fleEXT_CLINIC60.GetDecimalValue("ICONST_DATE_PERIOD_END")).ToString().PadRight(8).Substring(4, 2)));
                            fleICONST_MSTR_REC.set_SetValue("ICONST_DATE_PERIOD_END_DD", QDesign.NConvert((fleEXT_CLINIC60.GetDecimalValue("ICONST_DATE_PERIOD_END")).ToString().PadRight(8).Substring(6, 2)));
...
public class UTL0018B_UPDATE_MONTHEND_3_CLINICS_4 : UTL0018B
{
    public UTL0018B_UPDATE_MONTHEND_3_CLINICS_4(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        fleICONST_MSTR_REC = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "ICONST_MSTR_REC", "", false, false, false, 0, "m_trnTRANS_UPDATE");
    ...
    #region "Declarations (Variables, Files and Transactions)(UTL0018B_UPDATE_MONTHEND_3_CLINICS_4)"
    ...
    #region "Standard Generated Procedures(UTL0018B_UPDATE_MONTHEND_3_CLINICS_4)"


    #region "Automatic Item Initialization(UTL0018B_UPDATE_MONTHEND_3_CLINICS_4)"
    ...
    #region "Transaction Management Procedures(UTL0018B_UPDATE_MONTHEND_3_CLINICS_4)"
    ...
    #region "FILE Management Procedures(UTL0018B_UPDATE_MONTHEND_3_CLINICS_4)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(UTL0018B_UPDATE_MONTHEND_3_CLINICS_4)"

    public void Run()
    {
        try
        {
            Request("UPDATE_MONTHEND_3_CLINICS_4");
            ...
            while (fleICONST_MSTR_REC.QTPForMissing())
            {
                ...
                while (fleEXT_CLINIC22.QTPForMissing("1"))
                {
                    ...
                    if (Transaction())
                    {
                         if (Select_If())
                        {
                            fleICONST_MSTR_REC.set_SetValue("ICONST_DATE_PERIOD_END_YY", QDesign.NConvert((fleEXT_CLINIC22.GetDecimalValue("ICONST_DATE_PERIOD_END")).ToString().PadRight(8).Substring(0, 4)));
                            fleICONST_MSTR_REC.set_SetValue("ICONST_DATE_PERIOD_END_MM", QDesign.NConvert((fleEXT_CLINIC22.GetDecimalValue("ICONST_DATE_PERIOD_END")).ToString().PadRight(8).Substring(4, 2)));
                            fleICONST_MSTR_REC.set_SetValue("ICONST_DATE_PERIOD_END_DD", QDesign.NConvert((fleEXT_CLINIC22.GetDecimalValue("ICONST_DATE_PERIOD_END")).ToString().PadRight(8).Substring(6, 2)));
        ...
        {
            EndRequest("UPDATE_MONTHEND_3_CLINICS_4");
        }
    }

    #endregion
}
//UPDATE_MONTHEND_3_CLINICS_4
