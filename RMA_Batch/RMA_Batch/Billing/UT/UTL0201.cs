...
public class UTL0201 : BaseClassControl
{

    private UTL0201 m_UTL0201;

    public UTL0201(string Name, int Level)
        : base(Name, Level)
    {
    ...
    public UTL0201(string Name, int Level, bool Request)
    ...
    public override void Dispose()
    {
        if ((m_UTL0201 != null))
        {
            m_UTL0201.CloseTransactionObjects();
            m_UTL0201 = null;
        }
    }

    public UTL0201 GetUTL0201(int Level)
    {
        if (m_UTL0201 == null)
        {
            m_UTL0201 = new UTL0201("UTL0201", Level);
        }
        else
        {
            m_UTL0201.ResetValues();
        }
        return m_UTL0201;
    }
    ...
    public override bool RunQTP()
    {
        ...
        try
        {
            ...
            UTL0201_A_CONSTANTS_VALUES_EP_NBR_1 A_CONSTANTS_VALUES_EP_NBR_1 = new UTL0201_A_CONSTANTS_VALUES_EP_NBR_1(Name, Level);
            A_CONSTANTS_VALUES_EP_NBR_1.Run();
            A_CONSTANTS_VALUES_EP_NBR_1.Dispose();
            A_CONSTANTS_VALUES_EP_NBR_1 = null;

            UTL0201_F020_AUDIT_2 F020_AUDIT_2 = new UTL0201_F020_AUDIT_2(Name, Level);
            F020_AUDIT_2.Run();
            F020_AUDIT_2.Dispose();
            F020_AUDIT_2 = null;

            UTL0201_F028_AUDIT_3 F028_AUDIT_3 = new UTL0201_F028_AUDIT_3(Name, Level);
            F028_AUDIT_3.Run();
            F028_AUDIT_3.Dispose();
            F028_AUDIT_3 = null;

            UTL0201_F110_AUDIT_4 F110_AUDIT_4 = new UTL0201_F110_AUDIT_4(Name, Level);
            F110_AUDIT_4.Run();
            F110_AUDIT_4.Dispose();
            F110_AUDIT_4 = null;

            UTL0201_F112_AUDIT_5 F112_AUDIT_5 = new UTL0201_F112_AUDIT_5(Name, Level);
            F112_AUDIT_5.Run();
            F112_AUDIT_5.Dispose();
            F112_AUDIT_5 = null;

            UTL0201_F119_AUDIT_6 F119_AUDIT_6 = new UTL0201_F119_AUDIT_6(Name, Level);
            F119_AUDIT_6.Run();
            F119_AUDIT_6.Dispose();
            F119_AUDIT_6 = null;

            UTL0201_F020_7 F020_7 = new UTL0201_F020_7(Name, Level);
            F020_7.Run();
            F020_7.Dispose();
            F020_7 = null;

            UTL0201_F119_8 F119_8 = new UTL0201_F119_8(Name, Level);
            F119_8.Run();
            F119_8.Dispose();
            F119_8 = null;

            UTL0201_F119_HISTORY_9 F119_HISTORY_9 = new UTL0201_F119_HISTORY_9(Name, Level);
            F119_HISTORY_9.Run();
            F119_HISTORY_9.Dispose();
            F119_HISTORY_9 = null;

            UTL0201_F191_10 F191_10 = new UTL0201_F191_10(Name, Level);
            F191_10.Run();
            F191_10.Dispose();
            F191_10 = null;
...
public class UTL0201_A_CONSTANTS_VALUES_EP_NBR_1 : UTL0201
{

    public UTL0201_A_CONSTANTS_VALUES_EP_NBR_1(string Name, int Level)
    ...
    #region "Declarations (Variables, Files and Transactions)(UTL0201_A_CONSTANTS_VALUES_EP_NBR_1)"
    ...
    #region "Standard Generated Procedures(UTL0201_A_CONSTANTS_VALUES_EP_NBR_1)"


    #region "Automatic Item Initialization(UTL0201_A_CONSTANTS_VALUES_EP_NBR_1)"
    ...
    #region "Transaction Management Procedures(UTL0201_A_CONSTANTS_VALUES_EP_NBR_1)"
    ...
    #region "FILE Management Procedures(UTL0201_A_CONSTANTS_VALUES_EP_NBR_1)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(UTL0201_A_CONSTANTS_VALUES_EP_NBR_1)"
...
public class UTL0201_F020_AUDIT_2 : UTL0201
{

    public UTL0201_F020_AUDIT_2(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        fleF020_DOCTOR_AUDIT = new SqlFileObject(this, FileTypes.Primary, 0, "SEQUENTIAL", "F020_DOCTOR_AUDIT", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SequentialDataBase);
    ...
    #region "Declarations (Variables, Files and Transactions)(UTL0201_F020_AUDIT_2)"
    ...
    #region "Standard Generated Procedures(UTL0201_F020_AUDIT_2)"


    #region "Automatic Item Initialization(UTL0201_F020_AUDIT_2)"
    ...
    #region "Transaction Management Procedures(UTL0201_F020_AUDIT_2)"
    ...
    #region "FILE Management Procedures(UTL0201_F020_AUDIT_2)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(UTL0201_F020_AUDIT_2)"
        ...
        try
        {
            ...
            while (fleF020_DOCTOR_AUDIT.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleUTLF020_AUDIT, SubFileType.Portable, ENVIRONMENT, X_DELIMITER, fleF020_DOCTOR_AUDIT);
...
public class UTL0201_F028_AUDIT_3 : UTL0201
{

    public UTL0201_F028_AUDIT_3(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
    ...
    #region "Declarations (Variables, Files and Transactions)(UTL0201_F028_AUDIT_3)"
    ...
    #region "Standard Generated Procedures(UTL0201_F028_AUDIT_3)"


    #region "Automatic Item Initialization(UTL0201_F028_AUDIT_3)"
    ...
    #region "Transaction Management Procedures(UTL0201_F028_AUDIT_3)"
    ...
    #region "FILE Management Procedures(UTL0201_F028_AUDIT_3)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(UTL0201_F028_AUDIT_3)"
        ...
        try
        {
            ...
            while (fleF028_AUDIT_FILE.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleUTLF028_AUDIT, SubFileType.Portable, ENVIRONMENT, X_DELIMITER, fleF028_AUDIT_FILE, X_LF);
...
public class UTL0201_F110_AUDIT_4 : UTL0201
{

    public UTL0201_F110_AUDIT_4(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        fleF110_COMPENSATION_AUDIT = new SqlFileObject(this, FileTypes.Primary, 0, "SEQUENTIAL", "F110_COMPENSATION_AUDIT", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SequentialDataBase);
    ...
    #region "Declarations (Variables, Files and Transactions)(UTL0201_F110_AUDIT_4)"
    ...
    #region "Standard Generated Procedures(UTL0201_F110_AUDIT_4)"


    #region "Automatic Item Initialization(UTL0201_F110_AUDIT_4)"
    ...
    #region "Transaction Management Procedures(UTL0201_F110_AUDIT_4)"
    ...
    #region "FILE Management Procedures(UTL0201_F110_AUDIT_4)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(UTL0201_F110_AUDIT_4)"
        ...
        try
        {
            ...
            while (fleF110_COMPENSATION_AUDIT.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleUTLF110_AUDIT, SubFileType.Portable, ENVIRONMENT, X_DELIMITER, fleF110_COMPENSATION_AUDIT, X_LF);
...
public class UTL0201_F112_AUDIT_5 : UTL0201
{

    public UTL0201_F112_AUDIT_5(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        fleF112_PYCDCEILINGS_AUDIT = new SqlFileObject(this, FileTypes.Primary, 0, "SEQUENTIAL", "F112_PYCDCEILINGS_AUDIT", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SequentialDataBase);
    ...
    #region "Declarations (Variables, Files and Transactions)(UTL0201_F112_AUDIT_5)"
    ...
    #region "Standard Generated Procedures(UTL0201_F112_AUDIT_5)"


    #region "Automatic Item Initialization(UTL0201_F112_AUDIT_5)"
    ...
    #region "Transaction Management Procedures(UTL0201_F112_AUDIT_5)"
    ...
    #region "FILE Management Procedures(UTL0201_F112_AUDIT_5)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(UTL0201_F112_AUDIT_5)"
        ...
        try
        {
            ...
            while (fleF112_PYCDCEILINGS_AUDIT.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleUTLF112_AUDIT, SubFileType.Portable, ENVIRONMENT, X_DELIMITER, fleF112_PYCDCEILINGS_AUDIT, X_LF);
...
public class UTL0201_F119_AUDIT_6 : UTL0201
{

    public UTL0201_F119_AUDIT_6(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        fleF119_DOCTOR_YTD_AUDIT = new SqlFileObject(this, FileTypes.Primary, 0, "SEQUENTIAL", "F119_DOCTOR_YTD_AUDIT", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SequentialDataBase);
        fleUTL0201_F119_AUDIT = new SqlFileObject(this, FileTypes.Primary, 0, "TEMPORARYDATA", "UTL0201_F119_AUDIT", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SubFile);
    ...
    #region "Declarations (Variables, Files and Transactions)(UTL0201_F119_AUDIT_6)"
    ...
    private SqlFileObject fleUTL0201_F119_AUDIT;


    #endregion


    #region "Standard Generated Procedures(UTL0201_F119_AUDIT_6)"


    #region "Automatic Item Initialization(UTL0201_F119_AUDIT_6)"
    ...
    #region "Transaction Management Procedures(UTL0201_F119_AUDIT_6)"
    ...
    private void Initialize_TRANS_UPDATE()
    {
        ...
        fleUTL0201_F119_AUDIT.Transaction = m_trnTRANS_UPDATE;
    ...
    #region "FILE Management Procedures(UTL0201_F119_AUDIT_6)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(UTL0201_F119_AUDIT_6)"
        ...
        try
        {
            ...
            while (fleF119_DOCTOR_YTD_AUDIT.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleUTL0201_F119_AUDIT, SubFileType.Portable, ENVIRONMENT, X_DELIMITER, fleF119_DOCTOR_YTD_AUDIT, X_LF);
...
public class UTL0201_F020_7 : UTL0201
{

    public UTL0201_F020_7(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
    ...
    #region "Declarations (Variables, Files and Transactions)(UTL0201_F020_7)"
    ...
    #region "Standard Generated Procedures(UTL0201_F020_7)"


    #region "Automatic Item Initialization(UTL0201_F020_7)"
    ...
    #region "Transaction Management Procedures(UTL0201_F020_7)"
    ...
    #region "FILE Management Procedures(UTL0201_F020_7)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(UTL0201_F020_7)"
                ...
                while (fleF070_DEPT_MSTR.QTPForMissing("1"))
                {
                    ...
                    if (Transaction())
                    {
                         ...
                         if (Select_If())
                        {
                            ...
                            SubFile(ref m_trnTRANS_UPDATE, ref fleUTL0F020, SubFileType.Portable, ENVIRONMENT, X_DELIMITER, fleF020_DOCTOR_MSTR, "DOC_NBR", "DOC_DEPT", "DOC_NAME", "DOC_INITS",
...
public class UTL0201_F119_8 : UTL0201
{

    public UTL0201_F119_8(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
    ...
    #region "Declarations (Variables, Files and Transactions)(UTL0201_F119_8)"
    ...
    #region "Standard Generated Procedures(UTL0201_F119_8)"


    #region "Automatic Item Initialization(UTL0201_F119_8)"
    ...
    #region "Transaction Management Procedures(UTL0201_F119_8)"
    ...
    #region "FILE Management Procedures(UTL0201_F119_8)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(UTL0201_F119_8)"
...
public class UTL0201_F119_HISTORY_9 : UTL0201
{

    public UTL0201_F119_HISTORY_9(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        ...
        fleUTL0201_F119_HISTORY = new SqlFileObject(this, FileTypes.Primary, 0, "TEMPORARYDATA", "UTL0201_F119_HISTORY", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SubFile);
    ...
    #region "Declarations (Variables, Files and Transactions)(UTL0201_F119_HISTORY_9)"
    ...
    private SqlFileObject fleUTL0201_F119_HISTORY;


    #endregion


    #region "Standard Generated Procedures(UTL0201_F119_HISTORY_9)"


    #region "Automatic Item Initialization(UTL0201_F119_HISTORY_9)"
    ...
    #region "Transaction Management Procedures(UTL0201_F119_HISTORY_9)"
    ...
    private void Initialize_TRANS_UPDATE()
    {
        ...
        fleUTL0201_F119_HISTORY.Transaction = m_trnTRANS_UPDATE;
    ...
    #region "FILE Management Procedures(UTL0201_F119_HISTORY_9)"
    ...
    protected override void CloseFiles()
    {
        ...
        try
        {
            ...
            fleUTL0201_F119_HISTORY.Dispose();
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(UTL0201_F119_HISTORY_9)"
            ...
            while (fleF119_DOCTOR_YTD_HISTORY.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                     ...
                     if (Select_If())
                    {
                        ...
                        SubFile(ref m_trnTRANS_UPDATE, ref fleUTL0201_F119_HISTORY, SubFileType.Portable, ENVIRONMENT, X_DELIMITER, fleF119_DOCTOR_YTD_HISTORY, X_BLANK_LAST_MOD_DATE, X_BLANK_LAST_MOD_TIME, X_BLANK_LAST_MOD_USER_ID, X_LF);
...
public class UTL0201_F191_10 : UTL0201
{

    public UTL0201_F191_10(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
    ...
    #region "Declarations (Variables, Files and Transactions)(UTL0201_F191_10)"
    ...
    #region "Standard Generated Procedures(UTL0201_F191_10)"


    #region "Automatic Item Initialization(UTL0201_F191_10)"
    ...
    #region "Transaction Management Procedures(UTL0201_F191_10)"
    ...
    #region "FILE Management Procedures(UTL0201_F191_10)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(UTL0201_F191_10)"
        ...
        try
        {
            ...
            while (fleF191_EARNINGS_PERIOD.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleUTL0F191, SubFileType.Portable, ENVIRONMENT, X_DELIMITER, fleF191_EARNINGS_PERIOD, "EP_NBR", X_ICONST_DATE_PERIOD_END, X_EP_DATE_START, X_EP_DATE_END,
