    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (fleF020_DOCTOR_MSTR.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                    fleF020_UPDATE.OutPut(OutPutType.Update);
                }
            }
        }
        catch (CustomApplicationException ex)
                ...
                while (fleF020_DOCTOR_MSTR.QTPForMissing("1"))
                {
                    ...
                    while (fleF112_NEXT_YR.QTPForMissing("2"))
                    {
                        ...
                        if (Transaction())
                        {
                            ...
                            fleF020_UPDATE.set_SetValue("DOC_YRLY_CEILING_COMPUTED", 100 * fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_CEILING"));
                            fleF020_UPDATE.set_SetValue("DOC_YRLY_EXPENSE_COMPUTED", 100 * fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_EXPENSE"));
                            fleF020_UPDATE.OutPut(OutPutType.Update);
                        }
                    }
                }
