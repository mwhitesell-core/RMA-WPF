...
public class YEAREND_2_UPLOAD_F113_HISTORY_1 : YEAREND_2
{
    ...
    private void fleF113_DEFAULT_COMP_HISTORY_SetItemFinals()
    {
        try
        {
            fleF113_DEFAULT_COMP_HISTORY.set_SetValue("DOC_NBR", fleF113_YEAREND_OLD.GetStringValue("DOC_NBR"));
            fleF113_DEFAULT_COMP_HISTORY.set_SetValue("EP_YR", QDesign.NConvert(QDesign.Substring(QDesign.ASCII(fleF113_YEAREND_OLD.GetDecimalValue("EP_NBR_FROM")), 1, 4)));
            fleF113_DEFAULT_COMP_HISTORY.set_SetValue("EP_MM", QDesign.NConvert(QDesign.Substring(QDesign.ASCII(fleF113_YEAREND_OLD.GetDecimalValue("EP_NBR_FROM")), 5, 2)));
            fleF113_DEFAULT_COMP_HISTORY.set_SetValue("COMP_CODE", fleF113_YEAREND_OLD.GetStringValue("COMP_CODE"));
            fleF113_DEFAULT_COMP_HISTORY.set_SetValue("EP_NBR_TO", fleF113_YEAREND_OLD.GetDecimalValue("EP_NBR_TO"));
            fleF113_DEFAULT_COMP_HISTORY.set_SetValue("FACTOR", fleF113_YEAREND_OLD.GetDecimalValue("FACTOR"));
            fleF113_DEFAULT_COMP_HISTORY.set_SetValue("FACTOR_OVERRIDE", fleF113_YEAREND_OLD.GetStringValue("FACTOR_OVERRIDE"));
            fleF113_DEFAULT_COMP_HISTORY.set_SetValue("COMP_UNITS", fleF113_YEAREND_OLD.GetDecimalValue("COMP_UNITS"));
            fleF113_DEFAULT_COMP_HISTORY.set_SetValue("AMT_GROSS", fleF113_YEAREND_OLD.GetDecimalValue("AMT_GROSS"));
            fleF113_DEFAULT_COMP_HISTORY.set_SetValue("AMT_NET", fleF113_YEAREND_OLD.GetDecimalValue("AMT_NET"));
            fleF113_DEFAULT_COMP_HISTORY.set_SetValue("EP_NBR_ENTRY", fleF113_YEAREND_OLD.GetDecimalValue("EP_NBR_ENTRY"));
            fleF113_DEFAULT_COMP_HISTORY.set_SetValue("LAST_MOD_DATE", fleF113_YEAREND_OLD.GetDecimalValue("LAST_MOD_DATE"));
            fleF113_DEFAULT_COMP_HISTORY.set_SetValue("LAST_MOD_TIME", fleF113_YEAREND_OLD.GetDecimalValue("LAST_MOD_TIME"));
            fleF113_DEFAULT_COMP_HISTORY.set_SetValue("LAST_MOD_USER_ID", fleF113_YEAREND_OLD.GetStringValue("LAST_MOD_USER_ID"));
            fleF113_DEFAULT_COMP_HISTORY.set_SetValue("CORE_COMMENT", fleF113_YEAREND_OLD.GetStringValue("CORE_COMMENT"));
            fleF113_DEFAULT_COMP_HISTORY.set_SetValue("FILLER", fleF113_YEAREND_OLD.GetStringValue("FILLER"));
        }
...
public class YEAREND_2_UPLOAD_F113_CURRENT_2 : YEAREND_2
{
    ...
    private void fleF113_DEFAULT_COMP_SetItemFinals()
    {
        try
        {
            fleF113_DEFAULT_COMP.set_SetValue("DOC_NBR", fleF113_YEAREND_NEW.GetStringValue("DOC_NBR"));
            fleF113_DEFAULT_COMP.set_SetValue("EP_NBR_FROM", fleF113_YEAREND_NEW.GetDecimalValue("EP_NBR_FROM"));
            fleF113_DEFAULT_COMP.set_SetValue("COMP_CODE", fleF113_YEAREND_NEW.GetStringValue("COMP_CODE"));
            fleF113_DEFAULT_COMP.set_SetValue("EP_NBR_TO", fleF113_YEAREND_NEW.GetDecimalValue("EP_NBR_TO"));
            fleF113_DEFAULT_COMP.set_SetValue("FACTOR", fleF113_YEAREND_NEW.GetDecimalValue("FACTOR"));
            fleF113_DEFAULT_COMP.set_SetValue("FACTOR_OVERRIDE", fleF113_YEAREND_NEW.GetStringValue("FACTOR_OVERRIDE"));
            fleF113_DEFAULT_COMP.set_SetValue("COMP_UNITS", fleF113_YEAREND_NEW.GetDecimalValue("COMP_UNITS"));
            fleF113_DEFAULT_COMP.set_SetValue("AMT_GROSS", fleF113_YEAREND_NEW.GetDecimalValue("AMT_GROSS"));
            fleF113_DEFAULT_COMP.set_SetValue("AMT_NET", fleF113_YEAREND_NEW.GetDecimalValue("AMT_NET"));
            fleF113_DEFAULT_COMP.set_SetValue("EP_NBR_ENTRY", fleF113_YEAREND_NEW.GetDecimalValue("EP_NBR_ENTRY"));
            fleF113_DEFAULT_COMP.set_SetValue("LAST_MOD_DATE", fleF113_YEAREND_NEW.GetDecimalValue("LAST_MOD_DATE"));
            fleF113_DEFAULT_COMP.set_SetValue("LAST_MOD_TIME", fleF113_YEAREND_NEW.GetDecimalValue("LAST_MOD_TIME"));
            fleF113_DEFAULT_COMP.set_SetValue("LAST_MOD_USER_ID", fleF113_YEAREND_NEW.GetStringValue("LAST_MOD_USER_ID"));
            fleF113_DEFAULT_COMP.set_SetValue("CORE_COMMENT", fleF113_YEAREND_NEW.GetStringValue("CORE_COMMENT"));
            fleF113_DEFAULT_COMP.set_SetValue("FILLER", fleF113_YEAREND_NEW.GetStringValue("FILLER"));
        }
...
public class YEAREND_2_UPLOAD_F112_HISTORY_3 : YEAREND_2
{
        ...
        : base(Name, Level, true)
    {
        ...
        fleF112_PYCDCEILINGS_HISTORY.SetItemFinals += fleF112_PYCDCEILINGS_HISTORY_SetItemFinals;
    }
    ...
    private void fleF112_PYCDCEILINGS_HISTORY_SetItemFinals()
    {
        try
        {
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_NBR", fleF112_YEAREND_OLD.GetStringValue("DOC_NBR"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("EP_NBR", fleF112_YEAREND_OLD.GetDecimalValue("EP_NBR"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("FACTOR", fleF112_YEAREND_OLD.GetDecimalValue("FACTOR"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_PAY_CODE", fleF112_YEAREND_OLD.GetStringValue("DOC_PAY_CODE"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_PAY_SUB_CODE", fleF112_YEAREND_OLD.GetStringValue("DOC_PAY_SUB_CODE"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("RETRO_TO_EP_NBR", fleF112_YEAREND_OLD.GetDecimalValue("RETRO_TO_EP_NBR"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_YRLY_CEILING", fleF112_YEAREND_OLD.GetDecimalValue("DOC_YRLY_CEILING"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_YRLY_CEILING_ADJUSTED", fleF112_YEAREND_OLD.GetDecimalValue("DOC_YRLY_CEILING_ADJUSTED"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_YRLY_CEILING_COMPUTED", fleF112_YEAREND_OLD.GetDecimalValue("DOC_YRLY_CEILING_COMPUTED"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_YRLY_EXPENSE", fleF112_YEAREND_OLD.GetDecimalValue("DOC_YRLY_EXPENSE"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_YRLY_EXPENSE_ADJUSTED", fleF112_YEAREND_OLD.GetDecimalValue("DOC_YRLY_EXPENSE_ADJUSTED"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_YRLY_EXPENSE_COMPUTED", fleF112_YEAREND_OLD.GetDecimalValue("DOC_YRLY_EXPENSE_COMPUTED"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_YRLY_EXPN_ALLOC_PERS", fleF112_YEAREND_OLD.GetDecimalValue("DOC_YRLY_EXPN_ALLOC_PERS"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_YRLY_CEIL_GUAR", fleF112_YEAREND_OLD.GetDecimalValue("DOC_YRLY_CEIL_GUAR"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_YRLY_CEILING_GUAR_PERC", fleF112_YEAREND_OLD.GetDecimalValue("DOC_YRLY_CEILING_GUAR_PERC"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("LAST_MOD_DATE", fleF112_YEAREND_OLD.GetDecimalValue("LAST_MOD_DATE"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("LAST_MOD_TIME", fleF112_YEAREND_OLD.GetDecimalValue("LAST_MOD_TIME"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("LAST_MOD_USER_ID", fleF112_YEAREND_OLD.GetStringValue("LAST_MOD_USER_ID"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_RMA_EXPENSE_PERCENT_REG", fleF112_YEAREND_OLD.GetDecimalValue("DOC_RMA_EXPENSE_PERCENT_REG"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_RMA_EXPENSE_PERCENT_MISC", fleF112_YEAREND_OLD.GetDecimalValue("DOC_RMA_EXPENSE_PERCENT_MISC"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_DEPT_EXPENSE_PERCENT_REG", fleF112_YEAREND_OLD.GetDecimalValue("DOC_DEPT_EXPENSE_PERCENT_REG"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_DEPT_EXPENSE_PERCENT_MISC", fleF112_YEAREND_OLD.GetDecimalValue("DOC_DEPT_EXPENSE_PERCENT_MISC"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_YRLY_REQREV", fleF112_YEAREND_OLD.GetDecimalValue("DOC_YRLY_REQREV"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_YRLY_REQREV_ADJUSTED", fleF112_YEAREND_OLD.GetDecimalValue("DOC_YRLY_REQREV_ADJUSTED"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_YRLY_REQREV_COMPUTED", fleF112_YEAREND_OLD.GetDecimalValue("DOC_YRLY_REQREV_COMPUTED"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_YRLY_TARREV", fleF112_YEAREND_OLD.GetDecimalValue("DOC_YRLY_TARREV"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_YRLY_TARREV_ADJUSTED", fleF112_YEAREND_OLD.GetDecimalValue("DOC_YRLY_TARREV_ADJUSTED"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("DOC_YRLY_TARREV_COMPUTED", fleF112_YEAREND_OLD.GetDecimalValue("DOC_YRLY_TARREV_COMPUTED"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("RETRO_TO_EP_NBR_REQ", fleF112_YEAREND_OLD.GetDecimalValue("RETRO_TO_EP_NBR_REQ"));
            fleF112_PYCDCEILINGS_HISTORY.set_SetValue("RETRO_TO_EP_NBR_TAR", fleF112_YEAREND_OLD.GetDecimalValue("RETRO_TO_EP_NBR_TAR"));
        }
...
public class YEAREND_2_UPLOAD_F112_CURRENT_4 : YEAREND_2
{
    ...
    private void fleF112_PYCDCEILINGS_AutomaticItemInitialization(bool Fixed)
    {
        try
        {
            fleF112_PYCDCEILINGS.set_SetValue("DOC_NBR", !Fixed, fleF112_YEAREND_NEW.GetStringValue("DOC_NBR"));
            fleF112_PYCDCEILINGS.set_SetValue("EP_NBR", !Fixed, fleF112_YEAREND_NEW.GetDecimalValue("EP_NBR"));
            fleF112_PYCDCEILINGS.set_SetValue("FACTOR", !Fixed, fleF112_YEAREND_NEW.GetDecimalValue("FACTOR"));
            fleF112_PYCDCEILINGS.set_SetValue("DOC_PAY_CODE", !Fixed, fleF112_YEAREND_NEW.GetStringValue("DOC_PAY_CODE"));
            fleF112_PYCDCEILINGS.set_SetValue("DOC_PAY_SUB_CODE", !Fixed, fleF112_YEAREND_NEW.GetStringValue("DOC_PAY_SUB_CODE"));
            fleF112_PYCDCEILINGS.set_SetValue("RETRO_TO_EP_NBR", !Fixed, fleF112_YEAREND_NEW.GetDecimalValue("RETRO_TO_EP_NBR"));
            fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_CEILING", !Fixed, fleF112_YEAREND_NEW.GetDecimalValue("DOC_YRLY_CEILING"));
            fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_CEILING_ADJUSTED", !Fixed, fleF112_YEAREND_NEW.GetDecimalValue("DOC_YRLY_CEILING_ADJUSTED"));
            fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_CEILING_COMPUTED", !Fixed, fleF112_YEAREND_NEW.GetDecimalValue("DOC_YRLY_CEILING_COMPUTED"));
            fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_EXPENSE", !Fixed, fleF112_YEAREND_NEW.GetDecimalValue("DOC_YRLY_EXPENSE"));
            fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_EXPENSE_ADJUSTED", !Fixed, fleF112_YEAREND_NEW.GetDecimalValue("DOC_YRLY_EXPENSE_ADJUSTED"));
            fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_EXPENSE_COMPUTED", !Fixed, fleF112_YEAREND_NEW.GetDecimalValue("DOC_YRLY_EXPENSE_COMPUTED"));
            fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_EXPN_ALLOC_PERS", !Fixed, fleF112_YEAREND_NEW.GetDecimalValue("DOC_YRLY_EXPN_ALLOC_PERS"));
            fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_CEIL_GUAR", !Fixed, fleF112_YEAREND_NEW.GetDecimalValue("DOC_YRLY_CEIL_GUAR"));
            fleF112_PYCDCEILINGS.set_SetValue("DOC_YRLY_CEILING_GUAR_PERC", !Fixed, fleF112_YEAREND_NEW.GetDecimalValue("DOC_YRLY_CEILING_GUAR_PERC"));
            fleF112_PYCDCEILINGS.set_SetValue("LAST_MOD_DATE", !Fixed, fleF112_YEAREND_NEW.GetDecimalValue("LAST_MOD_DATE"));
            fleF112_PYCDCEILINGS.set_SetValue("LAST_MOD_TIME", !Fixed, fleF112_YEAREND_NEW.GetDecimalValue("LAST_MOD_TIME"));
            fleF112_PYCDCEILINGS.set_SetValue("LAST_MOD_USER_ID", !Fixed, fleF112_YEAREND_NEW.GetStringValue("LAST_MOD_USER_ID"));
            fleF112_PYCDCEILINGS.set_SetValue("DOC_RMA_EXPENSE_PERCENT_REG", !Fixed, fleF112_YEAREND_NEW.GetDecimalValue("DOC_RMA_EXPENSE_PERCENT_REG"));
            fleF112_PYCDCEILINGS.set_SetValue("DOC_RMA_EXPENSE_PERCENT_MISC", !Fixed, fleF112_YEAREND_NEW.GetDecimalValue("DOC_RMA_EXPENSE_PERCENT_MISC"));
            fleF112_PYCDCEILINGS.set_SetValue("DOC_DEPT_EXPENSE_PERCENT_REG", !Fixed, fleF112_YEAREND_NEW.GetDecimalValue("DOC_DEPT_EXPENSE_PERCENT_REG"));
            fleF112_PYCDCEILINGS.set_SetValue("DOC_DEPT_EXPENSE_PERCENT_MISC", !Fixed, fleF112_YEAREND_NEW.GetDecimalValue("DOC_DEPT_EXPENSE_PERCENT_MISC"));
        }
