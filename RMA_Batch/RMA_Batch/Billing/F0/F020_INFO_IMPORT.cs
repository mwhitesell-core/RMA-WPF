...
public class F020_INFO_IMPORT_ONE_1 : F020_INFO_IMPORT
{
    ...
    private void fleF020C_DOC_CLINIC_NEXT_BATCH_NBR_SetItemFinals()
    {
        ...
        try
        {
            fleF020C_DOC_CLINIC_NEXT_BATCH_NBR.set_SetValue("DOC_NBR", fleF020C_DOC_CLINIC_EXPORT.GetStringValue("DOC_NBR"));
            fleF020C_DOC_CLINIC_NEXT_BATCH_NBR.set_SetValue("DOC_CLINIC_NBR", fleF020C_DOC_CLINIC_EXPORT.GetStringValue("DOC_CLINIC_NBR"));
            fleF020C_DOC_CLINIC_NEXT_BATCH_NBR.set_SetValue("DOC_CLINIC_NBR_STATUS", fleF020C_DOC_CLINIC_EXPORT.GetStringValue("DOC_CLINIC_NBR_STATUS"));
            fleF020C_DOC_CLINIC_NEXT_BATCH_NBR.set_SetValue("DOC_NX_AVAIL_BATCH", fleF020C_DOC_CLINIC_EXPORT.GetStringValue("DOC_NX_AVAIL_BATCH"));
    ...
    private string GetPostalCode(string pc1, decimal pc2, string pc3, decimal pc4, string pc5, decimal pc6)
    {
        string postal_code = "";

        postal_code = pc1 + pc2.ToString() + pc3 + pc4.ToString() + pc5 + pc6.ToString();
        return postal_code;
    }
    ...
    private void fleF028_DOC_HOME_ADD_SetItemFinals()
    {
        ...
        try
        {
            ...
            postal_code = GetPostalCode(fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_HOME_PC1"),
                fleF020_INFO_EXPORT.GetDecimalValue("DOC_ADDR_HOME_PC2"),
                fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_HOME_PC3"),
                fleF020_INFO_EXPORT.GetDecimalValue("DOC_ADDR_HOME_PC4"),
                fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_HOME_PC5"),
                fleF020_INFO_EXPORT.GetDecimalValue("DOC_ADDR_HOME_PC6"));

            fleF028_DOC_HOME_ADD.set_SetValue("POSTAL_CODE", postal_code);
    ...
    private void fleF028_DOC_HOME_UPDATE_SetItemFinals()
    {
        ...
        try
        {
            ...
            if (QDesign.NULL(fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_HOME_PC1")) != QDesign.NULL(" "))
            {
                postal_code = GetPostalCode(fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_HOME_PC1"),
                    fleF020_INFO_EXPORT.GetDecimalValue("DOC_ADDR_HOME_PC2"),
                    fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_HOME_PC3"),
                ...
                fleF028_DOC_HOME_UPDATE.set_SetValue("POSTAL_CODE", postal_code);
            }
    ...
    private void fleF028_DOC_OFFICE_ADD_SetItemFinals()
    {
        ...
        try
        {
            ...
            fleF028_DOC_OFFICE_ADD.set_SetValue("POSTAL_CODE", postal_code);
    ...
    private void fleF028_DOC_OFFICE_UPDATE_SetItemFinals()
    {
        ...
        try
        {
            ...
            if (QDesign.NULL(fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_OFFICE_PC1")) != QDesign.NULL(" "))
            {
                postal_code = GetPostalCode(fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_HOME_PC1"),
                    fleF020_INFO_EXPORT.GetDecimalValue("DOC_ADDR_HOME_PC2"),
                    fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_HOME_PC3"),
                ...
                fleF028_DOC_OFFICE_UPDATE.set_SetValue("POSTAL_CODE", postal_code);
            }
    ...
    private void fleF020_DOCTOR_MSTR_ADD_AutomaticItemInitialization(bool Fixed)
    {
        ...
        {
            //TODO: Manual steps may be required.
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_NBR", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_NBR"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_DEPT", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_DEPT"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_OHIP_NBR", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_OHIP_NBR"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_SIN_123", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_SIN_123"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_SIN_456", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_SIN_456"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_SIN_789", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_SIN_789"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_SPEC_CD", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_SPEC_CD"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_HOSP_NBR", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_HOSP_NBR"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_NAME", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_NAME"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_NAME_SOUNDEX", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_NAME_SOUNDEX"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_INIT1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_INIT1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_INIT2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_INIT2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_INIT3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_INIT3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_ADDR_OFFICE_1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_OFFICE_1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_ADDR_OFFICE_2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_OFFICE_2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_ADDR_OFFICE_3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_OFFICE_3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_ADDR_OFFICE_PC1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_OFFICE_PC1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_ADDR_OFFICE_PC2", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_ADDR_OFFICE_PC2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_ADDR_OFFICE_PC3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_OFFICE_PC3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_ADDR_OFFICE_PC4", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_ADDR_OFFICE_PC4"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_ADDR_OFFICE_PC5", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_OFFICE_PC5"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_ADDR_OFFICE_PC6", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_ADDR_OFFICE_PC6"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_ADDR_HOME_1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_HOME_1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_ADDR_HOME_2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_HOME_2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_ADDR_HOME_3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_HOME_3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_ADDR_HOME_PC1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_HOME_PC1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_ADDR_HOME_PC2", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_ADDR_HOME_PC2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_ADDR_HOME_PC3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_HOME_PC3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_ADDR_HOME_PC4", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_ADDR_HOME_PC4"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_ADDR_HOME_PC5", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_ADDR_HOME_PC5"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_ADDR_HOME_PC6", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_ADDR_HOME_PC6"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_FULL_PART_IND", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_FULL_PART_IND"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_BANK_NBR", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_BANK_NBR"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_BANK_BRANCH", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_BANK_BRANCH"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_BANK_ACCT", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_BANK_ACCT"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_DATE_FAC_START_YY", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_DATE_FAC_START_YY"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_DATE_FAC_START_MM", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_DATE_FAC_START_MM"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_DATE_FAC_START_DD", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_DATE_FAC_START_DD"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_DATE_FAC_TERM_YY", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_DATE_FAC_TERM_YY"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_DATE_FAC_TERM_MM", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_DATE_FAC_TERM_MM"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_DATE_FAC_TERM_DD", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_DATE_FAC_TERM_DD"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_YTDGUA", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_YTDGUA"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_YTDGUB", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_YTDGUB"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_YTDGUC", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_YTDGUC"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_YTDGUD", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_YTDGUD"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_YTDCEA", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_YTDCEA"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_YTDCEX", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_YTDCEX"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_YTDEAR", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_YTDEAR"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_YTDINC", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_YTDINC"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_YTDEFT", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_YTDEFT"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_TOTINC_G", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_TOTINC_G"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_EP_DATE_DEPOSIT", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_EP_DATE_DEPOSIT"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_TOTINC", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_TOTINC"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_EP_CEIEXP", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_EP_CEIEXP"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_ADJCEA", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_ADJCEA"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_ADJCEX", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_ADJCEX"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_CEICEA", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_CEICEA"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_CEICEX", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_CEICEX"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("CEICEA_PRT_FORMAT", !Fixed, fleF020_INFO_EXPORT.GetStringValue("CEICEA_PRT_FORMAT"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("CEICEX_PRT_FORMAT", !Fixed, fleF020_INFO_EXPORT.GetStringValue("CEICEX_PRT_FORMAT"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("YTDCEA_PRT_FORMAT", !Fixed, fleF020_INFO_EXPORT.GetStringValue("YTDCEA_PRT_FORMAT"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("YTDCEX_PRT_FORMAT", !Fixed, fleF020_INFO_EXPORT.GetStringValue("YTDCEX_PRT_FORMAT"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_SPEC_CD_2", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_SPEC_CD_2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_SPEC_CD_3", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_SPEC_CD_3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_YTDINC_G", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_YTDINC_G"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_RMA_EXPENSE_PERCENT_MISC", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_RMA_EXPENSE_PERCENT_MISC"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_AFP_PAYM_GROUP", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_AFP_PAYM_GROUP"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_DEPT_2", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_DEPT_2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_IND_PAYS_GST", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_IND_PAYS_GST"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_NX_AVAIL_BATCH", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_NX_AVAIL_BATCH"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_NX_AVAIL_BATCH_2", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_NX_AVAIL_BATCH_2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_NX_AVAIL_BATCH_3", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_NX_AVAIL_BATCH_3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_NX_AVAIL_BATCH_4", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_NX_AVAIL_BATCH_4"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_NX_AVAIL_BATCH_5", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_NX_AVAIL_BATCH_5"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_NX_AVAIL_BATCH_6", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_NX_AVAIL_BATCH_6"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_YRLY_CEILING_COMPUTED", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_YRLY_CEILING_COMPUTED"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_YRLY_EXPENSE_COMPUTED", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_YRLY_EXPENSE_COMPUTED"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_RMA_EXPENSE_PERCENT_REG", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_RMA_EXPENSE_PERCENT_REG"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_SUB_SPECIALTY", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_SUB_SPECIALTY"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_PAYEFT", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_PAYEFT"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_YTDDED", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_YTDDED"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_DEPT_EXPENSE_PERCENT_MISC", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_DEPT_EXPENSE_PERCENT_MISC"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_DEPT_EXPENSE_PERCENT_REG", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_DEPT_EXPENSE_PERCENT_REG"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_EP_PED", !Fixed, fleF020_INFO_EXPORT.GetDecimalValue("DOC_EP_PED"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_EP_PAY_CODE", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_EP_PAY_CODE"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_EP_PAY_SUB_CODE", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_EP_PAY_SUB_CODE"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_PARTNERSHIP", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_PARTNERSHIP"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_IND_HOLDBACK_ACTIVE", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_IND_HOLDBACK_ACTIVE"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("GROUP_REGULAR_SERVICE", !Fixed, fleF020_INFO_EXPORT.GetStringValue("GROUP_REGULAR_SERVICE"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("GROUP_OVER_SERVICED", !Fixed, fleF020_INFO_EXPORT.GetStringValue("GROUP_OVER_SERVICED"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_1_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_1_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_1_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_1_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_1_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_1_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_2_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_2_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_2_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_2_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_2_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_2_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_3_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_3_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_3_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_3_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_3_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_3_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_4_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_4_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_4_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_4_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_4_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_4_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_5_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_5_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_5_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_5_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_5_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_5_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_6_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_6_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_6_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_6_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_6_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_6_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_7_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_7_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_7_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_7_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_7_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_7_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_8_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_8_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_8_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_8_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_8_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_8_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_9_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_9_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_9_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_9_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_9_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_9_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_10_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_10_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_10_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_10_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_10_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_10_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_11_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_11_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_11_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_11_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_11_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_11_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_12_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_12_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_12_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_12_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_12_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_12_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_13_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_13_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_13_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_13_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_13_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_13_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_14_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_14_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_14_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_14_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_14_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_14_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_15_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_15_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_15_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_15_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_15_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_15_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_16_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_16_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_16_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_16_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_16_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_16_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_17_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_17_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_17_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_17_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_17_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_17_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_18_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_18_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_18_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_18_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_18_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_18_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_19_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_19_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_19_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_19_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_19_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_19_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_20_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_20_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_20_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_20_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_20_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_20_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_21_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_21_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_21_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_21_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_21_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_21_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_22_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_22_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_22_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_22_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_22_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_22_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_23_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_23_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_23_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_23_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_23_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_23_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_24_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_24_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_24_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_24_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_24_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_24_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_25_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_25_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_25_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_25_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_25_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_25_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_26_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_26_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_26_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_26_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_26_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_26_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_27_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_27_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_27_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_27_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_27_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_27_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_28_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_28_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_28_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_28_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_28_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_28_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_29_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_29_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_29_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_29_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_29_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_29_S3"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_30_S1", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_30_S1"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_30_S2", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_30_S2"));
            fleF020_DOCTOR_MSTR_ADD.set_SetValue("DOC_LOC_30_S3", !Fixed, fleF020_INFO_EXPORT.GetStringValue("DOC_LOC_30_S3"));
    ...
    public void Run()
    {
        ...
        try
        {
                    ...
                    while (fleF027_DOC.QTPForMissing("2"))
                    {
                        ...
                        while (fleF028_DOC_HOME.QTPForMissing("3"))
                        {
                            ...
                            while (fleF028_DOC_OFFICE.QTPForMissing("4"))
                            {
                                ...
                                while (fleF020C_DOC_CLINIC_EXPORT.QTPForMissing("5"))
                                {

                                    m_strWhere = new StringBuilder(" WHERE ");
                                    m_strWhere.Append(" ").Append(fleF020C_DOC_CLINIC_EXPORT.ElementOwner("DOC_NBR")).Append(" = ");
                                    m_strWhere.Append(Common.StringToField(fleF020_INFO_EXPORT.GetStringValue("DOC_NBR")));

                                    fleF020C_DOC_CLINIC_EXPORT.GetData(m_strWhere.ToString(), GetDataOptions.IsOptional);
                                    ...
                                    if (Transaction())
                                    {
                                        ...
                                        Sort(fleF020_INFO_EXPORT.GetSortValue("DOC_NBR"));
            ...
            while (Sort(fleF020_INFO_EXPORT, fleF020_DOCTOR_MSTR, fleF027_DOC, fleF028_DOC_HOME, fleF028_DOC_OFFICE, fleF020C_DOC_CLINIC_EXPORT))
            {

                if (fleF020_INFO_EXPORT.At("DOC_NBR"))
                {
                    ...
                    fleF028_DOC_OFFICE_ADD.OutPut(OutPutType.Add, null, !fleF028_DOC_HOME.Exists());
                ...
                // GW2018. May 21. See Issue 82. Yasemin has asked tsat this update be removed from the system
                // Begin Comment
                ...
                //    m_strWhere.Append(Common.StringToField(fleF020C_DOC_CLINIC_EXPORT.GetStringValue("DOC_NBR")));

                //    fleF020C_DOC_CLINIC_NEXT_BATCH_NBR.GetData(m_strWhere.ToString());

                //    fleF020C_DOC_CLINIC_NEXT_BATCH_NBR.OutPut(OutPutType.Add_Update);
