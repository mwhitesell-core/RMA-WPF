...
public class COSTING7_1_2 : COSTING7
{
    ...
    public void Run()
    {
        Int64 TMP_COUNTERS_ALPHA_COUNT = 0;
        ...
        try
        {
            ...
            using (SqlConnection conn = new SqlConnection(Common.GetSqlConnectionString()))
            {
                using (SqlCommand cmd = new SqlCommand("INDEXED.sp_COSTING7", conn))
                {
                    ...
                    cmd.Parameters.Add("@outTMP_COUNTERS_ALPHA_COUNT", SqlDbType.BigInt).Direction = ParameterDirection.Output;
                    ...
                    sw.WriteLine("  TMP_COUNTERS_ALPHA" + " ".PadLeft(10 - TMP_COUNTERS_ALPHA_COUNT.ToString().Trim().Length, ' ') + TMP_COUNTERS_ALPHA_COUNT.ToString().Trim() + " ".PadLeft(11, ' ') + "0" + " ".PadLeft(13, ' ') + "0" + " ".PadLeft(11, ' ') + "0" + Environment.NewLine + Environment.NewLine);
                    sw.Flush();
                    sw.Close();
                    sw.Dispose();
                }
...
fleTMP_COUNTERS_ALPHA.SetItemFinals += fleTMP_COUNTERS_ALPHA_SetItemFinals;
    ...
    private void X_START_GetValue(ref string Value)
    {
        ...
        try
        {
            Value = QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_START_YY"), 4) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_START_MM"), 2) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_START_DD"), 2);
    ...
    private void X_TERM_GetValue(ref string Value)
    {
        ...
        try
        {
            Value = QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_YY"), 4) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_MM"), 2) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_DD"), 2);
    ...
    private void X_RENUMBERED_START_GetValue(ref decimal Value)
    {
        ...
        try
        {
            ...
            if (QDesign.NConvert(QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_START_YY"), 4) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_START_MM"), 2) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_START_DD"), 2)) <= W_CURRENT_FISCAL_START_YYMMDD.Value)
            {
                CurrentValue = 1;
            }
            else if (QDesign.NConvert(QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_START_YY"), 4) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_START_MM"), 2) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_START_DD"), 2)) >= W_CURRENT_FISCAL_END_YYMMDD.Value)
            {
                CurrentValue = 0;
            }
    ...
    private void X_RENUMBERED_TERM_GetValue(ref decimal Value)
    {
        ...
        {
            decimal CurrentValue = 0m;
            if (QDesign.NConvert(QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_YY"), 4) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_MM"), 2) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_DD"), 2)) >= W_CURRENT_FISCAL_END_YYMMDD.Value | QDesign.NConvert(QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_YY"), 4) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_MM"), 2) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_DD"), 2)) == 0)
            {
                CurrentValue = 12;
            }
            else if (QDesign.NConvert(QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_YY"), 4) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_DD"), 2) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_DD"), 2)) <= W_CURRENT_FISCAL_START_YYMMDD.Value)
            {
                CurrentValue = 0;
            }
    ...
    private void fleTMP_COUNTERS_ALPHA_SetItemFinals()
    {
        ...
        try
        {
            ...
            fleTMP_COUNTERS_ALPHA.set_SetValue("TMP_COUNTER_1", QDesign.NConvert(QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_START_YY"), 4) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_START_MM"), 2) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_START_DD"), 2)));
            fleTMP_COUNTERS_ALPHA.set_SetValue("TMP_COUNTER_2", QDesign.NConvert(QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_YY"), 4) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_MM"), 2) + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DATE_FAC_TERM_DD"), 2)));
        ...
        try
        {
            ...
            while (fleCOSTING7.QTPForMissing())
            {
                ...
                while (fleF020_DOCTOR_MSTR.QTPForMissing("1"))
                {
                    ...
                    m_strWhere.Append(Common.StringToField(fleCOSTING7.GetStringValue("DOC_NBR")));
