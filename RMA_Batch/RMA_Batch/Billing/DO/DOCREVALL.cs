...
public class DOCREVALL : BaseClassControl
{

    private DOCREVALL m_DOCREVALL;

    public DOCREVALL(string Name, int Level)
        : base(Name, Level)
    {
        ...
        fleDOCREVALL = new SqlFileObject(this, FileTypes.Primary, 0, "TEMPORARYDATA", "DOCREVALL", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SubFile);
        ...
        COMMA2.GetValue += COMMA2_GetValue;
        COMMA3.GetValue += COMMA3_GetValue;
        X_NUM_CR.GetValue += X_NUM_CR_GetValue;
        X_CR.GetValue += X_CR_GetValue;

    }

    public DOCREVALL(string Name, int Level, bool Request)
    ...
    public override void Dispose()
    {
        if ((m_DOCREVALL != null))
        {
            m_DOCREVALL.CloseTransactionObjects();
            m_DOCREVALL = null;
        }
    }

    public DOCREVALL GetDOCREVALL(int Level)
    {
        if (m_DOCREVALL == null)
        {
            m_DOCREVALL = new DOCREVALL("DOCREVALL", Level);
        }
        else
        {
            m_DOCREVALL.ResetValues();
        }
        return m_DOCREVALL;
    }
    ...
    public override bool SelectIf()
    {
        ...
        try
        {
            if (QDesign.NULL(fleF050_DOC_REVENUE_MSTR_HISTORY.GetDecimalValue("EP_YR")) == QDesign.NConvert(Prompt(1).ToString()) & QDesign.NULL(fleF050_DOC_REVENUE_MSTR_HISTORY.GetNumericDateValue("ICONST_DATE_PERIOD_END")) == QDesign.NConvert(Prompt(2).ToString()))
            {
                return true;
            }
    ...
    private DCharacter COMMA2 = new DCharacter("COMMA2", 1);
    private void COMMA2_GetValue(ref string Value)
    {
    ...
    private DCharacter COMMA3 = new DCharacter("COMMA3", 1);
    private void COMMA3_GetValue(ref string Value)
    {
    ...
    private SqlFileObject fleDOCREVALL;
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleF050_DOC_REVENUE_MSTR_HISTORY))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleDOCREVALL, fleF050_DOC_REVENUE_MSTR_HISTORY.At("DOCREV_CLINIC_1_2"), SubFileType.Portable, fleF050_DOC_REVENUE_MSTR_HISTORY, "DOCREV_CLINIC_1_2", COMMA, TOT_AMT_YTD, COMMA2, TOT_MISC, COMMA3, TOTALS);
    ...
    #region "Standard Generated Procedures(DOCREVALL_DOCREVALL)"

    #region "Transaction Management Procedures(DOCREVALL_DOCREVALL)"
    ...
    private void Initialize_TRANS_UPDATE()
    {
        ...
        fleDOCREVALL.Transaction = m_trnTRANS_UPDATE;
    ...
    #region "FILE Management Procedures(DOCREVALL_DOCREVALL)"
