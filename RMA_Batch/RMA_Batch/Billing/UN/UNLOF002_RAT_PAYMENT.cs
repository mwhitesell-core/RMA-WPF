...
public class UNLOF002_RAT_PAYMENT_UNLOF002_1 : UNLOF002_RAT_PAYMENT
{
    ...
    private DCharacter CLMHDR_DATE_CASH_TAPE_PAYMENT = new DCharacter("CLMHDR_DATE_CASH_TAPE_PAYMENT", 6);
    private void CLMHDR_DATE_CASH_TAPE_PAYMENT_GetValue(ref string Value)
    {
        try
        {
            Value = QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_MSG_NBR") + fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_REPRINT_FLAG") + 
                    fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_SUB_NBR") + fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_AUTO_LOGOUT") + fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_FEE_COMPLEX"));
        }
        catch (CustomApplicationException ex)
        {
            WriteError(ex);
    ...
    private void CLMHDR_ORIG_BATCH_ID_GetValue(ref string Value)
    {
        try
        {
            Value = fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_ORIG_BATCH_NBR") + QDesign.ASCII(fleF002_CLAIMS_MSTR.GetDecimalValue("CLMHDR_ORIG_CLAIM_NBR"), 2);
        }
        catch (CustomApplicationException ex)
        {
            WriteError(ex);
    ...
    private void KEY_P_CLAIMS_MSTR_GetValue(ref string Value)
    {
        try
        {
            Value = fleF002_CLAIMS_MSTR.GetStringValue("KEY_P_CLAIM_TYPE") + fleF002_CLAIMS_MSTR.GetStringValue("KEY_P_CLM_DATA");
        }
            ...
            while (fleU030_PAID_AMT.QTPForMissing())
            {
                ...
                while (fleF002_CLAIMS_MSTR.QTPForMissing("1"))
                {
                    ...
                    if (Transaction())
                    {
                        ...
                        SubFile(ref m_trnTRANS_UPDATE, ref fleUNLOF002HDR_RAT_PAYMENT, QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_ADJ_OMA_CD")) == "0000", SubFileType.Portable, fleF002_CLAIMS_MSTR, "CLMHDR_BATCH_NBR", X_DELIMITER, "CLMHDR_CLAIM_NBR", "CLMHDR_ADJ_OMA_CD",
                        "CLMHDR_ADJ_OMA_SUFF", "CLMHDR_BATCH_TYPE", "CLMHDR_ADJ_CD_SUB_TYPE", "CLMHDR_DOC_NBR_OHIP", "CLMHDR_DOC_SPEC_CD", "CLMHDR_REFER_DOC_NBR", "CLMHDR_DIAG_CD", fleU030_PAID_AMT, "CLMHDR_LOC",
                        CLMHDR_PAYROLL, fleU030_PAID_AMT, "CLMHDR_AGENT_CD", fleF002_CLAIMS_MSTR, "CLMHDR_ADJ_CD", "CLMHDR_I_O_PAT_IND", "CLMHDR_PAT_KEY_TYPE", "CLMHDR_PAT_KEY_DATA", fleU030_PAID_AMT, "CLMHDR_DOC_DEPT",
                        CLMHDR_DATE_CASH_TAPE_PAYMENT, fleF002_CLAIMS_MSTR, "CLMHDR_MSG_NBR", "CLMHDR_REPRINT_FLAG", "CLMHDR_SUB_NBR", "CLMHDR_AUTO_LOGOUT", "CLMHDR_FEE_COMPLEX", "CLMHDR_DATE_PERIOD_END", "CLMHDR_AMT_TECH_BILLED", "CLMHDR_AMT_TECH_PAID", "CLMHDR_TOT_CLAIM_AR_OMA",
