    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (fleF002_SUSPEND_DTL.QTPForMissing())
            {
                ...
                while (fleF002_SUSPEND_HDR.QTPForMissing("1"))
                {
                    ...
                    if (Transaction())
                    {
                        ...
                        Sort(CLMHDR_DOC_NBR.Value, fleF002_SUSPEND_HDR.GetSortValue("CLMHDR_DOC_DEPT"), fleF002_SUSPEND_HDR.GetSortValue("CLMHDR_DOC_SPEC_CD"), fleF002_SUSPEND_DTL.GetSortValue("CLMDTL_ACCOUNTING_NBR"));
            ...
            while (Sort(fleF002_SUSPEND_DTL, fleF002_SUSPEND_HDR))
            {
                ...
                if (At(CLMHDR_DOC_NBR) || fleF002_SUSPEND_HDR.At("CLMHDR_DOC_DEPT") || fleF002_SUSPEND_HDR.At("CLMHDR_DOC_SPEC_CD") || fleF002_SUSPEND_DTL.At("CLMDTL_ACCOUNTING_NBR"))
                {
                    X_CLM.Value = X_CLM.Value + 1;
                }
                X_AMT.Value = X_AMT.Value + fleF002_SUSPEND_DTL.GetDecimalValue("CLMDTL_FEE_OHIP");

                SubFile(ref m_trnTRANS_UPDATE, ref fleSUSPDTL_ALL, At(CLMHDR_DOC_NBR) || fleF002_SUSPEND_HDR.At("CLMHDR_DOC_DEPT") || fleF002_SUSPEND_HDR.At("CLMHDR_DOC_SPEC_CD"), SubFileType.Keep, SubFileMode.Append, CLMHDR_DOC_NBR, fleF002_SUSPEND_HDR, "CLMHDR_DOC_DEPT", "CLMHDR_DOC_SPEC_CD", X_SVC, X_CLM,
                X_AMT, X_SEQ);


                Reset(ref X_SVC, At(CLMHDR_DOC_NBR) || fleF002_SUSPEND_HDR.At("CLMHDR_DOC_DEPT") || fleF002_SUSPEND_HDR.At("CLMHDR_DOC_SPEC_CD"));
                Reset(ref X_CLM, At(CLMHDR_DOC_NBR) || fleF002_SUSPEND_HDR.At("CLMHDR_DOC_DEPT") || fleF002_SUSPEND_HDR.At("CLMHDR_DOC_SPEC_CD"));
                Reset(ref X_AMT, At(CLMHDR_DOC_NBR) || fleF002_SUSPEND_HDR.At("CLMHDR_DOC_DEPT") || fleF002_SUSPEND_HDR.At("CLMHDR_DOC_SPEC_CD"));
