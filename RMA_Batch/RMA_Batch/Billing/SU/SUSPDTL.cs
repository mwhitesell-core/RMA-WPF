...
public class SUSPDTL_SUSPEND_DTL_1 : SUSPDTL
{
    ...
    private DCharacter CLMHDR_CLINIC_NBR_1_2 = new DCharacter("CLMHDR_CLINIC_NBR_1_2", 2);
    private void CLMHDR_CLINIC_NBR_1_2_GetValue(ref string Value)
    {

        try
        {
            Value = QDesign.Substring(fleF002_SUSPEND_HDR.GetStringValue("CLMHDR_BATCH_NBR"), 1, 2);
        }
    ...
    public void Run()
    {
        ...
        try
        {
                ...
                while (fleF020_DOCTOR_MSTR.QTPForMissing("1"))
                {
                    ...
                    while (fleF002_SUSPEND_HDR.QTPForMissing("2"))
                    {
                        ...
                        if (Transaction())
                        {
                            ...
                            Sort(CLMHDR_CLINIC_NBR_1_2.Value, fleF002_SUSPEND_DTL.GetSortValue("CLMDTL_DOC_OHIP_NBR"), fleF002_SUSPEND_DTL.GetSortValue("CLMDTL_ACCOUNTING_NBR"));
            ...
            while (Sort(fleF002_SUSPEND_DTL, fleF020_DOCTOR_MSTR, fleF002_SUSPEND_HDR))
            {
                ...
                if (At(CLMHDR_CLINIC_NBR_1_2) || fleF002_SUSPEND_DTL.At("CLMDTL_DOC_OHIP_NBR") || fleF002_SUSPEND_DTL.At("CLMDTL_ACCOUNTING_NBR"))
                {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleSUSPDTL, At(CLMHDR_CLINIC_NBR_1_2), SubFileType.Keep, CLMHDR_CLINIC_NBR_1_2, fleF002_SUSPEND_HDR,  X_SVC, X_CLM, X_AMT);

                Reset(ref X_SVC, At(CLMHDR_CLINIC_NBR_1_2));
                Reset(ref X_CLM, At(CLMHDR_CLINIC_NBR_1_2));
                Reset(ref X_AMT, At(CLMHDR_CLINIC_NBR_1_2));
