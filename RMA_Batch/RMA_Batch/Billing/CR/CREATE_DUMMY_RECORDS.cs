...
public class CREATE_DUMMY_RECORDS_CREATE_F002_2 : CREATE_DUMMY_RECORDS
{
        ...
        : base(Name, Level, true)
    {
        ...
        fleF002_ADD = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "F002_CLAIMS_MSTR_HDR", "F002_ADD", false, false, false, 0, "m_trnTRANS_UPDATE");
...
public class CREATE_DUMMY_RECORDS_CREATE_F010_3 : CREATE_DUMMY_RECORDS
{
    ...
    private void fleF010_ADD_AutomaticItemInitialization(bool Fixed)
    {
        try
        {
            ...
            fleF010_ADD.set_SetValue("SUBSCR_POST_CD2", !Fixed, fleF010_PAT_MSTR.GetStringValue("SUBSCR_POST_CD2"));
            fleF010_ADD.set_SetValue("SUBSCR_POST_CD3", !Fixed, fleF010_PAT_MSTR.GetStringValue("SUBSCR_POST_CD3"));
            fleF010_ADD.set_SetValue("SUBSCR_POST_CD4", !Fixed, fleF010_PAT_MSTR.GetStringValue("SUBSCR_POST_CD4"));
            fleF010_ADD.set_SetValue("SUBSCR_POST_CD5", !Fixed, fleF010_PAT_MSTR.GetStringValue("SUBSCR_POST_CD5"));
            fleF010_ADD.set_SetValue("SUBSCR_POST_CD6", !Fixed, fleF010_PAT_MSTR.GetStringValue("SUBSCR_POST_CD6"));
...
public class CREATE_DUMMY_RECORDS_CREATE_F020_4 : CREATE_DUMMY_RECORDS
{
    ...
    private void fleF020_ADD_InitializeItems(bool Fixed)
    {
        ...
        try
        {
            ...
            if (!Fixed)
                fleF020_ADD.set_SetValue("DOC_DATE_FAC_START_YY", true, QDesign.NConvert(QDesign.Substring(QDesign.ASCII(QDesign.SysDate(ref m_cnnQUERY)),1, 4)));
            if (!Fixed)
                fleF020_ADD.set_SetValue("DOC_DATE_FAC_START_MM", true, QDesign.NConvert(QDesign.Substring(QDesign.ASCII(QDesign.SysDate(ref m_cnnQUERY)), 5, 2)));
            if (!Fixed)
                fleF020_ADD.set_SetValue("DOC_DATE_FAC_START_DD", true, QDesign.NConvert(QDesign.Substring(QDesign.ASCII(QDesign.SysDate(ref m_cnnQUERY)), 7, 2)));
