...
public class WEBPATIENTS_DOC : BaseClassControl
{

    private WEBPATIENTS_DOC m_WEBPATIENTS_DOC;

    public WEBPATIENTS_DOC(string Name, int Level)
        : base(Name, Level)
    {
    ...
    public WEBPATIENTS_DOC(string Name, int Level, bool Request)
    ...
    {
        if ((m_WEBPATIENTS_DOC != null))
        {
            m_WEBPATIENTS_DOC.CloseTransactionObjects();
            m_WEBPATIENTS_DOC = null;
        }
    }

    public WEBPATIENTS_DOC GetWEBPATIENTS_DOC(int Level)
    {
        if (m_WEBPATIENTS_DOC == null)
        {
            m_WEBPATIENTS_DOC = new WEBPATIENTS_DOC("WEBPATIENTS_DOC", Level);
        }
        else
        {
            m_WEBPATIENTS_DOC.ResetValues();
        }
        return m_WEBPATIENTS_DOC;
    }
    ...
    public override bool RunQTP()
    {
        ...
        try
        {
            ...
            WEBPATIENTS_DOC_ONE_1 ONE_1 = new WEBPATIENTS_DOC_ONE_1(Name, Level);
            ONE_1.Run();
            ONE_1.Dispose();
            ONE_1 = null;
...
public class WEBPATIENTS_DOC_ONE_1 : WEBPATIENTS_DOC
{

    public WEBPATIENTS_DOC_ONE_1(string Name, int Level)
    ...
    #region "Declarations (Variables, Files and Transactions)(WEBPATIENTS_DOC_ONE_1)"
    ...
    #region "Standard Generated Procedures(WEBPATIENTS_DOC_ONE_1)"


    #region "Automatic Item Initialization(WEBPATIENTS_DOC_ONE_1)"
    ...
    #region "Transaction Management Procedures(WEBPATIENTS_DOC_ONE_1)"
    ...
    #region "FILE Management Procedures(WEBPATIENTS_DOC_ONE_1)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(WEBPATIENTS_DOC_ONE_1)"
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleF002_CLAIMS_MSTR, fleF010_PAT_MSTR))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref flePATIENTS, fleF010_PAT_MSTR.At("PAT_HEALTH_NBR"), SubFileType.Portable, fleF010_PAT_MSTR, "PAT_SURNAME_FIRST3", "PAT_SURNAME_LAST22", COMMA, "PAT_GIVEN_NAME_FIRST1", "FILLER3", "PAT_HEALTH_NBR", "PAT_VERSION_CD",
                "PAT_PROV_CD", X_RMB_NBR, X_CHART_M, X_CHART_K, X_CHART_H, X_CHART_G, X_CHART_J, "PAT_BIRTH_DATE_YY", "PAT_BIRTH_DATE_MM", "PAT_BIRTH_DATE_DD", "PAT_PHONE_NBR", "PAT_SEX",
                X_ADDRESS, "SUBSCR_ADDR3", "PAT_COUNTRY", "SUBSCR_POST_CD1", "SUBSCR_POST_CD2", "SUBSCR_POST_CD3", "SUBSCR_POST_CD4", "SUBSCR_POST_CD5", "SUBSCR_POST_CD6", X_CR);
