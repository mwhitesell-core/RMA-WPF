...
public class U716C_IDENT_CLAIMS_WITH_CHANGED_DESC_1 : U716C
{
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            {
                SubFile(ref m_trnTRANS_UPDATE, ref fleU716C1, fleF002_SUSPEND_DESC.At("CLMDTL_DOC_OHIP_NBR") || fleF002_SUSPEND_DESC.At("CLMDTL_ACCOUNTING_NBR"), SubFileType.Keep, fleF002_SUSPEND_DESC, "CLMDTL_DOC_OHIP_NBR", "CLMDTL_ACCOUNTING_NBR");
        ...
        try
        {
            ...
            while (fleU716C1.QTPForMissing())
            {
                ...
                while (fleF002_SUSPEND_HDR.QTPForMissing("1"))
                {
                    ...
                    m_strWhere.Append((fleU716C1.GetDecimalValue("CLMDTL_DOC_OHIP_NBR")));
                    m_strWhere.Append(" And ").Append(fleF002_SUSPEND_HDR.ElementOwner("CLMHDR_ACCOUNTING_NBR")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(fleU716C1.GetStringValue("CLMDTL_ACCOUNTING_NBR")));
            ...
            while (Sort(fleU716C1, fleF002_SUSPEND_HDR, fleF002_SUSPEND_DESC))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleU716C2, fleF002_SUSPEND_HDR.At("CLMHDR_DOC_OHIP_NBR") || fleF002_SUSPEND_HDR.At("CLMHDR_ACCOUNTING_NBR"), SubFileType.Keep, fleF002_SUSPEND_DESC, "CLMDTL_DOC_OHIP_NBR", "CLMDTL_ACCOUNTING_NBR", X_TEXT);
