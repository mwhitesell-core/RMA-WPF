...
// 2014/may/13  MC1  - change field size from integer*8 to integer*10 for subfile f119
...
public class Mp_U115C : BaseClassControl
{

    private Mp_U115C m_Mp_U115C;

    public Mp_U115C(string Name, int Level)
        : base(Name, Level)
    {
    ...
    public Mp_U115C(string Name, int Level, bool Request)
    ...
    public override void Dispose()
    {
        if ((m_Mp_U115C != null))
        {
            m_Mp_U115C.CloseTransactionObjects();
            m_Mp_U115C = null;
        }
    }

    public Mp_U115C GetMp_U115C(int Level)
    {
        if (m_Mp_U115C == null)
        {
            m_Mp_U115C = new Mp_U115C("Mp_U115C", Level);
        }
        else
        {
            m_Mp_U115C.ResetValues();
        }
        return m_Mp_U115C;
    }
    ...
    public override bool RunQTP()
    {
        ...
        try
        {
            ...
            Mp_U115C_U115_A_GET_YTDINC_1 U115_A_GET_YTDINC_1 = new Mp_U115C_U115_A_GET_YTDINC_1(Name, Level);
            U115_A_GET_YTDINC_1.Run();
            U115_A_GET_YTDINC_1.Dispose();
            U115_A_GET_YTDINC_1 = null;

            Mp_U115C_U115_A_GET_INCREQ_2 U115_A_GET_INCREQ_2 = new Mp_U115C_U115_A_GET_INCREQ_2(Name, Level);
            U115_A_GET_INCREQ_2.Run();
            U115_A_GET_INCREQ_2.Dispose();
            U115_A_GET_INCREQ_2 = null;

            Mp_U115C_U115_A_GET_INCTAR_3 U115_A_GET_INCTAR_3 = new Mp_U115C_U115_A_GET_INCTAR_3(Name, Level);
            U115_A_GET_INCTAR_3.Run();
            U115_A_GET_INCTAR_3.Dispose();
            U115_A_GET_INCTAR_3 = null;

            Mp_U115C_U115_RUN_0_4 U115_RUN_0_4 = new Mp_U115C_U115_RUN_0_4(Name, Level);
            U115_RUN_0_4.Run();
...
public class Mp_U115C_U115_A_GET_YTDINC_1 : Mp_U115C
{

    public Mp_U115C_U115_A_GET_YTDINC_1(string Name, int Level)
    ...
    #region "Declarations (Variables, Files and Transactions)(Mp_U115C_U115_A_GET_YTDINC_1)"
    ...
    #region "Standard Generated Procedures(Mp_U115C_U115_A_GET_YTDINC_1)"


    #region "Automatic Item Initialization(Mp_U115C_U115_A_GET_YTDINC_1)"
    ...
    #region "Transaction Management Procedures(Mp_U115C_U115_A_GET_YTDINC_1)"

    //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
    //# Do not delete, modify or move it.  Updated: 6/27/2017 2:39:57 PM
    ...
    #region "FILE Management Procedures(Mp_U115C_U115_A_GET_YTDINC_1)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(Mp_U115C_U115_A_GET_YTDINC_1)"
...
public class Mp_U115C_U115_A_GET_INCREQ_2 : Mp_U115C
{

    public Mp_U115C_U115_A_GET_INCREQ_2(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        fleF190_COMP_CODES = new SqlFileObject(this, FileTypes.Primary, 0, "[101C].INDEXED", "F190_COMP_CODES", "", false, false, false, 0, "m_trnTRANS_UPDATE");
    ...
    #region "Declarations (Variables, Files and Transactions)(Mp_U115C_U115_A_GET_INCREQ_2)"
    ...
    #region "Standard Generated Procedures(Mp_U115C_U115_A_GET_INCREQ_2)"


    #region "Automatic Item Initialization(Mp_U115C_U115_A_GET_INCREQ_2)"
    ...
    #region "Transaction Management Procedures(Mp_U115C_U115_A_GET_INCREQ_2)"
    ...
    #region "FILE Management Procedures(Mp_U115C_U115_A_GET_INCREQ_2)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(Mp_U115C_U115_A_GET_INCREQ_2)"
...
public class Mp_U115C_U115_A_GET_INCTAR_3 : Mp_U115C
{

    public Mp_U115C_U115_A_GET_INCTAR_3(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        fleF190_COMP_CODES = new SqlFileObject(this, FileTypes.Primary, 0, "[101C].INDEXED", "F190_COMP_CODES", "", false, false, false, 0, "m_trnTRANS_UPDATE");
    ...
    #region "Declarations (Variables, Files and Transactions)(Mp_U115C_U115_A_GET_INCTAR_3)"
    ...
    #region "Standard Generated Procedures(Mp_U115C_U115_A_GET_INCTAR_3)"


    #region "Automatic Item Initialization(Mp_U115C_U115_A_GET_INCTAR_3)"
    ...
    #region "Transaction Management Procedures(Mp_U115C_U115_A_GET_INCTAR_3)"
    ...
    #region "FILE Management Procedures(Mp_U115C_U115_A_GET_INCTAR_3)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(Mp_U115C_U115_A_GET_INCTAR_3)"
...
public class Mp_U115C_U115_RUN_0_4 : Mp_U115C
{

    public Mp_U115C_U115_RUN_0_4(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
    ...
    #region "Declarations (Variables, Files and Transactions)(Mp_U115C_U115_RUN_0_4)"
    ...
    private void AMT_INCREQ_GetValue(ref decimal Value)
    {
        ...
        try
        {
            ...
            if (QDesign.NULL(fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_REQREV")) != 0)
            {
                CurrentValue = fleF110_YTDINC.GetDecimalValue("AMT_NET") - fleF020_DOCTOR_EXTRA.GetDecimalValue("DOC_YTDREQ");
            }
    ...
    private void AMT_INCTAR_GetValue(ref decimal Value)
    {
        ...
        {
            decimal CurrentValue = 0;
            if (QDesign.NULL(fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_TARREV")) != 0)
            {
                CurrentValue = fleF110_YTDINC.GetDecimalValue("AMT_NET") - fleF020_DOCTOR_EXTRA.GetDecimalValue("DOC_YTDTAR");
            }
    ...
    #region "Standard Generated Procedures(Mp_U115C_U115_RUN_0_4)"


    #region "Automatic Item Initialization(Mp_U115C_U115_RUN_0_4)"

    //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
    //# Do not delete, modify or move it.  Updated: 6/27/2017 2:40:05 PM

    //#-----------------------------------------
    //# fleF020_DOCTOR_EXTRA_AutomaticItemInitialization Procedure
    //# Precompiler Ver.: 1.0.6387.24052  Generated on: 6/27/2017 2:39:58 PM
    //#-----------------------------------------
    ...
    //# Precompiler Ver.: 1.0.6387.24052  Generated on: 6/27/2017 2:40:04 PM
    //#-----------------------------------------
    ...
    //# Precompiler Ver.: 1.0.6387.24052  Generated on: 6/27/2017 2:40:05 PM
    //#-----------------------------------------
    ...
    #region "Transaction Management Procedures(Mp_U115C_U115_RUN_0_4)"

    //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
    //# Do not delete, modify or move it.  Updated: 6/27/2017 2:39:58 PM
    ...
    #region "FILE Management Procedures(Mp_U115C_U115_RUN_0_4)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(Mp_U115C_U115_RUN_0_4)"
                ...
                while (fleF112_PYCDCEILINGS.QTPForMissing("1"))
                {
                    ...
                    while (fleF020_DOCTOR_EXTRA.QTPForMissing("2"))
                    {
                        ...
                        while (fleF110_YTDINC.QTPForMissing("3"))
                        {
                            ...
                            if (Transaction())
                            {
                                DEBUG_NOTE.Value = "Generated by: MP_u115C - INCREQ";
                                ...
                                X_NOT_NEEDED, AMT_INCREQ, DEBUG_NOTE);

                                DEBUG_NOTE.Value = "Generated by: MP_u115C - INCTAR";
                                ...
                                X_NOT_NEEDED, AMT_INCTAR, DEBUG_NOTE);
                                ...
                                fleF110_INCREQ.set_SetValue("LAST_MOD_USER_ID", "Mp_U115C gen`d");
                                ...
                                fleF110_INCTAR.set_SetValue("LAST_MOD_USER_ID", "Mp_U115C gen`d");
