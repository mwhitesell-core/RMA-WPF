...
public class EARNINGS_MP : BaseClassControl
{

    private EARNINGS_MP m_EARNINGS_MP;

    public EARNINGS_MP(string Name, int Level)
        : base(Name, Level)
    {
    ...
    public EARNINGS_MP(string Name, int Level, bool Request)
    ...
    {
        if ((m_EARNINGS_MP != null))
        {
            m_EARNINGS_MP.CloseTransactionObjects();
            m_EARNINGS_MP = null;
        }
    }

    public EARNINGS_MP GetEARNINGS_MP(int Level)
    {
        if (m_EARNINGS_MP == null)
        {
            m_EARNINGS_MP = new EARNINGS_MP("EARNINGS_MP", Level);
        }
        else
        {
            m_EARNINGS_MP.ResetValues();
        }
        return m_EARNINGS_MP;
    }
    ...
    public override bool RunQTP()
    {
        ...
        try
        {
            ...
            EARNINGS_MP_ONE_1 ONE_1 = new EARNINGS_MP_ONE_1(Name, Level);
            ONE_1.Run();
            ONE_1.Dispose();
            ONE_1 = null;
...
public class EARNINGS_MP_ONE_1 : EARNINGS_MP
{

    public EARNINGS_MP_ONE_1(string Name, int Level)
        : base(Name, Level, true)
    {
        ...
        X_AGEP = new CoreDecimal("X_AGEP", 7, this);
        X_EARN = new CoreDecimal("X_EARN", 7, this);
        X_MALPRA = new CoreDecimal("X_MALPRA", 7, this);
        X_MICA = new CoreDecimal("X_MICA", 7, this);
        X_MISC0 = new CoreDecimal("X_MISC0", 7, this);
        X_MOHD = new CoreDecimal("X_MOHD", 7, this);
        X_BLEPRE = new CoreDecimal("X_BLEPRE", 7, this);
        X_TRAVEL = new CoreDecimal("X_TRAVEL", 7, this);
    ...
    #region "Declarations (Variables, Files and Transactions)(EARNINGS_MP_ONE_1)"
    ...
    #region "Standard Generated Procedures(EARNINGS_MP_ONE_1)"


    #region "Automatic Item Initialization(EARNINGS_MP_ONE_1)"

    //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
    //# Do not delete, modify or move it.  Updated: 6/27/2017 2:35:02 PM

    //#-----------------------------------------
    //# fleF020_DOCTOR_MSTR_AutomaticItemInitialization Procedure
    //# Precompiler Ver.: 1.0.6387.24052  Generated on: 6/27/2017 2:35:01 PM
    //#-----------------------------------------
    ...
    #region "Transaction Management Procedures(EARNINGS_MP_ONE_1)"

    //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
    //# Do not delete, modify or move it.  Updated: 6/27/2017 2:35:00 PM
    ...
    #region "FILE Management Procedures(EARNINGS_MP_ONE_1)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(EARNINGS_MP_ONE_1)"
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleF119_DOCTOR_YTD, fleF020_DOCTOR_MSTR))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleEARNINGSMP, fleF020_DOCTOR_MSTR.At("DOC_DEPT") || fleF119_DOCTOR_YTD.At("DOC_NBR"), SubFileType.Keep, fleF020_DOCTOR_MSTR, "DOC_DEPT", COMMA, "DOC_NBR", X_NAME, X_PENPAY,
                ...
                X_DIABET, X_HGHCON, X_GUARAN, X_WSIB, X_UCAF, X_PDA, X_MRP, X_NEWPAT, X_NEPHRO, X_COVARL,
                X_PEDCAL, X_CONSUL, X_EFTPAY, X_PLASTI, X_ORTHO, X_BASE, X_OUTPRO, X_TOPOFF, X_BRIDGE, X_MICA,
                X_CR);
                //Parent:DOC_INITS
