...
public class G040_CODE : BaseClassControl
{
    private G040_CODE m_G040_CODE;
    
    public G040_CODE(string Name, int Level)
        : base(Name, Level)
    {
        this.ScreenType = ScreenTypes.QTP;
    }
    
    public G040_CODE(string Name, int Level, bool Request)
    ...
    public override void Dispose()
    {
        if (!(m_G040_CODE == null))
        {
            m_G040_CODE.CloseTransactionObjects();
            m_G040_CODE = null;
        }
    }
    
    public G040_CODE GetG040_CODE(int Level)
    {
        if ((m_G040_CODE == null))
        {
            m_G040_CODE = new G040_CODE("G040_CODE", Level);
        }
        else
        {
            m_G040_CODE.ResetValues();
        }
    ...
    public override bool RunQTP()
    {
        try
        {
            G040_CODE_ONE_1 ONE_1 = new G040_CODE_ONE_1(Name, Level);
            ONE_1.Run();
            ONE_1.Dispose();
            ONE_1 = null;

            G040_CODE_TWO_2 TWO_2 = new G040_CODE_TWO_2(Name, Level);
            TWO_2.Run();
            TWO_2.Dispose();
            TWO_2 = null;

            G040_CODE_THREE_3 THREE_3 = new G040_CODE_THREE_3(Name, Level);
            THREE_3.Run();
            THREE_3.Dispose();
            THREE_3 = null;
...
public class G040_CODE_ONE_1 : G040_CODE
{
    public G040_CODE_ONE_1(string Name, int Level)
        : base(Name, Level, true)
    {
        ...
        fleG040 = new SqlFileObject(this, FileTypes.Primary, 0, "TemporaryData", "G040", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SubFile);
    ...
    #region "Declarations (Variables, Files and Transactions)(G040_CODE_1)"
    ...
    private void fleF002_CLAIMS_MSTR_SelectIf(ref string SelectIfClause)
    {
        try
        {
            ...
            strSQL.Append(fleF002_CLAIMS_MSTR.ElementOwner("CLMHDR_DOC_DEPT")).Append(" = 80)");
    ...
    #region "Standard Generated Procedures(G040_CODE_1)"

    #region "Automatic Item Initialization(G040_CODE_1)"
    ...
    #region "Transaction Management Procedures(G040_CODE_1)"

    // # NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
    // # Do not delete, modify or move it.  Updated: 2019-01-31 8:40:35 AM
    // #-----------------------------------------
    ...
    private void Initialize_TRANS_UPDATE()
    {
        ...
        fleG040.Transaction = m_trnTRANS_UPDATE;
    }

    #endregion

    #region "FILE Management Procedures(G040_CODE_1)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(G040_CODE_1)"
    public void Run()
    {
        try
        {
            ...
            while (fleF002_CLAIMS_MSTR.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                    SubFile(ref m_trnTRANS_UPDATE, "G040", SubFileType.Keep, CLMHDR_CLAIM_ID, fleF002_CLAIMS_MSTR, "KEY_CLM_BATCH_NBR", "KEY_CLM_CLAIM_NBR", "CLMHDR_AGENT_CD", "CLMHDR_BATCH_TYPE");
                }
            }
        }
...
// ONE_1
public class G040_CODE_TWO_2 : G040_CODE
{
    public G040_CODE_TWO_2(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        ...
        fleG0401 = new SqlFileObject(this, FileTypes.Primary, 0, "TemporaryData", "G0401", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SubFile);
        fleCODE_SVC2 = new SqlFileObject(this, FileTypes.Primary, 0, "TemporaryData", "G0401", "CODE_SVC2", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SubFile);
        fleCODE_SVC3 = new SqlFileObject(this, FileTypes.Primary, 0, "TemporaryData", "G0401", "CODE_SVC3", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SubFile);
        fleCODE_SVC4 = new SqlFileObject(this, FileTypes.Primary, 0, "TemporaryData", "G0401", "CODE_SVC4", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SubFile);
    ...
    private SqlFileObject fleG0401;
    ...
    private void Initialize_TRANS_UPDATE()
    {
        fleG040.Transaction = m_trnTRANS_UPDATE;
        fleF002_CLAIMS_MSTR.Transaction = m_trnTRANS_UPDATE;
        fleG0401.Transaction = m_trnTRANS_UPDATE;
        ...
        try
        {
            ...
            while (fleG040.QTPForMissing())
            {
                ...
                while (fleF002_CLAIMS_MSTR.QTPForMissing("1"))
                {
                    ...
                    m_strWhere.Append(Common.StringToField(fleG040.GetStringValue("KEY_CLM_BATCH_NBR")));
                    m_strWhere.Append(" And ").Append(fleF002_CLAIMS_MSTR.ElementOwner("KEY_CLM_CLAIM_NBR")).Append(" = ");
                    m_strWhere.Append(fleG040.GetDecimalValue("KEY_CLM_CLAIM_NBR"));
                    m_strWhere.Append(" And ").Append(fleF002_CLAIMS_MSTR.ElementOwner("KEY_CLM_SERV_CODE")).Append(" = ");
                    m_strWhere.Append(Common.StringToField("G040A"));

                    fleF002_CLAIMS_MSTR.GetData(m_strWhere.ToString());
                    //  --> End GET F002_CLAIMS_MSTR <--
                    if (Transaction())
                    {
                        SubFile(ref m_trnTRANS_UPDATE, "G0401", SubFileType.Keep, CLMDTL_ID, fleF002_CLAIMS_MSTR, "KEY_CLM_BATCH_NBR", "KEY_CLM_CLAIM_NBR", X_CLMDTL_FEE_OHIP_1, X_SV_DATE_1, "CLMDTL_OMA_CD");
...
// TWO_2
public class G040_CODE_THREE_3 : G040_CODE
{
    public G040_CODE_THREE_3(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        ...
        fleG040A = new SqlFileObject(this, FileTypes.Primary, 0, "TemporaryData", "G040A", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SubFile);

        X_G040 = new CoreDecimal("X_G040", 7, this);
        X_G040_COUNT = new CoreDecimal("X_G040_COUNT", 7, this);
    ...
    private void X_CLINIC_GetValue(ref string Value)
    {
        try
        {
            Value = QDesign.Substring(fleG0401.GetStringValue("CLMDTL_ID"), 1, 2);
        }
    ...
    private void X_DOC_GetValue(ref string Value)
    {
        try
        {
            Value = QDesign.Substring(fleG0401.GetStringValue("CLMDTL_ID"), 3, 3);
        }
    ...
    private CoreDecimal X_G040;
    private CoreDecimal X_G040_COUNT;
    ...
    private SqlFileObject fleG040A;
    ...
    private DCharacter LINE = new DCharacter("LINE", 56);
    private void LINE_GetValue(ref string Value)
    {
        try
        {
            Value = X_CLINIC.Value + COMMA.Value + QDesign.ASCII(fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_DEPT"), 2) + COMMA.Value + X_DOC.Value + COMMA.Value + fleF020_DOCTOR_MSTR.GetStringValue("DOC_NAME") + COMMA.Value + DOC_INITS.Value + COMMA.Value + QDesign.ASCII(X_G040.Value, 7) + COMMA.Value + QDesign.ASCII(X_G040_COUNT.Value, 7) + X_CR.Value;
        }
    ...
    private void Initialize_TRANS_UPDATE()
    {
        ...
        fleG040A.Transaction = m_trnTRANS_UPDATE;
    }
        ...
        try
        {
            ...
            while (fleG0401.QTPForMissing())
            {
                ...
                while (fleF020_DOCTOR_MSTR.QTPForMissing("1"))
                {
                    ...
                    m_strWhere.Append(Common.StringToField(QDesign.Substring(fleG0401.GetStringValue("CLMDTL_ID"), 3, 3)));
                    ...
                    if (Transaction())
                    {
                        Sort(X_CLINIC.Value, X_DOC.Value, fleG0401.GetSortValue("X_SV_DATE_1"));
                    }
                }
            }
            
            while (Sort(fleG0401, fleF020_DOCTOR_MSTR))
            {
                X_G040.Value = X_G040.Value + fleG0401.GetDecimalValue("X_CLMDTL_FEE_OHIP_1");
                X_G040_COUNT.Value = (X_G040_COUNT.Value + 1);

                SubFile(ref m_trnTRANS_UPDATE, "G040A", (At(X_CLINIC) || At(X_DOC)), SubFileType.Portable, LINE);

                Reset(ref X_G040, (At(X_CLINIC) || At(X_DOC)));
                Reset(ref X_G040_COUNT, (At(X_CLINIC) || At(X_DOC)));
            }
        }
