    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleF050_DOC_REVENUE_MSTR_HISTORY))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleDOCREVALL, fleF050_DOC_REVENUE_MSTR_HISTORY.At("DOCREV_CLINIC_1_2"), SubFileType.Portable, fleF050_DOC_REVENUE_MSTR_HISTORY, "DOCREV_CLINIC_1_2", COMMA, TOT_AMT_YTD, TOT_MISC, TOTALS,
                X_CR);
