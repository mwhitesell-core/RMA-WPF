...
// /M/ 2015/Aug/31 MC3       - do not change paycode 4A to 1A, keep the original value  
// - retain the expense ceiling for paycode 4A
// - correction - ceiling/expense-computed should multiply 100 to get 2 decimal places
// - update expense-computed in f020 file as well
// /M/ 2016/Jul/12 MC4       - do not roll over for comp code CANCEL, CMPA, MANPY, OVPAY, PYRFEE, PYRHST, REVHBK,
// TITDEF, WEB, WEBHST in f113 as Helena requested  
// /M/ 2016/Jul/27 MC5       - Helena requests to set period allocation to be 12 if paycode  = 4A 
// -----------------------------------------------------------------------
...
public class YEAREND_1 : BaseClassControl
{

    private YEAREND_1 m_YEAREND_1;

    public YEAREND_1(string Name, int Level) : base(Name, Level)
    {
    ...
    public YEAREND_1(string Name, int Level, bool Request) : base(Name, Level, Request)
    {
        this.ScreenType = ScreenTypes.QTP;
        T_CURRENT_EP_NBR = new CoreDecimal("T_CURRENT_EP_NBR", 1, this, ResetTypes.ResetAtStartup);
        T_CURRENT_EP_NBR_MINUS1 = new CoreDecimal("T_CURRENT_EP_NBR_MINUS1", 1, this, ResetTypes.ResetAtStartup);
    ...
    public override void Dispose()
    {
        if ((m_YEAREND_1 != null))
        {
            m_YEAREND_1.CloseTransactionObjects();
            m_YEAREND_1 = null;
        }
    }

    public YEAREND_1 GetYEAREND_1(int Level)
    {
        if (m_YEAREND_1 == null)
        {
            m_YEAREND_1 = new YEAREND_1("YEAREND_1", Level);
        }
        else
        {
            m_YEAREND_1.ResetValues();
        }
        return m_YEAREND_1;
    }
    ...
    public override bool RunQTP()
    {
        ...
        try
        {
            ...
            YEAREND_1_GET_CONST_EP_NBR_1 GET_CONST_EP_NBR_1 = new YEAREND_1_GET_CONST_EP_NBR_1(Name, Level);
            GET_CONST_EP_NBR_1.Run();
            GET_CONST_EP_NBR_1.Dispose();
            GET_CONST_EP_NBR_1 = null;

            YEAREND_1_MOVE_F110_TO_HISTORY_2 MOVE_F110_TO_HISTORY_2 = new YEAREND_1_MOVE_F110_TO_HISTORY_2(Name, Level);
            MOVE_F110_TO_HISTORY_2.Run();
            MOVE_F110_TO_HISTORY_2.Dispose();
            MOVE_F110_TO_HISTORY_2 = null;

            YEAREND_1_SETUP_F113_NEXT_YEAR_3 SETUP_F113_NEXT_YEAR_3 = new YEAREND_1_SETUP_F113_NEXT_YEAR_3(Name, Level);
            SETUP_F113_NEXT_YEAR_3.Run();
            SETUP_F113_NEXT_YEAR_3.Dispose();
            SETUP_F113_NEXT_YEAR_3 = null;

            YEAREND_1_SPLIT_F113_YEAR_INTO_SUBFILES_4 SPLIT_F113_YEAR_INTO_SUBFILES_4 = new YEAREND_1_SPLIT_F113_YEAR_INTO_SUBFILES_4(Name, Level);
            SPLIT_F113_YEAR_INTO_SUBFILES_4.Run();
            SPLIT_F113_YEAR_INTO_SUBFILES_4.Dispose();
            SPLIT_F113_YEAR_INTO_SUBFILES_4 = null;

            YEAREND_1_RESET_F020_VALUES_5 RESET_F020_VALUES_5 = new YEAREND_1_RESET_F020_VALUES_5(Name, Level);
            RESET_F020_VALUES_5.Run();
            RESET_F020_VALUES_5.Dispose();
            RESET_F020_VALUES_5 = null;

            YEAREND_1_SETUP_F112_NEXT_YEAR_6 SETUP_F112_NEXT_YEAR_6 = new YEAREND_1_SETUP_F112_NEXT_YEAR_6(Name, Level);
            SETUP_F112_NEXT_YEAR_6.Run();
            SETUP_F112_NEXT_YEAR_6.Dispose();
            SETUP_F112_NEXT_YEAR_6 = null;

            YEAREND_1_SPLIT_F112_YEAR_INTO_SUBFILES_7 SPLIT_F112_YEAR_INTO_SUBFILES_7 = new YEAREND_1_SPLIT_F112_YEAR_INTO_SUBFILES_7(Name, Level);
            SPLIT_F112_YEAR_INTO_SUBFILES_7.Run();
            SPLIT_F112_YEAR_INTO_SUBFILES_7.Dispose();
            SPLIT_F112_YEAR_INTO_SUBFILES_7 = null;
...
public class YEAREND_1_GET_CONST_EP_NBR_1 : YEAREND_1
{

    public YEAREND_1_GET_CONST_EP_NBR_1(string Name, int Level) : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
    ...
    #region "Declarations (Variables, Files and Transactions)(YEAREND_1_GET_CONST_EP_NBR_1)"
    ...
    #region "Standard Generated Procedures(YEAREND_1_GET_CONST_EP_NBR_1)"


    #region "Automatic Item Initialization(YEAREND_1_GET_CONST_EP_NBR_1)"
    ...
    #region "Transaction Management Procedures(YEAREND_1_GET_CONST_EP_NBR_1)"

    //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
    //# Do not delete, modify or move it.  Updated: 6/27/2017 4:52:04 PM
    ...
    #region "FILE Management Procedures(YEAREND_1_GET_CONST_EP_NBR_1)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(YEAREND_1_GET_CONST_EP_NBR_1)"
...
public class YEAREND_1_MOVE_F110_TO_HISTORY_2 : YEAREND_1
{

    public YEAREND_1_MOVE_F110_TO_HISTORY_2(string Name, int Level) : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        ...
        fleF110_COMPENSATION_HISTORY = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "F110_COMP_HISTORY", "", false, false, false, 0, "m_trnTRANS_UPDATE");


    }


    #region "Declarations (Variables, Files and Transactions)(YEAREND_1_MOVE_F110_TO_HISTORY_2)"
    ...
    #region "Standard Generated Procedures(YEAREND_1_MOVE_F110_TO_HISTORY_2)"


    #region "Automatic Item Initialization(YEAREND_1_MOVE_F110_TO_HISTORY_2)"
    ...
    #region "Transaction Management Procedures(YEAREND_1_MOVE_F110_TO_HISTORY_2)"
    ...
    #region "FILE Management Procedures(YEAREND_1_MOVE_F110_TO_HISTORY_2)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(YEAREND_1_MOVE_F110_TO_HISTORY_2)"
...
public class YEAREND_1_SETUP_F113_NEXT_YEAR_3 : YEAREND_1
{

    public YEAREND_1_SETUP_F113_NEXT_YEAR_3(string Name, int Level) : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
    ...
    #region "Declarations (Variables, Files and Transactions)(YEAREND_1_SETUP_F113_NEXT_YEAR_3)"
    ...
    public override bool SelectIf()
    {
        ...
        try
        {
            if (QDesign.NULL(fleF113_DEFAULT_COMP.GetDecimalValue("EP_NBR_TO")) == QDesign.NULL(T_CURRENT_EP_NBR.Value) | QDesign.NULL(fleF113_DEFAULT_COMP.GetDecimalValue("EP_NBR_TO")) == QDesign.NULL(T_CURRENT_EP_NBR_MINUS1.Value) & (QDesign.NULL(fleF113_DEFAULT_COMP.GetStringValue("COMP_CODE")) != "CANCEL" & QDesign.NULL(fleF113_DEFAULT_COMP.GetStringValue("COMP_CODE")) != "CMPA" & QDesign.NULL(fleF113_DEFAULT_COMP.GetStringValue("COMP_CODE")) != "MANPY" & QDesign.NULL(fleF113_DEFAULT_COMP.GetStringValue("COMP_CODE")) != "OVPAY" & QDesign.NULL(fleF113_DEFAULT_COMP.GetStringValue("COMP_CODE")) != "PYRFEE" & QDesign.NULL(fleF113_DEFAULT_COMP.GetStringValue("COMP_CODE")) != "PYRHST" & QDesign.NULL(fleF113_DEFAULT_COMP.GetStringValue("COMP_CODE")) != "REVHBK" & QDesign.NULL(fleF113_DEFAULT_COMP.GetStringValue("COMP_CODE")) != "TITDEF" & QDesign.NULL(fleF113_DEFAULT_COMP.GetStringValue("COMP_CODE")) != "WEB" & QDesign.NULL(fleF113_DEFAULT_COMP.GetStringValue("COMP_CODE")) != "WEBHST"))
            {
                return true;
            }
    ...
    private void TERMINATED_DAYS_GetValue(ref decimal Value)
    {
        ...
        try
        {
            ...
            {
                CurrentValue = QDesign.Days(QDesign.SysDate(ref m_cnnQUERY)) - QDesign.Days(fleF020_DOCTOR_MSTR.GetNumericDateValue("DOC_DATE_FAC_TERM"));
            }
    ...
    #region "Standard Generated Procedures(YEAREND_1_SETUP_F113_NEXT_YEAR_3)"


    #region "Automatic Item Initialization(YEAREND_1_SETUP_F113_NEXT_YEAR_3)"

    //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
    //# Do not delete, modify or move it.  Updated: 6/27/2017 4:52:06 PM

    //#-----------------------------------------
    //# fleF190_COMP_CODES_AutomaticItemInitialization Procedure
    //# Precompiler Ver.: 1.0.6387.27217  Generated on: 6/27/2017 4:52:05 PM
    //#-----------------------------------------
    ...
    //# Precompiler Ver.: 1.0.6387.27217  Generated on: 6/27/2017 4:52:06 PM
    //#-----------------------------------------
    ...
    #region "Transaction Management Procedures(YEAREND_1_SETUP_F113_NEXT_YEAR_3)"
    ...
    #region "FILE Management Procedures(YEAREND_1_SETUP_F113_NEXT_YEAR_3)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(YEAREND_1_SETUP_F113_NEXT_YEAR_3)"
...
public class YEAREND_1_SPLIT_F113_YEAR_INTO_SUBFILES_4 : YEAREND_1
{

    public YEAREND_1_SPLIT_F113_YEAR_INTO_SUBFILES_4(string Name, int Level) : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        fleF113_DEFAULT_COMP = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "F113_DEFAULT_COMP", "", false, false, false, 0, "m_trnTRANS_UPDATE");
    ...
    #region "Declarations (Variables, Files and Transactions)(YEAREND_1_SPLIT_F113_YEAR_INTO_SUBFILES_4)"
    ...
    #region "Standard Generated Procedures(YEAREND_1_SPLIT_F113_YEAR_INTO_SUBFILES_4)"


    #region "Automatic Item Initialization(YEAREND_1_SPLIT_F113_YEAR_INTO_SUBFILES_4)"
    ...
    #region "Transaction Management Procedures(YEAREND_1_SPLIT_F113_YEAR_INTO_SUBFILES_4)"
    ...
    #region "FILE Management Procedures(YEAREND_1_SPLIT_F113_YEAR_INTO_SUBFILES_4)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(YEAREND_1_SPLIT_F113_YEAR_INTO_SUBFILES_4)"
...
public class YEAREND_1_RESET_F020_VALUES_5 : YEAREND_1
{

    public YEAREND_1_RESET_F020_VALUES_5(string Name, int Level) : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        fleF020_DOCTOR_MSTR = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "F020_DOCTOR_MSTR", "", false, false, false, 0, "m_trnTRANS_UPDATE");
    ...
    #region "Declarations (Variables, Files and Transactions)(YEAREND_1_RESET_F020_VALUES_5)"
    ...
    #region "Standard Generated Procedures(YEAREND_1_RESET_F020_VALUES_5)"


    #region "Automatic Item Initialization(YEAREND_1_RESET_F020_VALUES_5)"

    //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
    //# Do not delete, modify or move it.  Updated: 6/27/2017 4:52:07 PM

    //#-----------------------------------------
    //# fleF020_UPDATE_AutomaticItemInitialization Procedure
    //# Precompiler Ver.: 1.0.6387.27217  Generated on: 6/27/2017 4:52:07 PM
    //#-----------------------------------------
    ...
    #region "Transaction Management Procedures(YEAREND_1_RESET_F020_VALUES_5)"
    ...
    #region "FILE Management Procedures(YEAREND_1_RESET_F020_VALUES_5)"

    //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
    //# Do not delete, modify or move it.  Updated: 6/27/2017 4:52:05 PM
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(YEAREND_1_RESET_F020_VALUES_5)"
...
public class YEAREND_1_SETUP_F112_NEXT_YEAR_6 : YEAREND_1
{

    public YEAREND_1_SETUP_F112_NEXT_YEAR_6(string Name, int Level) : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
    ...
    #region "Declarations (Variables, Files and Transactions)(YEAREND_1_SETUP_F112_NEXT_YEAR_6)"
    ...
    #region "Standard Generated Procedures(YEAREND_1_SETUP_F112_NEXT_YEAR_6)"


    #region "Automatic Item Initialization(YEAREND_1_SETUP_F112_NEXT_YEAR_6)"

    //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
    //# Do not delete, modify or move it.  Updated: 6/27/2017 4:52:09 PM

    //#-----------------------------------------
    //# fleF020_DOCTOR_MSTR_AutomaticItemInitialization Procedure
    //# Precompiler Ver.: 1.0.6387.27217  Generated on: 6/27/2017 4:52:08 PM
    //#-----------------------------------------
    private void fleF020_DOCTOR_MSTR_AutomaticItemInitialization(bool Fixed)
    {
        try
    ...
    //#-----------------------------------------
    //# fleF020_UPDATE_AutomaticItemInitialization Procedure
    //# Precompiler Ver.: 1.0.6387.27217  Generated on: 6/27/2017 4:52:09 PM
    //#-----------------------------------------
    private void fleF020_UPDATE_AutomaticItemInitialization(bool Fixed)
    {
        try
    ...
    #region "Transaction Management Procedures(YEAREND_1_SETUP_F112_NEXT_YEAR_6)"
    ...
    #region "FILE Management Procedures(YEAREND_1_SETUP_F112_NEXT_YEAR_6)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(YEAREND_1_SETUP_F112_NEXT_YEAR_6)"
                ...
                while (fleF020_DOCTOR_MSTR.QTPForMissing("1"))
                {
                    ...
                    while (fleF112_NEXT_YR.QTPForMissing("2"))
                    {
                        ...
                        if (Transaction())
                        {
                            ...
                            fleF112_ADD.set_SetValue("DOC_PAY_CODE", fleF112_PYCDCEILINGS.GetStringValue("DOC_PAY_CODE"));
                            ...
                            fleF112_ADD.set_SetValue("DOC_YRLY_CEILING_COMPUTED", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_CEILING") * 100);


                            fleF112_ADD.set_SetValue("DOC_YRLY_EXPENSE", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_EXPENSE"));
                            ...
                            {
                                fleF112_ADD.set_SetValue("DOC_YRLY_EXPENSE_COMPUTED", fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_EXPENSE") * 100);

                            }

                            if (QDesign.NULL(fleF112_PYCDCEILINGS.GetStringValue("DOC_PAY_CODE")) == "4" & QDesign.NULL(fleF112_PYCDCEILINGS.GetStringValue("DOC_PAY_SUB_CODE")) == "A")
                            {
                                fleF112_ADD.set_SetValue("DOC_YRLY_EXPN_ALLOC_PERS", 12);
                            ...
                            fleF020_DOCTOR_MSTR.set_SetValue("DOC_YRLY_EXPENSE_COMPUTED", 100 * fleF112_PYCDCEILINGS.GetDecimalValue("DOC_YRLY_EXPENSE"));
...
public class YEAREND_1_SPLIT_F112_YEAR_INTO_SUBFILES_7 : YEAREND_1
{

    public YEAREND_1_SPLIT_F112_YEAR_INTO_SUBFILES_7(string Name, int Level) : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        fleF112_PYCDCEILINGS = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "F112_PYCDCEILINGS", "", false, false, false, 0, "m_trnTRANS_UPDATE");
    ...
    #region "Declarations (Variables, Files and Transactions)(YEAREND_1_SPLIT_F112_YEAR_INTO_SUBFILES_7)"
    ...
    #region "Standard Generated Procedures(YEAREND_1_SPLIT_F112_YEAR_INTO_SUBFILES_7)"


    #region "Automatic Item Initialization(YEAREND_1_SPLIT_F112_YEAR_INTO_SUBFILES_7)"
    ...
    #region "Transaction Management Procedures(YEAREND_1_SPLIT_F112_YEAR_INTO_SUBFILES_7)"
    ...
    #region "FILE Management Procedures(YEAREND_1_SPLIT_F112_YEAR_INTO_SUBFILES_7)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(YEAREND_1_SPLIT_F112_YEAR_INTO_SUBFILES_7)"
    ...
    public void Run()
    {
        ...
        try
        {
            Request("SPLIT_F112_YEAR_INTO_SUBFILES_7");
        ...
        {
            EndRequest("SPLIT_F112_YEAR_INTO_SUBFILES_7");
...
//SPLIT_F112_YEAR_INTO_SUBFILES_7
