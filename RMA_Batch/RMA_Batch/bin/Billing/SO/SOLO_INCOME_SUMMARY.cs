    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleF119_DOCTOR_YTD_HISTORY, fleF020_DOCTOR_MSTR))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleSOLOINCOME, fleF119_DOCTOR_YTD_HISTORY.At("DOC_NBR"), SubFileType.Portable, fleF020_DOCTOR_MSTR, "DOC_DEPT", COMMA, fleF119_DOCTOR_YTD_HISTORY, "DOC_NBR", fleF020_DOCTOR_MSTR,
