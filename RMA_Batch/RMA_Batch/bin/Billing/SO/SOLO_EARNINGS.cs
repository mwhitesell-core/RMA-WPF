...
public class SOLO_EARNINGS : BaseClassControl
{

    private SOLO_EARNINGS m_SOLO_EARNINGS;

    public SOLO_EARNINGS(string Name, int Level)
        : base(Name, Level)
    {
    ...
    public SOLO_EARNINGS(string Name, int Level, bool Request)
    ...
    {
        if ((m_SOLO_EARNINGS != null))
        {
            m_SOLO_EARNINGS.CloseTransactionObjects();
            m_SOLO_EARNINGS = null;
        }
    }

    public SOLO_EARNINGS GetSOLO_EARNINGS(int Level)
    {
        if (m_SOLO_EARNINGS == null)
        {
            m_SOLO_EARNINGS = new SOLO_EARNINGS("SOLO_EARNINGS", Level);
        }
        else
        {
            m_SOLO_EARNINGS.ResetValues();
        }
        return m_SOLO_EARNINGS;
    }
    ...
    public override bool RunQTP()
    {
        ...
        try
        {
            ...
            SOLO_EARNINGS_ONE_1 ONE_1 = new SOLO_EARNINGS_ONE_1(Name, Level);
            ONE_1.Run();
            ONE_1.Dispose();
            ONE_1 = null;
...
public class SOLO_EARNINGS_ONE_1 : SOLO_EARNINGS
{

    public SOLO_EARNINGS_ONE_1(string Name, int Level)
    ...
    #region "Declarations (Variables, Files and Transactions)(SOLO_EARNINGS_ONE_1)"
    ...
    #region "Standard Generated Procedures(SOLO_EARNINGS_ONE_1)"


    #region "Automatic Item Initialization(SOLO_EARNINGS_ONE_1)"
    ...
    #region "Transaction Management Procedures(SOLO_EARNINGS_ONE_1)"
    ...
    #region "FILE Management Procedures(SOLO_EARNINGS_ONE_1)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(SOLO_EARNINGS_ONE_1)"
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleF119_DOCTOR_YTD, fleF020_DOCTOR_MSTR))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleEARNINGSSOLO, fleF020_DOCTOR_MSTR.At("DOC_DEPT") || fleF119_DOCTOR_YTD.At("DOC_NBR"), SubFileType.Portable, fleF020_DOCTOR_MSTR, "DOC_DEPT", COMMA, "DOC_NBR", X_NAME, X_PENPAY,
