    ...
    public void Run()
	{
		...
		try {
			...
			while (Sort(fleF119_DOCTOR_YTD, fleF020_DOCTOR_MSTR, fleF020_DOCTOR_EXTRA)) {
				...
				SubFile(ref m_trnTRANS_UPDATE, ref fleSOLOTITHE, fleF119_DOCTOR_YTD.At("DOC_NBR"), SubFileType.Portable, fleF020_DOCTOR_MSTR, "DOC_NBR", COMMA, "DOC_NAME", COMMA, "DOC_INITS", COMMA, X_NONRB,
                COMMA, X_NONRBP, COMMA, X_TOTREV, COMMA, X_TITHD1, COMMA, X_TITHD2, COMMA, X_TITHD3, COMMA, X_DEPMED, COMMA, X_TOTDED, COMMA, X_ADVOUT, COMMA, TERM_DATE, COMMA, fleF020_DOCTOR_EXTRA,
                COMMA, "DOC_FLAG_PRIMARY", X_CR);
