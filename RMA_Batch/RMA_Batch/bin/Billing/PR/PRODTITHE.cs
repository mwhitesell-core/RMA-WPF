    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleF119_DOCTOR_YTD, fleF020_DOCTOR_MSTR, fleF020_DOCTOR_EXTRA))
            {
                ...
                {
                    TITHE1.Value = TITHE1.Value + fleF119_DOCTOR_YTD.GetDecimalValue("AMT_YTD") / 100;
                }
                if (QDesign.NULL(fleF119_DOCTOR_YTD.GetStringValue("COMP_CODE")) == "TITHE2")
                {
                    TITHE2.Value = TITHE2.Value + fleF119_DOCTOR_YTD.GetDecimalValue("AMT_YTD") / 100;
                }
                if (QDesign.NULL(fleF119_DOCTOR_YTD.GetStringValue("COMP_CODE")) == "TITHE3")
                {
                    TITHE3.Value = TITHE3.Value + fleF119_DOCTOR_YTD.GetDecimalValue("AMT_YTD") / 100;
                }
                if (QDesign.NULL(fleF119_DOCTOR_YTD.GetStringValue("COMP_CODE")) == "TOTITE")
                {
                    TOTITE.Value = TOTITE.Value + fleF119_DOCTOR_YTD.GetDecimalValue("AMT_YTD") / 100;
                }
                if (QDesign.NULL(fleF119_DOCTOR_YTD.GetStringValue("COMP_CODE")) == "DEPMEM")
                {
                    DEPMEM.Value = DEPMEM.Value + fleF119_DOCTOR_YTD.GetDecimalValue("AMT_YTD") / 100;
                }
                if (QDesign.NULL(fleF119_DOCTOR_YTD.GetStringValue("COMP_CODE")) == "PAYEFT")
                {
                    PAYEFT.Value = PAYEFT.Value + fleF119_DOCTOR_YTD.GetDecimalValue("AMT_YTD") / 100;
                }
                ...
                "DOC_NAME", "DOC_INITS", fleF020_DOCTOR_EXTRA, "DOC_FLAG_PRIMARY", fleF020_DOCTOR_MSTR, "DOC_DATE_FAC_TERM_YY", "DOC_DATE_FAC_TERM_MM", "DOC_DATE_FAC_TERM_DD", TOTITE, TITHE1, TITHE2, TITHE3,
...
public class PRODTITHE_TWO_2 : PRODTITHE
{
    ...
    private void TOTITE_GetValue(ref decimal Value)
    {
        ...
        try
        {
            ...
            Value = fleF119_DOCTOR_YTD.GetDecimalValue("AMT_YTD") / 100;
    ...
    private void TOTDED_GetValue(ref decimal Value)
    {
        ...
        try
        {
            Value = flePRODTITHE_DTL.GetDecimalValue("TITHE1") + flePRODTITHE_DTL.GetDecimalValue("TITHE2") + flePRODTITHE_DTL.GetDecimalValue("TITHE3") + flePRODTITHE_DTL.GetDecimalValue("DEPMEM");
                ...
                while (fleF119_DOCTOR_YTD.QTPForMissing("1"))
                {
                    ...
                    if (Transaction())
                    {
                         ...
                         if (Select_If())
                        {
                            ...
                            SubFile(ref m_trnTRANS_UPDATE, ref flePRODTITHE, SubFileType.Portable, flePRODTITHE_DTL, "DOC_AFP_PAYM_GROUP", COMMA, "DOC_NBR", "DOC_DEPT", "DOC_NAME", "DOC_INITS",
                            TOTITE, "TITHE1", "TITHE2", "TITHE3", "DEPMEM", TOTDED, TERM_DATE, "DOC_FLAG_PRIMARY", CR);
