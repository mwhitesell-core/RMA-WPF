            ...
            while (fleF002_SUSPEND_HDR.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                     ...
                     if (Select_If())
                    {
                        ...
                        SubFile(ref m_trnTRANS_UPDATE, ref fleU704_CLMHDR, SubFileType.Keep, fleF002_SUSPEND_HDR, "CLMHDR_PAT_OHIP_ID_OR_CHART", "CLMHDR_DOC_OHIP_NBR", "CLMHDR_ACCOUNTING_NBR");
