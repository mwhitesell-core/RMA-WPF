...
public class Billing_UNLOF002_RAT_PAYMENT : BaseClassControl
{

    private Billing_UNLOF002_RAT_PAYMENT m_Billing_UNLOF002_RAT_PAYMENT;

    public Billing_UNLOF002_RAT_PAYMENT(string Name, int Level)
        : base(Name, Level)
    {
    ...
    public Billing_UNLOF002_RAT_PAYMENT(string Name, int Level, bool Request)
    ...
    {
        if ((m_Billing_UNLOF002_RAT_PAYMENT != null))
        {
            m_Billing_UNLOF002_RAT_PAYMENT.CloseTransactionObjects();
            m_Billing_UNLOF002_RAT_PAYMENT = null;
        }
    }

    public Billing_UNLOF002_RAT_PAYMENT GetBilling_UNLOF002_RAT_PAYMENT(int Level)
    {
        if (m_Billing_UNLOF002_RAT_PAYMENT == null)
        {
            m_Billing_UNLOF002_RAT_PAYMENT = new Billing_UNLOF002_RAT_PAYMENT("Billing_UNLOF002_RAT_PAYMENT", Level);
        }
        else
        {
            m_Billing_UNLOF002_RAT_PAYMENT.ResetValues();
        }
        return m_Billing_UNLOF002_RAT_PAYMENT;
    }
    ...
    public override bool RunQTP()
    {
        ...
        try
        {
            ...
            Billing_UNLOF002_RAT_PAYMENT_UNLOF002_1 UNLOF002_1 = new Billing_UNLOF002_RAT_PAYMENT_UNLOF002_1(Name, Level);
            UNLOF002_1.Run();
            UNLOF002_1.Dispose();
            UNLOF002_1 = null;
...
public class Billing_UNLOF002_RAT_PAYMENT_UNLOF002_1 : Billing_UNLOF002_RAT_PAYMENT
{

    public Billing_UNLOF002_RAT_PAYMENT_UNLOF002_1(string Name, int Level)
    ...
    #region "Declarations (Variables, Files and Transactions)(Billing_UNLOF002_RAT_PAYMENT_UNLOF002_1)"
    ...
    #region "Standard Generated Procedures(Billing_UNLOF002_RAT_PAYMENT_UNLOF002_1)"


    #region "Automatic Item Initialization(Billing_UNLOF002_RAT_PAYMENT_UNLOF002_1)"
    ...
    #region "Transaction Management Procedures(Billing_UNLOF002_RAT_PAYMENT_UNLOF002_1)"
    ...
    #region "FILE Management Procedures(Billing_UNLOF002_RAT_PAYMENT_UNLOF002_1)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(Billing_UNLOF002_RAT_PAYMENT_UNLOF002_1)"
            ...
            while (fleU030_PAID_AMT.QTPForMissing())
            {
                ...
                while (fleF002_CLAIMS_MSTR.QTPForMissing("1"))
                {
                    ...
                    if (Transaction())
                    {
                        ...
                        SubFile(ref m_trnTRANS_UPDATE, ref fleUNLOF002HDR_RAT_PAYMENT, QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_ADJ_OMA_CD")) == "0000", SubFileType.Keep, fleF002_CLAIMS_MSTR, "CLMHDR_BATCH_NBR", X_DELIMITER, "CLMHDR_CLAIM_NBR", "CLMHDR_ADJ_OMA_CD", "CLMHDR_ADJ_OMA_CD",
