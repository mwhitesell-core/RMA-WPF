...
public class Billing_UNLOF002_ME_CLAIM : BaseClassControl
{

    private Billing_UNLOF002_ME_CLAIM m_Billing_UNLOF002_ME_CLAIM;

    public Billing_UNLOF002_ME_CLAIM(string Name, int Level)
        : base(Name, Level)
    {
    ...
    public Billing_UNLOF002_ME_CLAIM(string Name, int Level, bool Request)
    ...
    {
        if ((m_Billing_UNLOF002_ME_CLAIM != null))
        {
            m_Billing_UNLOF002_ME_CLAIM.CloseTransactionObjects();
            m_Billing_UNLOF002_ME_CLAIM = null;
        }
    }

    public Billing_UNLOF002_ME_CLAIM GetBilling_UNLOF002_ME_CLAIM(int Level)
    {
        if (m_Billing_UNLOF002_ME_CLAIM == null)
        {
            m_Billing_UNLOF002_ME_CLAIM = new Billing_UNLOF002_ME_CLAIM("Billing_UNLOF002_ME_CLAIM", Level);
        }
        else
        {
            m_Billing_UNLOF002_ME_CLAIM.ResetValues();
        }
        return m_Billing_UNLOF002_ME_CLAIM;
    }
    ...
    public override bool RunQTP()
    {
        ...
        try
        {
            ...
            Billing_UNLOF002_ME_CLAIM_UNLOF002_1 UNLOF002_1 = new Billing_UNLOF002_ME_CLAIM_UNLOF002_1(Name, Level);
            UNLOF002_1.Run();
            UNLOF002_1.Dispose();
            UNLOF002_1 = null;
...
public class Billing_UNLOF002_ME_CLAIM_UNLOF002_1 : Billing_UNLOF002_ME_CLAIM
{

    public Billing_UNLOF002_ME_CLAIM_UNLOF002_1(string Name, int Level)
    ...
    #region "Declarations (Variables, Files and Transactions)(Billing_UNLOF002_ME_CLAIM_UNLOF002_1)"
    ...
    #region "Standard Generated Procedures(Billing_UNLOF002_ME_CLAIM_UNLOF002_1)"


    #region "Automatic Item Initialization(Billing_UNLOF002_ME_CLAIM_UNLOF002_1)"
    ...
    #region "Transaction Management Procedures(Billing_UNLOF002_ME_CLAIM_UNLOF002_1)"
    ...
    #region "FILE Management Procedures(Billing_UNLOF002_ME_CLAIM_UNLOF002_1)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(Billing_UNLOF002_ME_CLAIM_UNLOF002_1)"
                    ...
                    while (fleICONST_MSTR_REC.QTPForMissing("2"))
                    {
                        ...
                        if (Transaction())
                        {
                             ...
                             if (Select_If())
                            {
                                ...
                                SubFile(ref m_trnTRANS_UPDATE, ref fleUNLOF002HDR_BI_SEL, QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_ADJ_OMA_CD")) == "0000", SubFileType.Keep, fleF002_CLAIMS_MSTR, "CLMHDR_BATCH_NBR", X_DELIMITER, "CLMHDR_CLAIM_NBR", "CLMHDR_ADJ_OMA_CD", "CLMHDR_ADJ_OMA_CD",
                                ...
                                SubFile(ref m_trnTRANS_UPDATE, ref fleUNLOF002DTL_BI_SEL, QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_ADJ_OMA_CD")) != "0000" & QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_ADJ_OMA_CD")) != "ZZZZ", SubFileType.Keep, fleF002_CLAIMS_MSTR, "CLMDTL_ID", X_DELIMITER, "CLMDTL_REV_GROUP_CD", "CLMDTL_AGENT_CD", "CLMDTL_ADJ_CD",
                                ...
                                SubFile(ref m_trnTRANS_UPDATE, ref fleUNLOF002DTL_3, QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_ADJ_OMA_CD")) != "0000" & QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_ADJ_OMA_CD")) != "ZZZZ" & QDesign.NULL(CLMDTL_NBR_SERV_3.Value) > 0, SubFileType.Temp, fleF002_CLAIMS_MSTR, "CLMDTL_ID", X_DELIMITER, "CLMDTL_REV_GROUP_CD", "CLMDTL_AGENT_CD", "CLMDTL_ADJ_CD",
                                ...
                                SubFile(ref m_trnTRANS_UPDATE, ref fleUNLOF002DTL_4, QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_ADJ_OMA_CD")) != "0000" & QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_ADJ_OMA_CD")) != "ZZZZ" & QDesign.NULL(CLMDTL_NBR_SERV_4.Value) > 0, SubFileType.Temp, fleF002_CLAIMS_MSTR, "CLMDTL_ID", X_DELIMITER, "CLMDTL_REV_GROUP_CD", "CLMDTL_AGENT_CD", "CLMDTL_ADJ_CD",
