...
public class SUSPEND_AGENT_DETAIL_EXTRACT_SUSPEND_DETAIL_1 : SUSPEND_AGENT_DETAIL
{
    ...
    private void X_LINE_GetValue(ref string Value)
    {
        ...
        try
        {
            ...
            Value = fleF002_SUSPEND_DTL.GetStringValue("CLMDTL_OMA_CD") + fleF002_SUSPEND_DTL.GetStringValue("CLMDTL_OMA_SUFF") + "     " + QDesign.ASCII(fleF002_SUSPEND_DTL.GetDecimalValue("CLMDTL_NBR_SERV"), 2) + "     " + QDesign.ASCII(fleF002_SUSPEND_DTL.GetDecimalValue("CLMDTL_DIAG_CD"), 3) + "     " + QDesign.Substring(QDesign.ASCII(fleF002_SUSPEND_DTL.GetDecimalValue("CLMDTL_SV_YY"), 4) + fleF002_SUSPEND_DTL.GetStringValue("CLMDTL_SV_YY_ALPHA") + QDesign.ASCII(fleF002_SUSPEND_DTL.GetDecimalValue("CLMDTL_SV_MM"), 2) + fleF002_SUSPEND_DTL.GetStringValue("CLMDTL_SV_MM_ALPHA") + QDesign.ASCII(fleF002_SUSPEND_DTL.GetDecimalValue("CLMDTL_SV_DD"), 2) + fleF002_SUSPEND_DTL.GetStringValue("CLMDTL_SV_DD_ALPHA"), 1, 4) + "/" + QDesign.Substring(QDesign.ASCII(fleF002_SUSPEND_DTL.GetDecimalValue("CLMDTL_SV_YY"), 4) + fleF002_SUSPEND_DTL.GetStringValue("CLMDTL_SV_YY_ALPHA") + QDesign.ASCII(fleF002_SUSPEND_DTL.GetDecimalValue("CLMDTL_SV_MM"), 2) + fleF002_SUSPEND_DTL.GetStringValue("CLMDTL_SV_MM_ALPHA") + QDesign.ASCII(fleF002_SUSPEND_DTL.GetDecimalValue("CLMDTL_SV_DD"), 2) + fleF002_SUSPEND_DTL.GetStringValue("CLMDTL_SV_DD_ALPHA"), 5, 2) + "/" + QDesign.Substring(QDesign.ASCII(fleF002_SUSPEND_DTL.GetDecimalValue("CLMDTL_SV_YY"), 4) + fleF002_SUSPEND_DTL.GetStringValue("CLMDTL_SV_YY_ALPHA") + QDesign.ASCII(fleF002_SUSPEND_DTL.GetDecimalValue("CLMDTL_SV_MM"), 2) + fleF002_SUSPEND_DTL.GetStringValue("CLMDTL_SV_MM_ALPHA") + QDesign.ASCII(fleF002_SUSPEND_DTL.GetDecimalValue("CLMDTL_SV_DD"), 2) + fleF002_SUSPEND_DTL.GetStringValue("CLMDTL_SV_DD_ALPHA"), 7, 2);
        ...
        try
        {
            ...
            while (fleF002_SUSPEND_HDR.QTPForMissing())
            {
                ...
                while (fleF010_PAT_MSTR.QTPForMissing("1"))
                {
                    ...
                    m_strWhere.Append(Common.StringToField((fleF002_SUSPEND_HDR.GetStringValue("CLMHDR_PAT_KEY_TYPE") + fleF002_SUSPEND_HDR.GetStringValue("CLMHDR_PAT_KEY_DATA")).PadRight(16).Substring(1, 2)));
                    //Parent:CLMHDR_PAT_OHIP_ID_OR_CHART    'Parent:KEY_PAT_MSTR
                    m_strWhere.Append(" AND ").Append(" ").Append(fleF010_PAT_MSTR.ElementOwner("PAT_I_NBR")).Append(" = ");
                    m_strWhere.Append(Common.StringToField((fleF002_SUSPEND_HDR.GetStringValue("CLMHDR_PAT_KEY_TYPE") + fleF002_SUSPEND_HDR.GetStringValue("CLMHDR_PAT_KEY_DATA")).PadRight(16).Substring(3, 12)));
                    //Parent:CLMHDR_PAT_OHIP_ID_OR_CHART    'Parent:KEY_PAT_MSTR
                    ...
                    while (fleF002_SUSPEND_DTL.QTPForMissing("2"))
                    {
                        ...
                        while (fleF040_OMA_FEE_MSTR.QTPForMissing("3"))
                        {
                            ...
                            m_strWhere.Append(Common.StringToField((fleF002_SUSPEND_DTL.GetStringValue("CLMDTL_OMA_CD")).PadRight(4).Substring(1, 1)));
            ...
            while (Sort(fleF002_SUSPEND_HDR, fleF010_PAT_MSTR, fleF002_SUSPEND_DTL, fleF040_OMA_FEE_MSTR, fleF091_DIAG_CODES_MSTR, fleF020_DOCTOR_MSTR, fleF020_DOCTOR_EXTRA))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleSUSP_AGENT_DTL, SubFileType.Keep, fleF002_SUSPEND_HDR, fleF010_PAT_MSTR, "PAT_SURNAME", "PAT_GIVEN_NAME", "PAT_HEALTH_NBR", "PAT_VERSION_CD", "PAT_OHIP_MMYY",
                "PAT_BIRTH_DATE", "PAT_SEX", "SUBSCR_ADDR1", "SUBSCR_ADDR2", "SUBSCR_ADDR3", "SUBSCR_POSTAL_CD", "SUBSCR_PROV_CD", "PAT_PHONE_NBR", X_TYPE, X_SEQ,
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleSUSP_OMA_DESC, SubFileType.Keep, fleF002_SUSPEND_HDR, fleF010_PAT_MSTR, "PAT_SURNAME", "PAT_GIVEN_NAME", "PAT_HEALTH_NBR", "PAT_VERSION_CD", "PAT_OHIP_MMYY",
                "PAT_BIRTH_DATE", "PAT_SEX", "SUBSCR_ADDR1", "SUBSCR_ADDR2", "SUBSCR_ADDR3", "SUBSCR_POSTAL_CD", "SUBSCR_PROV_CD", "PAT_PHONE_NBR", X_TYPE, X_SEQ,
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleSUSP_DIAG_DESC, QDesign.NULL(fleF002_SUSPEND_DTL.GetDecimalValue("CLMDTL_DIAG_CD")) != 0, SubFileType.Keep, fleF002_SUSPEND_HDR, fleF010_PAT_MSTR, "PAT_SURNAME", "PAT_GIVEN_NAME", "PAT_HEALTH_NBR", "PAT_VERSION_CD",
                "PAT_OHIP_MMYY", "PAT_BIRTH_DATE", "PAT_SEX", "SUBSCR_ADDR1", "SUBSCR_ADDR2", "SUBSCR_ADDR3", "SUBSCR_POSTAL_CD", "SUBSCR_PROV_CD", "PAT_PHONE_NBR", X_TYPE,
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleF002_SUSPEND_HDR, fleF010_PAT_MSTR, fleF002_SUSPEND_DESC, fleF020_DOCTOR_MSTR, fleF020_DOCTOR_EXTRA))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleSUSP_AGENT_DESC, SubFileType.Keep, fleF002_SUSPEND_HDR, fleF010_PAT_MSTR, "PAT_SURNAME", "PAT_GIVEN_NAME", "PAT_HEALTH_NBR", "PAT_VERSION_CD", "PAT_OHIP_MMYY",
                "PAT_BIRTH_DATE", "PAT_SEX", "SUBSCR_ADDR1", "SUBSCR_ADDR2", "SUBSCR_ADDR3", "SUBSCR_POSTAL_CD", "SUBSCR_PROV_CD", "PAT_PHONE_NBR", X_TYPE, X_SEQ,
                X_LINE, fleF020_DOCTOR_MSTR, "DOC_NAME", fleF020_DOCTOR_EXTRA, "CPSO_NBR", X_CHART_KEY);
