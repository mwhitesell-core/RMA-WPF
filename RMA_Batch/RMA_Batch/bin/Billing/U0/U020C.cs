...
public class U020C_PROCESS_SHADOW_1 : U020C
{
    ...
    private void fleF002_CLAIM_SHADOW_SetItemFinals()
    {
        ...
        try
        {
            ...
            fleF002_CLAIM_SHADOW.set_SetValue("CLM_SHADOW_PAT_KEY_TYPE", (fleU020A1.GetStringValue("CLMHDR_PAT_OHIP_ID_OR_CHART")).PadRight(16).Substring(0, 1));

            fleF002_CLAIM_SHADOW.set_SetValue("CLM_SHADOW_PAT_KEY_OHIP", (fleU020A1.GetStringValue("CLMHDR_PAT_OHIP_ID_OR_CHART")).PadRight(16).Substring(1, 8));

            fleF002_CLAIM_SHADOW.set_SetValue("CLM_SHADOW_FILLER5", (fleU020A1.GetStringValue("CLMHDR_PAT_OHIP_ID_OR_CHART")).PadRight(16).Substring(9, 7));

            fleF002_CLAIM_SHADOW.set_SetValue("CLM_SHADOW_BATCH_NBR", fleU020A1.GetStringValue("BATCTRL_BATCH_NBR"));
            fleF002_CLAIM_SHADOW.set_SetValue("CLM_SHADOW_CLAIM_NBR", QDesign.NConvert(QDesign.Substring(fleU020A1.GetStringValue("CLMHDR_CLAIM_ID"), 9, 2)));
    ...
    private void fleREJECTED_CLAIMS_SetItemFinals()
    {
        ...
        try
        {
            ...
            fleREJECTED_CLAIMS.set_SetValue("CLMHDR_PAT_OHIP_ID_OR_CHART", fleU020A1.GetStringValue("CLMHDR_PAT_OHIP_ID_OR_CHART"));
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (fleU020A1.QTPForMissing())
            {
                ...
                while (fleF002_CLAIMS_MSTR.QTPForMissing("1"))
                {
                    ...
                    if (Transaction())
                    {
                        ...
                        Sort(fleU020A1.GetSortValue("CLMHDR_CLAIM_ID"));
            ...
            {
                fleF002_CLAIM_SHADOW.OutPut(OutPutType.Add, fleU020A1.At("CLMHDR_CLAIM_ID"), (QDesign.NULL(fleU020A1.GetDecimalValue("BATCTRL_AGENT_CD")) == 4 | QDesign.NULL(fleU020A1.GetDecimalValue("BATCTRL_AGENT_CD")) == 6));
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleU020C1, QDesign.NULL(fleU020A1.GetStringValue("MOH_FLAG")) == "Y" & QDesign.NULL(fleU020A1.GetStringValue("PAT_MESS_CODE")) != QDesign.NULL(" "), SubFileType.Keep, fleU020A1);
