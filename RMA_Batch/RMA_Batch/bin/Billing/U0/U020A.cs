...
public class U020A_EXTRACT_1 : U020A
{
    ...
    private void W_PAT_OHIP_MMYY_GetValue(ref string Value)
    {
        ...
        {
            string CurrentValue = string.Empty;
            if (QDesign.NULL(fleF010_PAT_MSTR.GetDecimalValue("PAT_HEALTH_NBR")) == 0 & QDesign.NULL(QDesign.ASCII(fleF010_PAT_MSTR.GetDecimalValue("PAT_OHIP_NBR"), 8) + QDesign.ASCII(fleF010_PAT_MSTR.GetDecimalValue("PAT_MM"), 2) + QDesign.ASCII(fleF010_PAT_MSTR.GetDecimalValue("PAT_YY"), 2) + fleF010_PAT_MSTR.GetStringValue("FILLER1")) != QDesign.NULL(" "))
            {
    ...
    public void Run()
    {
        ...
        try
        {
                                ...
                                while (fleF020_DOCTOR_MSTR.QTPForMissing("5"))
                                {
                                    ...
                                    while (fleF030_LOCATIONS_MSTR.QTPForMissing("6"))
                                    {
                                        ...
                                        if (Transaction())
                                        {
                                            ...
                                            Sort(TRANSLATED_GROUP_NBR.Value);
            ...
            while (Sort(fleF001_BATCH_CONTROL_FILE, fleCONTRACT_DTL, fleF002_CLAIMS_MSTR, fleF010_PAT_MSTR, fleICONST_MSTR_REC, fleF020_DOCTOR_MSTR, fleF030_LOCATIONS_MSTR))
            {
                ...
                "BATCTRL_AGENT_CD", "BATCTRL_DATE_BATCH_ENTERED", fleICONST_MSTR_REC, "ICONST_CLINIC_NBR_1_2", "ICONST_CLINIC_CYCLE_NBR", "ICONST_DATE_PERIOD_END", fleF002_CLAIMS_MSTR, "CLMHDR_CLAIM_ID", "CLMHDR_CLAIM_NBR", W_CLMHDR_HOSP,
                W_MOH_LOCATION_CODE, "CLMHDR_DATE_ADMIT", "CLMHDR_PAT_OHIP_ID_OR_CHART", "CLMHDR_REFER_DOC_NBR", "CLMHDR_LOC", "CLMHDR_I_O_PAT_IND", "CLMHDR_AGENT_CD", "CLMHDR_TOT_CLAIM_AR_OMA", "CLMHDR_TOT_CLAIM_AR_OHIP", "CLMHDR_STATUS_OHIP",
                ...
                "PAT_SURNAME", "PAT_GIVEN_NAME", "PAT_ACRONYM", "PAT_BIRTH_DATE", W_PAT_SEX, "PAT_PROV_CD", "SUBSCR_ADDR1", "SUBSCR_ADDR2", "SUBSCR_ADDR3", "SUBSCR_POSTAL_CD",
                fleCONTRACT_DTL, "MOH_FLAG", "DOLLAR_FLAG", fleF010_PAT_MSTR, "PAT_MESS_CODE", TRANSLATED_GROUP_NBR, fleCONTRACT_DTL, "CONTRACT_CODE", "CONTRACT_CODE");
