        ...
        try
        {
            ...
            while (fleSORTF086.QTPForMissing())
            {
                ...
                while (fleREJECTED_CLAIMS.QTPForMissing("1"))
                {
                    ...
                    m_strWhere.Append(Common.StringToField(fleREJECTED_CLAIMS.GetStringValue("CLMHDR_PAT_OHIP_ID_OR_CHART")));
        ...
        try
        {
            ...
            while (fleSORTF086.QTPForMissing())
            {
                ...
                while (fleF002_CLAIMS_MSTR.QTPForMissing("1"))
                {
                    ...
                    m_strWhere.Append(Common.StringToField(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_PAT_KEY_TYPE") + fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_PAT_KEY_DATA"), 2, 15)));
                    //Parent:CLMHDR_PAT_OHIP_ID_OR_CHART
