...
public class U015_UPDATE_F050_1 : U015
{
    ...
    private void fleF050_DOC_REVENUE_MSTR_Choose(ref string ChooseClause)
    {
        ...
        try
        {
            ...
            {
                strSQL.Append(fleF050_DOC_REVENUE_MSTR.ElementOwner("DOCREV_KEY"));
...
public class U015_UPDATE_F051_2 : U015
{
    ...
    private void fleF051_DOC_CASH_MSTR_Choose(ref string ChooseClause)
    {
        ...
        try
        {
            ...
            {
                strSQL.Append(fleF051_DOC_CASH_MSTR.ElementOwner("DOCASH_KEY"));
                strSQL.Append(" BETWEEN ");
                strSQL.Append(Common.StringToField(Prompt(4).ToString())).Append(" AND ").Append(Common.StringToField(Prompt(4).ToString()));
