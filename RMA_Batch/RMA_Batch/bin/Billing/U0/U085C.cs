	...
	public void Run()
	{
		...
		try {
			...
			while (Sort(fleU085B, fleF002_CLAIMS_MSTR)) {
				...
				SubFile(ref m_trnTRANS_UPDATE, ref fleU085C, SubFileType.Keep, X_OLD_DOC_NBR, X_DOC_CHANGED, X_DOC_NBR_COUNT);
				//Parent:CLMHDR_PAT_OHIP_ID_OR_CHART


				Reset(ref X_DOC_NBR_COUNT, fleF002_CLAIMS_MSTR.At("CLMHDR_PAT_OHIP_ID_OR_CHART"));
