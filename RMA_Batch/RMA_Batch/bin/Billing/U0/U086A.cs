...
public class U086A_PATIENT_CLAIMS_UPDATE_1 : U086A
{
    ...
    {
        this.ScreenType = ScreenTypes.QTP;
        fleF086A_ORIG_NEW_PAT_IDS = new SqlFileObject(this, FileTypes.Primary, 0, "SEQUENTIAL", "F086A_ORIG_NEW_PAT_IDS", "", false, false, false, 0, "m_trnTRANS_UPDATE");
    ...
    private void fleF010_NEW_AutomaticItemInitialization(bool Fixed)
    {
        try
        {
            ...
            fleF010_NEW.set_SetValue("SUBSCR_POST_CD2", !Fixed, fleF010_ORIG.GetDecimalValue("SUBSCR_POST_CD2"));
            fleF010_NEW.set_SetValue("SUBSCR_POST_CD3", !Fixed, fleF010_ORIG.GetStringValue("SUBSCR_POST_CD3"));
            fleF010_NEW.set_SetValue("SUBSCR_POST_CD4", !Fixed, fleF010_ORIG.GetDecimalValue("SUBSCR_POST_CD4"));
            fleF010_NEW.set_SetValue("SUBSCR_POST_CD5", !Fixed, fleF010_ORIG.GetStringValue("SUBSCR_POST_CD5"));
            fleF010_NEW.set_SetValue("SUBSCR_POST_CD6", !Fixed, fleF010_ORIG.GetDecimalValue("SUBSCR_POST_CD6"));
            ...
            while (fleF086A_ORIG_NEW_PAT_IDS.QTPForMissing())
            {
                ...
                while (fleF002_CLAIMS_MSTR.QTPForMissing("1"))
                {
                    ...
                    while (fleF010_ORIG.QTPForMissing("2"))
                    {
                        ...
                        m_strWhere.Append(Common.StringToField((fleF086A_ORIG_NEW_PAT_IDS.GetStringValue("ORIG_CLMHDR_PAT_OHIP_ID_OR_CHART")).PadRight(16).Substring(1, 2)));
                        
                        m_strWhere.Append(" AND ").Append(" ").Append(fleF010_ORIG.ElementOwner("PAT_I_NBR")).Append(" = ");
                        m_strWhere.Append(Common.StringToField((fleF086A_ORIG_NEW_PAT_IDS.GetStringValue("ORIG_CLMHDR_PAT_OHIP_ID_OR_CHART")).PadRight(16).Substring(3, 12)));
                        ...
                        while (fleF010_NEW.QTPForMissing("3"))
                        {
                            ...
                            m_strWhere.Append(Common.StringToField((fleF086A_ORIG_NEW_PAT_IDS.GetStringValue("CLMHDR_PAT_OHIP_ID_OR_CHART")).PadRight(16).Substring(1, 2)));
                            
                            m_strWhere.Append(" AND ").Append(" ").Append(fleF010_NEW.ElementOwner("PAT_I_NBR")).Append(" = ");
                            m_strWhere.Append(Common.StringToField((fleF086A_ORIG_NEW_PAT_IDS.GetStringValue("CLMHDR_PAT_OHIP_ID_OR_CHART")).PadRight(16).Substring(3, 12)));
                            ...
                            while (fleF001_BATCH_CONTROL_FILE.QTPForMissing("4"))
                            {
                                ...
                                if (Transaction())
                                {
                                    ...
                                    SubFile(ref m_trnTRANS_UPDATE, ref fleU086A_AUDIT, SubFileType.Keep, fleF002_CLAIMS_MSTR, "CLMHDR_PAT_OHIP_ID_OR_CHART", "CLMHDR_PAT_ACRONYM", fleF010_ORIG, "PAT_SURNAME", "PAT_GIVEN_NAME", fleF002_CLAIMS_MSTR,
                                    "CLMHDR_CLAIM_ID", "KEY_CLAIMS_MSTR", "KEY_P_CLAIMS_MSTR", fleF086A_ORIG_NEW_PAT_IDS, "ORIG_CLMHDR_PAT_OHIP_ID_OR_CHART", "ORIG_PAT_OLD_SURNAME", "ORIG_PAT_OLD_GIVEN_NAME", "PAT_OLD_SURNAME", "PAT_OLD_GIVEN_NAME");
