    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleF001_BATCH_CONTROL_FILE))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleEXTF001NON_AA, QDesign.NULL(fleF001_BATCH_CONTROL_FILE.GetStringValue("BATCTRL_BATCH_TYPE")) != "A" | QDesign.NULL(fleF001_BATCH_CONTROL_FILE.GetStringValue("BATCTRL_ADJ_CD")) != "A", SubFileType.Keep, fleF001_BATCH_CONTROL_FILE, "BATCTRL_BATCH_NBR", "BATCTRL_AGENT_CD", "BATCTRL_ADJ_CD", "BATCTRL_ADJ_CD", "BATCTRL_CYCLE_NBR",
                "BATCTRL_DATE_PERIOD_END", "BATCTRL_BATCH_TYPE", "BATCTRL_BATCH_TYPE", "BATCTRL_MANUAL_PAY_TOT", "BATCTRL_CALC_AR_DUE", "BATCTRL_CALC_TOT_REV");
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleEXTF001AA, QDesign.NULL(fleF001_BATCH_CONTROL_FILE.GetStringValue("BATCTRL_BATCH_TYPE")) == "A" & QDesign.NULL(fleF001_BATCH_CONTROL_FILE.GetStringValue("BATCTRL_ADJ_CD")) == "A", SubFileType.Keep, fleF001_BATCH_CONTROL_FILE, "BATCTRL_BATCH_NBR", "BATCTRL_AGENT_CD", "BATCTRL_CALC_AR_DUE");
...
public class U010DAILY_EXTRACT_F002_HDR_2 : U010DAILY
{
    ...
    public override bool SelectIf()
    {
        ...
        try
        {
            if (QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("KEY_CLM_SERV_CODE")) == "00000" & QDesign.NULL(fleEXTF001NON_AA.GetStringValue("BATCTRL_DATE_PERIOD_END")) == QDesign.NULL(QDesign.ASCII(fleF002_CLAIMS_MSTR.GetNumericDateValue("CLMHDR_DATE_PERIOD_END"), 8)) & QDesign.NULL(fleEXTF001NON_AA.GetStringValue("BATCTRL_BATCH_NBR")) == QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_ORIG_BATCH_NBR")))
            {
                return true;
            }
                ...
                while (fleF002_CLAIMS_MSTR.QTPForMissing("1"))
                {
                    ...
                    if (Transaction())
                    {
                         ...
                         if (Select_If())
                        {
                            ...
                            SubFile(ref m_trnTRANS_UPDATE, ref fleEXTF001F002, SubFileType.Keep, fleEXTF001NON_AA, fleF002_CLAIMS_MSTR, "CLMHDR_DOC_DEPT", "CLMHDR_MANUAL_AND_TAPE_PAYMENTS", "CLMHDR_AMT_TECH_PAID", "CLMHDR_I_O_PAT_IND", "CLMHDR_AGENT_CD",
...
public class U010DAILY_EXTF002DTL_3 : U010DAILY
{
    ...
    public override bool SelectIf()
    {
        ...
        try
        {
            if (QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_OMA_CD")) != "0000" & QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_OMA_CD")) != "ZZZZ" & QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_ORIG_BATCH_NBR")) == QDesign.NULL(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_ORIG_BATCH_NBR")) & QDesign.NULL(fleF002_CLAIMS_MSTR.GetDecimalValue("CLMDTL_ORIG_CLAIM_NBR_IN_BATCH")) == QDesign.NULL(fleF002_CLAIMS_MSTR.GetDecimalValue("CLMHDR_ORIG_CLAIM_NBR")))
            {
                return true;
            }
    ...
    private void X_SV_NBR2_GetValue(ref decimal Value)
    {
        ...
        try
        {
            ...
            if (QDesign.NULL(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R" + (1).ToString()), 2, 2)) != "OP" & QDesign.NULL(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R" + (1).ToString()), 2, 2)) != "MR" & QDesign.NULL(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R" + (1).ToString()), 2, 2)) != "BI")
            {
    ...
    private void X_SV_NBR3_GetValue(ref decimal Value)
    {
        ...
        {
            decimal CurrentValue = 0m;
            if (QDesign.NULL(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R" + (2).ToString()), 2, 2)) != "OP" & QDesign.NULL(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R" + (2).ToString()), 2, 2)) != "MR" & QDesign.NULL(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R" + (2).ToString()), 2, 2)) != "BI")
            {
    ...
    private void X_SV_NBR4_GetValue(ref decimal Value)
    {
        ...
        {
            decimal CurrentValue = 0m;
            if (QDesign.NULL(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R" + (3).ToString()), 2, 2)) != "OP" & QDesign.NULL(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R" + (3).ToString()), 2, 2)) != "MR" & QDesign.NULL(QDesign.Substring(fleF002_CLAIMS_MSTR.GetStringValue("CLMDTL_CONSEC_DATES_R" + (3).ToString()), 2, 2)) != "BI")
            {
    ...
    private void X_NBR_SERV_GetValue(ref decimal Value)
    {
        ...
        try
        {
            Value = fleF002_CLAIMS_MSTR.GetDecimalValue("CLMDTL_NBR_SERV") + X_SV_NBR2.Value + X_SV_NBR3.Value + X_SV_NBR4.Value;
                ...
                while (fleF002_CLAIMS_MSTR.QTPForMissing("1"))
                {
                    ...
                    if (Transaction())
                    {
                         ...
                         if (Select_If())
                        {
                            ...
                            SubFile(ref m_trnTRANS_UPDATE, ref fleEXTF001F002DTL, SubFileType.Keep, fleF002_CLAIMS_MSTR, "CLMDTL_SV_DATE", "CLMDTL_CONSEC_DATES_R", "CLMDTL_NBR_SERV", "CLMDTL_FEE_OHIP", "CLMDTL_AMT_TECH_BILLED", "CLMDTL_OMA_CD",
                            "CLMDTL_OMA_SUFF", "CLMDTL_LINE_NO", X_NBR_SERV, fleEXTF001F002);
...
public class U010DAILY_UPDATE_REV_CASH_4 : U010DAILY
{
    ...
    private void fleF050_DOC_REVENUE_MSTR_InitializeItems(bool Fixed)
    {
        ...
        try
        {
            ...
            if (!Fixed)
                fleF050_DOC_REVENUE_MSTR.set_SetValue("DOCREV_OMA_CD", true, fleEXTF001F002DTL.GetStringValue("CLMDTL_OMA_CD"));
            if (!Fixed)
        ...
        try
        {
            ...
            while (Sort(fleEXTF001F002DTL, fleF923_DOC_REVENUE_TRANSLATION))
            {
                ...
                while (fleF050_DOC_REVENUE_MSTR.QTPForMissing())
                {
                    ...
                    m_strWhere.Append(Common.StringToField(((X_TRANSLATED_CLINIC.Value + QDesign.ASCII(fleEXTF001F002DTL.GetDecimalValue("CLMHDR_DOC_DEPT"), 2) + fleEXTF001F002DTL.GetStringValue("CLMHDR_DOC_NBR") + fleEXTF001F002DTL.GetStringValue("CLMHDR_LOC") + fleEXTF001F002DTL.GetStringValue("CLMDTL_OMA_CD") + X_SUFF.Value)).PadRight(16).Substring(2, 2)));

                    m_strWhere.Append(" AND ").Append(" ").Append(fleF050_DOC_REVENUE_MSTR.ElementOwner("DOCREV_DOC_NBR")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(((X_TRANSLATED_CLINIC.Value + QDesign.ASCII(fleEXTF001F002DTL.GetDecimalValue("CLMHDR_DOC_DEPT"), 2) + fleEXTF001F002DTL.GetStringValue("CLMHDR_DOC_NBR") + fleEXTF001F002DTL.GetStringValue("CLMHDR_LOC") + fleEXTF001F002DTL.GetStringValue("CLMDTL_OMA_CD") + X_SUFF.Value)).PadRight(16).Substring(4, 3)));

                    m_strWhere.Append(" AND ").Append(" ").Append(fleF050_DOC_REVENUE_MSTR.ElementOwner("DOCREV_LOCATION")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(((X_TRANSLATED_CLINIC.Value + QDesign.ASCII(fleEXTF001F002DTL.GetDecimalValue("CLMHDR_DOC_DEPT"), 2) + fleEXTF001F002DTL.GetStringValue("CLMHDR_DOC_NBR") + fleEXTF001F002DTL.GetStringValue("CLMHDR_LOC") + fleEXTF001F002DTL.GetStringValue("CLMDTL_OMA_CD") + X_SUFF.Value)).PadRight(16).Substring(7, 4)));

                    m_strWhere.Append(" AND ").Append(" ").Append(fleF050_DOC_REVENUE_MSTR.ElementOwner("DOCREV_OMA_CODE")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(((X_TRANSLATED_CLINIC.Value + QDesign.ASCII(fleEXTF001F002DTL.GetDecimalValue("CLMHDR_DOC_DEPT"), 2) + fleEXTF001F002DTL.GetStringValue("CLMHDR_DOC_NBR") + fleEXTF001F002DTL.GetStringValue("CLMHDR_LOC") + fleEXTF001F002DTL.GetStringValue("CLMDTL_OMA_CD") + X_SUFF.Value)).PadRight(16).Substring(11, 4)));

                    m_strWhere.Append(" AND ").Append(" ").Append(fleF050_DOC_REVENUE_MSTR.ElementOwner("DOCREV_OMA_SUFF")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(((X_TRANSLATED_CLINIC.Value + QDesign.ASCII(fleEXTF001F002DTL.GetDecimalValue("CLMHDR_DOC_DEPT"), 2) + fleEXTF001F002DTL.GetStringValue("CLMHDR_DOC_NBR") + fleEXTF001F002DTL.GetStringValue("CLMHDR_LOC") + fleEXTF001F002DTL.GetStringValue("CLMDTL_OMA_CD") + X_SUFF.Value)).PadRight(16).Substring(15, 1)));

                    m_strWhere.Append(" AND ").Append(" ").Append(fleF050_DOC_REVENUE_MSTR.ElementOwner("DOCREV_ADJ_CD_SUB_TYPE")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(((X_TRANSLATED_CLINIC.Value + QDesign.ASCII(fleEXTF001F002DTL.GetDecimalValue("CLMHDR_DOC_DEPT"), 2) + fleEXTF001F002DTL.GetStringValue("CLMHDR_DOC_NBR") + fleEXTF001F002DTL.GetStringValue("CLMHDR_LOC") + fleEXTF001F002DTL.GetStringValue("CLMDTL_OMA_CD") + X_SUFF.Value)).PadRight(16).Substring(16, 1)));
                ...
                while (fleF050TP_DOC_REVENUE_MSTR.QTPForMissing())
                {
                    ...
                    m_strWhere.Append(Common.StringToField(((X_TRANSLATED_CLINIC.Value + QDesign.ASCII(fleEXTF001F002DTL.GetDecimalValue("CLMHDR_AGENT_CD"), 1) + fleEXTF001F002DTL.GetStringValue("CLMHDR_LOC") + fleEXTF001F002DTL.GetStringValue("CLMDTL_OMA_CD") + X_SUFF.Value + fleEXTF001F002DTL.GetStringValue("CLMHDR_DOC_NBR"))).PadRight(15).Substring(2, 1)));
                    //Parent:DOCREVTP_KEY
                    m_strWhere.Append(" AND ").Append(" ").Append(fleF050TP_DOC_REVENUE_MSTR.ElementOwner("DOCREVTP_LOC_CD")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(((X_TRANSLATED_CLINIC.Value + QDesign.ASCII(fleEXTF001F002DTL.GetDecimalValue("CLMHDR_AGENT_CD"), 1) + fleEXTF001F002DTL.GetStringValue("CLMHDR_LOC") + fleEXTF001F002DTL.GetStringValue("CLMDTL_OMA_CD") + X_SUFF.Value + fleEXTF001F002DTL.GetStringValue("CLMHDR_DOC_NBR"))).PadRight(15).Substring(3, 4)));
                    //Parent:DOCREVTP_KEY
                    m_strWhere.Append(" AND ").Append(" ").Append(fleF050TP_DOC_REVENUE_MSTR.ElementOwner("DOCREVTP_OMA_CODE")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(((X_TRANSLATED_CLINIC.Value + QDesign.ASCII(fleEXTF001F002DTL.GetDecimalValue("CLMHDR_AGENT_CD"), 1) + fleEXTF001F002DTL.GetStringValue("CLMHDR_LOC") + fleEXTF001F002DTL.GetStringValue("CLMDTL_OMA_CD") + X_SUFF.Value + fleEXTF001F002DTL.GetStringValue("CLMHDR_DOC_NBR"))).PadRight(15).Substring(7, 4)));
                    //Parent:DOCREVTP_KEY
                    m_strWhere.Append(" AND ").Append(" ").Append(fleF050TP_DOC_REVENUE_MSTR.ElementOwner("DOCREVTP_OMA_SUFFIX")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(((X_TRANSLATED_CLINIC.Value + QDesign.ASCII(fleEXTF001F002DTL.GetDecimalValue("CLMHDR_AGENT_CD"), 1) + fleEXTF001F002DTL.GetStringValue("CLMHDR_LOC") + fleEXTF001F002DTL.GetStringValue("CLMDTL_OMA_CD") + X_SUFF.Value + fleEXTF001F002DTL.GetStringValue("CLMHDR_DOC_NBR"))).PadRight(15).Substring(11, 1)));
                    //Parent:DOCREVTP_KEY
                    m_strWhere.Append(" AND ").Append(" ").Append(fleF050TP_DOC_REVENUE_MSTR.ElementOwner("DOCREVTP_DOC_NBR")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(((X_TRANSLATED_CLINIC.Value + QDesign.ASCII(fleEXTF001F002DTL.GetDecimalValue("CLMHDR_AGENT_CD"), 1) + fleEXTF001F002DTL.GetStringValue("CLMHDR_LOC") + fleEXTF001F002DTL.GetStringValue("CLMDTL_OMA_CD") + X_SUFF.Value + fleEXTF001F002DTL.GetStringValue("CLMHDR_DOC_NBR"))).PadRight(15).Substring(12, 3)));
                    //Parent:DOCREVTP_KEY
                    ...
                    {
                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR, "DOCREVTP_OUT_TECH_NBR_SVC", X_NBR_SVC.Value);
                    ...
                    {
                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR, "DOCREVTP_OUT_PROF_NBR_SVC", X_NBR_SVC.Value);
                    ...
                    {
                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR, "DOCREVTP_OUT_TECH_AMT_BILLED", fleEXTF001F002DTL.GetDecimalValue("CLMDTL_AMT_TECH_BILLED"));
                    ...
                    if (QDesign.NULL(fleEXTF001F002DTL.GetStringValue("BATCTRL_BATCH_TYPE")) == "C" | QDesign.NULL(fleEXTF001F002DTL.GetStringValue("BATCTRL_BATCH_TYPE")) == "P")
                    {
                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR, "DOCREVTP_OUT_PROF_AMT_BILLED", X_PROF_FEE.Value);
                    ...
                    if (QDesign.NULL(fleEXTF001F002DTL.GetStringValue("BATCTRL_BATCH_TYPE")) == "A")
                    {
                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR, "DOCREVTP_OUT_TECH_AMT_ADJUSTS", fleEXTF001F002DTL.GetDecimalValue("CLMDTL_AMT_TECH_BILLED"));
                    ...
                    if (QDesign.NULL(fleEXTF001F002DTL.GetStringValue("BATCTRL_BATCH_TYPE")) == "A")
                    {
                        SubTotal(ref fleF050TP_DOC_REVENUE_MSTR, "DOCREVTP_OUT_PROF_AMT_ADJUSTS", X_PROF_FEE.Value);
                ...
                while (fleF051TP_DOC_CASH_MSTR.QTPForMissing())
                {
                    ...
                    m_strWhere.Append(Common.StringToField(((X_TRANSLATED_CLINIC.Value + QDesign.ASCII(fleEXTF001F002DTL.GetDecimalValue("CLMHDR_AGENT_CD"), 1) + fleEXTF001F002DTL.GetStringValue("CLMHDR_LOC") + fleEXTF001F002DTL.GetStringValue("CLMHDR_DOC_NBR"))).PadRight(10).Substring(2, 1)));
                    //Parent:DOCASHTP_KEY
                    m_strWhere.Append(" AND ").Append(" ").Append(fleF051TP_DOC_CASH_MSTR.ElementOwner("DOCASHTP_LOC_CD")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(((X_TRANSLATED_CLINIC.Value + QDesign.ASCII(fleEXTF001F002DTL.GetDecimalValue("CLMHDR_AGENT_CD"), 1) + fleEXTF001F002DTL.GetStringValue("CLMHDR_LOC") + fleEXTF001F002DTL.GetStringValue("CLMHDR_DOC_NBR"))).PadRight(10).Substring(3, 4)));
                    //Parent:DOCASHTP_KEY
                    m_strWhere.Append(" AND ").Append(" ").Append(fleF051TP_DOC_CASH_MSTR.ElementOwner("DOCASHTP_DOC_NBR")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(((X_TRANSLATED_CLINIC.Value + QDesign.ASCII(fleEXTF001F002DTL.GetDecimalValue("CLMHDR_AGENT_CD"), 1) + fleEXTF001F002DTL.GetStringValue("CLMHDR_LOC") + fleEXTF001F002DTL.GetStringValue("CLMHDR_DOC_NBR"))).PadRight(10).Substring(7, 3)));
                    //Parent:DOCASHTP_KEY
...
public class U010DAILY_DELETE_FROM_F002_OUTSTANDING_6 : U010DAILY
{
        ...
        : base(Name, Level, true)
    {
        ...
        fleEXTF001F002_ADJ_PAY = new SqlFileObject(this, FileTypes.Primary, 0, "TEMPORARYDATA", "EXTF001F002_ADJ_PAY", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SubFile);
        fleF002_CLAIMS_MSTR = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "F002_CLAIMS_MSTR", "", false, false, false, 0, "m_trnTRANS_UPDATE");
        fleF002_ADJ = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "F002_CLAIMS_MSTR", "F002_ADJ", false, false, false, 0, "m_trnTRANS_UPDATE");
        fleF002_OUTSTANDING = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "F002_OUTSTANDING", "", false, false, false, 0, "m_trnTRANS_UPDATE");
        ...
        try
        {
            ...
            while (fleEXTF001F002_ADJ_PAY.QTPForMissing())
            {
                ...
                while (fleF002_CLAIMS_MSTR.QTPForMissing("1"))
                {
                    ...
                    m_strWhere.Append(Common.StringToField("B"));
                    m_strWhere.Append(" And ").Append(fleF002_CLAIMS_MSTR.ElementOwner("KEY_CLM_BATCH_NBR")).Append(" = ");
                    m_strWhere.Append(Common.StringToField(fleF002_CLAIMS_MSTR.GetStringValue("CLMHDR_ORIG_BATCH_NBR")));
                    m_strWhere.Append(" And ").Append(fleF002_CLAIMS_MSTR.ElementOwner("KEY_CLM_CLAIM_NBR")).Append(" = ");
                    m_strWhere.Append((fleF002_CLAIMS_MSTR.GetDecimalValue("CLMHDR_ORIG_CLAIM_NBR")));
...
public class U010DAILY_DELETE_AA_FROM_F002_OUTSTANDING_7 : U010DAILY
{
    ...
    private void fleF002_CLAIMS_MSTR_SelectIf(ref string SelectIfClause)
    {
        ...
        try
        {
            ...
            strSQL.Append(" (    ").Append(fleF002_CLAIMS_MSTR.ElementOwner("KEY_CLM_SERV_CODE")).Append(" =  '00000')");
