...
public class U030BB_ADD_DTL_IGNORE_DUPLICATE_KEY_ERROR_3 : U030BB
{
    ...
    private void CONSEC_DATE_1_GetValue(ref decimal Value)
    {
        ...
        try
        {
            ...
            if (QDesign.NULL(fleF002_CLAIMS_MSTR.GetDecimalValue("CLMDTL_SV_DAY" + (1).ToString())) != 0)
            {
    ...
    private void CONSEC_DATE_2_GetValue(ref decimal Value)
    {
        ...
        {
            decimal CurrentValue = 0m;
            if (QDesign.NULL(fleF002_CLAIMS_MSTR.GetDecimalValue("CLMDTL_SV_DAY" + (2).ToString())) != 0)
            {
    ...
    private void CONSEC_DATE_3_GetValue(ref decimal Value)
    {
        ...
        {
            decimal CurrentValue = 0m;
            if (QDesign.NULL(fleF002_CLAIMS_MSTR.GetDecimalValue("CLMDTL_SV_DAY" + (3).ToString())) != 0)
            {
