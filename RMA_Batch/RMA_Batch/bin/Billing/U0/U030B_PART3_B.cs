...
public class U030B_PART3_B_CREATE_PAYMENT_RECS_1 : U030B_PART3_B
{
    ...
    private void X_TECH_AMT_GetValue(ref decimal Value)
    {
        ...
        try
        {
            ...
            {
                CurrentValue = fleR031A_BATCH_NBR.GetDecimalValue("X_TOTAL_PAID_AMT") * fleTMP_DOCTOR_ALPHA.GetDecimalValue("TMP_COUNTER_1") / fleTMP_DOCTOR_ALPHA.GetDecimalValue("TMP_COUNTER_3");
            }
    ...
    private void fleF002_ADJ_HDR_InitializeItems(bool Fixed)
    {
        ...
        try
        {
            ...
            if (!Fixed)
                fleF002_ADJ_HDR.set_SetValue("CLMHDR_OMA_SUFF_ADJ", true, "000000");
            if (!Fixed)
    ...
    private void fleF002_ADJ_DTL_InitializeItems(bool Fixed)
    {
        ...
        try
        {
            ...
            if (!Fixed)
                fleF002_ADJ_DTL.set_SetValue("CLMDTL_SV_DATE", true, QDesign.ASCII(QDesign.SysDate(ref m_cnnQUERY), 8));
            if (!Fixed)
