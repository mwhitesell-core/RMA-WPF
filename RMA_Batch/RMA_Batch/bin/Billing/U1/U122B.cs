                ...
                while (fleF119_DOCTOR_YTD.QTPForMissing("1"))
                {
                    ...
                    if (Transaction())
                    {
                         ...
                         if (Select_If())
                        {
                            ...
                            SubFile(ref m_trnTRANS_UPDATE, ref fleBRAD, SubFileType.Keep, fleF119_TITHE_ONE_COMP_CODE_PER_DOC_NBR, "COMP_CODE", "COMP_CODE", "DOC_NBR", fleF119_DOCTOR_YTD, "AMT_YTD", fleF119_TITHE_ONE_COMP_CODE_PER_DOC_NBR,
                            ...
                            while (fleF119_TITHE2.QTPForMissing("4"))
                            {
                                ...
                                while (fleF119_TITHE3.QTPForMissing("5"))
                                {
                                    ...
                                    if (Transaction())
                                    {
                                        ...
                                        SubFile(ref m_trnTRANS_UPDATE, ref fleBRAD_TITHE1, SubFileType.Keep, fleU122B_PRIM_DOC, "DOC_NBR", "DOC_NBR", "X_PRIMARY_DOC_NBR", "X_AMT_GROSS_SUMMARY_DOC", "DOC_OHIP_NBR", "DOC_OHIP_NBR",
                                        ...
                                        SubFile(ref m_trnTRANS_UPDATE, ref fleBRAD_TITHE2, SubFileType.Keep, fleU122B_PRIM_DOC, "DOC_NBR", "DOC_NBR", "X_PRIMARY_DOC_NBR", "X_AMT_GROSS_SUMMARY_DOC", "DOC_OHIP_NBR", "DOC_OHIP_NBR",
                                        ...
                                        SubFile(ref m_trnTRANS_UPDATE, ref fleBRAD_TITHE3, SubFileType.Keep, fleU122B_PRIM_DOC, "DOC_NBR", "DOC_NBR", "X_PRIMARY_DOC_NBR", "X_AMT_GROSS_SUMMARY_DOC", "DOC_OHIP_NBR", "DOC_OHIP_NBR",
                                        ...
                                        SubFile(ref m_trnTRANS_UPDATE, ref fleF119_TITHE_1_2_3_TRANS, QDesign.NULL(AMT_TITHE1_ACTUAL_MTD.Value) != 0 | QDesign.NULL(AMT_TITHE1_ACTUAL_YTD.Value) != 0, SubFileType.Keep, fleU122B_PRIM_DOC, "DOC_OHIP_NBR", "DOC_OHIP_NBR", "X_PRIMARY_DOC_NBR", COMP_CODE1, COMP_SEQ1,
                                        COMP_GROUP1, X_REC_TYPE, AMT_TITHE1_ACTUAL_MTD, AMT_TITHE1_ACTUAL_YTD);



                                        SubFile(ref m_trnTRANS_UPDATE, ref fleF119TITHE2, QDesign.NULL(AMT_TITHE2_ACTUAL_MTD.Value) != 0 | QDesign.NULL(AMT_TITHE2_ACTUAL_YTD.Value) != 0, SubFileType.Keep, fleU122B_PRIM_DOC, "DOC_OHIP_NBR", "DOC_OHIP_NBR", "X_PRIMARY_DOC_NBR", COMP_CODE2, COMP_SEQ2,
                                        COMP_GROUP2, X_REC_TYPE, AMT_TITHE2_ACTUAL_MTD, AMT_TITHE2_ACTUAL_YTD);



                                        SubFile(ref m_trnTRANS_UPDATE, ref fleF119TITHE3, QDesign.NULL(AMT_TITHE3_ACTUAL_MTD.Value) != 0 | QDesign.NULL(AMT_TITHE3_ACTUAL_YTD.Value) != 0, SubFileType.Keep, fleU122B_PRIM_DOC, "DOC_OHIP_NBR", "DOC_OHIP_NBR", "X_PRIMARY_DOC_NBR", COMP_CODE3, COMP_SEQ3,
