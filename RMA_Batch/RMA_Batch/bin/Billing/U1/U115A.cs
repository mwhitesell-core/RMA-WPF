...
public class U115A_U115_RUN_0_11 : U115A
{
    ...
    public U115A_U115_RUN_0_11(string Name, int Level) : base(Name, Level, true)
    {
        ...
        fleF116_GROUP = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "F116_DEPT_EXPENSE_RULES_DTL", "F116_GROUP", false, false, false, 0, "m_trnTRANS_UPDATE");
        fleF190_COMP_CODES = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "F190_COMP_CODES", "", false, false, false, 0, "m_trnTRANS_UPDATE");
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleCONSTANTS_MSTR_REC_6, fleF110_COMPENSATION, fleF020_DOCTOR_MSTR, fleF112_PYCDCEILINGS, fleF116_GROUP, fleF190_COMP_CODES))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleF119, (QDesign.NULL(fleF190_COMP_CODES.GetStringValue("COMP_TYPE")) == "I" | QDesign.NULL(fleF190_COMP_CODES.GetStringValue("COMP_TYPE")) == "E" | QDesign.NULL(fleF190_COMP_CODES.GetStringValue("COMP_TYPE")) == "A" | QDesign.NULL(fleF190_COMP_CODES.GetStringValue("COMP_TYPE")) == "M" | QDesign.NULL(fleF190_COMP_CODES.GetStringValue("COMP_TYPE")) == "P"), SubFileType.Keep, fleF110_COMPENSATION, "DOC_NBR", "COMP_CODE", fleF190_COMP_CODES, "REPORTING_SEQ", "COMP_CODE_GROUP",
                REC_TYPE, X_AMT_NET, X_AMT_GROSS);

                SubFile(ref m_trnTRANS_UPDATE, ref fleF119_RMAEXR, fleF110_COMPENSATION.At("DOC_NBR"), QDesign.NULL(TOT_RMA_EXPENSE_ONLY_REG.Value) != 0, SubFileType.Keep, fleF110_COMPENSATION, "DOC_NBR", X_COMP_CODE, RMAEXR_SEQ_RPT, RMAEXR_GROUP,
                X_REC_TYPE, X_NOT_NEEDED, TOT_RMA_EXPENSE_ONLY_REG);

                SubFile(ref m_trnTRANS_UPDATE, ref fleF119_RMAEXM, fleF110_COMPENSATION.At("DOC_NBR"), QDesign.NULL(TOT_RMA_EXPENSE_ONLY_MISC.Value) != 0, SubFileType.Keep, fleF110_COMPENSATION, "DOC_NBR", X_COMP_CODE_RMAEXM, RMAEXM_SEQ_RPT, RMAEXM_GROUP,
                X_REC_TYPE, X_NOT_NEEDED, TOT_RMA_EXPENSE_ONLY_MISC);

                SubFile(ref m_trnTRANS_UPDATE, ref fleF119_GST, fleF110_COMPENSATION.At("DOC_NBR"), QDesign.NULL(TOT_GST_ONLY.Value) != 0, SubFileType.Keep, fleF110_COMPENSATION, "DOC_NBR", X_COMP_CODE_GST, GST_SEQ_RPT, GST_GROUP,
                X_REC_TYPE, X_NOT_NEEDED, TOT_GST_ONLY);

                SubFile(ref m_trnTRANS_UPDATE, ref fleF119_HOLDBACK, fleF110_COMPENSATION.At("DOC_NBR"), QDesign.NULL(TOT_HOLDBACK_ONLY.Value) != 0, SubFileType.Keep, fleF110_COMPENSATION, "DOC_NBR", X_COMP_CODE_HOLDBACK, HOLDBACK_SEQ_RPT, HOLDBACK_GROUP,
                X_REC_TYPE, X_NOT_NEEDED, TOT_HOLDBACK_ONLY);

                SubFile(ref m_trnTRANS_UPDATE, ref fleF119_TOTINC, fleF110_COMPENSATION.At("DOC_NBR"), SubFileType.Keep, fleF110_COMPENSATION, "DOC_NBR", X_COMP_CODE_TOTINC, TOTINC_SEQ_RPT, TOTINC_GROUP, X_REC_TYPE,
                TOT_INCOME_NET, TOT_INCOME_GROSS);

                SubFile(ref m_trnTRANS_UPDATE, ref fleF119_DEPEXR, fleF110_COMPENSATION.At("DOC_NBR"), QDesign.NULL(TOT_DEPT_EXPENSE_REG.Value) != 0, SubFileType.Keep, fleF110_COMPENSATION, "DOC_NBR", X_COMP_CODE_DEPEXR, DEPEXR_SEQ_RPT, DEPEXR_GROUP,
                X_REC_TYPE, X_NOT_NEEDED, TOT_DEPT_EXPENSE_REG);

                SubFile(ref m_trnTRANS_UPDATE, ref fleF119_DEPEXM, fleF110_COMPENSATION.At("DOC_NBR"), QDesign.NULL(TOT_DEPT_EXPENSE_MISC.Value) != 0, SubFileType.Keep, fleF110_COMPENSATION, "DOC_NBR", X_COMP_CODE_DEPEXM, DEPEXM_SEQ_RPT, DEPEXM_GROUP,
                X_REC_TYPE, X_NOT_NEEDED, TOT_DEPT_EXPENSE_MISC);

                SubFile(ref m_trnTRANS_UPDATE, ref fleF119_TOTEXP, fleF110_COMPENSATION.At("DOC_NBR"), QDesign.NULL(FINAL_ALL_EXPENSES_PLUS_DEPT_EXPENSE_OTHER.Value) != 0, SubFileType.Keep, fleF110_COMPENSATION, "DOC_NBR", X_COMP_CODE_TOTEXP, TOTEXP_SEQ_RPT, TOTEXP_GROUP,
                X_REC_TYPE, X_NOT_NEEDED, FINAL_ALL_EXPENSES_PLUS_DEPT_EXPENSE_OTHER);

                AMT_INCOME_MINUS_EXPENSES_G.Value = TOT_INCOME_GROSS.Value - FINAL_ALL_EXPENSES_PLUS_DEPT_EXPENSE_OTHER.Value;
                SubFile(ref m_trnTRANS_UPDATE, ref fleU115_INCEXP, fleF110_COMPENSATION.At("DOC_NBR"), SubFileType.Keep, fleF110_COMPENSATION, "DOC_NBR", X_COMP_CODE_INCEXP, INCEXP_SEQ_RPT, INCEXP_GROUP,
                X_REC_TYPE, X_NOT_NEEDED, AMT_INCOME_MINUS_EXPENSES_G);

                DOC_YTDEAR_PLUS_AMT_MANPAY.Value = fleF020_DOCTOR_MSTR.GetDecimalValue("DOC_YTDEAR") + AMT_MANPAY.Value;
                SubFile(ref m_trnTRANS_UPDATE, ref fleF119_YTDEAR, fleF110_COMPENSATION.At("DOC_NBR"), SubFileType.Keep, fleF110_COMPENSATION, "DOC_NBR", X_COMP_CODE_YTDEAR, YTDEAR_SEQ_RPT, YTDEAR_GROUP, X_REC_TYPE,
                X_NOT_NEEDED, DOC_YTDEAR_PLUS_AMT_MANPAY);
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleDEBUGU115A_AT_DOC_NBR, fleF110_COMPENSATION.At("DOC_NBR"), SubFileType.Keep, fleF110_COMPENSATION, "DOC_NBR", TOT_INCOME_GROSS_REG, TOT_INCOME_GROSS_MISC, TOT_INCOME_GROSS_OTHER, TOT_INCOME_NET_REG,
