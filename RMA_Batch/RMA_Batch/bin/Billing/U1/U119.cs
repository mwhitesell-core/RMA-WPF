                                ...
                                while (fleF020_DOCTOR_MSTR.QTPForMissing("5"))
                                {
                                    ...
                                    if (Transaction())
                                    {
                                         ...
                                         if (Select_If())
                                        {
                                            ...
                                            //}
                                            W_COMP_CODE_TRANSFER_OR_EFT.Value = "PAYEFT";
                                            SubFile(ref m_trnTRANS_UPDATE, ref fleF119, SubFileType.Keep, SubFileMode.Append, fleF112_PYCDCEILINGS, "DOC_NBR", W_COMP_CODE_TRANSFER_OR_EFT, PAYEFT_SEQ, PAYEFT_GROUP, W_REC_TYPE, W_NOT_NEEDED, W_PAYEFT_AMT_N);
                                            ...
                                            SubFile(ref m_trnTRANS_UPDATE, ref fleF119_ADVOUT, QDesign.NULL(W_AMT_DEFICIT.Value) > 0, SubFileType.Keep, SubFileMode.Append, fleF112_PYCDCEILINGS, "DOC_NBR", W_COMP_CODE_ADVOUT, ADVOUT_SEQ, ADVOUT_GROUP, W_REC_TYPE, W_NOT_NEEDED, W_AMT_DEFICIT);
                                            ...
                                            if (fleF110_PAYEFT.Exists())
                                            {
                                                W_COMP_UNITS.Value = ((fleF110_PAYEFT.GetDecimalValue("COMP_UNITS") * fleF110_PAYEFT.GetDecimalValue("FACTOR")) + 0.5m) / 10000;
                                            }
                                            else
                                            {
