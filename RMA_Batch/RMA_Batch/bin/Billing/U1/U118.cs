    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleCONSTANTS_MSTR_REC_6, fleF110_COMPENSATION, fleF190_COMP_CODES))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleF119_TOTDED, fleF110_COMPENSATION.At("DOC_NBR"), SubFileType.Keep, SubFileMode.Append, fleF110_COMPENSATION, "DOC_NBR", COMP_CODE, REPORTING_SEQ, COMP_CODE_GROUP, X_REC_TYPE,
                X_AMT_NET, X_AMT_GROSS);

                X_COMP_CODE_TOTADV.Value = "TOTADV";
                SubFile(ref m_trnTRANS_UPDATE, ref fleF119_TOTADV, fleF110_COMPENSATION.At("DOC_NBR"), QDesign.NULL(AMT_TOTADV_N.Value) > 0, SubFileType.Keep, SubFileMode.Append, fleF110_COMPENSATION, "DOC_NBR", X_COMP_CODE_TOTADV, TOTADV_SEQ_RPT, TOTADV_GROUP,
                X_REC_TYPE, X_NOT_NEEDED, AMT_TOTADV_N);
