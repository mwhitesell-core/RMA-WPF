                        ...
                        while (fleF110_PAYPOT.QTPForMissing("3"))
                        {
                            ...
                            if (Transaction())
                            {
                                 ...
                                 if (Select_If())
                                {
                                    ...
                                    SubFile(ref m_trnTRANS_UPDATE, ref fleF119, SubFileType.Keep, SubFileMode.Append, fleF110_COMPENSATION, "DOC_NBR", COMP_CODE, fleF190_COMP_CODES, "REPORTING_SEQ", "COMP_CODE_GROUP", X_REC_TYPE,
