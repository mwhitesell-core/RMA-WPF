...
public class U112 : BaseClassControl
{

    private U112 m_U112;

    public U112(string Name, int Level)
        : base(Name, Level)
    {
    ...
    public U112(string Name, int Level, bool Request)
    ...
    public override void Dispose()
    {
        if ((m_U112 != null))
        {
            m_U112.CloseTransactionObjects();
            m_U112 = null;
        }
    }

    public U112 GetU112(int Level)
    {
        if (m_U112 == null)
        {
            m_U112 = new U112("U112", Level);
        }
        else
        {
            m_U112.ResetValues();
    ...
    public override bool RunQTP()
    {
        ...
        try
        {
            ...
            U112_CONST_MSTR_GET_EP_NBR_1 CONST_MSTR_GET_EP_NBR_1 = new U112_CONST_MSTR_GET_EP_NBR_1(Name, Level);
            CONST_MSTR_GET_EP_NBR_1.Run();
            CONST_MSTR_GET_EP_NBR_1.Dispose();
            CONST_MSTR_GET_EP_NBR_1 = null;

            U112_RUN_0_2 RUN_0_2 = new U112_RUN_0_2(Name, Level);
            RUN_0_2.Run();
            RUN_0_2.Dispose();
            RUN_0_2 = null;
...
public class U112_CONST_MSTR_GET_EP_NBR_1 : U112
{

    public U112_CONST_MSTR_GET_EP_NBR_1(string Name, int Level)
    ...
    #region "Declarations (Variables, Files and Transactions)(U112_CONST_MSTR_GET_EP_NBR_1)"
    ...
    #region "Standard Generated Procedures(U112_CONST_MSTR_GET_EP_NBR_1)"


    #region "Automatic Item Initialization(U112_CONST_MSTR_GET_EP_NBR_1)"
    ...
    #region "Transaction Management Procedures(U112_CONST_MSTR_GET_EP_NBR_1)"
    ...
    #region "FILE Management Procedures(U112_CONST_MSTR_GET_EP_NBR_1)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(U112_CONST_MSTR_GET_EP_NBR_1)"
...
public class U112_RUN_0_2 : U112
{

    public U112_RUN_0_2(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
    ...
    #region "Declarations (Variables, Files and Transactions)(U112_RUN_0_2)"
    ...
    #region "Standard Generated Procedures(U112_RUN_0_2)"


    #region "Automatic Item Initialization(U112_RUN_0_2)"
    ...
    #region "Transaction Management Procedures(U112_RUN_0_2)"
    ...
    #region "FILE Management Procedures(U112_RUN_0_2)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(U112_RUN_0_2)"
            ...
            while (fleF112_PYCDCEILINGS.QTPForMissing())
            {
                ...
                while (fleF112_CURRENT_EP.QTPForMissing("1"))
                {
                    ...
                    if (Transaction())
                    {
                        ...
                        fleF112_OUTPUT.set_SetValue("LAST_MOD_USER_ID", "U112      Gen`d");

                        fleF112_OUTPUT.OutPut(OutPutType.Add, null, !fleF112_CURRENT_EP.Exists());
