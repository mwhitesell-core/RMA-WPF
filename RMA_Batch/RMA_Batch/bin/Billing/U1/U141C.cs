        ...
        try
        {
            ...
            while (fleU141C_RUNNING_AMT.QTPForMissing())
            {
                ...
                while (fleU141C_HIGHEST_AMT.QTPForMissing("1"))
                {
                    ...
                    m_strWhere.Append(" ").Append(fleU141C_HIGHEST_AMT.ElementOwner("CORE_RECORD_NUMBER")).Append(" = ");
                    m_strWhere.Append((0));
...
public class U141C_U141_GEN_BATCH_NBRS_4 : U141C
{
        ...
        : base(Name, Level, true)
    {
        ...
        fleF002_HDR = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "F002_CLAIMS_MSTR", "F002_HDR", false, false, false, 0, "m_trnTRANS_UPDATE");
        fleF002_DTL = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "F002_CLAIMS_MSTR", "F002_DTL", false, false, false, 0, "m_trnTRANS_UPDATE");
    ...
    private void fleF002_HDR_InitializeItems(bool Fixed)
    {
        ...
        try
        {
            ...
            if (!Fixed)
                fleF002_HDR.set_SetValue("CLMHDR_OMA_SUFF_ADJ", true, "000000");
            if (!Fixed)
            ...
            if (!Fixed)
                fleF002_HDR.set_SetValue("CLMHDR_DATE_CASH_TAPE_PAYMENT", true, QDesign.ASCII(QDesign.SysDate(ref m_cnnQUERY), 8));
            if (!Fixed)
    ...
    private void fleF002_DTL_InitializeItems(bool Fixed)
    {
        ...
        try
        {
            ...
            if (!Fixed)
                fleF002_DTL.set_SetValue("CLMDTL_SV_DATE", true, QDesign.ASCII(QDesign.SysDate(ref m_cnnQUERY), 8));
            if (!Fixed)
            ...
            if (!Fixed)
                fleF002_DTL.set_SetValue("CLMDTL_ORIG_BATCH_ID", true, fleF002_HDR.GetStringValue("CLMHDR_ORIG_BATCH_NBR") + QDesign.ASCII(fleF002_HDR.GetDecimalValue("CLMHDR_ORIG_CLAIM_NBR"), 2));
