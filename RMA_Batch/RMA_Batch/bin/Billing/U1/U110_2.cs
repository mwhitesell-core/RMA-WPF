    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleF050_DOC_REVENUE_MSTR, fleF020_DOCTOR_MSTR, fleICONST_MSTR_REC))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MICF, fleF050_DOC_REVENUE_MSTR.At("DOCREV_CLINIC_1_2") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DEPT") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DOC_NBR"), QDesign.NULL(MTD_MICF.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR", X_COMP_CODE_MICF, MICF_TYPE, MICF_SEQ,
                MICF_FACTOR, MTD_MICF);

                X_COMP_CODE_MICG.Value = "MICG";
                SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MICG, fleF050_DOC_REVENUE_MSTR.At("DOCREV_CLINIC_1_2") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DEPT") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DOC_NBR"), QDesign.NULL(MTD_MICG.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR", X_COMP_CODE_MICG, MICG_TYPE, MICG_SEQ,
                MICG_FACTOR, MTD_MICG);

                X_COMP_CODE_MICH.Value = "MICH";
                SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MICH, fleF050_DOC_REVENUE_MSTR.At("DOCREV_CLINIC_1_2") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DEPT") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DOC_NBR"), QDesign.NULL(MTD_MICH.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR", X_COMP_CODE_MICH, MICH_TYPE, MICH_SEQ,
                MICH_FACTOR, MTD_MICH);

                X_COMP_CODE_MICJ.Value = "MICJ";
                SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MICJ, fleF050_DOC_REVENUE_MSTR.At("DOCREV_CLINIC_1_2") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DEPT") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DOC_NBR"), QDesign.NULL(MTD_MICJ.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR", X_COMP_CODE_MICJ, MICJ_TYPE, MICJ_SEQ,
                MICJ_FACTOR, MTD_MICJ);

                X_COMP_CODE_MICK.Value = "MICK";
                SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MICK, fleF050_DOC_REVENUE_MSTR.At("DOCREV_CLINIC_1_2") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DEPT") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DOC_NBR"), QDesign.NULL(MTD_MICK.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR", X_COMP_CODE_MICK, MICK_TYPE, MICK_SEQ,
                MICK_FACTOR, MTD_MICK);

                X_COMP_CODE_MICL.Value = "MICL";
                SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MICL, fleF050_DOC_REVENUE_MSTR.At("DOCREV_CLINIC_1_2") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DEPT") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DOC_NBR"), QDesign.NULL(MTD_MICL.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR", X_COMP_CODE_MICL, MICL_TYPE, MICL_SEQ,
                MICL_FACTOR, MTD_MICL);

                X_COMP_CODE_MOHD.Value = "MOHD";
                SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MOHD, fleF050_DOC_REVENUE_MSTR.At("DOCREV_CLINIC_1_2") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DEPT") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DOC_NBR"), QDesign.NULL(MTD_MOHD.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR", X_COMP_CODE_MOHD, MOHD_TYPE, MOHD_SEQ,
                MOHD_FACTOR, MTD_MOHD);

                X_COMP_CODE_MACC.Value = "MACC";
                SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MACC, fleF050_DOC_REVENUE_MSTR.At("DOCREV_CLINIC_1_2") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DEPT") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DOC_NBR"), QDesign.NULL(MTD_MACC.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR", X_COMP_CODE_MACC, MACC_TYPE, MACC_SEQ,
                MACC_FACTOR, MTD_MACC);

                X_COMP_CODE_MIBD.Value = "MIBD";
                SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MIBD, fleF050_DOC_REVENUE_MSTR.At("DOCREV_CLINIC_1_2") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DEPT") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DOC_NBR"), QDesign.NULL(MTD_MIBD.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR", X_COMP_CODE_MIBD, MIBD_TYPE, MIBD_SEQ,
                MIBD_FACTOR, MTD_MIBD);

                X_COMP_CODE_MPAP.Value = "MPAP";
                SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MPAP, fleF050_DOC_REVENUE_MSTR.At("DOCREV_CLINIC_1_2") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DEPT") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DOC_NBR"), QDesign.NULL(MTD_MPAP.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR", X_COMP_CODE_MPAP, MPAP_TYPE, MPAP_SEQ,
                MPAP_FACTOR, MTD_MPAP);

                X_COMP_CODE_MSLP.Value = "MSLP";
                SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MSLP, fleF050_DOC_REVENUE_MSTR.At("DOCREV_CLINIC_1_2") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DEPT") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DOC_NBR"), QDesign.NULL(MTD_MSLP.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR", X_COMP_CODE_MSLP, MSLP_TYPE, MSLP_SEQ,
                MSLP_FACTOR, MTD_MSLP);

                X_COMP_CODE_MMDU.Value = "MMDU";
                SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MMDU, fleF050_DOC_REVENUE_MSTR.At("DOCREV_CLINIC_1_2") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DEPT") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DOC_NBR"), QDesign.NULL(MTD_MMDU.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR", X_COMP_CODE_MMDU, MMDU_TYPE, MMDU_SEQ,
                MMDU_FACTOR, MTD_MMDU);

                X_COMP_CODE_MBRT.Value = "MBRT";
                SubFile(ref m_trnTRANS_UPDATE, ref fleU110_MBRT, fleF050_DOC_REVENUE_MSTR.At("DOCREV_CLINIC_1_2") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DEPT") || fleF050_DOC_REVENUE_MSTR.At("DOCREV_DOC_NBR"), QDesign.NULL(MTD_MBRT.Value) != 0, SubFileType.Keep, SubFileMode.Append, fleF050_DOC_REVENUE_MSTR, "DOCREV_DOC_NBR", X_COMP_CODE_MBRT, MBRT_TYPE, MBRT_SEQ,
