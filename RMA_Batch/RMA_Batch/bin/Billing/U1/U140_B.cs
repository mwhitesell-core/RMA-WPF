...
public class U140_B_F075_UPDATE_DOC_RECS_WITH_RA_TOTAL_2 : U140_B
{
        ...
        : base(Name, Level, true)
    {
        ...
        fleF075_UPDATE = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "F075_AFP_DOC_MSTR", "F075_UPDATE", false, false, false, 0, "m_trnTRANS_UPDATE");

        X_RA_PERCENTAGE.GetValue += X_RA_PERCENTAGE_GetValue;
        fleF075_AFP_DOC_MSTR.SetItemFinals += fleF075_UPDATE_SetItemFinals;
        fleF075_UPDATE.InitializeItems += fleF075_UPDATE_AutomaticItemInitialization;
    ...
    private SqlFileObject fleF075_UPDATE;

    private void fleF075_UPDATE_SetItemFinals()
    {
    ...
    //# NOTE: This region is placeholder and is required by the RenaissanceArchitectPreCompilerAddIn.
    //# Do not delete, modify or move it.  Updated: 6/27/2017 4:10:39 PM

    //#-----------------------------------------
    //# fleF075_UPDATE_AutomaticItemInitialization Procedure
    //# Precompiler Ver.: 1.0.6387.27217  Generated on: 6/27/2017 4:10:38 PM
    //#-----------------------------------------
    private void fleF075_UPDATE_AutomaticItemInitialization(bool Fixed)
    {
        try
        {
            //TODO: Manual steps may be required.
            fleF075_UPDATE.set_SetValue("DOC_OHIP_NBR", !Fixed, fleF075_AFP_DOC_MSTR.GetDecimalValue("DOC_OHIP_NBR"));
            fleF075_UPDATE.set_SetValue("DOC_NBR", !Fixed, fleF075_AFP_DOC_MSTR.GetStringValue("DOC_NBR"));
            fleF075_UPDATE.set_SetValue("DOC_AFP_PAYM_GROUP", !Fixed, fleF075_AFP_DOC_MSTR.GetStringValue("DOC_AFP_PAYM_GROUP"));
            fleF075_UPDATE.set_SetValue("AFP_REPORTING_MTH", !Fixed, fleF075_AFP_DOC_MSTR.GetStringValue("AFP_REPORTING_MTH"));
            fleF075_UPDATE.set_SetValue("AFP_MULTI_DOC_RA_PERCENTAGE", !Fixed, fleF075_AFP_DOC_MSTR.GetDecimalValue("AFP_MULTI_DOC_RA_PERCENTAGE"));
            fleF075_UPDATE.set_SetValue("RA_PAYMENT_AMT", !Fixed, fleF075_AFP_DOC_MSTR.GetDecimalValue("RA_PAYMENT_AMT"));
            fleF075_UPDATE.set_SetValue("RA_PAYMENT_AMT_TOTAL", !Fixed, fleF075_AFP_DOC_MSTR.GetDecimalValue("RA_PAYMENT_AMT_TOTAL"));
            fleF075_UPDATE.set_SetValue("AFP_PAYMENT_AMT", !Fixed, fleF075_AFP_DOC_MSTR.GetDecimalValue("AFP_PAYMENT_AMT"));
            fleF075_UPDATE.set_SetValue("AFP_PAYMENT_AMT_TOTAL", !Fixed, fleF075_AFP_DOC_MSTR.GetDecimalValue("AFP_PAYMENT_AMT_TOTAL"));
            fleF075_UPDATE.set_SetValue("AFP_SUBMISSION_AMT", !Fixed, fleF075_AFP_DOC_MSTR.GetDecimalValue("AFP_SUBMISSION_AMT"));
            fleF075_UPDATE.set_SetValue("AFP_DUPLICATE_DOC_COUNT", !Fixed, fleF075_AFP_DOC_MSTR.GetDecimalValue("AFP_DUPLICATE_DOC_COUNT"));
    ...
    private void Initialize_TRANS_UPDATE()
    {
        ...
        fleF075_UPDATE.Transaction = m_trnTRANS_UPDATE;
...
public class U140_B_F075_ENSURE_PERCENTAGE_IS_100_3 : U140_B
{
    ...
    private void fleF075_UPDATE_SetItemFinals()
    {
        ...
        try
        {
            fleF075_UPDATE.set_SetValue("AFP_MULTI_DOC_RA_PERCENTAGE", X_FINAL_PERCENTAGE.Value);
    ...
    //#-----------------------------------------
    //# fleF075_UPDATE_AutomaticItemInitialization Procedure
    //# Precompiler Ver.: 1.0.6387.27217  Generated on: 6/27/2017 4:10:40 PM
    //#-----------------------------------------
    private void fleF075_UPDATE_AutomaticItemInitialization(bool Fixed)
    {
        try
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleF075_AFP_DOC_MSTR, fleF020_DOCTOR_MSTR))
            {
                ...
                fleF075_UPDATE.OutPut(OutPutType.Update, null, QDesign.NULL(X_REC_COUNT.Value) == QDesign.NULL(fleF075_AFP_DOC_MSTR.GetDecimalValue("AFP_DUPLICATE_DOC_COUNT")));
