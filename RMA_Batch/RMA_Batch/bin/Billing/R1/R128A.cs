    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleF119_DOCTOR_YTD_HISTORY, fleF020_DOCTOR_MSTR))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleR128A, fleF119_DOCTOR_YTD_HISTORY.At("DOC_NBR"), SubFileType.Keep, fleF119_DOCTOR_YTD_HISTORY, "DOC_NBR", fleF020_DOCTOR_MSTR, "DOC_DEPT", "DOC_NAME", "DOC_DATE_FAC_START",
                "DOC_DATE_FAC_TERM", "DOC_EP_PAY_CODE", "DOC_EP_PAY_SUB_CODE", X_BILL, X_AFPIN, X_AFPOUT, X_BILL_AFPIN_AFPOUT);
...
public class R128A_CHECK_CLAIM_BALANCE_4 : R128A
{
    ...
    private void FleF002_CLAIMS_MSTR_SelectIf(ref string SelectIfClause)
    {
        try
        {
            ...
            strSQL.Append(" ").Append(fleF002_CLAIMS_MSTR.ElementOwner("KEY_CLM_SERV_CODE")).Append(" = ");
            strSQL.Append(Common.StringToField("00000"));
            strSQL.Append(" And ").Append(fleF002_CLAIMS_MSTR.ElementOwner("KEY_CLM_ADJ_NBR")).Append(" = ");
    ...
    public override bool SelectIf()
    {
        ...
        try
        {
            if ((QDesign.NULL(CLINIC_NBR.Value) == "22" | QDesign.NULL(CLINIC_NBR.Value) == "23" | QDesign.NULL(CLINIC_NBR.Value) == "24" | QDesign.NULL(CLINIC_NBR.Value) == "25" | QDesign.NULL(CLINIC_NBR.Value) == "26") | (QDesign.NULL(fleICONST_MSTR_REC.GetStringValue("ICONST_CLINIC_CARD_COLOUR")) == "Y" & QDesign.NULL(fleF020_DOCTOR_MSTR.GetStringValue("DOC_AFP_PAYM_GROUP")) != QDesign.NULL(" ") & (string.Compare(QDesign.NULL(CLINIC_NBR.Value), "71") < 0 | string.Compare(QDesign.NULL(CLINIC_NBR.Value) , "75")>0)))
            {
                return true;
            }
    ...
    public void Run()
    {
        ...
        try
        {
                ...
                while (fleF002_CLAIMS_MSTR.QTPForMissing("1"))
                {
                    ...
                    while (fleICONST_MSTR_REC.QTPForMissing("2"))
                    {
                        ...
                        while (fleF020_DOCTOR_MSTR.QTPForMissing("3"))
                        {
                            ...
                            m_strWhere = new StringBuilder(" WHERE ");
                            m_strWhere.Append(" ").Append(fleF020_DOCTOR_MSTR.ElementOwner("DOC_NBR")).Append(" = ");
                            m_strWhere.Append(Common.StringToField(QDesign.Substring(fleF002_OUTSTANDING.GetStringValue("KEY_CLM_BATCH_NBR"), 3, 3)));
            ...
            while (Sort(fleF002_OUTSTANDING, fleF002_CLAIMS_MSTR, fleICONST_MSTR_REC, fleF020_DOCTOR_MSTR))
            {
                X_CLAIM_BAL.Value = X_CLAIM_BAL.Value + fleF002_CLAIMS_MSTR.GetDecimalValue("CLMHDR_TOT_CLAIM_AR_OHIP") + fleF002_CLAIMS_MSTR.GetDecimalValue("CLMHDR_MANUAL_AND_TAPE_PAYMENTS");
            ...
            while (fleR128A_INACTIVE.QTPForMissing())
            {
                ...
                while (fleTMP_COUNTERS_ALPHA.QTPForMissing("1"))
                {
                    ...
                    if (Transaction())
                    {
                        ...
                        SubFile(ref m_trnTRANS_UPDATE, ref fleR128A_INACTIVE_DOC_WITH_CLM, SubFileType.Keep, fleTMP_COUNTERS_ALPHA, "X_CLAIM_BAL", fleR128A_INACTIVE);
