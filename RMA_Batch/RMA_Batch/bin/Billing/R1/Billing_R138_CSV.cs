...
public class Billing_R138_CSV : BaseClassControl
{

    private Billing_R138_CSV m_Billing_R138_CSV;

    public Billing_R138_CSV(string Name, int Level)
        : base(Name, Level)
    {
    ...
    public Billing_R138_CSV(string Name, int Level, bool Request)
    ...
    {
        if ((m_Billing_R138_CSV != null))
        {
            m_Billing_R138_CSV.CloseTransactionObjects();
            m_Billing_R138_CSV = null;
        }
    }

    public Billing_R138_CSV GetBilling_R138_CSV(int Level)
    {
        if (m_Billing_R138_CSV == null)
        {
            m_Billing_R138_CSV = new Billing_R138_CSV("Billing_R138_CSV", Level);
        }
        else
        {
            m_Billing_R138_CSV.ResetValues();
        }
        return m_Billing_R138_CSV;
    }
    ...
    public override bool RunQTP()
    {
        ...
        try
        {
            ...
            Billing_R138_CSV_EXTRACT_F110_1 EXTRACT_F110_1 = new Billing_R138_CSV_EXTRACT_F110_1(Name, Level);
            EXTRACT_F110_1.Run();
            EXTRACT_F110_1.Dispose();
            EXTRACT_F110_1 = null;

            Billing_R138_CSV_EXTRACT_F119_2 EXTRACT_F119_2 = new Billing_R138_CSV_EXTRACT_F119_2(Name, Level);
            EXTRACT_F119_2.Run();
            EXTRACT_F119_2.Dispose();
            EXTRACT_F119_2 = null;

            Billing_R138_CSV_MERGE_BY_DOC_3 MERGE_BY_DOC_3 = new Billing_R138_CSV_MERGE_BY_DOC_3(Name, Level);
            MERGE_BY_DOC_3.Run();
...
public class Billing_R138_CSV_EXTRACT_F110_1 : Billing_R138_CSV
{

    public Billing_R138_CSV_EXTRACT_F110_1(string Name, int Level)
        : base(Name, Level, true)
    {
        ...
        fleBilling_R138_CSV = new SqlFileObject(this, FileTypes.Primary, 0, "TEMPORARYDATA", "Billing_R138_CSV", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SubFile);
    ...
    #region "Declarations (Variables, Files and Transactions)(Billing_R138_CSV_EXTRACT_F110_1)"
    ...
    private SqlFileObject fleBilling_R138_CSV;


    #endregion


    #region "Standard Generated Procedures(Billing_R138_CSV_EXTRACT_F110_1)"


    #region "Automatic Item Initialization(Billing_R138_CSV_EXTRACT_F110_1)"
    ...
    #region "Transaction Management Procedures(Billing_R138_CSV_EXTRACT_F110_1)"
    ...
    private void Initialize_TRANS_UPDATE()
    {
        ...
        fleBilling_R138_CSV.Transaction = m_trnTRANS_UPDATE;
    ...
    #region "FILE Management Procedures(Billing_R138_CSV_EXTRACT_F110_1)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(Billing_R138_CSV_EXTRACT_F110_1)"
                    ...
                    while (fleF020_DOCTOR_MSTR.QTPForMissing("2"))
                    {
                        ...
                        while (fleF070_DEPT_MSTR.QTPForMissing("3"))
                        {
                            ...
                            if (Transaction())
                            {
                                 ...
                                 if (Select_If())
                                {
                                    SubFile(ref m_trnTRANS_UPDATE, ref fleBilling_R138_CSV, SubFileType.Keep, fleF070_DEPT_MSTR, "DEPT_COMPANY", fleF020_DOCTOR_MSTR, "DOC_DEPT", fleF110_COMPENSATION, "DOC_NBR", fleF020_DOCTOR_MSTR,
...
public class Billing_R138_CSV_EXTRACT_F119_2 : Billing_R138_CSV
{

    public Billing_R138_CSV_EXTRACT_F119_2(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
    ...
    #region "Declarations (Variables, Files and Transactions)(Billing_R138_CSV_EXTRACT_F119_2)"
    ...
    #region "Standard Generated Procedures(Billing_R138_CSV_EXTRACT_F119_2)"


    #region "Automatic Item Initialization(Billing_R138_CSV_EXTRACT_F119_2)"
    ...
    #region "Transaction Management Procedures(Billing_R138_CSV_EXTRACT_F119_2)"
    ...
    #region "FILE Management Procedures(Billing_R138_CSV_EXTRACT_F119_2)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(Billing_R138_CSV_EXTRACT_F119_2)"
                    ...
                    while (fleF020_DOCTOR_MSTR.QTPForMissing("2"))
                    {
                        ...
                        while (fleF070_DEPT_MSTR.QTPForMissing("3"))
                        {
                            ...
                            if (Transaction())
                            {
                                 ...
                                 if (Select_If())
                                {
                                    SubFile(ref m_trnTRANS_UPDATE, ref fleBilling_R138_CSV, SubFileType.Temp, fleF070_DEPT_MSTR, "DEPT_COMPANY", fleF020_DOCTOR_MSTR, "DOC_DEPT", fleF119_DOCTOR_YTD, "DOC_NBR", fleF020_DOCTOR_MSTR,
...
public class Billing_R138_CSV_MERGE_BY_DOC_3 : Billing_R138_CSV
{

    public Billing_R138_CSV_MERGE_BY_DOC_3(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        fleBilling_R138_CSV = new SqlFileObject(this, FileTypes.Primary, 0, "TEMPORARYDATA", "Billing_R138_CSV", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SubFile);
        ...
        fleBilling_R138_CSV_DOC = new SqlFileObject(this, FileTypes.Primary, 0, "TEMPORARYDATA", "Billing_R138_CSV_DOC", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SubFile);


    }


    #region "Declarations (Variables, Files and Transactions)(Billing_R138_CSV_MERGE_BY_DOC_3)"

    private SqlFileObject fleBilling_R138_CSV;
    private CoreDecimal DEFICIT_AMT;
    private CoreDecimal ADVOUT_AMT;
    private SqlFileObject fleBilling_R138_CSV_DOC;


    #endregion


    #region "Standard Generated Procedures(Billing_R138_CSV_MERGE_BY_DOC_3)"


    #region "Automatic Item Initialization(Billing_R138_CSV_MERGE_BY_DOC_3)"
    ...
    #region "Transaction Management Procedures(Billing_R138_CSV_MERGE_BY_DOC_3)"
    ...
    {
        fleBilling_R138_CSV.Transaction = m_trnTRANS_UPDATE;
        fleBilling_R138_CSV_DOC.Transaction = m_trnTRANS_UPDATE;
    ...
    #region "FILE Management Procedures(Billing_R138_CSV_MERGE_BY_DOC_3)"
    ...
    protected override void CloseFiles()
    {
        ...
        {
            fleBilling_R138_CSV.Dispose();
            fleBilling_R138_CSV_DOC.Dispose();
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(Billing_R138_CSV_MERGE_BY_DOC_3)"
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (fleBilling_R138_CSV.QTPForMissing())
            {
                // --> GET Billing_R138_CSV <--

                fleBilling_R138_CSV.GetData();
                // --> End GET Billing_R138_CSV <--


                if (Transaction())
                {

                    Sort(fleBilling_R138_CSV.GetSortValue("DOC_NBR"));
            ...
            while (Sort(fleBilling_R138_CSV))
            {
                DEFICIT_AMT.Value = DEFICIT_AMT.Value + fleBilling_R138_CSV.GetDecimalValue("X_DEFICIT_AMT");
                ADVOUT_AMT.Value = ADVOUT_AMT.Value + fleBilling_R138_CSV.GetDecimalValue("X_ADVOUT_AMT");

                SubFile(ref m_trnTRANS_UPDATE, ref fleBilling_R138_CSV_DOC, fleBilling_R138_CSV.At("DOC_NBR"), SubFileType.Keep, fleBilling_R138_CSV, "DEPT_COMPANY", "DOC_DEPT", "DOC_NBR", "DOC_NAME", "EP_NBR",
                "DOC_EP_PAY_CODE", "DOC_EP_PAY_SUB_CODE", DEFICIT_AMT, ADVOUT_AMT);


                Reset(ref DEFICIT_AMT, fleBilling_R138_CSV.At("DOC_NBR"));
                Reset(ref ADVOUT_AMT, fleBilling_R138_CSV.At("DOC_NBR"));
