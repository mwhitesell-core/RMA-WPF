...
public class Billing_F050_BI : BaseClassControl
{

    private Billing_F050_BI m_Billing_F050_BI;

    public Billing_F050_BI(string Name, int Level)
        : base(Name, Level)
    {
    ...
    public Billing_F050_BI(string Name, int Level, bool Request)
    ...
    {
        if ((m_Billing_F050_BI != null))
        {
            m_Billing_F050_BI.CloseTransactionObjects();
            m_Billing_F050_BI = null;
        }
    }

    public Billing_F050_BI GetBilling_F050_BI(int Level)
    {
        if (m_Billing_F050_BI == null)
        {
            m_Billing_F050_BI = new Billing_F050_BI("Billing_F050_BI", Level);
        }
        else
        {
            m_Billing_F050_BI.ResetValues();
        }
        return m_Billing_F050_BI;
    }
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (fleF050MA1.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                    SubFile(ref m_trnTRANS_UPDATE, ref fleBI_F050, SubFileType.Keep, fleF050MA1, "DOCREV_CLINIC_1_2", X_DELIMITER, "DOCREV_DEPT", "DOC_NBR", "DOCREV_LOCATION", "DOCREV_MTD_IN_REC",
    ...
    #region "Standard Generated Procedures(Billing_F050_BI_Billing_F050_BI)"

    #region "Transaction Management Procedures(Billing_F050_BI_Billing_F050_BI)"
    ...
    #region "FILE Management Procedures(Billing_F050_BI_Billing_F050_BI)"
