...
public class Billing_F050_CSV : BaseClassControl
{

    private Billing_F050_CSV m_Billing_F050_CSV;

    public Billing_F050_CSV(string Name, int Level)
        : base(Name, Level)
    {
    ...
    public Billing_F050_CSV(string Name, int Level, bool Request)
    ...
    {
        if ((m_Billing_F050_CSV != null))
        {
            m_Billing_F050_CSV.CloseTransactionObjects();
            m_Billing_F050_CSV = null;
        }
    }

    public Billing_F050_CSV GetBilling_F050_CSV(int Level)
    {
        if (m_Billing_F050_CSV == null)
        {
            m_Billing_F050_CSV = new Billing_F050_CSV("Billing_F050_CSV", Level);
        }
        else
        {
            m_Billing_F050_CSV.ResetValues();
        }
        return m_Billing_F050_CSV;
    }
    ...
    public override bool RunQTP()
    {
        ...
        try
        {
            ...
            Billing_F050_CSV_EXTRACT_F050HST_1 EXTRACT_F050HST_1 = new Billing_F050_CSV_EXTRACT_F050HST_1(Name, Level);
            EXTRACT_F050HST_1.Run();
            EXTRACT_F050HST_1.Dispose();
            EXTRACT_F050HST_1 = null;

            Billing_F050_CSV_CREATE_2 CREATE_2 = new Billing_F050_CSV_CREATE_2(Name, Level);
            CREATE_2.Run();
            CREATE_2.Dispose();
            CREATE_2 = null;
...
public class Billing_F050_CSV_EXTRACT_F050HST_1 : Billing_F050_CSV
{

    public Billing_F050_CSV_EXTRACT_F050HST_1(string Name, int Level)
    ...
    #region "Declarations (Variables, Files and Transactions)(Billing_F050_CSV_EXTRACT_F050HST_1)"
    ...
    #region "Standard Generated Procedures(Billing_F050_CSV_EXTRACT_F050HST_1)"


    #region "Automatic Item Initialization(Billing_F050_CSV_EXTRACT_F050HST_1)"
    ...
    #region "Transaction Management Procedures(Billing_F050_CSV_EXTRACT_F050HST_1)"
    ...
    #region "FILE Management Procedures(Billing_F050_CSV_EXTRACT_F050HST_1)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(Billing_F050_CSV_EXTRACT_F050HST_1)"
...
public class Billing_F050_CSV_CREATE_2 : Billing_F050_CSV
{

    public Billing_F050_CSV_CREATE_2(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        fleF050A = new SqlFileObject(this, FileTypes.Primary, 0, "TEMPORARYDATA", "F050A", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SubFile);
        fleBI_Billing_F050_CSV = new SqlFileObject(this, FileTypes.Primary, 0, "TEMPORARYDATA", "BI_Billing_F050_CSV", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SubFile);
    ...
    #region "Declarations (Variables, Files and Transactions)(Billing_F050_CSV_CREATE_2)"
    ...
    private SqlFileObject fleBI_Billing_F050_CSV;


    #endregion


    #region "Standard Generated Procedures(Billing_F050_CSV_CREATE_2)"


    #region "Automatic Item Initialization(Billing_F050_CSV_CREATE_2)"
    ...
    #region "Transaction Management Procedures(Billing_F050_CSV_CREATE_2)"
    ...
    {
        fleF050A.Transaction = m_trnTRANS_UPDATE;
        fleBI_Billing_F050_CSV.Transaction = m_trnTRANS_UPDATE;
    ...
    #region "FILE Management Procedures(Billing_F050_CSV_CREATE_2)"
    ...
    protected override void CloseFiles()
    {
        ...
        {
            fleF050A.Dispose();
            fleBI_Billing_F050_CSV.Dispose();
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(Billing_F050_CSV_CREATE_2)"
        ...
        try
        {
            ...
            while (fleF050A.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                    ...
                    SubFile(ref m_trnTRANS_UPDATE, ref fleBI_Billing_F050_CSV, SubFileType.Keep, PED, X_DELIMITER, fleF050A, X_LF);
