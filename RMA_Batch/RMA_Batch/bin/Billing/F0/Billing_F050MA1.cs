...
public class Billing_F050MA1 : BaseClassControl
{

    private Billing_F050MA1 m_Billing_F050MA1;

    public Billing_F050MA1(string Name, int Level)
        : base(Name, Level)
    {
        ...
        fleBilling_F050MA1 = new SqlFileObject(this, FileTypes.Primary, 0, "TEMPORARYDATA", "Billing_F050MA1", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SubFile);
    ...
    public Billing_F050MA1(string Name, int Level, bool Request)
    ...
    {
        if ((m_Billing_F050MA1 != null))
        {
            m_Billing_F050MA1.CloseTransactionObjects();
            m_Billing_F050MA1 = null;
        }
    }

    public Billing_F050MA1 GetBilling_F050MA1(int Level)
    {
        if (m_Billing_F050MA1 == null)
        {
            m_Billing_F050MA1 = new Billing_F050MA1("Billing_F050MA1", Level);
        }
        else
        {
            m_Billing_F050MA1.ResetValues();
        }
        return m_Billing_F050MA1;
    }
    ...
    private SqlFileObject fleBilling_F050MA1;
                    ...
                    while (fleF040_OMA_FEE_MSTR.QTPForMissing("2"))
                    {
                        ...
                        if (Transaction())
                        {
                             ...
                             if (Select_If())
                            {
                                ...
                                SubFile(ref m_trnTRANS_UPDATE, ref fleBilling_F050MA1, SubFileType.Keep, fleF050_DOC_REVENUE_MSTR, "DOCREV_CLINIC_1_2", "DOCREV_DEPT", DOC_NBR, "DOCREV_LOCATION", FIXED_DOCREV_OMA_CD, PRESORT_CODE,
    ...
    #region "Standard Generated Procedures(Billing_F050MA1_Billing_F050MA1)"

    #region "Transaction Management Procedures(Billing_F050MA1_Billing_F050MA1)"
    ...
    private void Initialize_TRANS_UPDATE()
    {
        ...
        fleBilling_F050MA1.Transaction = m_trnTRANS_UPDATE;
    ...
    #region "FILE Management Procedures(Billing_F050MA1_Billing_F050MA1)"
