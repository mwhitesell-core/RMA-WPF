        ...
        try
        {
            ...
            while (fleF050_DOC_REVENUE_MSTR_HISTORY.QTPForMissing())
            {
                ...
                while (fleF020_DOCTOR_MSTR.QTPForMissing("1"))
                {
                    ...
                    while (fleDOC_TOTALS_TMP.QTPForMissing("2"))
                    {
                        // --> GET DOC_TOTALS_TMP <--
                        m_strWhere = new StringBuilder(" WHERE ");
                        ...
                        while (fleICONST_MSTR_REC.QTPForMissing("3"))
                        {
                            ...
                            if (Transaction())
                            {
                                 ...
                                 if (Select_If())
                                {
                                    ...
                                    Sort(fleF050_DOC_REVENUE_MSTR_HISTORY.GetSortValue("DOCREV_CLINIC_1_2"), fleF050_DOC_REVENUE_MSTR_HISTORY.GetSortValue("DOCREV_DEPT"), fleF050_DOC_REVENUE_MSTR_HISTORY.GetSortValue("DOCREV_DOC_NBR"), fleF050_DOC_REVENUE_MSTR_HISTORY.GetSortValue("DOCREV_LOCATION"), fleF050_DOC_REVENUE_MSTR_HISTORY.GetSortValue("DOCREV_OMA_CODE"), fleF050_DOC_REVENUE_MSTR_HISTORY.GetSortValue("DOCREV_OMA_SUFF"), fleF050_DOC_REVENUE_MSTR_HISTORY.GetSortValue("DOCREV_ADJ_CD_SUB_TYPE"), fleF050_DOC_REVENUE_MSTR_HISTORY.GetSortValue("DOCREV_DOC_NBR"));
            ...
            while (Sort(fleF050_DOC_REVENUE_MSTR_HISTORY, fleF020_DOCTOR_MSTR, fleDOC_TOTALS_TMP, fleICONST_MSTR_REC))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref fleCOSTING2, fleF050_DOC_REVENUE_MSTR_HISTORY.At("DOCREV_KEY") || fleF050_DOC_REVENUE_MSTR_HISTORY.At("DOCREV_DOC_NBR"), SubFileType.Keep, fleF050_DOC_REVENUE_MSTR_HISTORY, "DOC_NBR", fleF020_DOCTOR_MSTR, "DOC_NAME", "DOC_INITS", "DOC_DEPT",
                "DOC_CLINIC_NBR", NBR_SVC, NBR_CLM, NBR_DTL, NBR_REJECT, AMT_YTD, MISC_AMT_YTD, MOHR_AMT_YTD, TOTAL_AMT_YTD, MAN_REJECT);



                Reset(ref AMT_YTD, fleF050_DOC_REVENUE_MSTR_HISTORY.At("DOCREV_KEY") || fleF050_DOC_REVENUE_MSTR_HISTORY.At("DOCREV_DOC_NBR"));
                Reset(ref MISC_AMT_YTD, fleF050_DOC_REVENUE_MSTR_HISTORY.At("DOCREV_KEY") || fleF050_DOC_REVENUE_MSTR_HISTORY.At("DOCREV_DOC_NBR"));
                Reset(ref MOHR_AMT_YTD, fleF050_DOC_REVENUE_MSTR_HISTORY.At("DOCREV_KEY") || fleF050_DOC_REVENUE_MSTR_HISTORY.At("DOCREV_DOC_NBR"));
