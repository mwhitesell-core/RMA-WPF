    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (Sort(fleF002_CLAIMS_MSTR, fleF010_PAT_MSTR))
            {
                ...
                SubFile(ref m_trnTRANS_UPDATE, ref flePATIENTS, fleF010_PAT_MSTR.At("PAT_HEALTH_NBR"), SubFileType.Portable, fleF010_PAT_MSTR, "PAT_SURNAME", COMMA, "PAT_GIVEN_NAME", "PAT_HEALTH_NBR", "PAT_VERSION_CD",
