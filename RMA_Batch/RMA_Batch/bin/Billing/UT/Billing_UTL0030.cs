...
public class Billing_UTL0030 : BaseClassControl
{

    private Billing_UTL0030 m_Billing_UTL0030;

    public Billing_UTL0030(string Name, int Level)
        : base(Name, Level)
    {
    ...
    public Billing_UTL0030(string Name, int Level, bool Request)
    ...
    {
        if ((m_Billing_UTL0030 != null))
        {
            m_Billing_UTL0030.CloseTransactionObjects();
            m_Billing_UTL0030 = null;
        }
    }

    public Billing_UTL0030 GetBilling_UTL0030(int Level)
    {
        if (m_Billing_UTL0030 == null)
        {
            m_Billing_UTL0030 = new Billing_UTL0030("Billing_UTL0030", Level);
        }
        else
        {
            m_Billing_UTL0030.ResetValues();
        }
        return m_Billing_UTL0030;
    }
    ...
    public override bool RunQTP()
    {
        ...
        try
        {
            ...
            Billing_UTL0030_CONST_REC6_1 CONST_REC6_1 = new Billing_UTL0030_CONST_REC6_1(Name, Level);
            CONST_REC6_1.Run();
            CONST_REC6_1.Dispose();
            CONST_REC6_1 = null;

            Billing_UTL0030_F030_2 F030_2 = new Billing_UTL0030_F030_2(Name, Level);
            F030_2.Run();
            F030_2.Dispose();
            F030_2 = null;

            Billing_UTL0030_F070_3 F070_3 = new Billing_UTL0030_F070_3(Name, Level);
            F070_3.Run();
            F070_3.Dispose();
            F070_3 = null;

            Billing_UTL0030_F190_4 F190_4 = new Billing_UTL0030_F190_4(Name, Level);
            F190_4.Run();
            F190_4.Dispose();
            F190_4 = null;

            Billing_UTL0030_F090_CLINIC_5 F090_CLINIC_5 = new Billing_UTL0030_F090_CLINIC_5(Name, Level);
            F090_CLINIC_5.Run();
            F090_CLINIC_5.Dispose();
            F090_CLINIC_5 = null;

            Billing_UTL0030_F123_6 F123_6 = new Billing_UTL0030_F123_6(Name, Level);
            F123_6.Run();
            F123_6.Dispose();
            F123_6 = null;
...
public class Billing_UTL0030_CONST_REC6_1 : Billing_UTL0030
{

    public Billing_UTL0030_CONST_REC6_1(string Name, int Level)
    ...
    #region "Declarations (Variables, Files and Transactions)(Billing_UTL0030_CONST_REC6_1)"
    ...
    #region "Standard Generated Procedures(Billing_UTL0030_CONST_REC6_1)"


    #region "Automatic Item Initialization(Billing_UTL0030_CONST_REC6_1)"
    ...
    #region "Transaction Management Procedures(Billing_UTL0030_CONST_REC6_1)"
    ...
    #region "FILE Management Procedures(Billing_UTL0030_CONST_REC6_1)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(Billing_UTL0030_CONST_REC6_1)"
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (fleCONSTANTS_MSTR_REC_6.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                    SubFile(ref m_trnTRANS_UPDATE, ref fleUTL0F090_REC6, SubFileType.Keep, fleCONSTANTS_MSTR_REC_6, "CURRENT_EP_NBR", X_LF);
...
public class Billing_UTL0030_F030_2 : Billing_UTL0030
{

    public Billing_UTL0030_F030_2(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
    ...
    #region "Declarations (Variables, Files and Transactions)(Billing_UTL0030_F030_2)"
    ...
    #region "Standard Generated Procedures(Billing_UTL0030_F030_2)"


    #region "Automatic Item Initialization(Billing_UTL0030_F030_2)"
    ...
    #region "Transaction Management Procedures(Billing_UTL0030_F030_2)"
    ...
    #region "FILE Management Procedures(Billing_UTL0030_F030_2)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(Billing_UTL0030_F030_2)"
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (fleF030_LOCATIONS_MSTR.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                    SubFile(ref m_trnTRANS_UPDATE, ref fleUTL0F030, SubFileType.Keep, fleF030_LOCATIONS_MSTR, "LOC_NBR", X_DELIMITER, "LOC_NAME", "LOC_CLINIC_NBR", "LOC_HOSPITAL_NBR", "LOC_HOSPITAL_CODE",
...
public class Billing_UTL0030_F070_3 : Billing_UTL0030
{

    public Billing_UTL0030_F070_3(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
    ...
    #region "Declarations (Variables, Files and Transactions)(Billing_UTL0030_F070_3)"
    ...
    #region "Standard Generated Procedures(Billing_UTL0030_F070_3)"


    #region "Automatic Item Initialization(Billing_UTL0030_F070_3)"
    ...
    #region "Transaction Management Procedures(Billing_UTL0030_F070_3)"
    ...
    #region "FILE Management Procedures(Billing_UTL0030_F070_3)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(Billing_UTL0030_F070_3)"
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (fleF070_DEPT_MSTR.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                    SubFile(ref m_trnTRANS_UPDATE, ref fleUTL0F070, SubFileType.Keep, fleF070_DEPT_MSTR, "DEPT_NBR", X_DELIMITER, "DEPT_NAME", "DEPT_ADDR1", "DEPT_ADDR2", "DEPT_ADDR3",
...
public class Billing_UTL0030_F190_4 : Billing_UTL0030
{

    public Billing_UTL0030_F190_4(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
    ...
    #region "Declarations (Variables, Files and Transactions)(Billing_UTL0030_F190_4)"
    ...
    #region "Standard Generated Procedures(Billing_UTL0030_F190_4)"


    #region "Automatic Item Initialization(Billing_UTL0030_F190_4)"
    ...
    #region "Transaction Management Procedures(Billing_UTL0030_F190_4)"
    ...
    #region "FILE Management Procedures(Billing_UTL0030_F190_4)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(Billing_UTL0030_F190_4)"
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (fleF190_COMP_CODES.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                    SubFile(ref m_trnTRANS_UPDATE, ref fleUTL0F190, SubFileType.Keep, fleF190_COMP_CODES, "COMP_CODE", X_DELIMITER, "COMP_TYPE", "DESC_LONG", "DESC_SHORT", X_LF);
...
public class Billing_UTL0030_F090_CLINIC_5 : Billing_UTL0030
{

    public Billing_UTL0030_F090_CLINIC_5(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
    ...
    #region "Declarations (Variables, Files and Transactions)(Billing_UTL0030_F090_CLINIC_5)"
    ...
    #region "Standard Generated Procedures(Billing_UTL0030_F090_CLINIC_5)"


    #region "Automatic Item Initialization(Billing_UTL0030_F090_CLINIC_5)"
    ...
    #region "Transaction Management Procedures(Billing_UTL0030_F090_CLINIC_5)"
    ...
    #region "FILE Management Procedures(Billing_UTL0030_F090_CLINIC_5)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(Billing_UTL0030_F090_CLINIC_5)"
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (fleICONST_MSTR_REC.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                    SubFile(ref m_trnTRANS_UPDATE, ref fleUTL0F090_CLINIC, SubFileType.Keep, fleICONST_MSTR_REC, "ICONST_CLINIC_NBR_1_2", X_DELIMITER, "ICONST_CLINIC_NBR", "ICONST_CLINIC_NAME", X_LF);
...
public class Billing_UTL0030_F123_6 : Billing_UTL0030
{

    public Billing_UTL0030_F123_6(string Name, int Level)
        : base(Name, Level, true)
    {
        this.ScreenType = ScreenTypes.QTP;
        fleF123_COMPANY_MSTR = new SqlFileObject(this, FileTypes.Primary, 0, "INDEXED", "F123_COMPANY_MSTR", "", false, false, false, 0, "m_trnTRANS_UPDATE");
    ...
    #region "Declarations (Variables, Files and Transactions)(Billing_UTL0030_F123_6)"
    ...
    #region "Standard Generated Procedures(Billing_UTL0030_F123_6)"


    #region "Automatic Item Initialization(Billing_UTL0030_F123_6)"
    ...
    #region "Transaction Management Procedures(Billing_UTL0030_F123_6)"
    ...
    #region "FILE Management Procedures(Billing_UTL0030_F123_6)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(Billing_UTL0030_F123_6)"
    ...
    public void Run()
    {
        ...
        try
        {
            ...
            while (fleF123_COMPANY_MSTR.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                    SubFile(ref m_trnTRANS_UPDATE, ref fleUTL0F123, SubFileType.Keep, fleF123_COMPANY_MSTR, "COMPANY_NBR", X_DELIMITER, "COMPANY_NAME", X_LF);
