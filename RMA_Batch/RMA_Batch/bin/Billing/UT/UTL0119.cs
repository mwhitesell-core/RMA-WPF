            ...
            while (fleF020_DOCTOR_MSTR.QTPForMissing())
            {
                ...
                if (Transaction())
                {
                     ...
                     if (Select_If())
                    {
                        ...
                        SubFile(ref m_trnTRANS_UPDATE, ref fleUTL0F020_B, QDesign.NULL(fleF020_DOCTOR_MSTR.GetNumericDateValue("DOC_DATE_FAC_TERM")) == 0 | QDesign.NULL(fleF020_DOCTOR_MSTR.GetNumericDateValue("DOC_DATE_FAC_TERM")) > 20131201, SubFileType.Portable, ENVIRONMENT, X_DELIMITER, fleF020_DOCTOR_MSTR, X_LF);
