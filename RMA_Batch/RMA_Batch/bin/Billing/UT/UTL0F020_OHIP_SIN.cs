...
public class UTL0F020_OHIP_SIN_TWO_2 : UTL0F020_OHIP_SIN
{
    ...
    private void KEY2_GetValue(ref string Value)
    {
        ...
        try
        {
            Value = QDesign.ASCII(fleUTL0F020_COUNT.GetDecimalValue("DOC_OHIP_NBR"), 6) + QDesign.ASCII(fleUTL0F020_COUNT.GetDecimalValue("DOC_SIN_NBR"), 9);
...
public class UTL0F020_OHIP_SIN_THREE_3 : UTL0F020_OHIP_SIN
{
    ...
    private void KEY2_GetValue(ref string Value)
    {
        ...
        try
        {
            Value = QDesign.ASCII(fleUTL0F020_OHIP_SIN.GetDecimalValue("DOC_OHIP_NBR"), 6) + QDesign.ASCII(fleUTL0F020_OHIP_SIN.GetDecimalValue("DOC_SIN_NBR"), 9);
