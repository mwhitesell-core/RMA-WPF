...
public class UTL0200 : BaseClassControl
{

    private UTL0200 m_UTL0200;

    public UTL0200(string Name, int Level)
        : base(Name, Level)
    {
    ...
    public UTL0200(string Name, int Level, bool Request)
    ...
    public override void Dispose()
    {
        if ((m_UTL0200 != null))
        {
            m_UTL0200.CloseTransactionObjects();
            m_UTL0200 = null;
        }
    }

    public UTL0200 GetUTL0200(int Level)
    {
        if (m_UTL0200 == null)
        {
            m_UTL0200 = new UTL0200("UTL0200", Level);
        }
        else
        {
            m_UTL0200.ResetValues();
        }
        return m_UTL0200;
    }
    ...
    public override bool RunQTP()
    {
        ...
        try
        {
            ...
            UTL0200_DOWNLOAD_DOC_1_1 DOWNLOAD_DOC_1_1 = new UTL0200_DOWNLOAD_DOC_1_1(Name, Level);
...
public class UTL0200_DOWNLOAD_DOC_1_1 : UTL0200
{

    public UTL0200_DOWNLOAD_DOC_1_1(string Name, int Level)
        : base(Name, Level, true)
    {
        ...
        fleUTL0200 = new SqlFileObject(this, FileTypes.Primary, 0, "TEMPORARYDATA", "UTL0200", "", false, false, false, 0, "m_trnTRANS_UPDATE", FileType.SubFile);
    ...
    #region "Declarations (Variables, Files and Transactions)(UTL0200_DOWNLOAD_DOC_1_1)"
    ...
    private SqlFileObject fleUTL0200;


    #endregion


    #region "Standard Generated Procedures(UTL0200_DOWNLOAD_DOC_1_1)"


    #region "Automatic Item Initialization(UTL0200_DOWNLOAD_DOC_1_1)"
    ...
    #region "Transaction Management Procedures(UTL0200_DOWNLOAD_DOC_1_1)"
    ...
    private void Initialize_TRANS_UPDATE()
    {
        ...
        fleUTL0200.Transaction = m_trnTRANS_UPDATE;
    ...
    #region "FILE Management Procedures(UTL0200_DOWNLOAD_DOC_1_1)"
    ...
    #region "Local Procedures (DESIGNERS, INTERNAL and INPUT, EDIT, PROCESS and OUTPUT)(UTL0200_DOWNLOAD_DOC_1_1)"
                                        ...
                                        while (fleF028_SEC_HOME.QTPForMissing("7"))
                                        {
                                            ...
                                            while (fleF070_DEPT_MSTR.QTPForMissing("8"))
                                            {
                                                ...
                                                if (Transaction())
                                                {
                                                    ...
                                                    SubFile(ref m_trnTRANS_UPDATE, ref fleUTL0200, SubFileType.Portable, fleF020_DOCTOR_MSTR, "DOC_NBR", X_DELIMINER, "DOC_DEPT", fleF070_DEPT_MSTR, "DEPT_COMPANY", fleF020_DOCTOR_MSTR,
