...
public class UTL0017 : BaseClassControl
{
    ...
    private void fleF113_DEFAULT_COMP_SetItemFinals()
    {
        ...
        try
        {
            if (QDesign.NULL(fleF113_DEFAULT_COMP.GetDecimalValue("AMT_GROSS")) == 27417)
            {
                fleF113_DEFAULT_COMP.set_SetValue("AMT_GROSS", 27967);
            }
            else if (QDesign.NULL(fleF113_DEFAULT_COMP.GetDecimalValue("AMT_GROSS")) == 29292)
            {
                fleF113_DEFAULT_COMP.set_SetValue("AMT_GROSS", 29875);
            }
            else if (QDesign.NULL(fleF113_DEFAULT_COMP.GetDecimalValue("AMT_GROSS")) == 32292)
            {
                fleF113_DEFAULT_COMP.set_SetValue("AMT_GROSS", 32942);
            }
            else if (QDesign.NULL(fleF113_DEFAULT_COMP.GetDecimalValue("AMT_GROSS")) == 3564)
            {
                fleF113_DEFAULT_COMP.set_SetValue("AMT_GROSS", 3636);
            }
            else if (QDesign.NULL(fleF113_DEFAULT_COMP.GetDecimalValue("AMT_GROSS")) == 3808)
            {
                fleF113_DEFAULT_COMP.set_SetValue("AMT_GROSS", 3884);
            }
            else if (QDesign.NULL(fleF113_DEFAULT_COMP.GetDecimalValue("AMT_GROSS")) == 4198)
            {
                fleF113_DEFAULT_COMP.set_SetValue("AMT_GROSS", 4282);
            }
            if (QDesign.NULL(fleF113_DEFAULT_COMP.GetDecimalValue("AMT_GROSS")) ==27417)
            {
                fleF113_DEFAULT_COMP.set_SetValue("AMT_GROSS", 27967);
            ...
            if (QDesign.NULL(fleF113_DEFAULT_COMP.GetDecimalValue("AMT_NET")) == 27417)
            {
                fleF113_DEFAULT_COMP.set_SetValue("AMT_NET", 27967);
            }
            else if (QDesign.NULL(fleF113_DEFAULT_COMP.GetDecimalValue("AMT_NET")) == 29292)
            {
                fleF113_DEFAULT_COMP.set_SetValue("AMT_NET", 29875);
            }
            else if (QDesign.NULL(fleF113_DEFAULT_COMP.GetDecimalValue("AMT_NET")) == 32292)
            {
                fleF113_DEFAULT_COMP.set_SetValue("AMT_NET", 32942);
            }
            else if (QDesign.NULL(fleF113_DEFAULT_COMP.GetDecimalValue("AMT_NET")) == 3564)
            {
                fleF113_DEFAULT_COMP.set_SetValue("AMT_NET", 3636);
            }
            else if (QDesign.NULL(fleF113_DEFAULT_COMP.GetDecimalValue("AMT_NET")) == 3808)
            {
                fleF113_DEFAULT_COMP.set_SetValue("AMT_NET", 3884);
            }
            else if (QDesign.NULL(fleF113_DEFAULT_COMP.GetDecimalValue("AMT_NET")) == 4198)
            {
                fleF113_DEFAULT_COMP.set_SetValue("AMT_NET", 4282);
            }
            if (QDesign.NULL(fleF113_DEFAULT_COMP.GetDecimalValue("AMT_NET")) == 27417)
            {
                fleF113_DEFAULT_COMP.set_SetValue("AMT_NET", 27967);
